...
Процедура СообщитьРезультат(Знач Текст, Знач Статус = "")
	...
	Если ЗначениеЗаполнено(ФайлВывода) Тогда
		...
		Если ФайлВыводаНормализованный = "<base64>" Или ФайлВыводаНормализованный = "<hex>" Тогда
			
			Текст = ПолучитьПредставлениеДвоичныхДанных(Текст, ФайлВывода);
