Функция ПолучитьСостав() Экспорт
    ...
    НоваяСтрока.Библиотека  = "tcp";
    НоваяСтрока.Модуль      = "OPI_TCP";
    НоваяСтрока.Метод       = "ПолучитьПоследнююОшибку";
    НоваяСтрока.МетодПоиска = "ПОЛУЧИТЬПОСЛЕДНЮЮОШИБКУ";
    НоваяСтрока.Параметр    = "--tcp";
    НоваяСтрока.Описание    = "Соединение, см. ОткрытьСоединение";
    НоваяСтрока.Область     = "Методы клиента";
    НоваяСтрока.ОписаниеМетода   = "Получает информацию о последней ошибке в соединении";
