...
Функция ПолучитьСтрокуПодключения() Экспорт
    ...
    Возврат "
        ...
        | Контекст.Вставить(""OPI_ЗапросыSQL"", Неопределено);
        ...
        | OPI_ЗапросыSQL = ЗагрузитьСценарий(""%1/oint/tools/Modules/OPI_ЗапросыSQL.os"", Контекст);
        | Контекст.Вставить(""OPI_ЗапросыSQL"", OPI_ЗапросыSQL);
