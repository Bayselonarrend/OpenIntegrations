...
Функция ПолучитьСостав() Экспорт
    ...
    НоваяСтрока.Описание     = "Пассивный режим соединения (необяз. по ум. - Да)";
    НоваяСтрока.Область      = "Основные методы";
    ...
    НоваяСтрока.Описание     = "Расширенное определение адресов в пассивном режиме (необяз. по ум. - Да)";
    НоваяСтрока.Область      = "Основные методы";
