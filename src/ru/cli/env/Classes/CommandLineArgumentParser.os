...
Процедура РазобратьИменованныйПараметр(Знач Токен, Значение, Знач ИменованныеПараметры, Знач РезультатРазбора)
	...
	ЗначениеТокена = ?(Значение = Неопределено, СледующийОбязательныйТокен(Токен, ИменованныеПараметры), Значение);
...
Функция СледующийТокен(БезСдвига = Ложь)
...
Функция СледующийОбязательныйТокен(Знач ИскомыйПараметр, Знач ИменованныеПараметры)

	Токен = СледующийТокен(Истина);

	Если Токен = Неопределено Или ЭтоПараметр(Токен, ИменованныеПараметры) Тогда
		Возврат "";
	Иначе
...
Функция ЭтоПараметр(Знач Токен, Знач ИменованныеПараметры)
	СтрПараметр = ИменованныеПараметры.Найти(Токен, "Имя");
