...
Процедура ВывестиНачальнуюСтраницу() Экспорт
	...
	ЦветнойВывод.Вывести(СтрШаблон("
		...
		| Структура вызова:
	    | 
		| (oint|#color=Белый) (<бибилотека>|#color=Бирюза) (<метод>|#color=Бирюза) (--опция1|#color=Серый) (""|#color=Зеленый)(Значение|#color=Белый)(""|#color=Зеленый) (...|#color=Белый) (--опцияN|#color=Серый) (""|#color=Зеленый)(Значение|#color=Белый)(""|#color=Зеленый) 
		|
		...
		|
		|  (--help|#color=Зеленый)  -%2
		|  (--debug|#color=Зеленый) -%3
		|  (--out|#color=Зеленый)   -%4
		|
