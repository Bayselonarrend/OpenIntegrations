...
Процедура ДобавитьСтрокуКомпонентыВДокумент(Документ, ТелоТаблицы, СтрокаКомпоненты)
	...
	Попытка
		...
		УстановитьТекстУзлаHTML(ЯчейкаИмя, ПредставлениеЗначенияКомпонентыНаКлиенте(ИмяКомпоненты));
		...
		УстановитьТекстУзлаHTML(ЯчейкаКонфигурации
			, ПредставлениеЗначенияКомпонентыНаКлиенте(СтрокаКомпоненты.ВерсияКонфигурации));
		...
		УстановитьТекстУзлаHTML(ЯчейкаКлиента
			, ПредставлениеЗначенияКомпонентыНаКлиенте(СтрокаКомпоненты.ВерсияКлиента));
