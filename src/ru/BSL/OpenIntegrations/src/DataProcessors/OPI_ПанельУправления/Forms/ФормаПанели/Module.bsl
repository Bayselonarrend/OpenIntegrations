...
Процедура ПересобратьHTMLПанелиНаСервере(ПоказыватьЗагрузку = Ложь)
	...
	СобратьHTMLПанели(ФормаHTML, ЛогоBase64, ПоказыватьЗагрузку);
...
&НаСервере
Процедура СобратьHTMLПанели(ФормаHTML, ЛогоBase64, ПоказыватьЗагрузку = Ложь)
...
Процедура СобратьОболочкуПанели(ФормаHTML)
	...
	ФормаHTML
		...
		.ВставитьДочернийЭлемент("tabs", "nav")
			...
			.НаУровеньВыше()
			.ВставитьДочернийЭлемент("tab-label-addins", "label", Истина, , , , "Внешние компоненты OnClient")
