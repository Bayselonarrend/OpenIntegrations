...
&НаСервере
Процедура ПересобратьHTMLПанелиНаСервере()
...
Процедура СобратьВкладкуГлавная(ФормаHTML, ЛогоBase64, ВерсияОПИ)
	...
	ФормаHTML
		.НаУровеньВыше()
		.ВставитьДочернийЭлемент("opi-main-links", "div")
			.ДобавитьКласс("opi-links");

	ВставитьСсылкуПанели(ФормаHTML, "opi-link-license-ru", "Лицензия (русский)");
	ВставитьСсылкуПанели(ФормаHTML, "opi-link-license-en", "Лицензия (english)");
	ВставитьСсылкуПанели(ФормаHTML, "opi-link-github", "GitHub");
	ВставитьСсылкуПанели(ФормаHTML, "opi-link-sourcecraft", "SourceCraft");
...
&НаСервере
Процедура ВставитьСсылкуПанели(ФормаHTML, IDСсылки, ТекстСсылки)

	ФормаHTML
		.ВставитьДочернийЭлемент(IDСсылки, "a", Истина, , , , ТекстСсылки)
			.УстановитьАтрибут("href", "#")
			.ДобавитьКласс("opi-link")
		.НаУровеньВыше();
