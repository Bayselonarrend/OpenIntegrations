...
Function GetConnectionString() Export
    ...
    Return "
        ...
        | Context.Insert(""OPI_SQLQueries"", Undefined);
        | 
        ...
        | OPI_SQLQueries = LoadScript(""%1/oint/tools/Modules/OPI_SQLQueries.os"", Context);
        | Context.Insert(""OPI_SQLQueries"", OPI_SQLQueries);
        |" + Chars.LF;
