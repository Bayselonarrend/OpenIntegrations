    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendVideo \
             ...
             --chat "***" \
             --text "Строковое значение" \
             --video "C:\Users\bayse\AppData\Local\Temp\lhjcbtbo.wsi"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "result": {
  ...
  "video": {
   ...
   "mime_type": "video/mp4",
   "thumbnail": {
    "file_id": "AAMCAgADGQMAAkeeaTlt7u18QefJQ4dfpNd0V-IPotsAAj2LAAKK7MhJfWlCHeXny-MBAAdtAAM2BA",
    "file_unique_id": "AQADPYsAAorsyEly",
    "file_size": 20106,
    "width": "***",
    "height": 240
   },
   ...
   "file_id": "BAACAgIAAxkDAAJHnmk5be7tfEHnyUOHX6TXdFfiD6LbAAI9iwACiuzISX1pQh3l58vjNgQ",
   "file_unique_id": "AgADPYsAAorsyEk",
   "file_size": 1137878
  },
