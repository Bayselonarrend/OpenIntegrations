    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendVideo \
             ...
             --chat "@testsichee" \
             --text "Строковое значение" \
             --video "C:\Users\bayse\AppData\Local\Temp\5qb2jxvi.ane"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "result": {
  ...
  "video": {
   ...
   "mime_type": "video/mp4",
   "thumbnail": {
    "file_id": "AAMCAgADGQMAAkajaTZIJTpo_mPI8Qq_m-rt_Y_i1gMAAp-cAAJBurBJmPsXDf00fHgBAAdtAAM2BA",
    "file_unique_id": "AQADn5wAAkG6sEly",
    "file_size": 20106,
    "width": "***",
    "height": 240
   },
   ...
   "file_id": "BAACAgIAAxkDAAJGo2k2SCU6aP5jyPEKv5vq7f2P4tYDAAKfnAACQbqwSZj7Fw39NHx4NgQ",
   "file_unique_id": "AgADn5wAAkG6sEk",
   "file_size": 1137878
  },
