    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendVideo \
             ...
             --chat "***" \
             --text "Строковое значение" \
             --video "C:\Users\bayse\AppData\Local\Temp\jr4ymosk.m3j"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "result": {
  ...
  "video": {
   ...
   "mime_type": "video/mp4",
   "thumbnail": {
    "file_id": "AAMCAgADGQMAAka1aTaaCB6Ko0DyWIxqNAH11ERUP3AAAjSSAAJBurhJS9ItCPEQza4BAAdtAAM2BA",
    "file_unique_id": "AQADNJIAAkG6uEly",
    "file_size": 20106,
    "width": "***",
    "height": 240
   },
   ...
   "file_id": "BAACAgIAAxkDAAJGtWk2mggeiqNA8liMajQB9dREVD9wAAI0kgACQbq4SUvSLQjxEM2uNgQ",
   "file_unique_id": "AgADNJIAAkG6uEk",
   "file_size": 1137878
  },
