    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendVideo \
             ...
             --chat "@testsichee" \
             --text "Строковое значение" \
             --video "C:\Users\bayse\AppData\Local\Temp\0thettcv.hq2"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "result": {
  ...
  "video": {
   ...
   "mime_type": "video/mp4",
   "thumbnail": {
    "file_id": "AAMCAgADGQMAAkIXaOgXyL_QYCsx22k1Mb4PuyBw87MAAhCLAAJ9jkFLh9j7qZ_IcCEBAAdtAAM2BA",
    "file_unique_id": "AQADEIsAAn2OQUty",
    "file_size": 20106,
    "width": 320,
    "height": 240
   },
   ...
   "file_id": "BAACAgIAAxkDAAJCF2joF8i_0GArMdtpNTG-D7sgcPOzAAIQiwACfY5BS4fY-6mfyHAhNgQ",
   "file_unique_id": "AgADEIsAAn2OQUs",
   "file_size": 1137878
  },
