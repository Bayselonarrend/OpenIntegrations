    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendVideo \
              ...
              --chat "***" \
              --text "Строковое значение" \
              --video "C:\Users\bayselonarrend\AppData\Local\Temp\hbae4ssz.zl1"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "result": {
  ...
  "video": {
   ...
   "mime_type": "video/mp4",
   "thumbnail": {
    "file_id": "AAMCAgADGQMAAlAwacPlrpfuxSBbINyhodfcMkSrE44AAh-eAAIyuiFKo1DBxnG7TJ4BAAdtAAM6BA",
    "file_unique_id": "AQADH54AAjK6IUpy",
    "file_size": 19807,
    "width": "***",
    "height": 240
   },
   ...
   "file_id": "BAACAgIAAxkDAAJQMGnD5a6X7sUgWyDcoaHX3DJEqxOOAAIfngACMrohSqNQwcZxu0yeOgQ",
   "file_unique_id": "AgADH54AAjK6IUo",
   "file_size": 1137878
  },
