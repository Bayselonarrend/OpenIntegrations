    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendAudio \
             ...
             --chat "@testsichee" \
             --text "Строковое значение" \
             --audio "C:\Users\bayse\AppData\Local\Temp\xyijgydr.pnp"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "result": {
  ...
  "audio": {
   ...
   "title": "Dogs",
   "performer": "Motorhead",
   "file_id": "CQACAgIAAxkDAAJCGGjoF-J3LZxltsFui6Yf9CcduuWEAAISiwACfY5BS5TQNVu6b9dINgQ",
   "file_unique_id": "AgADEosAAn2OQUs",
   "file_size": 9229352
  },
