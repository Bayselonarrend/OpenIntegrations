    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendAudio \
              ...
              --chat "***" \
              --text "Строковое значение" \
              --audio "C:\Users\bayse\AppData\Local\Temp\srmdqcgk.nvp"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "result": {
  ...
  "audio": {
   ...
   "title": "Dogs",
   "performer": "Motorhead",
   "file_id": "CQACAgIAAxkDAAJNrGmYJtg1vHtG7lerFCYTVnoyr9HIAALolAACIUrASIOBzYlNI3jxOgQ",
   "file_unique_id": "AgAD6JQAAiFKwEg",
   "file_size": 9229352
  },
