    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendAudio \
             ...
             --chat "***" \
             --text "Строковое значение" \
             --audio "C:\Users\bayse\AppData\Local\Temp\hjdarnin.dkr"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "result": {
  ...
  "audio": {
   ...
   "title": "Dogs",
   "performer": "Motorhead",
   "file_id": "CQACAgIAAxkDAAJHn2k5bg7nEEz9qiYQ0GVwdVsuRQABswACP4sAAorsyEkqrTDggsDjIjYE",
   "file_unique_id": "AgADP4sAAorsyEk",
   "file_size": 9229352
  },
