    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendAudio \
             ...
             --chat "***" \
             --text "Строковое значение" \
             --audio "C:\Users\bayse\AppData\Local\Temp\fpo0qzhj.1zu"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "result": {
  ...
  "audio": {
   ...
   "title": "Dogs",
   "performer": "Motorhead",
   "file_id": "CQACAgIAAxkDAAJGtmk2mjJz9xIkTMkQXJhvWEMGmvb9AAI3kgACQbq4SfLtEgydQzbXNgQ",
   "file_unique_id": "AgADN5IAAkG6uEk",
   "file_size": 9229352
  },
