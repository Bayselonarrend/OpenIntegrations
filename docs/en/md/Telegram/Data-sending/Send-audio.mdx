...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    Audio     = "https://releases.openintegrations.dev/test_data/song.mp3";
...
```json title="Result"
{
 ...
 "result": {
  ...
  "audio": {
   ...
   "title": "Dogs",
   "performer": "Motorhead",
   "file_id": "CQACAgIAAxkDAAJb2mo0LjB6Oe1JN_WTL1ERoEZBvxOnAALyngAClvihSVIi4UBMtgABmjwE",
   "file_unique_id": "AgAD8p4AApb4oUk",
   "file_size": 9229352
  },
