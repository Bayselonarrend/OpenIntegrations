    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendAudio \
              ...
              --chat "***" \
              --text "Строковое значение" \
              --audio "C:\Users\bayse\AppData\Local\Temp\a4a1uhsi.mlz"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "result": {
  ...
  "audio": {
   ...
   "title": "Dogs",
   "performer": "Motorhead",
   "file_id": "CQACAgIAAxkDAAJOqGmq6H2X_Tp6_iTw9eiSxwiJgKPgAALJogACq_JZSRfb3-J-gjCyOgQ",
   "file_unique_id": "AgADyaIAAqvyWUk",
   "file_size": 9229352
  },
