    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendAudio \
             ...
             --chat "@testsichee" \
             --text "Строковое значение" \
             --audio "C:\Users\bayse\AppData\Local\Temp\cf3h2fkc.zjt"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "result": {
  ...
  "audio": {
   ...
   "title": "Dogs",
   "performer": "Motorhead",
   "file_id": "CQACAgIAAxkDAAJFU2kEmWd16xAsjmipAa14dHz8srdRAAK1fwACy8ooSDsAARJhFOQ_AjYE",
   "file_unique_id": "AgADtX8AAsvKKEg",
   "file_size": 9229352
  },
