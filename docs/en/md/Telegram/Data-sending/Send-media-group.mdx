    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint telegram SendMediaGroup \
             ...
             --chat "@testsichee" \
             --text "Строковое значение" \
             --media "{'https://hut.openintegrations.dev/test_data/document.docx':'document','C:\\Users\\bayse\\AppData\\Local\\Temp\\2wqqwwmv.3bn.docx':'document'}"
        ```
    </TabItem>
 ...
 "result": [
  {
   ...
   "date": 1760040993,
   "media_group_id": "14080327946679042",
   "photo": [
    {
  ...
  },
  {
   ...
   "video": {
    ...
    "mime_type": "video/mp4",
    "thumbnail": {
     "file_id": "AAMCAgADFQdo6Bghs6vEGbQC01fqwN58dOEJXAACGYsAAn2OQUvRoiBJltjAtgEAB20AAzYE",
     "file_unique_id": "AQADGYsAAn2OQUty",
     "file_size": 20106,
     "width": 320,
     "height": 240
    },
    ...
    "file_id": "BAACAgIAAxUHaOgYIbOrxBm0AtNX6sDefHThCVwAAhmLAAJ9jkFL0aIgSZbYwLY2BA",
    "file_unique_id": "AgADGYsAAn2OQUs",
    "file_size": 1137878
   }
  }
 ]
