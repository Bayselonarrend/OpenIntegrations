    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint telegram SendMediaGroup \
              ...
              --chat "***" \
              --text "Строковое значение" \
              --media "{'https://releases.openintegrations.dev/test_data/document.docx':'document','/tmp/taa32ho2.pnj.docx':'document'}"
        ```
    </TabItem>
 ...
 "result": [
  {
   ...
   "date": 1781804708,
   "media_group_id": "14254437664495450",
   "photo": [
    {
  ...
  },
  {
   ...
   "video": {
    ...
    "mime_type": "video/mp4",
    "thumbnail": {
     "file_id": "AAMCAgADFQdqNC6jqzNtJIrtSEndIrzfuHiY5wADnwAClvihSYXPoz2BcJuxAQAHbQADPAQ",
     "file_unique_id": "AQAEnwAClvihSXI",
     "file_size": 19807,
     "width": "***",
     "height": 240
    },
    ...
    "file_id": "BAACAgIAAxUHajQuo6szbSSK7UhJ3SK837h4mOcAA58AApb4oUmFz6M9gXCbsTwE",
    "file_unique_id": "AgAEnwAClvihSQ",
    "file_size": 1137878
   }
  }
 ]
