    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint telegram SendMediaGroup \
             ...
             --chat "***" \
             --text "Строковое значение" \
             --media "{'https://hut.openintegrations.dev/test_data/document.docx':'document','C:\\Users\\bayse\\AppData\\Local\\Temp\\o3eradgq.3tn.docx':'document'}"
        ```
    </TabItem>
 ...
 "result": [
  ...
  },
  {
   ...
   "video": {
    ...
    "mime_type": "video/mp4",
    "thumbnail": {
     "file_id": "AAMCAgADFQdpOW5hobYv4H6VcXYPhWX0iH4ZvAACSIsAAorsyElSE1x-JXemEQEAB20AAzYE",
     "file_unique_id": "AQADSIsAAorsyEly",
     "file_size": 20106,
     "width": "***",
     "height": 240
    },
    ...
    "file_id": "BAACAgIAAxUHaTluYaG2L-B-lXF2D4Vl9Ih-GbwAAkiLAAKK7MhJUhNcfiV3phE2BA",
    "file_unique_id": "AgADSIsAAorsyEk",
    "file_size": 1137878
   }
  }
 ]
