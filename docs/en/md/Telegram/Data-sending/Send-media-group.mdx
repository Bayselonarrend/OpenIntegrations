    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint telegram SendMediaGroup \
             ...
             --chat "@testsichee" \
             --text "Строковое значение" \
             --media "{'https://hut.openintegrations.dev/test_data/document.docx':'document','/tmp/3qsbuwfw.lzr.docx':'document'}"
        ```
    </TabItem>
 ...
 "result": [
  {
   ...
   "date": 1759842578,
   "media_group_id": "14078740627847978",
   "photo": [
    {
  ...
  },
  {
   ...
   "video": {
    ...
    "mime_type": "video/mp4",
    "thumbnail": {
     "file_id": "AAMCAgADFQdo5RESc8S0THma23bTUcVcf8pidwACF38AAr90KEvMI_ySTgbONQEAB20AAzYE",
     "file_unique_id": "AQADF38AAr90KEty",
     "file_size": 20106,
     "width": 320,
     "height": 240
    },
    ...
    "file_id": "BAACAgIAAxUHaOUREnPEtEx5mtt201HFXH_KYncAAhd_AAK_dChLzCP8kk4GzjU2BA",
    "file_unique_id": "AgADF38AAr90KEs",
    "file_size": 1137878
   }
  }
 ]
