...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    Document  = "https://releases.openintegrations.dev/test_data/document.docx";
...
```json title="Result"
{
 ...
 "result": {
  ...
  "document": {
   ...
   "file_id": "BQACAgIAAxkDAAJb22o0LoEuhYFKmpPdcI7qefq_hwABdgAC-p4AApb4oUkn5cjNWpvBmzwE",
   "file_unique_id": "AgAD-p4AApb4oUk",
   "file_size": 24069
  },
