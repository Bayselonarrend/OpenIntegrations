    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendDocument \
              ...
              --chat "***" \
              --text "Строковое значение" \
              --doc "C:\Users\bayse\AppData\Local\Temp\onfjyvdu.vrz" \
...
```json title="Result"
{
 ...
 "result": {
  ...
  "document": {
   ...
   "file_id": "BQACAgIAAxkDAAJOqWmq6KOZ-5G7iZDSwL0pCkSZqOupAALQogACq_JZSdO6BKDFXfjlOgQ",
   "file_unique_id": "AgAD0KIAAqvyWUk",
   "file_size": 24069
  },
