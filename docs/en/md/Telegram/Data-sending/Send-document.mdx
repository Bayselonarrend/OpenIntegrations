    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendDocument \
             ...
             --chat "***" \
             --text "Строковое значение" \
             --doc "C:\Users\bayse\AppData\Local\Temp\e3ta3bhm.4i2" \
...
```json title="Result"
{
 ...
 "result": {
  ...
  "document": {
   ...
   "file_id": "BQACAgIAAxkDAAJGt2k2mmEirZnzmNSgr5lRm__ycg19AAI-kgACQbq4SX0kz6bZucITNgQ",
   "file_unique_id": "AgADPpIAAkG6uEk",
   "file_size": 24069
  },
