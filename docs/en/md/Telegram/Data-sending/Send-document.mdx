    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendDocument \
             ...
             --chat "@testsichee" \
             --text "Строковое значение" \
             --doc "C:\Users\bayse\AppData\Local\Temp\xcfkjha4.sdv" \
...
```json title="Result"
{
 ...
 "result": {
  ...
  "document": {
   ...
   "file_id": "BQACAgIAAxkDAAJCGWjoGAMO4_920ynybc-vhMubewkYAAIWiwACfY5BS5ZNxgbFolSENgQ",
   "file_unique_id": "AgADFosAAn2OQUs",
   "file_size": 24069
  },
