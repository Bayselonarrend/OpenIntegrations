    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendDocument \
              ...
              --chat "***" \
              --text "Строковое значение" \
              --doc "C:\Users\bayse\AppData\Local\Temp\re3xyt4g.pcf" \
...
```json title="Result"
{
 ...
 "result": {
  ...
  "document": {
   ...
   "file_id": "BQACAgIAAxkDAAJNrWmYJv6oRCKsETNG-3pycDtdAxlwAALulAACIUrASNR-JfCO8TODOgQ",
   "file_unique_id": "AgAD7pQAAiFKwEg",
   "file_size": 24069
  },
