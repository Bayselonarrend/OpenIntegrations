    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendDocument \
              ...
              --chat "***" \
              --text "Строковое значение" \
              --doc "C:\Users\bayselonarrend\AppData\Local\Temp\122eldse.5pe" \
...
```json title="Result"
{
 ...
 "result": {
  ...
  "document": {
   ...
   "file_id": "BQACAgIAAxkDAAJQMmnD5gYnCluNOR5qaqTWY0C0R8fUAAIjngACMrohSkqg9UDYhGP4OgQ",
   "file_unique_id": "AgADI54AAjK6IUo",
   "file_size": 24069
  },
