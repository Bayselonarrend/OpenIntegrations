    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendDocument \
             ...
             --chat "***" \
             --text "Строковое значение" \
             --doc "C:\Users\bayse\AppData\Local\Temp\j1k4bxfu.sog" \
...
```json title="Result"
{
 ...
 "result": {
  ...
  "document": {
   ...
   "file_id": "BQACAgIAAxkDAAJHoGk5bjpPefpIdOJN2Dvb7FioFMoAA0KLAAKK7MhJuEpcBl-dP9I2BA",
   "file_unique_id": "AgADQosAAorsyEk",
   "file_size": 24069
  },
