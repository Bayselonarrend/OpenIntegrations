    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendGif \
             ...
             --chat "***" \
             --text "Строковое значение" \
             --gif "C:\Users\bayse\AppData\Local\Temp\ghscysbb.vwg"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "result": {
  ...
  "animation": {
   ...
   "height": 220,
   "thumbnail": {
    "file_id": "AAMCAgADGQMAAkeiaTluS-B7EPa5clriEyysPqlhOswAAkaLAAKK7MhJmWfJ6UUpdrwBAAdtAAM2BA",
    "file_unique_id": "AQADRosAAorsyEly",
    "file_size": 11352,
    "width": "***",
    "height": 220
   },
   ...
   "file_id": "CgACAgIAAxkDAAJHomk5bkvgexD2uXJa4hMsrD6pYTrMAAJGiwACiuzISZlnyelFKXa8NgQ",
   "file_unique_id": "AgADRosAAorsyEk",
   "file_size": 84965
  },
  "document": {
   "file_name": "animation.gif.mp4",
