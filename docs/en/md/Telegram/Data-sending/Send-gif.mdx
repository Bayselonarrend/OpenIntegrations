    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendGif \
             ...
             --chat "@testsichee" \
             --text "Строковое значение" \
             --gif "C:\Users\bayse\AppData\Local\Temp\tqwy2iea.fsj"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "result": {
  ...
  "animation": {
   ...
   "height": 220,
   "thumbnail": {
    "file_id": "AAMCAgADGQMAAkVWaQSZk1E_Xef40A43mBXqvQ1sjyMAArx_AALLyihID5bH_fVYqCIBAAdtAAM2BA",
    "file_unique_id": "AQADvH8AAsvKKEhy",
    "file_size": 11352,
    "width": 220,
    "height": 220
   },
   ...
   "file_id": "CgACAgIAAxkDAAJFVmkEmZNRP13n-NAON5gV6r0NbI8jAAK8fwACy8ooSA-Wx_31WKgiNgQ",
   "file_unique_id": "AgADvH8AAsvKKEg",
   "file_size": 85181
  },
  "document": {
   "file_name": "animation.gif.mp4",
