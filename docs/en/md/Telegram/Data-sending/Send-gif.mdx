    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendGif \
             ...
             --chat "@testsichee" \
             --text "Строковое значение" \
             --gif "C:\Users\bayse\AppData\Local\Temp\40zbaby0.p0c"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "result": {
  ...
  "animation": {
   ...
   "height": 220,
   "thumbnail": {
    "file_id": "AAMCAgADGQMAAkIbaOgYDzDsR6fQbl15Fd8VVYypNtQAAhiLAAJ9jkFLkGGRrspcojABAAdtAAM2BA",
    "file_unique_id": "AQADGIsAAn2OQUty",
    "file_size": 11352,
    "width": 220,
    "height": 220
   },
   ...
   "file_id": "CgACAgIAAxkDAAJCG2joGA8w7Een0G5deRXfFVWMqTbUAAIYiwACfY5BS5Bhka7KXKIwNgQ",
   "file_unique_id": "AgADGIsAAn2OQUs",
   "file_size": 84965
  },
  "document": {
   "file_name": "animation.gif.mp4",
