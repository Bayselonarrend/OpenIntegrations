    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram SendGif \
             ...
             --chat "***" \
             --text "Строковое значение" \
             --gif "C:\Users\bayse\AppData\Local\Temp\l2vp153b.kjw"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "result": {
  ...
  "animation": {
   ...
   "height": 220,
   "thumbnail": {
    "file_id": "AAMCAgADGQMAAka5aTaagP0-RnqxyQlJtDdvog1WIEIAAkOSAAJBurhJcr0QfzxIpYEBAAdtAAM2BA",
    "file_unique_id": "AQADQ5IAAkG6uEly",
    "file_size": 11352,
    "width": "***",
    "height": 220
   },
   ...
   "file_id": "CgACAgIAAxkDAAJGuWk2moD9PkZ6sckJSbQ3b6INViBCAAJDkgACQbq4SXK9EH88SKWBNgQ",
   "file_unique_id": "AgADQ5IAAkG6uEk",
   "file_size": 84965
  },
  "document": {
   "file_name": "animation.gif.mp4",
