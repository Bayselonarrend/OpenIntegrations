...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    GIF       = "https://releases.openintegrations.dev/test_data/animation.gif";
...
```json title="Result"
{
 ...
 "result": {
  ...
  "animation": {
   ...
   "height": 220,
   "thumbnail": {
    "file_id": "AAMCAgADGQMAAlvdajQujjz6hgk5gtwUyQddoGO2KRQAAvyeAAKW-KFJWEGXRoj64B8BAAdtAAM8BA",
    "file_unique_id": "AQAD_J4AApb4oUly",
    "file_size": 11342,
    "width": "***",
    "height": 220
   },
   ...
   "file_id": "CgACAgIAAxkDAAJb3Wo0Lo48-oYJOYLcFMkHXaBjtikUAAL8ngAClvihSVhBl0aI-uAfPAQ",
   "file_unique_id": "AgAD_J4AApb4oUk",
   "file_size": 84979
  },
  "document": {
   "file_name": "animation.gif.mp4",
