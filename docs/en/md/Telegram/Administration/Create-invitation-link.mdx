    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram CreateInvitationLink \
             --token "***" \
             --chat "@testsichee" \
             --title "Link 10/8/2025 6:52:40 PM" \
             --expire "2025-10-09T18:52:40.2045813" \
             --limit 200
        ```
    </TabItem>
...
```json title="Result"
{
 "ok": true,
 "result": {
  "invite_link": "https://t.me/+skPa4VBuolxiMTBi",
  "name": "Link 10/09/2025 20:17:41",
  "creator": {
   "id": 6129457865,
   "is_bot": true,
