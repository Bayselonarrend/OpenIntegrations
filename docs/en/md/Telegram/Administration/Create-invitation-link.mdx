    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram CreateInvitationLink \
             --token "***" \
             --chat "@testsichee" \
             --title "Link 10/15/2025 08:23:10" \
             --expire "2025-10-16T08:23:10.2527166" \
             --limit 200
        ```
    </TabItem>
...
```json title="Result"
{
 "ok": true,
 "result": {
  "invite_link": "https://t.me/+etJUnzQePMI4Y2Zi",
  "name": "Link 10/27/2025 09:22:40",
  "creator": {
   "id": 6129457865,
   "is_bot": true,
