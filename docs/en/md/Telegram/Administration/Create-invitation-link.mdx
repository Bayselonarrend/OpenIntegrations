    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram CreateInvitationLink \
             --token "***" \
             --chat "@testsichee" \
             --title "Link 10/30/2025 7:08:36 PM" \
             --expire "2025-10-31T19:08:36.4065581" \
             --limit 200
        ```
    </TabItem>
...
```json title="Result"
{
 "ok": true,
 "result": {
  "invite_link": "https://t.me/+UlnDeH5uOY9lOGQy",
  "name": "Link 10/31/2025 11:13:45",
  "creator": {
   "id": 6129457865,
   "is_bot": true,
