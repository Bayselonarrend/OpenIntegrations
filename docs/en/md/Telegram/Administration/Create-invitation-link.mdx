...
:::tip
Method at API documentation: [createChatInviteLink](https://core.telegram.org/bots/api#createchatinvitelink)<br/>
<br/>
:::
<br/>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram CreateInvitationLink \
             --token "***" \
             --chat "@testsichee" \
             --expire "2024-11-21T09:21:00.0858995" \
             --title "Link 20.11.2024 9:21:00" \
             --limit 200
        ```
    </TabItem>
