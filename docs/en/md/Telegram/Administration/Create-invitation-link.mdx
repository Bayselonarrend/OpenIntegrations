    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram CreateInvitationLink \
             --token "***" \
             --chat "@testsichee" \
             --title "Link 09/15/2025 21:27:18" \
             --expire "2025-09-16T21:27:18.4748309" \
             --limit 200
        ```
    </TabItem>
...
```json title="Result"
{
 "ok": true,
 "result": {
  "invite_link": "https://t.me/+QBZtDlNwPdpkMzE6",
  "name": "Link 09/15/2025 21:27:18",
  "creator": {
   "id": 6129457865,
   "is_bot": true,
