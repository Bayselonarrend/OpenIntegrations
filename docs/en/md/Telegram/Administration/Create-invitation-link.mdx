    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram CreateInvitationLink \
             --token "***" \
             --chat "@testsichee" \
             --title "Link 10/07/2025 13:11:36" \
             --expire "2025-10-08T13:11:36.8126572" \
             --limit 200
        ```
    </TabItem>
...
```json title="Result"
{
 "ok": true,
 "result": {
  "invite_link": "https://t.me/+XuSUoee2ut03MDhi",
  "name": "Link 10/07/2025 13:11:36",
  "creator": {
   "id": 6129457865,
   "is_bot": true,
