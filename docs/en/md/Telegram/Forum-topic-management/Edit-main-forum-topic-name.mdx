---
sidebar_position: 9
description: Edit main forum thread name and other functions to work with Telegram in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram EditMainForumTopicName \
             --token "***" \
             --forum "-1001971186208" \
             --title "New main thread name cef11c57-9372-413c-b25d-84711b1e81da"
        ```
    </TabItem>
