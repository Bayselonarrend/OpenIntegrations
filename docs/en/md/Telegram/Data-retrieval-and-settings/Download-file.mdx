...
```bsl title="1C:Enterprise/OneScript code example"
    FileID = "AgACAgIAAxkDAAJGFWkwFfFE2BisPlbDM5TGPXaGd7OzAALoD2sbAAGqgEm_2MFZf9KMjgEAAwIAA3MAAzYE";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram DownloadFile \
             --token "***" \
             --fileid "CQACAgIAAx0EcNsaZQACV4FpA40AATJdyw4QH1dmDSgwXkJez8MAApOKAALp9SBIm5z0NhjhL7s2BA"
        ```
    </TabItem>
