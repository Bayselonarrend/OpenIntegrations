...
:::tip
Method at API documentation: [getFile](https://core.telegram.org/bots/api#getfile)<br/>
<br/>
:::
<br/>
...
```bsl title="1C:Enterprise/OneScript code example"
    FileID = "CQACAgIAAx0EcNsaZQACLaFnPujpQB1KQ5QoSGCtkhnUzX1Q2QACi1cAAktD-UklsOLt7kYekzYE";
