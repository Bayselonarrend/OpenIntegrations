...
```bsl title="1C:Enterprise/OneScript code example"
    FileID = "CQACAgIAAx0EcNsaZQACOoZntGR3NPfy86FECazbFV7OxfUstAACTWcAAuixqUnYilAUFJ1zpzYE";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram DownloadFile \
             --token "***" \
             --fileid "CQACAgIAAx0EcNsaZQACOnRntFnnkQQJozE18HUDRb58JxwBqAAC0GYAAuixqUnMN1OfU0OenDYE"
        ```
    </TabItem>
