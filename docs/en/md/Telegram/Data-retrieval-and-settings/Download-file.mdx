...
```bsl title="1C:Enterprise/OneScript code example"
    FileID = "CQACAgIAAx0EcNsaZQACWnJpNvvKXo7-kCWyo81ShE4kf4PSwAAC8YwAAgmluEnUBLw6LuDSMjYE";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram DownloadFile \
             --token "***" \
             --fileid "CQACAgIAAx0EcNsaZQACW2lpOW4q3Pn_tWHfhGlhEnVzGkGaGwAC5o8AAtOnyUlL-khe8G-aODYE"
        ```
    </TabItem>
