...
```bsl title="1C:Enterprise/OneScript code example"
    FileID = "CQACAgIAAx0EcNsaZQACOH1nqH6XfAmIhB0KM9FCkeMXzaNAUwACOGgAAroIQUkjYb3Ee2FpoTYE";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram DownloadFile \
             --token "***" \
             --fileid "CQACAgIAAx0EcNsaZQACOPdnqbh-vOHRSbUl_EuwR-0tkqFRkAACd2cAAroIUUnMMvzD9rs7OjYE"
        ```
    </TabItem>
