...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    From   = "1XlS0nEIKVmKA-cMFQvJ4BuJE0j1OFNuHt7SUHY-SAxA";
    Target = "1P8fG7fDvzEYiGSUTdTQ4kqKPZDqTaI0fn9uUdp8AGeg";
    Sheet  = "1885776414";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint gsheets CopySheet \
              --token "***" \
              --from "1HsLNufiKaEZUlGxfYNgIk3Pwy8TynS9GJjmlNrn9co4" \
              --to "1XDB7Du8Xd-0Dw2WWu_TtCahlykVzdvipyxoNLda86n8" \
              --sheet "1367100468"
        ```
    </TabItem>
