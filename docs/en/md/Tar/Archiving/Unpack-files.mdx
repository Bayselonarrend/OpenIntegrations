...
description: Unpack files and other functions to work with Tar in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
