    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateUser \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'977ddf96-1afa-43c0-9e3a-e29e7e27becd@example.org','NAME':'Vitaly','LAST_NAME':'Alpaca','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1771395419,
  "finish": 1771395421.00875,
  "duration": 2.00874900817871,
  "processing": 2,
  "date_start": "2026-02-18T06:16:59+00:00",
  "date_finish": "2026-02-18T06:17:01+00:00",
  "operating_reset_at": 1771396019,
  "operating": 1.92191100120544
 }
}
```
