    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateUser \
             --url "b24-ar17wx.bitrix24.by" \
             --fields "{'EMAIL':'ba253694-b754-4f3d-ba6d-36c302effb05@exepmple.org','NAME':'Vitaly','LAST_NAME':'Alpaca','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1767677930,
  "finish": 1767677931.20993,
  "duration": 1.20992708206177,
  "processing": 1,
  "date_start": "2026-01-06T05:38:50+00:00",
  "date_finish": "2026-01-06T05:38:51+00:00",
  "operating_reset_at": 1767678530,
  "operating": 0.79202389717102
 }
}
```
