    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateUser \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'32ff9aca-d331-4a0e-ad39-5c4860a9a169@mail.org','NAME':'Vitaly','LAST_NAME':'Alpaca','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1784481262,
  "finish": 1784481263.47339,
  "duration": 1.47339296340942,
  "processing": 1,
  "date_start": "2026-07-19T17:14:22+00:00",
  "date_finish": "2026-07-19T17:14:23+00:00",
  "operating_reset_at": 1784481862,
  "operating": 1.30282807350159
 }
}
```
