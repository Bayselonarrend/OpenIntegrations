    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateUser \
             --url "b24-ar17wx.bitrix24.by" \
             --fields "{'EMAIL':'7bcb0af0-268e-4a3c-9d9b-31152c07ebc7@exepmple.org','NAME':'Vitaly','LAST_NAME':'Alpaca','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1760044461,
  "finish": 1760044462.19259,
  "duration": 1.19259190559387,
  "processing": 1,
  "date_start": "2025-10-09T21:14:21+00:00",
  "date_finish": "2025-10-09T21:14:22+00:00",
  "operating_reset_at": 1760045061,
  "operating": 0.819743156433106
 }
}
```
