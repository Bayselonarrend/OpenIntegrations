    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateUser \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'f8d37437-efd6-47e2-8af2-9231a5427382@example.org','NAME':'Vitaly','LAST_NAME':'Alpaca','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1771439190,
  "finish": 1771439192.09517,
  "duration": 2.0951681137085,
  "processing": 2,
  "date_start": "2026-02-18T18:26:30+00:00",
  "date_finish": "2026-02-18T18:26:32+00:00",
  "operating_reset_at": 1771439790,
  "operating": 1.80284810066223
 }
}
```
