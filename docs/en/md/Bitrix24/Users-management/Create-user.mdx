    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateUser \
             --url "b24-ar17wx.bitrix24.by" \
             --fields "{'EMAIL':'3b1bc75c-17a0-40c6-9d61-574abcb2221b@exepmple.org','NAME':'Vitaly','LAST_NAME':'Alpaca','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1765376594,
  "finish": 1765376595.28911,
  "duration": 1.28910994529724,
  "processing": 1,
  "date_start": "2025-12-10T17:23:14+03:00",
  "date_finish": "2025-12-10T17:23:15+03:00",
  "operating_reset_at": 1765377194,
  "operating": 0.959870100021362
 }
}
```
