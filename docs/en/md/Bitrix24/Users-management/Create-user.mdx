    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateUser \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'4d827e80-cb64-4033-9837-735482c26fce@example.org','NAME':'Vitaly','LAST_NAME':'Alpaca','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1772810779,
  "finish": 1772810780.802,
  "duration": 1.80200290679932,
  "processing": 1,
  "date_start": "2026-03-06T18:26:19+03:00",
  "date_finish": "2026-03-06T18:26:20+03:00",
  "operating_reset_at": 1772811379,
  "operating": 1.76517295837402
 }
}
```
