    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateUser \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'b730fe75-7859-4210-af3d-02c9091593e9@mail.org','NAME':'Vitaly','LAST_NAME':'Alpaca','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1779718599,
  "finish": 1779718600.43477,
  "duration": 1.43477296829224,
  "processing": 1,
  "date_start": "2026-05-25T14:16:39+00:00",
  "date_finish": "2026-05-25T14:16:40+00:00",
  "operating_reset_at": 1779719199,
  "operating": 1.3543119430542
 }
}
```
