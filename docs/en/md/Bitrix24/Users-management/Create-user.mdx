    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateUser \
             --url "b24-ar17wx.bitrix24.by" \
             --fields "{'EMAIL':'8e1a1ffa-6434-4a06-afa9-f07cfde4b72f@exepmple.org','NAME':'Vitaly','LAST_NAME':'Alpaca','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1765191682,
  "finish": 1765191684.52157,
  "duration": 2.52156805992126,
  "processing": 2,
  "date_start": "2025-12-08T14:01:22+03:00",
  "date_finish": "2025-12-08T14:01:24+03:00",
  "operating_reset_at": 1765192282,
  "operating": 1.58083391189575
 }
}
```
