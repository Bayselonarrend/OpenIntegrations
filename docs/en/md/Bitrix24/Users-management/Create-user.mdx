    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateUser \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'f01d279a-4a68-404d-995d-e5805ede3322@mail.org','NAME':'Vitaly','LAST_NAME':'Alpaca','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1781804780,
  "finish": 1781804781.76243,
  "duration": 1.76242709159851,
  "processing": 1,
  "date_start": "2026-06-18T17:46:20+00:00",
  "date_finish": "2026-06-18T17:46:21+00:00",
  "operating_reset_at": 1781805380,
  "operating": 1.34394001960754
 }
}
```
