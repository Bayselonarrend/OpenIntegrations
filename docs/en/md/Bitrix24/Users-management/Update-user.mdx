    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 UpdateUser \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 4214 \
              --fields "{'EMAIL':'e66c6bd6-366c-4ce1-8397-4f638824491d@example.org','NAME':'Oleg','LAST_NAME':'Lama','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1781804783,
  "finish": 1781804784.26148,
  "duration": 1.26147603988647,
  "processing": 1,
  "date_start": "2026-06-18T17:46:23+00:00",
  "date_finish": "2026-06-18T17:46:24+00:00",
  "operating_reset_at": 1781805383,
  "operating": 0.407614946365356
 }
}
```
