    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 UpdateUser \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 4314 \
              --fields "{'EMAIL':'832fe28f-5f79-4daa-9f20-225d39999961@example.org','NAME':'Oleg','LAST_NAME':'Lama','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1784481266,
  "finish": 1784481266.53638,
  "duration": 0.536379098892212,
  "processing": 0,
  "date_start": "2026-07-19T17:14:26+00:00",
  "date_finish": "2026-07-19T17:14:26+00:00",
  "operating_reset_at": 1784481866,
  "operating": 0.334501028060913
 }
}
```
