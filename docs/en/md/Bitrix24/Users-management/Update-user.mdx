    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 UpdateUser \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3742 \
              --fields "{'EMAIL':'b40d0e9d-067c-4406-b5ba-e229840c134d@example.org','NAME':'Oleg','LAST_NAME':'Lama','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1779718604,
  "finish": 1779718604.63958,
  "duration": 0.639579057693481,
  "processing": 0,
  "date_start": "2026-05-25T14:16:44+00:00",
  "date_finish": "2026-05-25T14:16:44+00:00",
  "operating_reset_at": 1779719204,
  "operating": 0.387815952301025
 }
}
```
