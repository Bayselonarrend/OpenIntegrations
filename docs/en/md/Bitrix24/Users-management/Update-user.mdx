    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 UpdateUser \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3328 \
              --fields "{'EMAIL':'890b04a1-53ce-4edf-b80a-336584fb5a7c@example.org','NAME':'Oleg','LAST_NAME':'Lama','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1771439195,
  "finish": 1771439195.78533,
  "duration": 0.785331964492798,
  "processing": 0,
  "date_start": "2026-02-18T18:26:35+00:00",
  "date_finish": "2026-02-18T18:26:35+00:00",
  "operating_reset_at": 1771439795,
  "operating": 0.166481018066406
 }
}
```
