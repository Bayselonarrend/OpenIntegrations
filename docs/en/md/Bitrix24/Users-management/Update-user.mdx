    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 UpdateUser \
             --url "b24-ar17wx.bitrix24.by" \
             --userid 3184 \
             --fields "{'EMAIL':'986a056e-9f3f-4a05-94dc-3c70f6631101@exepmple.org','NAME':'Oleg','LAST_NAME':'Lama','UF_DEPARTMENT':'7'}" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1767677933,
  "finish": 1767677933.76747,
  "duration": 0.767468929290772,
  "processing": 0,
  "date_start": "2026-01-06T05:38:53+00:00",
  "date_finish": "2026-01-06T05:38:53+00:00",
  "operating_reset_at": 1767678533,
  "operating": 0.197805881500244
 }
}
```
