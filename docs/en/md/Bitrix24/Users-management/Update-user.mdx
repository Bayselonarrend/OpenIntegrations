    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 UpdateUser \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3324 \
              --fields "{'EMAIL':'59658071-cf99-4933-8a7a-b9b7774c619e@example.org','NAME':'Oleg','LAST_NAME':'Lama','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1771395431,
  "finish": 1771395431.51667,
  "duration": 0.516666889190674,
  "processing": 0,
  "date_start": "2026-02-18T06:17:11+00:00",
  "date_finish": "2026-02-18T06:17:11+00:00",
  "operating_reset_at": 1771396031,
  "operating": 0.237723827362061
 }
}
```
