    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 UpdateUser \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3766 \
              --fields "{'EMAIL':'328bab6a-a29c-47f3-917b-044ce520ee21@example.org','NAME':'Oleg','LAST_NAME':'Lama','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1779804940,
  "finish": 1779804940.75094,
  "duration": 0.75094199180603,
  "processing": 0,
  "date_start": "2026-05-26T14:15:40+00:00",
  "date_finish": "2026-05-26T14:15:40+00:00",
  "operating_reset_at": 1779805540,
  "operating": 0.403472900390625
 }
}
```
