    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 UpdateUser \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3524 \
              --fields "{'EMAIL':'d2f35d09-b52d-4dd4-8e44-161b0f9bc245@example.org','NAME':'Oleg','LAST_NAME':'Lama','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1774449352,
  "finish": 1774449353.01609,
  "duration": 1.01609396934509,
  "processing": 1,
  "date_start": "2026-03-25T17:35:52+03:00",
  "date_finish": "2026-03-25T17:35:53+03:00",
  "operating_reset_at": 1774449952,
  "operating": 0.178508996963501
 }
}
```
