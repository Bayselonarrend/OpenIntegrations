    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 UpdateUser \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3436 \
              --fields "{'EMAIL':'94d122e9-d0ab-4360-8509-2961ebcdf637@example.org','NAME':'Oleg','LAST_NAME':'Lama','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1772810782,
  "finish": 1772810782.7792,
  "duration": 0.779201030731201,
  "processing": 0,
  "date_start": "2026-03-06T18:26:22+03:00",
  "date_finish": "2026-03-06T18:26:22+03:00",
  "operating_reset_at": 1772811382,
  "operating": 0.268005847930908
 }
}
```
