    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 UpdateUser \
             --url "b24-ar17wx.bitrix24.by" \
             --userid 3080 \
             --fields "{'EMAIL':'596b6957-4a31-443d-a393-9860fc670ac6@exepmple.org','NAME':'Oleg','LAST_NAME':'Lama','UF_DEPARTMENT':'7'}" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1765376603,
  "finish": 1765376603.52487,
  "duration": 0.524873971939087,
  "processing": 0,
  "date_start": "2025-12-10T17:23:23+03:00",
  "date_finish": "2025-12-10T17:23:23+03:00",
  "operating_reset_at": 1765377203,
  "operating": 0.233973026275635
 }
}
```
