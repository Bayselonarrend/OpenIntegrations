    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 UpdateUser \
             --url "b24-ar17wx.bitrix24.by" \
             --userid 3024 \
             --fields "{'EMAIL':'a21b59a1-c453-442e-a4a8-0f4acaaf703a@exepmple.org','NAME':'Oleg','LAST_NAME':'Lama','UF_DEPARTMENT':'7'}" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1765191693,
  "finish": 1765191693.66731,
  "duration": 0.667305946350098,
  "processing": 0,
  "date_start": "2025-12-08T14:01:33+03:00",
  "date_finish": "2025-12-08T14:01:33+03:00",
  "operating_reset_at": 1765192293,
  "operating": 0.292126178741455
 }
}
```
