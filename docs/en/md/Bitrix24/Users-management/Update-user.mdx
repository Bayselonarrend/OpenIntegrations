    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 UpdateUser \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3388 \
              --fields "{'EMAIL':'aec9e6f2-f496-4798-b557-14f2ddefb5ea@example.org','NAME':'Oleg','LAST_NAME':'Lama','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1771583932,
  "finish": 1771583932.93788,
  "duration": 0.937877893447876,
  "processing": 0,
  "date_start": "2026-02-20T13:38:52+03:00",
  "date_finish": "2026-02-20T13:38:52+03:00",
  "operating_reset_at": 1771584532,
  "operating": 0.222893953323364
 }
}
```
