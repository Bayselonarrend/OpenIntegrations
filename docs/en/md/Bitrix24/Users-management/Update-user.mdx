    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 UpdateUser \
             --url "b24-ar17wx.bitrix24.by" \
             --userid 2754 \
             --fields "{'EMAIL':'f328760e-34b1-4dd7-b058-dad4b3116665@exepmple.org','NAME':'Oleg','LAST_NAME':'Lama','UF_DEPARTMENT':'7'}" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1760044464,
  "finish": 1760044464.76908,
  "duration": 0.769076108932495,
  "processing": 0,
  "date_start": "2025-10-09T21:14:24+00:00",
  "date_finish": "2025-10-09T21:14:24+00:00",
  "operating_reset_at": 1760045064,
  "operating": 0.220596075057983
 }
}
```
