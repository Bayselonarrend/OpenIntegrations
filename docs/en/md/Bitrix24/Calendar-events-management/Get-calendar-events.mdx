    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 GetCalendarEvents \
             ...
             --owner 1 \
             --type "user" \
             --filter "{'from':'2025-07-16T17:36:20.3401047Z','to':'2025-07-17T17:36:20.3401047Z','section':[1096,1098]}" \
             --token "***"
        ```
    </TabItem>
 ...
 "result": [
  {
   ...
   "TZ_OFFSET_TO": "10800",
   "DATE_FROM_TS_UTC": "1757914383",
   "DATE_TO_TS_UTC": "1760520780",
   "DT_SKIP_TIME": "N",
   "DT_LENGTH": 3600,
   "EVENT_TYPE": null,
   "CREATED_BY": "1",
   "DATE_CREATE": "14.09.2025 14:33:03",
   "TIMESTAMP_X": "14.09.2025 14:33:03",
   ...
   "EXDATE": "",
   "DAV_XML_ID": "20250915T083300Z-3ef630fa508beed0293f00688a003a14@b24-ar17wx.bitrix24.by",
   "G_EVENT_ID": "",
   "DAV_EXCH_LABEL": "",
   "CAL_DAV_LABEL": "",
   "VERSION": "1",
   ...
   "DATE_FROM_FORMATTED": "Mon Sep 15 2025 11:33:00",
   "DATE_TO_FORMATTED": "Mon Sep 15 2025 12:33:00",
   ...
   "COLLAB_ID": null,
   "~RRULE_DESCRIPTION": "каждый 10-й день, от 15.09.2025 до 25.09.2025",
   "attendeesEntityList": [
    {
     "entityId": "user",
     "id": 1
  ...
  },
  {
   ...
   "EVENT_TYPE": null,
   "CREATED_BY": "1",
   "DATE_CREATE": "14.09.2025 14:33:04",
   "TIMESTAMP_X": "14.09.2025 14:33:04",
   "DESCRIPTION": "Event description",
   "DT_FROM": null,
   "DT_TO": null,
   "PRIVATE_EVENT": "1",
