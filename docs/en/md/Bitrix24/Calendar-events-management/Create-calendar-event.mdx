    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateCalendarEvent \
             --url "b24-ar17wx.bitrix24.by" \
             --fields "{'type':'user','ownerId':'1','from':'01/06/2026 22:05:17','to':'01/06/2026 23:05:17','section':'1876','name':'New event','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Event description','color':'%23000000>','text_color':'%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'01/16/2026 22:05:17'},'is_meeting':'Y','location':'Office','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'***','allow_invite':'***','hide_guests':'N'}}" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1767677969,
  "finish": 1767677969.53799,
  "duration": 0.537992000579834,
  "processing": 0,
  "date_start": "2026-01-06T05:39:29+00:00",
  "date_finish": "2026-01-06T05:39:29+00:00",
  "operating_reset_at": 1767678569,
  "operating": 0.141442775726318
 }
}
```
