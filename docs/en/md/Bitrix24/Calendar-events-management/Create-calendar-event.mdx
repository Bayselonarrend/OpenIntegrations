    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateCalendarEvent \
             --url "b24-ar17wx.bitrix24.by" \
             --fields "{'type':'user','ownerId':'1','from':'10/9/2025 8:32:37 PM','to':'10/9/2025 9:32:37 PM','section':'1444','name':'New event','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Event description','color':'%%23000000>','text_color':'%%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'10/19/2025 8:32:37 PM'},'is_meeting':'Y','location':'Office','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'Y','allow_invite':'N','hide_guests':'N'}}" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1760044499,
  "finish": 1760044499.32002,
  "duration": 0.320020914077759,
  "processing": 0,
  "date_start": "2025-10-09T21:14:59+00:00",
  "date_finish": "2025-10-09T21:14:59+00:00",
  "operating_reset_at": 1760045099,
  "operating": 0.18125581741333
 }
}
```
