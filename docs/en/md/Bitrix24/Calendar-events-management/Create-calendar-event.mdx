    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateCalendarEvent \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'type':'user','ownerId':'1','from':'05/03/2026 12:10:27','to':'05/03/2026 13:10:27','section':'2360','name':'New event','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Event description','color':'%23000000>','text_color':'%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'05/13/2026 12:10:27'},'is_meeting':'Y','location':'Office','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'***','allow_invite':'***','hide_guests':'N'}}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1777723829,
  "finish": 1777723829.78841,
  "duration": 0.788409948348999,
  "processing": 0,
  "date_start": "2026-05-02T12:10:29+00:00",
  "date_finish": "2026-05-02T12:10:29+00:00",
  "operating_reset_at": 1777724429,
  "operating": 0.150430917739868
 }
}
```
