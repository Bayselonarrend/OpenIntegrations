    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateCalendarEvent \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'type':'user','ownerId':'1','from':'07/17/2026 05:49:12','to':'07/17/2026 06:49:12','section':'2928','name':'New event','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Event description','color':'%23000000>','text_color':'%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'07/27/2026 05:49:12'},'is_meeting':'Y','location':'Office','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'***','allow_invite':'***','hide_guests':'N'}}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1781804814,
  "finish": 1781804814.17209,
  "duration": 0.172086954116821,
  "processing": 0,
  "date_start": "2026-06-18T17:46:54+00:00",
  "date_finish": "2026-06-18T17:46:54+00:00",
  "operating_reset_at": 1781805414,
  "operating": 0.14417290687561
 }
}
```
