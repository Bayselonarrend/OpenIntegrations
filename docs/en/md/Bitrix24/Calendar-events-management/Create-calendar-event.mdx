    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateCalendarEvent \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'type':'user','ownerId':'1','from':'2/21/2026 1:40:16 PM','to':'2/21/2026 2:40:16 PM','section':'2080','name':'New event','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Event description','color':'%%23000000>','text_color':'%%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'3/3/2026 1:40:16 PM'},'is_meeting':'Y','location':'Office','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'***','allow_invite':'***','hide_guests':'N'}}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1771584019,
  "finish": 1771584019.48238,
  "duration": 0.482377052307129,
  "processing": 0,
  "date_start": "2026-02-20T13:40:19+03:00",
  "date_finish": "2026-02-20T13:40:19+03:00",
  "operating_reset_at": 1771584619,
  "operating": 0.195389986038208
 }
}
```
