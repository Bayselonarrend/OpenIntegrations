    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateCalendarEvent \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'type':'user','ownerId':'1','from':'02/19/2026 06:19:09','to':'02/19/2026 07:19:09','section':'2016','name':'New event','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Event description','color':'%23000000>','text_color':'%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'03/01/2026 06:19:09'},'is_meeting':'Y','location':'Office','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'***','allow_invite':'***','hide_guests':'N'}}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1771395553,
  "finish": 1771395553.98471,
  "duration": 0.984713077545166,
  "processing": 0,
  "date_start": "2026-02-18T06:19:13+00:00",
  "date_finish": "2026-02-18T06:19:13+00:00",
  "operating_reset_at": 1771396153,
  "operating": 0.195286989212036
 }
}
```
