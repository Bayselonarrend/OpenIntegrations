    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateCalendarEvent \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'type':'user','ownerId':'1','from':'07/20/2026 18:00:16','to':'07/20/2026 19:00:16','section':'3028','name':'New event','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Event description','color':'%23000000>','text_color':'%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'07/30/2026 18:00:16'},'is_meeting':'Y','location':'Office','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'***','allow_invite':'***','hide_guests':'N'}}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1784481301,
  "finish": 1784481302.16997,
  "duration": 1.16997289657593,
  "processing": 1,
  "date_start": "2026-07-19T17:15:01+00:00",
  "date_finish": "2026-07-19T17:15:02+00:00",
  "operating_reset_at": 1784481901,
  "operating": 0.172505140304565
 }
}
```
