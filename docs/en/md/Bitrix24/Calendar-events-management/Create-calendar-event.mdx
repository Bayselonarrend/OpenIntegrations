    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateCalendarEvent \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'type':'user','ownerId':'1','from':'05/26/2026 14:17:25','to':'05/26/2026 15:17:25','section':'2452','name':'New event','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Event description','color':'%23000000>','text_color':'%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'06/05/2026 14:17:25'},'is_meeting':'Y','location':'Office','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'***','allow_invite':'***','hide_guests':'N'}}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1779718647,
  "finish": 1779718647.23122,
  "duration": 0.231220960617065,
  "processing": 0,
  "date_start": "2026-05-25T14:17:27+00:00",
  "date_finish": "2026-05-25T14:17:27+00:00",
  "operating_reset_at": 1779719247,
  "operating": 0.134276151657104
 }
}
```
