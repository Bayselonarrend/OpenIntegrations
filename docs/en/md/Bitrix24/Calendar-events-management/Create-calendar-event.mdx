    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateCalendarEvent \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'type':'user','ownerId':'1','from':'05/27/2026 14:16:22','to':'05/27/2026 15:16:22','section':'2476','name':'New event','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Event description','color':'%23000000>','text_color':'%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'06/06/2026 14:16:22'},'is_meeting':'Y','location':'Office','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'***','allow_invite':'***','hide_guests':'N'}}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1779804983,
  "finish": 1779804983.94142,
  "duration": 0.94141697883606,
  "processing": 0,
  "date_start": "2026-05-26T14:16:23+00:00",
  "date_finish": "2026-05-26T14:16:23+00:00",
  "operating_reset_at": 1779805583,
  "operating": 0.144616842269897
 }
}
```
