    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateCalendarEvent \
             --url "b24-ar17wx.bitrix24.by" \
             --fields "{'type':'user','ownerId':'1','from':'12/9/2025 2:03:10 PM','to':'12/9/2025 3:03:10 PM','section':'1716','name':'New event','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Event description','color':'%%23000000>','text_color':'%%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'12/19/2025 2:03:10 PM'},'is_meeting':'Y','location':'Office','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'***','allow_invite':'***','hide_guests':'N'}}" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1765191794,
  "finish": 1765191794.74232,
  "duration": 0.742316961288452,
  "processing": 0,
  "date_start": "2025-12-08T14:03:14+03:00",
  "date_finish": "2025-12-08T14:03:14+03:00",
  "operating_reset_at": 1765192394,
  "operating": 0.17150092124939
 }
}
```
