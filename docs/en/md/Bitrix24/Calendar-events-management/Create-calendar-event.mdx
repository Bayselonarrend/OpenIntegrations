    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateCalendarEvent \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'type':'user','ownerId':'1','from':'3/7/2026 2:49:33 PM','to':'3/7/2026 3:49:33 PM','section':'2128','name':'New event','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Event description','color':'%%23000000>','text_color':'%%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'3/17/2026 2:49:33 PM'},'is_meeting':'Y','location':'Office','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'***','allow_invite':'***','hide_guests':'N'}}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1772810811,
  "finish": 1772810811.7773,
  "duration": 0.77729606628418,
  "processing": 0,
  "date_start": "2026-03-06T18:26:51+03:00",
  "date_finish": "2026-03-06T18:26:51+03:00",
  "operating_reset_at": 1772811411,
  "operating": 0.277462959289551
 }
}
```
