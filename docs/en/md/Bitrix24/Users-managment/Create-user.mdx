...
:::tip
Method at API documentation: [user.add](https://dev.1c-bitrix.ru/rest_help/users/user_add.php)<br/>
If you want to add an extranet user, you must pass in the fields: EXTRANET: Y and SONET_GROUP_ID: [...]<br/>
If you want to add an intranet user, you must pass UF_DEPARTMENT field: [...]<br/>
<br/>
:::
<br/>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateUser \
             --url "b24-ar17wx.bitrix24.by" \
             --fields "{'EMAIL':'51f4480e-5dfb-4ac5-941d-2d2cc8681035@exepmple.org','NAME':'Vitaly','LAST_NAME':'Alpaca','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':1}" \
             --token "***"
        ```
    </TabItem>
