...
:::tip
Method at API documentation: [user.update](https://dev.1c-bitrix.ru/rest_help/users/user_update.php)<br/>
<br/>
:::
<br/>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 UpdateUser \
             --url "b24-ar17wx.bitrix24.by" \
             --userid 1042 \
             --fields "{'EMAIL':'ec1b4190-e1ad-4db2-8c8f-a48790665b27@exepmple.org','NAME':'Oleg','LAST_NAME':'Lama','UF_DEPARTMENT':7}" \
             --token "***"
        ```
    </TabItem>
