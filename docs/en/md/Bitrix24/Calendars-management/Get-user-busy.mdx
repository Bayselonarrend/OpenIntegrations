    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 GetUserBusy \
             --url "b24-ar17wx.bitrix24.by" \
             --users 1 \
             --from "2025-12-08T14:03:38.0580684" \
             --to "2025-12-15T14:03:38.0580684" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1765191822,
  "finish": 1765191822.37777,
  "duration": 0.37777304649353,
  "processing": 0,
  "date_start": "2025-12-08T14:03:42+03:00",
  "date_finish": "2025-12-08T14:03:42+03:00",
  "operating_reset_at": 1765192422,
  "operating": 0
 }
}
```
