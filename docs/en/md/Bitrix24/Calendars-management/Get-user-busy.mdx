    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 GetUserBusy \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-02-18T13:47:11" \
              --to "2026-02-25T13:47:11" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1771439256,
  "finish": 1771439256.62064,
  "duration": 0.620640993118286,
  "processing": 0,
  "date_start": "2026-02-18T18:27:36+00:00",
  "date_finish": "2026-02-18T18:27:36+00:00",
  "operating_reset_at": 1771439856,
  "operating": 0
 }
}
```
