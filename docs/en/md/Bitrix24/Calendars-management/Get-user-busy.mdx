    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 GetUserBusy \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-03-25T06:42:41" \
              --to "2026-04-01T06:42:41" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1774430411,
  "finish": 1774430411.74573,
  "duration": 0.745733022689819,
  "processing": 0,
  "date_start": "2026-03-25T09:20:11+00:00",
  "date_finish": "2026-03-25T09:20:11+00:00",
  "operating_reset_at": 1774431011,
  "operating": 0
 }
}
```
