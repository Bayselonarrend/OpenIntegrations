    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 GetUserBusy \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-05-25T14:17:37" \
              --to "2026-06-01T14:17:37" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1779718658,
  "finish": 1779718658.17428,
  "duration": 0.174277067184448,
  "processing": 0,
  "date_start": "2026-05-25T14:17:38+00:00",
  "date_finish": "2026-05-25T14:17:38+00:00",
  "operating_reset_at": 1779719258,
  "operating": 0
 }
}
```
