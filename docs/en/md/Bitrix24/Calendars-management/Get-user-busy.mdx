    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 GetUserBusy \
             --url "b24-ar17wx.bitrix24.by" \
             --users 1 \
             --from "2026-01-05T22:05:46.988629" \
             --to "2026-01-12T22:05:46.988629" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1767677976,
  "finish": 1767677976.50302,
  "duration": 0.50302004814148,
  "processing": 0,
  "date_start": "2026-01-06T05:39:36+00:00",
  "date_finish": "2026-01-06T05:39:36+00:00",
  "operating_reset_at": 1767678576,
  "operating": 0
 }
}
```
