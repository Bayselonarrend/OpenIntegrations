    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 GetUserBusy \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-06-18T16:22:42" \
              --to "2026-06-25T16:22:42" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1781804820,
  "finish": 1781804820.12187,
  "duration": 0.121871948242188,
  "processing": 0,
  "date_start": "2026-06-18T17:47:00+00:00",
  "date_finish": "2026-06-18T17:47:00+00:00",
  "operating_reset_at": 1781805420,
  "operating": 0
 }
}
```
