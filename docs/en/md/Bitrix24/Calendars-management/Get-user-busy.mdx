    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 GetUserBusy \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-07-19T18:00:31" \
              --to "2026-07-26T18:00:31" \
              --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1784481308,
  "finish": 1784481308.8439,
  "duration": 0.843899011611938,
  "processing": 0,
  "date_start": "2026-07-19T17:15:08+00:00",
  "date_finish": "2026-07-19T17:15:08+00:00",
  "operating_reset_at": 1784481908,
  "operating": 0
 }
}
```
