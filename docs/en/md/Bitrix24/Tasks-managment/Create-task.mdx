...
:::tip
Method at API documentation: [tasks.task.add](https://dev.1c-bitrix.ru/rest_help/tasks/task/tasks/tasks_task_add.php)<br/>
<br/>
:::
<br/>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 CreateTask \
             --url "b24-ar17wx.bitrix24.by" \
             --fields "{'TITLE':'New task','DESCRIPTION':'New task description','PRIORITY':'2','DEADLINE':'2024-11-21T09:50:54.8030454Z','RESPONSIBLE_ID':1}" \
             --token "***"
        ```
    </TabItem>
