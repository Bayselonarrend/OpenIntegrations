...
:::tip
Returning fields as a map allows you to specify the filtering type before the filtered field name<br/>
Types of filtration: !, &lt;, &lt;=, &gt;, &gt;=. For example: !ID:3 (ID not equal to 3)<br/>
<br/>
:::
<br/>
