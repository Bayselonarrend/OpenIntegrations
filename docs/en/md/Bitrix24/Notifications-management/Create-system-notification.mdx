...
description: Create system notification and other functions to work with Bitrix24 in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
...
```json title="Result"
{
 ...
 "time": {
  "start": 1777723712,
  "finish": 1777723712.08832,
  "duration": 0.0883209705352783,
  "processing": 0,
  "date_start": "2026-05-02T12:08:32+00:00",
  "date_finish": "2026-05-02T12:08:32+00:00",
  "operating_reset_at": 1777724312,
  "operating": 0
 }
}
```
