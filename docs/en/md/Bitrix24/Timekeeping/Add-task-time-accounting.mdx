    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 AddTaskTimeAccounting \
             ...
             --user 10 \
             --text "Time spent on work" \
             --date "2025-12-05T21:57:28.3507092" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1767677805,
  "finish": 1767677806.0308,
  "duration": 1.03079795837402,
  "processing": 1,
  "date_start": "2026-01-06T05:36:45+00:00",
  "date_finish": "2026-01-06T05:36:46+00:00",
  "operating_reset_at": 1767678405,
  "operating": 0
 }
}
```
