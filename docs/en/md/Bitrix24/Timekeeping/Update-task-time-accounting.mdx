    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 UpdateTaskTimeAccounting \
             ...
             --amount 4800 \
             --text "New time record" \
             --date "2025-12-05T21:57:42.8466927" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1767677809,
  "finish": 1767677809.53037,
  "duration": 0.530369997024536,
  "processing": 0,
  "date_start": "2026-01-06T05:36:49+00:00",
  "date_finish": "2026-01-06T05:36:49+00:00",
  "operating_reset_at": 1767678409,
  "operating": 0
 }
}
```
