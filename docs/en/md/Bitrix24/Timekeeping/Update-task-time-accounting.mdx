    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 UpdateTaskTimeAccounting \
             ...
             --amount 4800 \
             --text "New time record" \
             --date "2025-09-15T09:56:37.9545897" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1761559745,
  "finish": 1761559745.22232,
  "duration": 0.222316026687622,
  "processing": 0,
  "date_start": "2025-10-27T10:09:05+00:00",
  "date_finish": "2025-10-27T10:09:05+00:00",
  "operating_reset_at": 1761560345,
  "operating": 0
 }
}
```
