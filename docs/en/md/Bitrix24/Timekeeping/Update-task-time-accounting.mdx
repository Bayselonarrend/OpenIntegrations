    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 UpdateTaskTimeAccounting \
             ...
             --amount 4800 \
             --text "New time record" \
             --date "2025-11-10T17:18:31.7444292" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1765376313,
  "finish": 1765376313.54524,
  "duration": 0.545243978500366,
  "processing": 0,
  "date_start": "2025-12-10T17:18:33+03:00",
  "date_finish": "2025-12-10T17:18:33+03:00",
  "operating_reset_at": 1765376913,
  "operating": 0
 }
}
```
