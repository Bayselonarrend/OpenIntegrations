...
:::tip
Method at API documentation: [task.elapseditem.update](https://dev.1c-bitrix.ru/rest_help/tasks/task/elapseditem/update.php)<br/>
<br/>
:::
<br/>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 UpdateTaskTimeAccounting \
             ...
             --amount 4800 \
             --text "New time record" \
             --date "2024-10-20T09:55:49.291588" \
             --token "***"
        ```
    </TabItem>
