    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 UpdateTaskTimeAccounting \
             ...
             --amount 4800 \
             --text "New time record" \
             --date "2025-09-08T20:26:46.6896264" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1760044343,
  "finish": 1760044343.33081,
  "duration": 0.330811977386475,
  "processing": 0,
  "date_start": "2025-10-09T21:12:23+00:00",
  "date_finish": "2025-10-09T21:12:23+00:00",
  "operating_reset_at": 1760044943,
  "operating": 0
 }
}
```
