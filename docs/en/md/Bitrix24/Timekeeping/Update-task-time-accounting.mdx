    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 UpdateTaskTimeAccounting \
             ...
             --amount 4800 \
             --text "New time record" \
             --date "2025-06-15T17:30:39.1378341" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 "result": null,
 "time": {
  "start": 1757918829.14954,
  "finish": 1757918829.20474,
  "duration": 0.0551941394805908,
  "processing": 0.0296070575714111,
  "date_start": "2025-09-15T09:47:09+03:00",
  "date_finish": "2025-09-15T09:47:09+03:00",
  "operating_reset_at": 1757919429,
  "operating": 0
 }
}
```
