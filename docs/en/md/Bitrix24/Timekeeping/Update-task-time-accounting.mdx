    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 UpdateTaskTimeAccounting \
             ...
             --amount 4800 \
             --text "New time record" \
             --date "2025-11-08T13:56:14.6999877" \
             --token "***"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "time": {
  "start": 1765191376,
  "finish": 1765191376.33847,
  "duration": 0.338470935821533,
  "processing": 0,
  "date_start": "2025-12-08T13:56:16+03:00",
  "date_finish": "2025-12-08T13:56:16+03:00",
  "operating_reset_at": 1765191976,
  "operating": 0
 }
}
```
