...
description: Unarchive directory and other functions to work with RAR in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
