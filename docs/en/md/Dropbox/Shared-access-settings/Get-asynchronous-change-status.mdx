...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    JobID = "dbjid:AAD1L-bMwKTHuiWt8DVi_FBjPGiqtsF1OhsqgQZho90yphBS7Brp8jf94FBNNDBuvMFCjNAnOOJUBPD_hC-8zT-t";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint dropbox GetAsynchronousChangeStatus \
              --token "***" \
              --job "dbjid:AAAmXsdJgFHtzM8zPkFEPv4eWvCUESj1sQdGJRaHoJ9NiQmZ6zDQmkjOPZPzL72cab6S4B7GQVavgOUQeVq6Pl9t"
        ```
    </TabItem>
