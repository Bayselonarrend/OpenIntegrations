    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek GetDeliveryAppointment \
              --token "***" \
              --uuid "e68265fe-b1a9-4c74-93f8-2eba05f90f73" \
              --testapi "***"
        ```
    </TabItem>
...
```json title="Result"
{
 "entity": {
  ...
  "order_uuid": "88f4902d-3bdf-482e-9d5c-48035fffbb37",
  "date": "2026-07-02",
  "time_from": "10:00",
  "time_to": "17:00",
  ...
  "uuid": "cccef456-7291-4db3-be4f-9eca57db1e2d",
  "statuses": [
   {
    "code": "INVALID",
    "name": "Некорректна",
    "date_time": "2026-06-18T17:42:27+00:00"
   },
   {
    "code": "ACCEPTED",
    "name": "Принята",
    "date_time": "2026-06-18T17:42:26+00:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "fb02be91-1d79-4cf1-9d6e-4433a1b6a846",
   "type": "CREATE",
   "date_time": "2026-06-18T17:42:26+00:00",
   "state": "INVALID",
   "errors": [
