    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek GetDeliveryAppointment \
              --token "***" \
              --uuid "b470781e-2a8c-4357-a7e9-58a0f3ee3915" \
              --testapi "***"
        ```
    </TabItem>
...
```json title="Result"
{
 "entity": {
  ...
  "order_uuid": "bb23ee55-cba8-464f-870f-e8a490668e85",
  "date": "2026-04-08",
  "time_from": "10:00",
  "time_to": "17:00",
  ...
  "statuses": [
   {
    "code": "INVALID",
    "name": "Некорректна",
    "date_time": "2026-03-25T17:41:27+03:00"
   },
   {
    "code": "ACCEPTED",
    "name": "Принята",
    "date_time": "2026-03-25T17:41:26+03:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "13bdf31c-8750-4bef-a5a4-988f5891d191",
   "type": "CREATE",
   "date_time": "2026-03-25T17:41:26+03:00",
   "state": "INVALID",
   "errors": [
    {
     ...
     "message": "Указанная дата доставки не может быть позднее 2026-04-06"
    }
   ]
  }
 ],
