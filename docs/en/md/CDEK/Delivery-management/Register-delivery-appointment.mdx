...
:::tip
Method at API documentation: [Registration of delivery appointment](https://api-docs.cdek.ru/36989576.html)<br/>
<br/>
:::
<br/>
...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    OrderUUID = "69650666-d64f-497c-b725-a624908ba929";
