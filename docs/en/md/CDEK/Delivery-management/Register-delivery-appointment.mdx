---
sidebar_position: 5
description:  Fixes the delivery date, time and address agreed with the customerСтраницы
...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    OrderUUID = "fef31e96-2d88-4681-b43a-d79258d288c8";
