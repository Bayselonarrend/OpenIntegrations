    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek GetCourierInvitation \
              --token "***" \
              --uuid "92bb0b7c-6f57-4c31-a044-3cbdb0d27121" \
              --testapi "***"
        ```
    </TabItem>
...
{
 "entity": {
  "uuid": "f81813e7-0edd-4cb3-9749-3e12da5a4e8c",
  "cdek_number": "1109907667",
  "order_uuid": "687998c6-4247-4d16-baeb-ed705a81052d",
  "intake_date": "2026-06-16",
  "intake_number": "13312311",
  ...
  "statuses": [
   {
    ...
    "date_time": "2026-06-15T17:32:48+03:00"
   },
   {
    "code": "CREATED",
    "name": "Создан",
  ...
  "packages": [
   {
    "package_id": "500c1704-949a-412a-b697-caf6fada387d",
    "weight": 1000,
    "length": 10,
    "width": "***",
    "height": 10
 ...
 "requests": [
  {
   "request_uuid": "e0366a70-8b10-4da2-a4fa-4417ef2b1c54",
   "type": "CREATE",
   "date_time": "2026-06-15T17:32:47+03:00",
   "state": "SUCCESSFUL"
  }
 ]
}
