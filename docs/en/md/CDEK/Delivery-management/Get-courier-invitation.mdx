    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek GetCourierInvitation \
              --token "***" \
              --uuid "fde4986f-ae14-4712-b9d0-bb1129070aea" \
              --testapi "***"
        ```
    </TabItem>
...
{
 "entity": {
  "uuid": "7eb553e5-d5a3-4dec-97b2-6eb63344215a",
  "cdek_number": "1109910104",
  "order_uuid": "296a0767-b6ad-4b2f-9290-3be859c1b1e2",
  "intake_date": "2026-06-19",
  "intake_number": "13312384",
  ...
  "statuses": [
   {
    ...
    "date_time": "2026-06-18T17:42:14+00:00"
   },
   {
    "code": "CREATED",
    "name": "Создан",
  ...
  "packages": [
   {
    "package_id": "32a7585f-f3b2-4034-ad60-50045dcdb979",
    "weight": 1000,
    "length": 10,
    "width": "***",
    "height": 10
 ...
 "requests": [
  {
   "request_uuid": "48c621dc-3653-4b22-8fb6-2a8f8ab408ec",
   "type": "CREATE",
   "date_time": "2026-06-18T17:42:10+00:00",
   "state": "SUCCESSFUL"
  }
 ]
}
