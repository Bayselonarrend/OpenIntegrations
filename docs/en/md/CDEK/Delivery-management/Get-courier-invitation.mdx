    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek GetCourierInvitation \
              --token "***" \
              --uuid "787de2fe-7b63-4392-8ad5-0f67d9559b63" \
              --testapi "***"
        ```
    </TabItem>
...
```json title="Result"
{
 "entity": {
  "uuid": "787de2fe-7b63-4392-8ad5-0f67d9559b63",
  "cdek_number": "1106992998",
  "order_uuid": "491ddc54-3c04-4704-a90d-36f32e7edd43",
  "intake_date": "2026-02-19",
  "intake_number": "13311200",
  ...
  "statuses": [
   {
    ...
    "date_time": "2026-02-18T06:26:43+00:00"
   },
   {
    "code": "CREATED",
    "name": "Создан",
  ...
  "packages": [
   {
    "package_id": "9b5e620e-f56d-4d29-ac3f-f6ded882efc4",
    "weight": 1000,
    "length": 10,
    "width": "***",
    "height": 10
 ...
 "requests": [
  {
   "request_uuid": "e5ea6870-c971-48f8-9ed3-592a40d46718",
   "type": "CREATE",
   "date_time": "2026-02-18T06:26:39+00:00",
   "state": "SUCCESSFUL"
  }
 ]
}
