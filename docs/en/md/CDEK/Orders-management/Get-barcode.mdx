---
sidebar_position: 11
description:  Gets the barcode CP for the orderСтраницы
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek GetBarcode \
             --token "***" \
             --uuid "72753031-9c97-4697-b055-05a06fd47c70" \
             --getfile true \
             --testapi "***" \
             --out "C:\Users\Administrator\AppData\Local\Temp\svfj1lkswrs.pdf"
        ```
    </TabItem>
