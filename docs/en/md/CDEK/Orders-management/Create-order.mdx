...
```json title="Result"
{
 ...
 "requests": [
  {
   "request_uuid": "27c80cd0-578b-414b-97ca-bf95a5a5727c",
   "type": "CREATE",
   "date_time": "2025-10-09T21:20:56+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
