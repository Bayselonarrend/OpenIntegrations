    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek CreatePrealert \
              --token "***" \
              --uuids "6f5b6652-c1db-4f25-a9a5-5b4eaf85c445" \
              --date "2026-06-19T16:11:39" \
              --point "NSK27" \
              --testapi "***"
        ```
    </TabItem>
...
{
 "entity": {
  "uuid": "a5824106-10ac-4c71-b89c-07460478a7bc"
 },
 "requests": [
  {
   "request_uuid": "986fca0b-3515-4ef8-a669-d9f81ce8705b",
   "type": "CREATE",
   "date_time": "2026-06-18T17:40:11+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
