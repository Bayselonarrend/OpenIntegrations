    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek CreatePrealert \
              --token "***" \
              --uuids "cf0e8ec8-a88b-48ce-8585-0102a179bf0f" \
              --date "2026-05-26T14:22:08" \
              --point "NSK27" \
              --testapi "***"
        ```
    </TabItem>
...
{
 "entity": {
  "uuid": "f9899bb2-145c-4715-a49f-729e5ad4e39c"
 },
 "requests": [
  {
   "request_uuid": "19aafbec-c307-4619-81d5-762100fa93c0",
   "type": "CREATE",
   "date_time": "2026-05-25T14:22:08+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
