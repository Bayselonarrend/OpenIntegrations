    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek GetOrderByNumber \
              --token "***" \
              --number "1bd5a512-1d07-4b16-9b33-c9a49f4a171b" \
              --internal true \
              --testapi "***"
        ```
    </TabItem>
...
{
 "entity": {
  "uuid": "4a76daaf-7d6d-49c6-98af-f2540679e5b0",
  "type": 1,
  "is_return": false,
  "is_reverse": false,
  "cdek_number": "1106995038",
  "number": "2145f805-fd04-409f-953c-58f005eed352",
  "tariff_code": 139,
  "comment": "New order",
  ...
  "packages": [
   {
    ...
    "package_id": "45456a74-2937-4234-b607-a039d3e072bc"
   }
  ],
  "statuses": [
   {
    "code": "CREATED",
    "name": "Создан",
    "date_time": "2026-02-18T18:31:04+00:00",
    "city": "Офис СДЭК",
    "deleted": false
   },
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-02-18T18:31:03+00:00",
    "city": "Офис СДЭК",
    "deleted": false
   }
  ],
