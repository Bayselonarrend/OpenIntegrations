    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek GetOrderByNumber \
              --token "***" \
              --number "72622f17-7fa4-4258-9025-f91fdfc97b32" \
              --internal true \
              --testapi "***"
        ```
    </TabItem>
...
{
 "entity": {
  "uuid": "96271f42-2a8e-4db5-a7ef-72d028e39f2e",
  "type": 1,
  "is_return": false,
  "is_reverse": false,
  "cdek_number": "1109910100",
  "number": "84ab5df0-ed49-4cf7-b807-c60134ef9282",
  "tariff_code": 139,
  "comment": "New order",
  ...
  "packages": [
   {
    ...
    "package_id": "1d077ba5-2aba-4858-916b-0e305e2613bc"
   }
  ],
  "statuses": [
   {
    "code": "CREATED",
    "name": "Создан",
    "date_time": "2026-06-18T17:39:40+00:00",
    "city": "Офис СДЭК",
    "deleted": false
   },
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-06-18T17:39:39+00:00",
    "city": "Офис СДЭК",
    "deleted": false
   }
  ],
