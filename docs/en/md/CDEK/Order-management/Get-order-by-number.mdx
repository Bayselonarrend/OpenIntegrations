    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek GetOrderByNumber \
              --token "***" \
              --number "0d97d579-4233-4b34-9d62-46c5c42b3b3d" \
              --internal true \
              --testapi "***"
        ```
    </TabItem>
...
{
 "entity": {
  "uuid": "cf0e8ec8-a88b-48ce-8585-0102a179bf0f",
  "type": 1,
  "is_return": false,
  "is_reverse": false,
  "cdek_number": "1109018826",
  "number": "0d97d579-4233-4b34-9d62-46c5c42b3b3d",
  "tariff_code": 139,
  "comment": "New order",
  ...
  "packages": [
   {
    ...
    "package_id": "5538c9c4-c11f-4ea3-9bdc-f97f45f516fc"
   }
  ],
  "statuses": [
   {
    "code": "CREATED",
    "name": "Создан",
    "date_time": "2026-05-25T14:21:41+00:00",
    "city": "Офис СДЭК",
    "deleted": false
   },
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-05-25T14:21:40+00:00",
    "city": "Офис СДЭК",
    "deleted": false
   }
  ],
