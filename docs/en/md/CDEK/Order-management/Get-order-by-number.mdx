    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek GetOrderByNumber \
              --token "***" \
              --number "2998f172-4a28-470f-ab61-0f72abd0a7a0" \
              --internal true \
              --testapi "***"
        ```
    </TabItem>
  ...
  "packages": [
   {
    ...
    "package_id": "390cdf6b-d9d7-41d9-b051-d06583533be9"
   }
  ],
  "statuses": [
   {
    "code": "CREATED",
    "name": "Создан",
    "date_time": "2026-02-20T13:45:00+03:00",
    "city": "Офис СДЭК",
    "deleted": false
   },
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-02-20T13:44:59+03:00",
    "city": "Офис СДЭК",
    "deleted": false
   }
  ],
