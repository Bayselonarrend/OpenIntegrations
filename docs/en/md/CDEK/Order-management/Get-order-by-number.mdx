...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    OrderNumber = "b949a3da-a22a-4216-8fd2-e194d9ddda64";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek GetOrderByNumber \
              --token "***" \
              --number "46704a03-f935-477f-a987-d153f04f58c4" \
              --internal true \
              --testapi "***"
        ```
    </TabItem>
  ...
  "packages": [
   {
    ...
    "package_id": "1a0b30a5-e856-4877-98db-cb3ce36d677c"
   }
  ],
  "statuses": [
   {
    "code": "CREATED",
    "name": "Создан",
    "date_time": "2026-05-26T14:19:15+00:00",
    "city": "Офис СДЭК",
    "deleted": false
   },
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-05-26T14:19:14+00:00",
    "city": "Офис СДЭК",
    "deleted": false
   }
  ],
