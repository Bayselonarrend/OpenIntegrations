    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek GetOrderByNumber \
              --token "***" \
              --number "2ec4e11d-512d-43ff-8346-e4a817283544" \
              --internal true \
              --testapi "***"
        ```
    </TabItem>
...
{
 "entity": {
  "uuid": "f31c1a19-bc49-4972-8684-68cc95ad28fa",
  "type": 1,
  "number": "176a62eb-4e29-4a52-ac15-b7e06ee21955",
  "tariff_code": 139,
  "comment": "New order",
  ...
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-03-25T09:22:28+00:00",
    "city": "Офис СДЭК",
    "deleted": false
   }
  ]
 ...
 "requests": [
  {
   "request_uuid": "f9a1cbf3-1965-4c7c-9588-22aaaaf7ae0c",
   "type": "CREATE",
   "date_time": "2026-03-25T09:22:28+00:00",
   "state": "ACCEPTED"
  }
