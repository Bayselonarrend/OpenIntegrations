...
{
 "entity": {
  "uuid": "662bdd3c-8831-4a93-b74b-35beec18a095",
  "orders": [
   {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/662bdd3c-8831-4a93-b74b-35beec18a095.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-02-20T13:45:29+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2026-02-20T13:45:30+03:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "f80e4b10-f9b2-49aa-9393-0bf798ffc63b",
   "type": "CREATE",
   "date_time": "2026-02-20T13:45:29+03:00",
   "state": "SUCCESSFUL"
  }
