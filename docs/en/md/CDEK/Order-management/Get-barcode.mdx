...
{
 "entity": {
  "uuid": "3ca41de9-5088-4271-bf0a-a8cc7ea1b4cc",
  "orders": [
   {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/3ca41de9-5088-4271-bf0a-a8cc7ea1b4cc.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-07-19T17:07:18+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "87d6cdc8-d32d-4936-a1dc-04b917035fca",
   "type": "CREATE",
   "date_time": "2026-07-19T17:07:18+00:00",
   "state": "SUCCESSFUL"
  }
