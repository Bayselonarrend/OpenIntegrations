...
```json title="Result"
{
 ...
 "requests": [
  {
   "request_uuid": "9e60b976-7da7-465a-b6ea-5039952d838a",
   "type": "CREATE",
   "date_time": "2026-02-07T14:08:38+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
