...
{
 "entity": {
  "uuid": "8fb195bd-e983-4bf9-b9ba-d26ad9cf8c79",
  "orders": [
   {
    "order_uuid": "484cc23f-50be-4ca6-a197-e743043647f5"
   }
  ],
  "copy_count": 1,
  "type": "tpl_russia",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-02-18T06:25:37+00:00"
   },
   {
    "code": "INVALID",
    "name": "Некорректный запрос",
    "date_time": "2026-02-18T06:25:38+00:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "ec353a55-df88-4126-9e0d-3c07cd8b66f3",
   "type": "CREATE",
   "date_time": "2026-02-18T06:25:37+00:00",
   "state": "INVALID",
   "errors": [
   ...
   "warnings": [
    {
     ...
     "message": "Order is invalid 484cc23f-50be-4ca6-a197-e743043647f5"
    }
   ]
  }
 ],
