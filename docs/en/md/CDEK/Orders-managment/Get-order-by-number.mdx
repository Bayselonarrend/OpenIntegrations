...
:::tip
Method at API documentation: [Order details](https://api-docs.cdek.ru/33828849.html)<br/>
<br/>
:::
<br/>
...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    OrderNumber = "c8d37e23-bb49-43b8-8d36-265d242f60aa";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek GetOrderByNumber \
             --token "***" \
             --number "143edcc7-6a15-4bb3-ac47-ae4b3490f443" \
             --internal true \
             --testapi "***"
        ```
    </TabItem>
