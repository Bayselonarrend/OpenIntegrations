...
:::tip
Required fields may depend on the type of order or nesting. Be sure to read the CDEK documentation<br/>
Field descriptions in the documentation: [List of pickup points](https://api-docs.cdek.ru/36990336.html)<br/>
<br/>
:::
<br/>
