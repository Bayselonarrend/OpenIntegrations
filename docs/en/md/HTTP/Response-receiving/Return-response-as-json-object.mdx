...
description: Return response as JSON object  and other functions to work with HTTP in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
...
```json title="Result"
{
 ...
 "headers": {
  ...
  "X-Arr-Log-Id": "99d721c3-efba-4d1e-b73b-588122b172c2",
