...
description: Use URL encoding  and other functions to work with HTTP in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
...
```json title="Result"
{
 "No encoding": "/page?param1=search?text&param2=John Doe&param3=value&another&param4=кириллица&param5=<script>alert(...",
 "With encoding": "/page?param1=search%3Ftext&param2=John%20Doe&param3=value%26another&param4=%D0%BA%D0%B8%D1%80%D0%B8%..."
}
```
