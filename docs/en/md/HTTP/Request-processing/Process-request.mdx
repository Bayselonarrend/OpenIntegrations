---
sidebar_position: 1
description: Process request  and other functions to work with HTTP in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
...
```json title="Result"
{
 ...
 "headers": {
  ...
  "X-Arr-Log-Id": "d87ca7ab-4017-499d-8d2b-b7a4c2d7019f",
