    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateVideoTweet \
              --text "TestTweet42fa30aa-d04f-4ead-80da-43a106ddfc4d" \
              --videos "C:\Users\bayse\AppData\Local\Temp\v132gngt.oay" \
...
```json title="Result"
{
 "data": {
  ...
  "id": "2029933997434782058",
  "text": "TestTweetb5d69d82-255a-495a-841a-3ea3824f197c https://t.co/mtyJHJLqyL"
 }
}
```
