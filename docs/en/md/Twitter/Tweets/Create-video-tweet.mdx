    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateVideoTweet \
             --text "TestTweet8e8681f5-ee56-4bf1-8bf9-dc0475df5733" \
             --videos "/tmp/yl3vaglu.1lr" \
...
{
 "data": {
  "text": "TestTweetf91990d9-fc19-4bc2-abda-a15510a69744 https://t.co/3AwlywZXyO",
  "id": "1997875912293892544",
