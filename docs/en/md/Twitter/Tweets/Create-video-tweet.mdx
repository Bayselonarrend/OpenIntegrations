    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateVideoTweet \
              --text "TestTweet221666da-ad05-4f98-8bb1-4e1c5427b804" \
              --videos "C:\Users\bayselonarrend\AppData\Local\Temp\r2rt4vag.n4l" \
...
{
 "data": {
  "id": "2036802743428334050",
  "edit_history_tweet_ids": [
   "2036802743428334050"
  ],
  "text": "TestTweet9bea683e-37a3-4d4e-988d-544e325c2970 https://t.co/I8FGNB2VFR"
 }
}
```
