    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateVideoTweet \
              --text "TestTweet6872b88f-7ac1-449a-92ed-6b84294c3977" \
              --videos "C:\Users\bayse\AppData\Local\Temp\ov524o2o.adf" \
...
```json title="Result"
{
 "data": {
  ...
  "id": "2024778474527871264",
  "text": "TestTweet761576b7-978f-4bd0-980d-5dc0b9394429 https://t.co/4DZKGYSEEO"
 }
}
```
