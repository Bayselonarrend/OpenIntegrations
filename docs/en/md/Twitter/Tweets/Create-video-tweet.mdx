    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateVideoTweet \
              --text "TestTweet333945a6-8618-49c4-8665-3f9cebc42c86" \
              --videos "/tmp/0vwtchgy.n0u" \
...
{
 "data": {
  "id": "2036727409504854342",
  "edit_history_tweet_ids": [
   "2036727409504854342"
  ],
  "text": "TestTweet39e9e3e2-44e7-4aea-9e07-065445cc7b89 https://t.co/SbWT9L1wfo"
 }
}
```
