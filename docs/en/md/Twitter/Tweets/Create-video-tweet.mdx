    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateVideoTweet \
              --text "TestTweetb1c163be-1ade-473e-a940-e42730924912" \
              --videos "/tmp/3wlxsh03.l12" \
...
```json title="Result"
{
 "data": {
  ...
  "id": "2023984849665614144",
  "text": "TestTweet21fa42a2-be37-45e5-a891-52c8aa5eda68 https://t.co/Sk9UFgeZtW"
 }
}
```
