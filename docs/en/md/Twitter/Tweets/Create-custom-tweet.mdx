    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateCustomTweet \
             --text "TestTweet8d77cbcf-d726-4b2f-ac0f-ff577cee7b0e" \
             --media "['1998822556820807680','1998822569118519297']" \
...
```json title="Result"
{
 "data": {
  ...
  "id": "2007600343392100601",
  "text": "TestTweet1b2837a1-430f-42f5-987d-85f8c150424f https://t.co/HkDKNAz949"
 }
}
```
