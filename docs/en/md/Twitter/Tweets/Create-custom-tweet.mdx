    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateCustomTweet \
              --text "TestTweet201cdf37-fa57-4887-bf7b-05ece814a7b0" \
              --media "['2029861989980205056','2029862003708502016']" \
...
```json title="Result"
{
 "data": {
  ...
  "id": "2029934665331585276",
  "text": "TestTweeta19e8cc7-9f40-43cd-82a8-92b3bf7c9b37 https://t.co/aFqLRTp3fZ"
 }
}
```
