    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateGifTweet \
              --text "TestTweet3c9a2913-1874-4370-9804-cfef4c141477" \
              --gifs "/tmp/n13vyufr.y4i" \
...
```json title="Result"
{
 "data": {
  ...
  "text": "TestTweetbdc9b567-20f8-4d4d-a0f0-b02ee971937c https://t.co/GkWj9pe3Qy",
  "id": "2023985289237025113"
 }
}
```
