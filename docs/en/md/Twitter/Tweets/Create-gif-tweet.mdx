    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateGifTweet \
              --text "TestTweetf3f05a0a-7830-4d4e-afab-c9983e80301d" \
              --gifs "C:\Users\bayse\AppData\Local\Temp\lmlggsq3.2bw" \
...
{
 "data": {
  "id": "2029934422787502162",
  "edit_history_tweet_ids": [
   "2029934422787502162"
  ],
  "text": "TestTweetfb08f9e6-1d14-4463-afc6-174bd1801c72 https://t.co/noot9rSpf7"
 }
}
```
