    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateGifTweet \
             --text "TestTweet37e765c4-f035-4db8-aab5-d4c5cb1ff07b" \
             --gifs "/tmp/dmb5svix.qsp" \
...
{
 "data": {
  "id": "2007600117038071951",
  "text": "TestTweet5c0a980d-18de-4c6d-9c4c-52bd40aa0b48 https://t.co/DrYDKKvCyq",
