---
sidebar_position: 4
description:  Creates a tweet with a gif attachmentСтраницы
...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    GIF  = "https://api.athenaeum.digital/test_data/animation.gif"; // URL, Binary or File path
    Gif2 = "https://api.athenaeum.digital/test_data/animation.gif"; // URL, Binary or File path
