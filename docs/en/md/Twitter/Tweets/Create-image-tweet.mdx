    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateImageTweet \
             --text "TestTweetfcf34847-6c03-4ed9-bc51-977f9070f241" \
             --pictures "/tmp/d5wmsqse.h2k" \
...
{
 "data": {
  "id": "2007599926784512034",
  "edit_history_tweet_ids": [
   null
  ],
  "text": "TestTweet8830730b-a0e4-4e8b-a91b-cb92a1ebc057 https://t.co/JTmfZV9IC5"
 }
}
```
