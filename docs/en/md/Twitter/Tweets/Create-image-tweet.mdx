    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateImageTweet \
              --text "TestTweet6080bb59-023d-412d-965c-f8553c6f51ef" \
              --pictures "C:\Users\bayse\AppData\Local\Temp\qkfutkis.ezb" \
...
{
 "data": {
  "text": "TestTweet050883b9-9287-47f8-98dd-8e5234103a5d https://t.co/5dGAwYiPHp",
  "id": "2029934210056622186",
