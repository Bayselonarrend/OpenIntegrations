    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateImageTweet \
              --text "TestTweet9bdd21f5-54a9-48f7-963b-99335271497b" \
              --pictures "C:\Users\bayse\AppData\Local\Temp\cjwssbjn.ixk" \
...
```json title="Result"
{
 "data": {
  ...
  "text": "TestTweet36600f4c-9e89-47df-ab40-03f289e6261c https://t.co/XDRE3UD712",
  "id": "2024778675149750509"
 }
}
```
