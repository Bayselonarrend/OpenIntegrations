    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateImageTweet \
             --text "TestTweet127ede98-c4a7-4f9d-97e5-ec8882ff18f0" \
             --pictures "C:\Users\bayse\AppData\Local\Temp\w22akhon.qnf" \
...
```json title="Result"
{
 "data": {
  ...
  "id": "1982742011133272478",
  "text": "TestTweetff184e7c-3115-41d4-8e71-a62b91db886a https://t.co/2pzFJc8V9I"
 }
}
```
