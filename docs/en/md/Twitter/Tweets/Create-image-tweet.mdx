    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateImageTweet \
              --text "TestTweeteefa3c3e-7a72-4d97-b706-3aadc1196929" \
              --pictures "C:\Users\bayselonarrend\AppData\Local\Temp\qetedjfp.nz4" \
...
{
 "data": {
  "text": "TestTweete0b0048b-7bee-479c-9061-ac5f795de52f https://t.co/ElaJEGy0zr",
  "edit_history_tweet_ids": [
   "2036802935171043488"
  ],
  "id": "2036802935171043488"
 }
}
```
