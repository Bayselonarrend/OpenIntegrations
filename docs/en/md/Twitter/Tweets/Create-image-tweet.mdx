    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter CreateImageTweet \
              --text "TestTweetcc004d06-1f2b-4f34-9c1d-210dc9812d90" \
              --pictures "/tmp/olytt2rz.mc5" \
...
```json title="Result"
{
 "data": {
  ...
  "text": "TestTweetf7c0b591-339d-457b-a058-5c35a60c0559 https://t.co/FaiXKuL8CL",
  "id": "2023985071812653323"
 }
}
```
