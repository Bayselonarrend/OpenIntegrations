...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    SourceCalendar = "dab5d3445c73b7ed25725760d7f531a74a1be2c11a708994fa3546b6606dffdf@group.calendar.google.com";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint gcalendar MoveEvent \
             --token "***" \
             --from "d2dc57cb33f285656c52d93e198eab177d81c79a82104a62d0fa98ee46c30e99@group.calendar.google.com" \
