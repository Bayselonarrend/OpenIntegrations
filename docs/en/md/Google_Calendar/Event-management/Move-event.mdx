...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    SourceCalendar = "eb6cf62ed0d8a131b78d5d654a4ec4eb828192397f987cb90f003e77804508ae@group.calendar.google.com";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint gcalendar MoveEvent \
             --token "***" \
             --from "bfa0b9aa4a90d293f608bc1788add444ad5d39b30dff980aebd7701e4d57a3dc@group.calendar.google.com" \
