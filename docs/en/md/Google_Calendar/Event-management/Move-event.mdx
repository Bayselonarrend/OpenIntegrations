...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    SourceCalendar = "498953a29d6cb0f89dc7d5a2a4f5783a10fcc566dce5c5eb9d7fa7c2c97f1aff@group.calendar.google.com";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint gcalendar MoveEvent \
             --token "***" \
             --from "a930d19b94a6cfcc1665308620f4bc210820543de8cff92d5900648fd573fe81@group.calendar.google.com" \
