 ...
 <Tabs>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint sftp SaveFile \
             --conn "{'proxy':{'login':'proxyuser','password':'***','port':'8071','proxy_type':'http','server':'127.0.0.1'},'set':{'auth_type':'private_key','host':'172.33.0.13','key_path':'***','passphrase':null,'password':null,'port':'2222','pub_path':'C:\\Users\\bayse\\AppData\\Local\\Temp\\haecq5rj.sat.tmp','username':'bayselonarrend'}}" \
             --path "pic_from_disk.png" \
             --file "C:\Users\bayse\AppData\Local\Temp\ohlmoip1.b1h.bin"
        ```
    </TabItem>
...
{
 "bytes": 2114023,
 "filepath": "C:\\Users\\bayse\\AppData\\Local\\Temp\\ip0dfc2z.ay0.bin",
 "result": true,
 "close_connection": {
  "result": true
 }
