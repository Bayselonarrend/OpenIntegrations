...
description: Get outgoing message count and other functions to work with GreenMax in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
...
:::tip
Method at API documentation: [GetMessagesCount](https://green-api.com/v3/docs/api/queues/GetMessagesCount/)
:::
<br/>
 ...
 <Tabs>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint greenmax GetOutgoingMessageCount \
