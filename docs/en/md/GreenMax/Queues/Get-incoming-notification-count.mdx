...
description: Get incoming notification count and other functions to work with GreenMax in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
...
:::tip
Method at API documentation: [GetWebhooksCount](https://green-api.com/v3/docs/api/queues/GetWebhooksCount/)
:::
<br/>
 ...
 <Tabs>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint greenmax GetIncomingNotificationCount \
