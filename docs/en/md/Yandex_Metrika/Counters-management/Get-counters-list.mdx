...
:::tip
Method at API documentation: [List of available counters](https://yandex.ru/dev/metrika/en/management/openapi/counter/counters)<br/>
<br/>
:::
<br/>
