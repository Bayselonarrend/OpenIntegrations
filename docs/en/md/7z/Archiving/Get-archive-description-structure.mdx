...
description: Get archive description structure and other functions to work with 7z in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
