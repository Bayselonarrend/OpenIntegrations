    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal WriteLog \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'launchUuid':'0475c26e-b1ea-40dc-9464-8335e6b46d32','itemUuid':'f5d52209-afbc-454d-a79d-42f526195eba','time':'1767258010','message':'Some log 1','level':'info'}"
        ```
    </TabItem>
...
```json title="Result"
{
 "id": "48d98459-45c1-4df1-ba3c-bfa0baa61c80"
}
```
