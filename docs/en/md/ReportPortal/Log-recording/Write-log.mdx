    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal WriteLog \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'launchUuid':'1b461642-fd7f-41a6-ba5e-d12f626933cc','itemUuid':'2c45517f-d534-4264-8a2e-fc309cb385d9','time':'1767258010','message':'Some log 1','level':'info'}"
        ```
    </TabItem>
...
```json title="Result"
{
 "id": "8f649c12-a2f2-42ca-9694-cab8d66f2add"
}
```
