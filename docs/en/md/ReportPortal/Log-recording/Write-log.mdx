    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal WriteLog \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'launchUuid':'ef2c2e24-e919-4fdc-bb12-4128d74fadaf','itemUuid':'d6d3e4a9-1fe2-4279-84e7-7911cf0a5e49','time':'1767258010','message':'Some log 1','level':'info'}"
        ```
    </TabItem>
...
```json title="Result"
{
 "id": "65b9c58b-70c1-4c58-8d51-caa6ea0137dc"
}
```
