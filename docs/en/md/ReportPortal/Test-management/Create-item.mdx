...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    Token    = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJzdXBlcmFkbWluIiwiYXVkIjoicmVwb3J0cG9ydGFsIiwibmJmIjoxNzgwMzgxMjU5LCJ1c2VyX25hbWUiOiJzdXBlcmFkbWluIiwiaXNzIjoiaHR0cDovL3JlcG9ydHBvcnRhbC5pbnRlcm5hbCIsInNjb3BlcyI6WyJ1aSJdLCJleHAiOjE3ODA0Njc2N...";
    LaunchID = "6a2ac1fd-6058-49eb-b58e-6514c3b3747a";
    Project  = "Test";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal CreateItem \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'name':'Test','startTime':'01/01/2026 10:00:00','type':'test','description':'Test launch','launchUuid':'05226b08-ff9f-4f35-806b-7e6af60beac0'}"
        ```
    </TabItem>
