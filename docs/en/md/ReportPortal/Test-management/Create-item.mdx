    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal CreateItem \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'name':'Test','startTime':'01/01/2026 10:00:00','type':'test','description':'Test launch','launchUuid':'1b461642-fd7f-41a6-ba5e-d12f626933cc'}"
        ```
    </TabItem>
...
```json title="Result"
{
 "id": "2c45517f-d534-4264-8a2e-fc309cb385d9",
