    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal CreateItem \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'name':'Test','startTime':'01/01/2026 10:00:00','type':'test','description':'Test launch','launchUuid':'151178cf-41bd-483f-9d80-a4deb3d6f5b3'}"
        ```
    </TabItem>
...
```json title="Result"
{
 "id": "c54a75ef-742f-40a7-9b0c-5cb7c7e7299b",
