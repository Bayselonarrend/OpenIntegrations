...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    LaunchUUID = "cb951f92-5e40-481c-93b2-c55cea50a183";
    Project    = "Test";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint rportal GetLaunch \
              ...
              --token "***" \
              --proj "Test" \
              --uuid "4e8f9ef4-c468-49b5-b2f1-1c2da95251ed"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "locked": false,
 "id": 660,
 "uuid": "b4af82ea-89fb-431f-b4c7-3ad1a97afe69",
 "name": "Test",
 "number": 427,
 "startTime": "2026-01-01T10:00:00Z",
 "lastModified": "2026-07-19T17:06:29.003431Z",
 "status": "IN_PROGRESS",
 "statistics": {
  "executions": {},
  "defects": {}
