...
description: Get property and other functions to work with NativeAPI in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
...
`Function GetProperty(Val Host, Val Instance, Val Property) Export`
  ...
  | Property | --prop | String, Number | &#x2714; | PropertyName |
