...
:::tip
You can mention a user by appending their userId to the text in the following format @[userId]<br/>
Method at API documentation: [GET /messages/sendText](https://teams.vk.com/botapi/#/messages/get_messages_sendText)<br/>
<br/>
:::
<br/>
