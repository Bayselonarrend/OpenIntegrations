...
:::tip
If you want the client to display this file as a playable voice message, it must be in aac, ogg, or m4a format<br/>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint vkteams SendVoice \
             --token "***" \
             --chatid "689203963@chat.agent" \
             --file "C:\Users\Administrator\AppData\Local\Temp\og3csg5k4fq.m4a" \
             --reply "7439253007327303646"
        ```
    </TabItem>
