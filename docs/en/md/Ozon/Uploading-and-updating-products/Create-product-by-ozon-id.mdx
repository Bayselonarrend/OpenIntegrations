...
:::tip
You can get an empty structure using the GetSimplifiedProductStructure method()<br/>
It is not possible to update a product fields by Ozon ID<br/>
Method at API documentation: [post /v1/product/import-by-sku](https://docs.ozon.ru/api/seller/#operation/ProductAPI_ImportProductsBySKU)<br/>
<br/>
:::
<br/>
