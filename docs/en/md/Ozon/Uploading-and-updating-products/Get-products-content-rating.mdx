---
sidebar_position: 5
description: Get products content rating and other functions to work with Ozon in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
