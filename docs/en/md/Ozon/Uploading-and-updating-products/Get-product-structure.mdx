...
:::tip
This structure should be supplemented with fields that depend on the product category from GetCategoryAttributes()<br/>
The first image in the image array (images field) will be the main image<br/>
<br/>
:::
<br/>
