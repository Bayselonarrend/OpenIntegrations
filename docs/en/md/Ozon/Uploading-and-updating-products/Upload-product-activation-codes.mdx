...
:::tip
The activation code is linked to the digital product card<br/>
Uploading status check - GetCodesUploadStatus()<br/>
Method at API documentation: [post /v1/product/upload_digital_codes](https://docs.ozon.ru/api/seller/#operation/ProductAPI_UploadDigitalCode)<br/>
<br/>
:::
<br/>
