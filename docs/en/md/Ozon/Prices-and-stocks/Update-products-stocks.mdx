---
sidebar_position: 4
description:  Changes the information about the stock amount of a productСтраницы
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint ozon UpdateProductsStocks \
             --clientid "***" \
             --apikey "***" \
             --stocks "{'offer_id':'143210610','product_id':1708120242,'stock':20,'warehouse_id':1}"
        ```
    </TabItem>
