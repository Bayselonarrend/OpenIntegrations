    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint gcalendar CreateEvent \
              ...
              --props "{'Description':'TestEventDescription','Title':'New event','Venue':'InOffice','StartDate':'06/15/2026 18:17:00','EndDate':'06/15/2026 19:17:00','ArrayOfAttachmentURLs':{'Image1':'https://hut.openintegrations.dev/test_data/picture.jpg','Image2':'https://hut.openintegrations.dev/test_data/picture2.jpg'},'SendNotifications':true}"
        ```
    </TabItem>
