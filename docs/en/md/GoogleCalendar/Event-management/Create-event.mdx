    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint gcalendar CreateEvent \
              ...
              --props "{'Description':'TestEventDescription','Title':'New event','Venue':'InOffice','StartDate':'07/16/2026 05:39:01','EndDate':'07/16/2026 06:39:01','ArrayOfAttachmentURLs':{'Image1':'https://releases.openintegrations.dev/test_data/picture.jpg','Image2':'https://releases.openintegrations.dev/test_data/picture2.jpg'},'SendNotifications':true}"
        ```
    </TabItem>
