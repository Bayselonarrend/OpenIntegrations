...
description: Get log  and other functions to work with SQLite in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
...
{
 "logs": [
  "[2026-06-18 17:40:14.233] Connecting to SQLite (in_memory=false)",
  "[2026-06-18 17:40:14.233] Connected to SQLite",
  "[2026-06-18 17:40:14.235] Execute query (params=0, force_result=false): SELECT 1 AS n",
  "[2026-06-18 17:40:14.235] Query returned 1 row(s)"
 ],
 "result": true,
 "returned": 4,
 "total": 4
