...
{
 "logs": [
  "[2026-06-15 17:31:03.229] Connecting to SQLite (in_memory=false)",
  "[2026-06-15 17:31:03.230] Connected to SQLite",
  "[2026-06-15 17:31:03.232] Execute query (params=0, force_result=false): SELECT 1 AS n",
  "[2026-06-15 17:31:03.232] Query returned 1 row(s)"
 ],
 "result": true,
 "returned": 4,
 "total": 4
