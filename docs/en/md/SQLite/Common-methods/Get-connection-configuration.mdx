---
sidebar_position: 2
description: Get connection configuration and other functions to work with SQLite in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
