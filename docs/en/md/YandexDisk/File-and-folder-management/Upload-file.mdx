...
description: Upload file and other functions to work with YandexDisk in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint yadisk UploadFile \
              --token "***" \
              --path "/aef383ec-e09e-46e0-aeb6-b94afbeede58.png" \
              --file "/tmp/rwr2muir.vyb.png" \
              --rewrite true
        ```
    </TabItem>
