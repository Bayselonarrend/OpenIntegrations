...
:::tip
The user can be specified in one of the following formats:<br/>String: `name of user`<br/>Structure: `{ user: &lt;name&gt;, db: &lt;database&gt; }`<br/>Array: `[ { user: &lt;name&gt;, db: &lt;база data&gt; }, { user: &lt;name&gt;, db: &lt;база data&gt; }, ... ]`
:::
<br/>
