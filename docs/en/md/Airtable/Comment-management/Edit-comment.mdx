    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable EditComment \
              --token "***" \
              --base "app0ndMVGaXY4LHaN" \
              --table "tbl1e0GlYT0rXRLxT" \
              --record "recaoDE1tqAF1ierL" \
              --comment "comV5A7BB71QDloH1" \
              --text "Test comment (change.)"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "text": "Test comment (change.)",
 "createdTime": "2026-03-25T09:13:49Z",
 "lastUpdatedTime": "2026-03-25T09:13:49.959Z"
}
```
