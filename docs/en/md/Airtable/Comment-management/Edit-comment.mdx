    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable EditComment \
              --token "***" \
              --base "appqD0VJlOEXwKFbI" \
              --table "tblunQKOV76cLeBg2" \
              --record "recv2kN0dEI2wpRt8" \
              --comment "compOM6gau68OqipL" \
              --text "Test comment (change.)"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "text": "Test comment (change.)",
 "createdTime": "2026-06-15T14:31:26Z",
 "lastUpdatedTime": "2026-06-15T14:31:27.595Z"
}
```
