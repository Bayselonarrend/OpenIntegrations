...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    Base    = "appxKRlB5clfelDah";
    Table   = "tblxh6z17MN8ufZ8U";
    Record  = "recJxk3ZylvQOTB0v";
    Comment = "comIdykP6Hrwc4MCn";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable EditComment \
              ...
              --table "tblKyRpkhVtDq4Ngu" \
              --record "reczHl7xnwF1YSXCe" \
              --comment "comQEvg83poHDmfZY" \
              --text "Test comment (change.)"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "text": "Test comment (change.)",
 "createdTime": "2026-07-19T17:08:22Z",
 "lastUpdatedTime": "2026-07-19T17:08:26.645Z"
}
```
