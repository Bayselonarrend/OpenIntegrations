    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable EditComment \
              ...
              --table "tblth2sLd0GjcTxKs" \
              --record "rec6U5Yls6rbnmulk" \
              --comment "comyNfXQGjVqTZ18Q" \
              --text "Test comment (change.)"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "text": "Test comment (change.)",
 "createdTime": "2026-05-25T14:08:17Z",
 "lastUpdatedTime": "2026-05-25T14:08:18.85Z"
}
```
