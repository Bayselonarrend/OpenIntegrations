...
```json title="Result"
{
 "id": "tblEHRcl5dWksDg5Y",
 "name": "Test table 2 (change.)",
 "description": "New table (change.)",
 "primaryFieldId": "fldtI0abmtaQVhuMe",
 "fields": [
  {
   "id": "fldtI0abmtaQVhuMe",
   "name": "Number",
   "type": "number",
   "options": {
    "precision": 0
  ...
  {
   "id": "fld4eEqn4q0svvYwv",
   "name": "String",
   "type": "richText"
  },
  {
   "id": "fldxWgUfYmGuloef2",
   "name": "Attachment",
  ...
  {
   "id": "fldlg3ZWVOsVUZlX9",
   "name": "Phone",
   "type": "phoneNumber"
  },
  {
   "id": "fld9cpAGAzQn3WOsB",
   "name": "Email",
   "type": "email"
  },
  {
   "id": "fldfJw12EEp1sYRhH",
   "name": "Link",
   "type": "url"
  }
 ],
