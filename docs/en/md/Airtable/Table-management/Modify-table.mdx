...
```json title="Result"
{
 "id": "tbljPjQmLeMk5Lbog",
 "name": "Test table 2 (change.)",
 "description": "New table (change.)",
 "primaryFieldId": "fldYT9Yg0v039fzBE",
 "fields": [
  {
   "id": "fldYT9Yg0v039fzBE",
   "name": "Number",
   "type": "number",
   "options": {
    "precision": 0
  ...
  {
   "id": "fldrqrEvfr7m7oMiB",
   "name": "String",
   "type": "richText"
  },
  {
   "id": "fld20gyRVWH61Slis",
   "name": "Attachment",
  ...
  {
   "id": "fldxHfg26Ua5wAMjh",
   "name": "Phone",
   "type": "phoneNumber"
  },
  {
   "id": "fldElu8E4lKqrg8RW",
   "name": "Email",
   "type": "email"
  },
  {
   "id": "fldKbBWRbCDKYTpU6",
   "name": "Link",
   "type": "url"
  }
 ],
