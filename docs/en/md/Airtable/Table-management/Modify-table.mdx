...
```json title="Result"
{
 "id": "tblRWUcLPEIK8qDNM",
 "name": "Test table 2 (change.)",
 "description": "New table (change.)",
 "primaryFieldId": "fldJZvy497n9T5SZF",
 "fields": [
  {
   "id": "fldJZvy497n9T5SZF",
   "name": "Number",
   "type": "number",
   "options": {
    "precision": 0
  ...
  {
   "id": "fldGfzxMnob3Xxwvf",
   "name": "String",
   "type": "richText"
  },
  {
   "id": "fldmE0rdqTuwYar9z",
   "name": "Attachment",
  ...
  {
   "id": "fldsf5SBRv0Tggz6s",
   "name": "Phone",
   "type": "phoneNumber"
  },
  {
   "id": "fldD4fvpWQrFEWF2T",
   "name": "Email",
   "type": "email"
  },
  {
   "id": "fldRxPa7T27uJco1y",
   "name": "Link",
   "type": "url"
  }
 ],
