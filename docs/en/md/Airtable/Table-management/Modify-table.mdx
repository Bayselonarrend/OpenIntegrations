...
```json title="Result"
{
 "id": "tblfc24Hh76uNExoi",
 "name": "Test table 2 (change.)",
 "description": "New table (change.)",
 "primaryFieldId": "fldPUk9V2OkWbku1v",
 "fields": [
  {
   "id": "fldPUk9V2OkWbku1v",
   "name": "Number",
   "type": "number",
   "options": {
    "precision": 0
  ...
  {
   "id": "fld20WHeiDAtqSeW3",
   "name": "String",
   "type": "richText"
  },
  {
   "id": "fldX4O1tMD9DU86Bq",
   "name": "Attachment",
  ...
  {
   "id": "fldDIDstK5ACIFBIg",
   "name": "Phone",
   "type": "phoneNumber"
  },
  {
   "id": "fldaEVaOtXB87oWCx",
   "name": "Email",
   "type": "email"
  },
  {
   "id": "fldEpOg8YZV4BGiap",
   "name": "Link",
   "type": "url"
  }
 ],
