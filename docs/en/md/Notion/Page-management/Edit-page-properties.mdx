    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion EditPageProperties \
              --token "***" \
              --page "30b82aa7-fc4e-817a-8a9b-ef918d6e7d3a" \
...
{
 "object": "page",
 "id": "30b82aa7-fc4e-817a-8a9b-ef918d6e7d3a",
 ...
 "url": "https://www.notion.so/title-30b82aa7fc4e817a8a9bef918d6e7d3a",
 "public_url": null,
 "request_id": "c85cbcc2-a201-4fe3-a8ba-917b684474b5"
}
```
