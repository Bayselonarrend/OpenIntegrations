...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    Page    = "31a82aa7-fc4e-81ec-b239-f7b6e08febfc";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion EditPageProperties \
              --token "***" \
              --page "31b82aa7-fc4e-81e6-9823-e0776c6a8955" \
...
{
 "object": "page",
 "id": "31b82aa7-fc4e-81cc-9dbc-dd8c6581d61c",
 ...
 "url": "https://www.notion.so/title-31b82aa7fc4e81cc9dbcdd8c6581d61c",
 "public_url": null,
 "request_id": "c6d01f3e-089b-4d50-8342-37c44e3fa369"
}
```
