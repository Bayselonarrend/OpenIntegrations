    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion CreatePageInDatabase \
              ...
              --data "{'Name':'LLC Vector','Description':'OurFirstClient','Number':'1','CreationDate':'07/16/2026 05:35:36','Image':{'Logo':'https://releases.openintegrations.dev/test_data/picture.jpg'},'Active':true,'Website':'https://vector.ru','Email':'mail@vector.ru','Phone':'***','Status':'New'}"
        ```
    </TabItem>
