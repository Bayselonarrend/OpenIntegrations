    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion CreatePageInDatabase \
             --token "***" \
             --base "1fa82aa7-fc4e-81ec-928b-ceb0b54079c8" \
             --data "{'Name':'LLC Vector','Description':'OurFirstClient','Number':1,'Status':'New','CreationDate':'2025-05-21T09:22:13.1567602Z','Image':{'Logo':'https://github.com/Bayselonarrend/OpenIntegrations/raw/main/service/test_data/picture.jpg'},'Active':true,'Website':'https://vector.ru','Email':'mail@vector.ru','Phone':'88005553535'}"
        ```
    </TabItem>
