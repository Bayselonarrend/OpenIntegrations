    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion CreatePageInDatabase \
             --token "***" \
             --base "14482aa7-fc4e-81bc-ab40-efafda2a0fac" \
             --data "{'Name':'LLC Vector','Description':'OurFirstClient','Number':1,'Status':'New','CreationDate':'2024-11-20T09:42:07.6748788Z','Image':{'Logo':'https://github.com/Bayselonarrend/OpenIntegrations/raw/main/service/test_data/picture.jpg'},'Active':true,'Website':'https://vector.ru','Email':'mail@vector.ru','Phone':'88005553535'}"
        ```
    </TabItem>
