    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion CreatePageInDatabase \
              --token "***" \
              --base "36b82aa7-fc4e-814c-87eb-d3189eef7211" \
              --data "{'Name':'LLC Vector','Description':'OurFirstClient','Number':'1','CreationDate':'05/25/2026 14:06:14','Image':{'Logo':'https://hut.openintegrations.dev/test_data/picture.jpg'},'Active':true,'Website':'https://vector.ru','Email':'mail@vector.ru','Phone':'***','Status':'New'}"
        ```
    </TabItem>
...
{
 "object": "page",
 "id": "36b82aa7-fc4e-8102-ae3a-d73b85688324",
 ...
 "parent": {
  "type": "database_id",
  "database_id": "36b82aa7-fc4e-814c-87eb-d3189eef7211"
 },
 "in_trash": false,
 "is_archived": false,
 "is_locked": false,
 "properties": {
  ...
  "CreationDate": {
   ...
   "type": "date",
   "date": {
    "start": "2026-05-25T02:06:00+00:00",
    "end": null,
    "time_zone": null
   }
  },
 ...
 "url": "https://www.notion.so/LLC-Vector-36b82aa7fc4e8102ae3ad73b85688324",
 "public_url": null,
 "archived": false,
 "request_id": "9d455f6e-bcbd-45e6-a553-9ca24f2f9b5b"
}
```
