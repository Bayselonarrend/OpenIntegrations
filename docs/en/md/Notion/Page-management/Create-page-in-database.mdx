    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion CreatePageInDatabase \
             --token "***" \
             --base "16582aa7-fc4e-81c5-9b58-e08c52d84418" \
             --data "{'Name':'LLC Vector','Description':'OurFirstClient','Number':1,'Status':'New','CreationDate':'2024-12-23T09:35:05.1838827Z','Image':{'Logo':'https://github.com/Bayselonarrend/OpenIntegrations/raw/main/service/test_data/picture.jpg'},'Active':true,'Website':'https://vector.ru','Email':'mail@vector.ru','Phone':'88005553535'}"
        ```
    </TabItem>
