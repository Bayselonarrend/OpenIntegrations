...
:::tip
Method at AWS documentation: [PutBucketEncryption](https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutBucketEncryption.html)<br/>
<br/>
:::
<br/>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 PutBucketEncryption \
             ...
             --conf "C:\Users\Administrator\AppData\Local\Temp\w4zi5uzp4go.xml" \
             --dir false
        ```
    </TabItem>
