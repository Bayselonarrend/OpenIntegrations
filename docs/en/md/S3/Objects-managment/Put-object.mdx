...
:::tip
Method at AWS documentation (default): [PutObject](https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutObject.html)<br/>
Method at AWS documentation (multipart): [Multipart upload](https:<br/>
docs.aws.amazon.com/AmazonS3/latest/userguide/mpuoverview.html)<br/>
You can use the `ChunkSize` field in the basic data to specify the minimum file and chunk size for a chunked upload<br/>
For example, ChunkSize=X means that all files larger than X (in bytes) will be downloaded in chunks, where one chunk will be of size X.<br/>
Chunk upload is used for large files. Default ChunkSize - 20971520 bytes (20 MB)<br/>
<br/><br/>
