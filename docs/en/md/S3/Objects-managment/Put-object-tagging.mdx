...
:::tip
Setting up a new set removes all existing object tags<br/>
Method at AWS documentation: [PutObjectTagging](https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutObjectTagging.html)<br/>
<br/>
:::
<br/>
