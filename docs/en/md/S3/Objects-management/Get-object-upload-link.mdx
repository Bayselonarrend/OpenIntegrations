...
```json title="Result"
"s3.openintegrations.dev/newbucket2/pictureU.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=bayselonarrend%2F20260104%2FBTC%2Fs3%2Faws4_request&X-Amz-Date=20260104T003534Z&X-Amz-Expires=7200&X-Amz-SignedHeaders=host&X-Amz-Signature=36d6325531922a9df21ee00c9df67f2b7178667b2c1175d92dfc01b42066cc05"
```
