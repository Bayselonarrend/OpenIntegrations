...
```json title="Result"
"s3.openintegrations.dev/newbucket2/pictureU.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=bayselonarrend%2F20260525%2FBTC%2Fs3%2Faws4_request&X-Amz-Date=20260525T143307Z&X-Amz-Expires=7200&X-Amz-SignedHeaders=host&X-Amz-Signature=2b7fb9fa6f0615c457425e7aa300ddbb8ce567843c891d13937d1a598d30ea15"
```
