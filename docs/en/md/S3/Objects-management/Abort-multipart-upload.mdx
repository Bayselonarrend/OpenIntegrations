    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 AbortMultipartUpload \
              ...
              --upload "MGI2Y2U2YTAtMDYxZC00NzkwLTk3YmEtOTM0NDY2MWFjZGYwLjI1ZjAxZmE5LWQ1ZmYtNGZiMS1iOTkyLWNhYjA3ZGIxODczZXgxNzg0NDgzODEwNjkyMTk5MjY1" \
              --dir true
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18C3C02C041121C3",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "6364",
  "X-Ratelimit-Remaining": "6364",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Sun, 19 Jul 2026 17:12:52 GMT"
 }
}
```
