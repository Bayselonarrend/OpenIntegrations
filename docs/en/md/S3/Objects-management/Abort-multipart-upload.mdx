    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 AbortMultipartUpload \
              ...
              --upload "NGU4YWU5ZGItY2JiMC00Y2U4LThjM2QtY2QyODU2N2VkODVmLjcyOTAzODlhLWI5NWMtNDk3MC04YTVkLTEwYzU4YzM3NGUxNHgxNzcxNDIzMzQ1MDYzMDYxNTAz" \
              --dir true
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18956B226D783EE9",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "3038",
  "X-Ratelimit-Remaining": "3038",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Wed, 18 Feb 2026 18:37:03 GMT"
 }
}
```
