---
sidebar_position: 6
description:  Aborts the multipart uploading of the objectСтраницы
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 AbortMultipartUpload \
             ...
             --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLjJjMzk1NTAxLTdiNzctNDhjMy05YTlhLTA2OTE1ZThhMTg3Mg"
        ```
    </TabItem>
