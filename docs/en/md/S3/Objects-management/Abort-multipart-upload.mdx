    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 AbortMultipartUpload \
             ...
             --upload "NjdmMzY2OTktYjA2ZC00MTViLTkwOGUtZDM2NmI5MDk1NTllLmYwMGZmODI3LTA2NTYtNDQ4Yy04YmNjLWUwOTIyOTdiNmYyMw" \
             --dir true
        ```
    </TabItem>
