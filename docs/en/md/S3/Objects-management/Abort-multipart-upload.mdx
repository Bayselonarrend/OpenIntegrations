    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 AbortMultipartUpload \
             ...
             --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLjBmNTAyZTliLWE1ZmUtNDViYS05OTNkLTgzZmY0NmYyMzgwMg" \
             --dir true
        ```
    </TabItem>
