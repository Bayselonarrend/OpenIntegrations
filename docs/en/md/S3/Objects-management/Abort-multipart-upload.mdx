    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 AbortMultipartUpload \
              ...
              --upload "NGU4YWU5ZGItY2JiMC00Y2U4LThjM2QtY2QyODU2N2VkODVmLjk1ZGJiZGQ4LTE1NmItNDQ2YS04YzNkLWFjMzhkY2FmNWU5NHgxNzcxNTg0NzQ2NjQzNzY2Njc3" \
              --dir true
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "1895EEF136FF58D1",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "3057",
  "X-Ratelimit-Remaining": "3057",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Fri, 20 Feb 2026 10:52:28 GMT"
 }
}
```
