    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 AbortMultipartUpload \
             ...
             --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLmUzNmNlNDU5LTUyNWItNGY3Zi04ZmZhLWNmMzc4YTc5ZGFkZQ" \
             --dir true
        ```
    </TabItem>
