    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint s3 AbortMultipartUpload \
             ...
             --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLjUyYTNkZjliLTBlODktNDVhNC1hMDk1LWEwMjEyZDFhOTk4NA" \
             --dir true
        ```
    </TabItem>
