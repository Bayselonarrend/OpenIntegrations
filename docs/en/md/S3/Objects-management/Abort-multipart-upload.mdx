    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 AbortMultipartUpload \
              ...
              --upload "MGI2Y2U2YTAtMDYxZC00NzkwLTk3YmEtOTM0NDY2MWFjZGYwLjNmMzRjZWIyLWI0NjctNDY5NS1hOTE0LWYyNjkxMmIyZmRkN3gxNzc5NzE5MzY0MDIwODM5NjYz" \
              --dir true
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18B2D5552D5F19BD",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "6518",
  "X-Ratelimit-Remaining": "6518",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Mon, 25 May 2026 14:29:24 GMT"
 }
}
```
