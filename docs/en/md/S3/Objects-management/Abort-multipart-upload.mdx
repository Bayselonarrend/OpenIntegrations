    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 AbortMultipartUpload \
              ...
              --upload "MGI2Y2U2YTAtMDYxZC00NzkwLTk3YmEtOTM0NDY2MWFjZGYwLjMwN2QzMWE4LWUwNTAtNDJkOS1iNThkLWE0YTY3ZTk5MjU2M3gxNzg0MTgwNjQ3MDExMDA2MzM0" \
              --dir true
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18BA3E0D309892CE",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "6209",
  "X-Ratelimit-Remaining": "6209",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Thu, 18 Jun 2026 17:47:08 GMT"
 }
}
```
