    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 FinishPartsUpload \
              ...
              --upload "MGI2Y2U2YTAtMDYxZC00NzkwLTk3YmEtOTM0NDY2MWFjZGYwLmVjYmI4ZTMwLTNlOTctNDE2MC1iNGU3LTk2MjljYTE3NTE5ZXgxNzc0NDUwMDM5OTU3ODM2ODQ4" \
...
```json title="Result"
{
 ...
 "response": {
  "CompleteMultipartUploadResult": {
   "Location": "http://s3.openintegrations.dev/466bcca8/fileChunked.mp3",
   "Bucket": "466bcca8",
   "Key": "***",
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18A01CE98EA9BEF5",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "6373",
  "X-Ratelimit-Remaining": "6373",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Wed, 25 Mar 2026 14:47:22 GMT",
