    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 FinishPartsUpload \
             ...
             --upload "NGU4YWU5ZGItY2JiMC00Y2U4LThjM2QtY2QyODU2N2VkODVmLjlhOWNiN2NhLTZhOGMtNGExYS05OWE5LTQ2NzQyNjFhNDg2MngxNzY3NjUxNjIyMjgwMjcwODM0" \
...
```json title="Result"
{
 ...
 "response": {
  "CompleteMultipartUploadResult": {
   "Location": "http://s3.openintegrations.dev/5611e67b/fileChunked.mp3",
   "Bucket": "5611e67b",
   "Key": "***",
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18880E2CCC0ACAEA",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "2955",
  "X-Ratelimit-Remaining": "2955",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Tue, 06 Jan 2026 05:47:18 GMT",
