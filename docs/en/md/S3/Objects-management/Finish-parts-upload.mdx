    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 FinishPartsUpload \
             ...
             --upload "NjdmMzY2OTktYjA2ZC00MTViLTkwOGUtZDM2NmI5MDk1NTllLjNhZTcyMzcyLTZhMTUtNDg1MC1iMWJmLTFkODE3ZjQ4MzQ4ZA" \
...
```json title="Result"
{
 ...
 "response": {
  "CompleteMultipartUploadResult": {
   "Location": "https://storage-564.s3hoster.by/03e6b32e/fileChunked.mp3",
   "Bucket": "03e6b32e",
   "Key": "***",
