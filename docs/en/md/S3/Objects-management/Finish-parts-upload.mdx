    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 FinishPartsUpload \
              ...
              --upload "NGU4YWU5ZGItY2JiMC00Y2U4LThjM2QtY2QyODU2N2VkODVmLmNiNDUyZjRlLTczYTQtNDFmNy1hMmNkLWZmOTdlMjM4ZWMwMXgxNzcxMzk2NDIzOTUyNDgzNDU2" \
...
```json title="Result"
{
 ...
 "response": {
  "CompleteMultipartUploadResult": {
   "Location": "http://s3.openintegrations.dev/a21b504e/fileChunked.mp3",
   "Bucket": "a21b504e",
   "Key": "***",
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "189543AA9335EB03",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "3038",
  "X-Ratelimit-Remaining": "3038",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Wed, 18 Feb 2026 06:33:48 GMT",
