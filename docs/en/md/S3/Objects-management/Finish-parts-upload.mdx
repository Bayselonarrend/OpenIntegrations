...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    Bucket = "w567hjy1";
    Entity = "https://releases.openintegrations.dev/test_data/song.mp3"; // URL, Path or Binary data
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 FinishPartsUpload \
              ...
              --upload "MGI2Y2U2YTAtMDYxZC00NzkwLTk3YmEtOTM0NDY2MWFjZGYwLmNiY2U3ZDk2LTA4NTMtNDJkZS1hZDI0LTY5YzA0OTk4NjFjMXgxNzg0MTgwNjQxNDM1MTcyMDgz" \
...
```json title="Result"
{
 ...
 "response": {
  "CompleteMultipartUploadResult": {
   "Location": "http://s3.openintegrations.dev/5da34d1e/fileChunked.mp3",
   "Bucket": "5da34d1e",
   "Key": "***",
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18BA3E0D186AB591",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "6209",
  "X-Ratelimit-Remaining": "6209",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Thu, 18 Jun 2026 17:47:07 GMT",
