    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 FinishPartsUpload \
              ...
              --upload "MGI2Y2U2YTAtMDYxZC00NzkwLTk3YmEtOTM0NDY2MWFjZGYwLjEyNzAxYzQ2LWRmMjQtNDZlMC05YWMwLTIzNWEyOGRmNTkxMXgxNzc0NDIxNTg1MzgwNzM1NjM1" \
...
```json title="Result"
{
 ...
 "response": {
  "CompleteMultipartUploadResult": {
   "Location": "http://s3.openintegrations.dev/0f78b405/fileChunked.mp3",
   "Bucket": "0f78b405",
   "Key": "***",
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18A00B850E63DC28",
