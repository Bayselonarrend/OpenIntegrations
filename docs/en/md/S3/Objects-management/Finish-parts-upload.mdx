    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 FinishPartsUpload \
              ...
              --upload "MGI2Y2U2YTAtMDYxZC00NzkwLTk3YmEtOTM0NDY2MWFjZGYwLjAxNzUxMGRjLTZmODYtNGNmOS04Y2E1LTYwM2M3MGYwMTc1YXgxNzgxNTQ3ODkzNzg2Nzk5NDE3" \
...
```json title="Result"
{
 ...
 "response": {
  "CompleteMultipartUploadResult": {
   "Location": "http://6bcd1097.s3.openintegrations.dev/fileChunked.mp3",
   "Bucket": "6bcd1097",
   "Key": "***",
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18B947AEC64B392B",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "6476",
  "X-Ratelimit-Remaining": "6476",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Mon, 15 Jun 2026 14:32:23 GMT",
