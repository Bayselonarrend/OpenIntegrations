    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 FinishPartsUpload \
              ...
              --upload "NGU4YWU5ZGItY2JiMC00Y2U4LThjM2QtY2QyODU2N2VkODVmLmQyNWNiNWEwLWY5ODAtNGZiMi05YTFlLTQ2MjFjODQ5ZTM2ZHgxNzcxNDIzMzM2MzY4MzEzNTc1" \
...
```json title="Result"
{
 ...
 "response": {
  "CompleteMultipartUploadResult": {
   "Location": "http://s3.openintegrations.dev/e6e20092/fileChunked.mp3",
   "Bucket": "e6e20092",
   "Key": "***",
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18956B223D61BAB1",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "3038",
  "X-Ratelimit-Remaining": "3038",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Wed, 18 Feb 2026 18:37:02 GMT",
