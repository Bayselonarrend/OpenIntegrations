    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 FinishPartsUpload \
              ...
              --upload "MGI2Y2U2YTAtMDYxZC00NzkwLTk3YmEtOTM0NDY2MWFjZGYwLjZjMDQ5ZGJiLTA1ZjItNGE3Zi1iZWY5LWQ5N2YzYWM0M2ViZXgxNzc5NzE5MzYwMTc3NTQzMTg4" \
...
```json title="Result"
{
 ...
 "response": {
  "CompleteMultipartUploadResult": {
   "Location": "http://s3.openintegrations.dev/1438bb04/fileChunked.mp3",
   "Bucket": "1438bb04",
   "Key": "***",
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18B2D554C29EB005",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "6518",
  "X-Ratelimit-Remaining": "6518",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Mon, 25 May 2026 14:29:22 GMT",
