    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 FinishPartsUpload \
              ...
              --upload "MGI2Y2U2YTAtMDYxZC00NzkwLTk3YmEtOTM0NDY2MWFjZGYwLjRlZWJmMzBiLWMwNGQtNGQ0Yi1iN2VhLWRiNWJmZWE5OTNmOHgxNzg0NDgzODA2OTI2NDE1ODg0" \
...
```json title="Result"
{
 ...
 "response": {
  "CompleteMultipartUploadResult": {
   "Location": "http://s3.openintegrations.dev/f106d890/fileChunked.mp3",
   "Bucket": "f106d890",
   "Key": "***",
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18C3C02BE0AFB392",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "6364",
  "X-Ratelimit-Remaining": "6364",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Sun, 19 Jul 2026 17:12:51 GMT",
