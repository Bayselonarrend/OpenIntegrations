    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 FinishPartsUpload \
             ...
             --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLmFjMmU0ZDZiLWE4YTgtNDlkNS04NTJjLTRiNmZiMWVmOWY3Ng" \
...
```json title="Result"
{
 ...
 "response": {
  "CompleteMultipartUploadResult": {
   "Location": "https://storage-155.s3hoster.by/opi-dirbucket4/fileChunked.mp3",
   "Bucket": "opi-dirbucket4",
   "Key": "fileChunked.mp3",
