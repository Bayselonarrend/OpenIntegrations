...
```json title="Result"
"s3.openintegrations.dev/42625bab/picture.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=bayselonarrend%2F20260220%2FBTC%2Fs3%2Faws4_request&X-Amz-Date=20260220T105341Z&X-Amz-Expires=7200&X-Amz-SignedHeaders=host&X-Amz-Signature=b4bafc803a13dfcc4d8edd507fcd4bae82a1e73f2572f2409a296014532d88b7"
```
