...
```json title="Result"
"s3.openintegrations.dev/aceadc87/picture.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=bayselonarrend%2F20260207%2FBTC%2Fs3%2Faws4_request&X-Amz-Date=20260207T141343Z&X-Amz-Expires=7200&X-Amz-SignedHeaders=host&X-Amz-Signature=61a20d023d22eb8c0599093f9d228eac1672f13b862078f391505adf6d5bca2f"
```
