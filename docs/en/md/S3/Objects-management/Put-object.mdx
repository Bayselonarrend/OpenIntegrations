...
```bsl title="1C:Enterprise/OneScript code example"
    ...
    Bucket = "w567hjy1";
    Name   = "picture.jpg";
    Entity = "https://releases.openintegrations.dev/test_data/picture.jpg"; // URL, Path or Binary data
...
```json title="Result"
{
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18C3C02857102DF1",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "6364",
  "X-Ratelimit-Remaining": "6364",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Sun, 19 Jul 2026 17:12:36 GMT",
  "Content-Length": "0"
 }
}
```
