...
```json title="Result"
{
 ...
 "response": {
  "InitiateMultipartUploadResult": {
   "Bucket": "e6e20092",
   "Key": "***",
   "UploadId": "NGU4YWU5ZGItY2JiMC00Y2U4LThjM2QtY2QyODU2N2VkODVmLjY3N2JlNWVjLTg0ZmYtNDE2Yi05ZjM1LWJmNzNhNDQ5MzU3YngxNzcxNDM5ODA2ODUyNjY5OTg4"
  }
 },
 "headers": {
  "Accept-Ranges": "bytes",
  ...
  "X-Amz-Request-Id": "18956B1E6C6B2D4F",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "3038",
  "X-Ratelimit-Remaining": "3038",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Wed, 18 Feb 2026 18:36:46 GMT",
