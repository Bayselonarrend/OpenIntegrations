...
```json title="Result"
{
 ...
 "response": {
  "InitiateMultipartUploadResult": {
   "Bucket": "466bcca8",
   "Key": "***",
   "UploadId": "MGI2Y2U2YTAtMDYxZC00NzkwLTk3YmEtOTM0NDY2MWFjZGYwLmQ2MThmZjE2LWRmN2MtNDAyMS05ODkzLTZiMzdiMGIzYjg4YXgx..."
  }
 },
 "headers": {
  "Accept-Ranges": "bytes",
  ...
  "X-Amz-Request-Id": "18A01CE66492CFDD",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "6373",
  "X-Ratelimit-Remaining": "6373",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Wed, 25 Mar 2026 14:47:09 GMT",
