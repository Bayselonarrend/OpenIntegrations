 ...
 <Tabs>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint vk CreatePost \
             --text "Post from autotest" \
             --pictures "['https://github.com/Bayselonarrend/OpenIntegrations/raw/main/service/test_data/picture.jpg','C:\\Users\\Administrator\\AppData\\Local\\Temp\\cd0eluschod.png']" \
             --ad true \
             --url "https://github.com/Bayselonarrend/OpenIntegrations" \
