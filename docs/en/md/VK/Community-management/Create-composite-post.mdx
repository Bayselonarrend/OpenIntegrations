---
sidebar_position: 2
description:  Creates a post based on an array of object identifiers (images, videos, etc..)Страницы
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint vk CreateCompositePost \
             --text "Post from autotest" \
             --objects "['photo657846756_457247189','video-218861756_456240332']" \
             --ad false \
             --url "https://github.com/Bayselonarrend/OpenIntegrations" \
