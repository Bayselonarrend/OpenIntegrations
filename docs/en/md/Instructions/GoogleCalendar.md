...
This section covers the library for working with the Google Calendar API in 1C:Enterprise, OneScript, and CLI. This page describes all the actions required to get started.
