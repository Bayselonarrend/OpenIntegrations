---
sidebar_position: 1
description: Generate code retrieval link and other functions to work with Google Drive in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
