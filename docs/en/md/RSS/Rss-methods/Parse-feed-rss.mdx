...
```bsl title="1C:Enterprise/OneScript code example"
    FeedXML = "C:\Users\bayselonarrend\AppData\Local\Temp\v8_4BFA_22.xml";
...
```json title="Result"
{
 ...
 "lastBuildDate": "Sun, 0,000,000,019 Jul 2026 17:05:57 +0000",
 "items": [
  {
   "title": "First element",
   "description": "First element description",
   "link": "https://example.com/item1",
   "pubDate": "Sun, 0,000,000,019 Jul 2026 17:05:57 +0000",
