    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rss CreateFeedRSS \
              ...
              --items "[{'title':'First element','description':'First element description','link':'https://example.com/item1','pubDate':'05/25/2026 14:42:26','author':'test@example.com','guid':'item-1'},{'title':'Second element','description':'Second element description','link':'https://example.com/item2','pubDate':'05/25/2026 14:42:27','author':'test@example.com','guid':'item-2'}]"
        ```
    </TabItem>
