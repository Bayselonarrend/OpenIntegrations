    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rss CreateFeedRSS \
              ...
              --items "[{'title':'First element','description':'First element description','link':'https://example.com/item1','pubDate':'07/19/2026 17:46:28','author':'test@example.com','guid':'item-1'},{'title':'Second element','description':'Second element description','link':'https://example.com/item2','pubDate':'07/19/2026 17:46:32','author':'test@example.com','guid':'item-2'}]"
        ```
    </TabItem>
