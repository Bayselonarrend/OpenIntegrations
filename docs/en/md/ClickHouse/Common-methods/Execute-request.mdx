    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint clickhouse ExecuteRequest \
              --conn "{'transport':'grpc','user':'bayselonarrend','password':'***','address':'http://127.0.0.1:9101','auth_type':'basic'}" \
...
```json title="Result"
{
 ...
 "headers": {
  "Date": "Sat, 02 May 2026 12:32:53 GMT",
  "Connection": "Keep-Alive",
  "X-ClickHouse-Server-Display-Name": "clickhouse",
  "Transfer-Encoding": "chunked",
  "X-ClickHouse-Query-Id": "af7a9909-27a2-4d76-bb4b-15921feb7826",
