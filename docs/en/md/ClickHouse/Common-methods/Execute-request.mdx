    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint clickhouse ExecuteRequest \
              --conn "{'address':'http://127.0.0.1:9101','transport':'grpc','user':'bayselonarrend','password':'***','auth_type':'basic'}" \
...
```json title="Result"
{
 ...
 "headers": {
  "Date": "Mon, 25 May 2026 14:41:56 GMT",
  "Connection": "Keep-Alive",
  "X-ClickHouse-Server-Display-Name": "clickhouse",
  "Transfer-Encoding": "chunked",
  "X-ClickHouse-Query-Id": "bf31512e-bc72-4d33-830b-448bf8b51799",
