...
```json title="Result"
{
 "data": {
  ...
  "logs": [],
  "output": {
   "BYTES": ""
  },
  "output_columns": [],
  "output_format": "JSON",
  "progress": {
  ...
  "query_id": "9d7c54ec-fa6a-4de4-a519-047315114995",
  "stats": {
