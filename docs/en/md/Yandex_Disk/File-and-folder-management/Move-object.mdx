---
sidebar_position: 9
description:  Moves the object to the specified path and path to the originalСтраницы
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint yadisk MoveObject \
             --token "***" \
             --from "/2dba97ac-7a52-4519-9b54-888a1201c79a.png" \
             --to "/9a3913ae-2570-4ab3-b9e3-6c9b4638ff1e.png" \
             --rewrite true
        ```
    </TabItem>
