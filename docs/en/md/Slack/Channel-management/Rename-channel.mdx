    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack RenameChannel \
              --token "***" \
              --channel "C0B6USH5EL8" \
              --title "testconvd29961b4-1e8e-4d4a-9b5c-b6676986b911"
        ```
    </TabItem>
...
```json title="Result"
{
 ...
 "channel": {
  ...
  "updated": 1779718037350,
  "name": "testconvd29961b4-1e8e-4d4a-9b5c-b6676986b911",
  "name_normalized": "testconvd29961b4-1e8e-4d4a-9b5c-b6676986b911",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
  ...
  "previous_names": [
   "testconv0e9221aa-906e-411f-ac48-32712bc83574"
  ]
 }
}
```
