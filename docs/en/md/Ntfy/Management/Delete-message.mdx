...
description: Delete message and other functions to work with Ntfy in the Open Integration Package, a free open-source integration library for 1C:Enterprise 8, OneScript and CLI
...
`Function DeleteMessage(Val URL, Val Topic, Val MessageID, Val Token = "") Export`
  ...
  | MessageID | --id | String | &#x2714; | ID of message to delete |
  | Token | --token | String | &#x2716; | Topic access token |
