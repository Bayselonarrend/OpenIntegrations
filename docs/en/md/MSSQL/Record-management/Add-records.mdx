    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql AddRecords \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':5},'smallint_field':{'SMALLINT':2000},'int_field':{'INT':200000},'bigint_field':{'BIGINT':20000000000},'float24_field':{'FLOAT24':10.1234567},'float53_field':{'FLOAT53':10.123456789123456},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/ojcfnks2.u14'},'uid_field':{'UUID':'ac8d895d-c38e-477a-984b-2401d98333a3'},'numeric_field':{'NUMERIC':5.333},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?><root>\n    <element>\n        <name>Example</name>\n        <value>123</value>\n    </element>\n    <element>\n        <name>Test</name>\n        <value>456</value>\n    </element>\n</root>'},'date_field':{'DATE':'2026-07-16T05:38:11+00:00'},'time_field':{'TIME':'2026-07-16T05:38:11+00:00'},'dto_field':{'DATETIMEOFFSET':'2026-07-16T05:38:11+05:00'},'datetime_field':{'DATETIME':'2026-07-16T05:38:11+00:00'}}]" \
              --trn true \
