    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql AddRecords \
             --table "testtable" \
             --rows "[{'tinyint_field':{'TINYINT':5},'smallint_field':{'SMALLINT':2000},'int_field':{'INT':200000},'bigint_field':{'BIGINT':20000000000},'float24_field':{'FLOAT24':10.1234567},'float53_field':{'FLOAT53':10.123456789123456},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/a4nifzge.pm0'},'uid_field':{'UUID':'ac01f6c8-c1a8-4e8e-9a3d-b3f4f703cdf0'},'numeric_field':{'NUMERIC':5.333},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?><root>  <element>  <name>Example</name>  <value>123</value>  </element>  <element>  <name>Test</name>  <value>456</value>  </element> </root>'},'date_field':{'DATE':'2026-01-05T21:22:27.284483Z'},'time_field':{'TIME':'2026-01-05T21:22:27.284483Z'},'dto_field':{'DATETIMEOFFSET':'2026-01-05T21:22:27.284483+05:00'},'datetime_field':{'DATETIME':'2026-01-05T21:22:27.284483Z'}}]" \
             --trn true \
