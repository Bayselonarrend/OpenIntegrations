...
```json title="Result"
{
 ...
 "headers": {
  ...
  "Authorization": "OAuth oauth_consumer_key=\"***\",oauth_token=\"***\",oauth_signature_method=\"HMAC-SHA256\",oauth_timestamp=\"1757937869\",oauth_nonce=\"1757937869\",oauth_version=\"1.0\",oauth_signature=WGjOww0qeDhf2XaD7t0cKAnWzg8a9zGiK8msrw8vetE%3D",
  "Content-Length": "2114372",
  "Content-Type": "multipart/form-data; boundary=5b383188338d4347a65a851f2513add9",
  "Host": "httpbin.org",
  "User-Agent": "1Script v$2.0.0.0",
  "X-Amzn-Trace-Id": "Root=1-68c7e4ad-7a50e20759480cf430358ad9"
 },
 "json": null,
 "origin": "***",
