...
```json title="Result"
{
 ...
 "headers": {
  ...
  "Authorization": "OAuth oauth_consumer_key=\"***\",oauth_token=\"***\",oauth_signature_method=\"HMAC-SHA256\",oauth_timestamp=\"1757847391\",oauth_nonce=\"1757847391\",oauth_version=\"1.0\",oauth_signature=oGR8pjvzt1gTFDR4WWPIXRTnLPErEV4Ygok3xdbMqKg%3D",
  "Content-Length": "2114372",
  "Content-Type": "multipart/form-data; boundary=b8c1e93d096441ad80d9f985c2b8637e",
  "Host": "httpbin.org",
  "User-Agent": "1Script v$2.0.0.0",
  "X-Amzn-Trace-Id": "Root=1-68c6ad6f-0b0475704bcefab9328b8e78"
 },
 "json": null,
 "origin": "***",
