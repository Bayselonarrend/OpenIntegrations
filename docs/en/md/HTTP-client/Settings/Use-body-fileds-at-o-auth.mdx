...
```json title="Result"
{
 ...
 "headers": {
  ...
  "Authorization": "OAuth oauth_consumer_key=\"***\",oauth_token=\"***\",oauth_signature_method=\"HMAC-SHA256\",oauth_timestamp=\"1765168519\",oauth_nonce=\"1765168519\",oauth_version=\"1.0\",oauth_signature=mjgyWelUnrDfJ9HoOrEaqz%2B%2FGjSJ8z0Y69eF46zVxzA%3D",
  "Connection": "Keep-Alive",
  "Content-Length": "2114372",
  "Content-Type": "multipart/form-data; boundary=61fafb14657c4697b85c1bc5fad8254c",
  "Host": "localhost:2424",
  "Max-Forwards": "10",
  "User-Agent": "1Script v$2.0.0.0",
  "X-Arr-Log-Id": "5aeb5d3e-994b-42ad-8527-f5eb47807f43",
