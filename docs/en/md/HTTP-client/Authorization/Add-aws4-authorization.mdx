...
```json title="Result"
{
 ...
 "headers": {
  ...
  "Authorization": "AWS4-HMAC-SHA256 Credential=AccessKey/20251031/Region/s3/aws4_request, SignedHeaders=host;x-amz-content-sha256;x-amz-date, Signature=1c0588fba3f8e9ca25232afac1f37dbd9988081cf35a78b342668cdb4d029a3f",
  ...
  "X-Amz-Date": "20251031T123051Z",
  "X-Arr-Log-Id": "f55eeaba-d6bb-4d87-b30e-7a0dc5f5e99c",
