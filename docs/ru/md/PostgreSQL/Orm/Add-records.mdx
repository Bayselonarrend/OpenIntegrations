    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint postgres ДобавитьЗаписи \
              --table ""testtable"" \
              --rows ""[{'bool_field':{'BOOL':true},'oldchar_field':{'OLDCHAR':1},'smallint_field':{'SMALLINT':5},'smallserial_field':{'SMALLSERIAL':6},'int_field':{'INT':100},'serial_field':{'SERIAL':100},'oid_field':{'OID':24576},'bigint_field':{'BIGINT':9999999},'bigserial_field':{'BIGSERIAL':9999999},'real_field':{'REAL':15.2},'dp_field':{'DOUBLE_PRECISION':1.0002},'text_field':{'TEXT':'Some text'},'varchar_field':{'VARCHAR':'Some varchar'},'charn_field':{'CHAR':'AAA'},'char_field':{'CHAR':'A'},'name_field':{'NAME':'Vitaly'},'bytea_field':{'BYTEA':'C:\\Users\\bayse\\AppData\\Local\\Temp\\1bd0noyp.4n3'},'ts_field':{'TIMESTAMP':'2025-09-16T22:54:50.7763754Z'},'tswtz_field':{'TIMESTAMP_WITH_TIME_ZONE':'2025-09-16T22:54:50.7763754+05:00'},'ip_field':{'INET':'127.0.0.1'},'json_field':{'JSON':{'key':'ItsKey','value':10}},'jsonb_field':{'JSONB':{'key':'ItsKey','value':10}},'date_field':{'DATE':'2025-09-16T22:54:50.7763754Z'},'time_field':{'TIME':'2025-09-16T22:54:50.7763754Z'},'uuid_field':{'UUID':'5fcc38a8-9243-4910-9f26-fad88355ed62'}}]"" \
              --trn "true" \
              --dbc "postgresql://bayselonarrend:***@127.0.0.1:5432/" \
              --tls ""C:\Users\bayse\AppData\Local\Temp\loviaa2v.41m.json""
        ```
    </TabItem>
