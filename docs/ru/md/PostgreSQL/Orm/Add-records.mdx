    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint postgres ДобавитьЗаписи \
              --table "\"testtable\"" \
              --rows "\"[{'bool_field':{'BOOL':true},'oldchar_field':{'OLDCHAR':1},'smallint_field':{'SMALLINT':5},'smallserial_field':{'SMALLSERIAL':6},'int_field':{'INT':100},'serial_field':{'SERIAL':100},'oid_field':{'OID':24576},'bigint_field':{'BIGINT':9999999},'bigserial_field':{'BIGSERIAL':9999999},'real_field':{'REAL':15.2},'dp_field':{'DOUBLE_PRECISION':1.0002},'text_field':{'TEXT':'Some text'},'varchar_field':{'VARCHAR':'Some varchar'},'charn_field':{'CHAR':'AAA'},'char_field':{'CHAR':'A'},'name_field':{'NAME':'Vitaly'},'bytea_field':{'BYTEA':'/tmp/fwb0jal4.f5h'},'ts_field':{'TIMESTAMP':'2025-09-08T08:40:00.169761Z'},'tswtz_field':{'TIMESTAMP_WITH_TIME_ZONE':'2025-09-08T08:40:00.169761+05:00'},'ip_field':{'INET':'127.0.0.1'},'json_field':{'JSON':{'key':'ItsKey','value':10}},'jsonb_field':{'JSONB':{'key':'ItsKey','value':10}},'date_field':{'DATE':'2025-09-08T08:40:00.169761Z'},'time_field':{'TIME':'2025-09-08T08:40:00.169761Z'},'uuid_field':{'UUID':'fc2ee14a-fbf9-4bc3-826a-14f9e7f38e01'}}]\"" \
              --trn "true" \
              --dbc "postgresql://bayselonarrend:***@127.0.0.1:5432/" \
              --tls "\"/tmp/xogywrql.i2t.json\""
        ```
    </TabItem>
