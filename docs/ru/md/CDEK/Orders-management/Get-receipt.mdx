...
{
 "entity": {
  "uuid": "21437cfa-fb2e-436a-9286-99afe60b8af8",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/21437cfa-fb2e-436a-9286-99afe60b8af8.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2025-09-08T09:40:05+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2025-09-08T09:40:07+00:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "49816743-e367-441b-a7ad-0bcc029dc616",
   "type": "CREATE",
   "date_time": "2025-09-08T09:40:05+00:00",
   "state": "SUCCESSFUL"
  }
