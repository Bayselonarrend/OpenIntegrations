...
{
 "entity": {
  "uuid": "909d39ea-e29f-42d6-b012-d2dc3d431d4d",
  "orders": [
   {
    "order_uuid": "e7b47ed7-a08a-4143-ab45-ea66efad0184"
   }
  ],
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/909d39ea-e29f-42d6-b012-d2dc3d431d4d.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2025-09-08T19:45:21+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2025-09-08T19:45:23+00:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "48eb87fd-7e1f-464d-a06b-b689593a910c",
   "type": "CREATE",
   "date_time": "2025-09-08T19:45:21+00:00",
   "state": "SUCCESSFUL"
  }
