...
{
 "entity": {
  "uuid": "27dbf7b4-ea4c-48a6-a738-ee8b9ddd2caa",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/27dbf7b4-ea4c-48a6-a738-ee8b9ddd2caa.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2025-12-02T16:21:57+00:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "39542361-5c67-4e98-97f7-ed3de6dd6c72",
   "type": "CREATE",
   "date_time": "2025-12-02T16:21:45+00:00",
   "state": "SUCCESSFUL"
  }
 ],
 "related_entities": []
