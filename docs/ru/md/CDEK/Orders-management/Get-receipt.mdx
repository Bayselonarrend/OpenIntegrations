...
{
 "entity": {
  "uuid": "e96b6bb4-4b0b-4d8e-b60b-e6c6e28f12c9",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/e96b6bb4-4b0b-4d8e-b60b-e6c6e28f12c9.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2025-09-30T19:41:42+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "be2a738c-5722-4fa6-b94f-dd29a39682a7",
   "type": "CREATE",
   "date_time": "2025-09-30T19:41:42+00:00",
   "state": "SUCCESSFUL"
  }
