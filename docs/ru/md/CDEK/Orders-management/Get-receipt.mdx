...
{
 "entity": {
  "uuid": "5a1316ed-4fd9-4368-ac44-b7c04664b7c6",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/5a1316ed-4fd9-4368-ac44-b7c04664b7c6.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2025-10-09T17:33:04+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "b457c38a-0147-4f41-9b42-691d17ebc7ec",
   "type": "CREATE",
   "date_time": "2025-10-09T17:33:04+00:00",
   "state": "SUCCESSFUL"
  }
