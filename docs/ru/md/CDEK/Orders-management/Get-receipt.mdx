...
{
 "entity": {
  "uuid": "c3906407-3422-4382-a98a-9090196ef84f",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/c3906407-3422-4382-a98a-9090196ef84f.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2025-10-06T17:59:03+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "cd88ce1d-6ff0-4a6b-afdd-5d43b4f7a17e",
   "type": "CREATE",
   "date_time": "2025-10-06T17:59:03+00:00",
   "state": "SUCCESSFUL"
  }
