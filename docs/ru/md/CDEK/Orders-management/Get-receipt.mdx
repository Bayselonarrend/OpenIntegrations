...
{
 "entity": {
  "uuid": "18b669c0-d549-4b8c-8787-6009c525f685",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/18b669c0-d549-4b8c-8787-6009c525f685.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2025-09-23T14:28:42+03:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "8969a2d4-0930-47a5-80cc-14bc2ca743bf",
   "type": "CREATE",
   "date_time": "2025-09-23T14:28:38+03:00",
   "state": "SUCCESSFUL"
  }
