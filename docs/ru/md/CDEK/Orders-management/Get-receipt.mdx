...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    UUID  = "dedaa821-311b-4dac-a596-c879f53e7e85";
...
{
 "entity": {
  "uuid": "dad863b1-b890-4398-95dd-614d069e378e",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/dad863b1-b890-4398-95dd-614d069e378e.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
 ...
 "requests": [
  {
   "request_uuid": "5a2e8628-6225-4d16-a21e-5a7867eceee7",
   "type": "CREATE",
   "date_time": "2025-09-11T20:57:13+03:00",
   "state": "SUCCESSFUL"
  }
 ],
 "related_entities": []
