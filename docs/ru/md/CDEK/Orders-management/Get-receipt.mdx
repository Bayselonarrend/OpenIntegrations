...
{
 "entity": {
  "uuid": "6bb625b8-32b0-4568-bf90-3fe7a8d13f9b",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/6bb625b8-32b0-4568-bf90-3fe7a8d13f9b.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-02-02T19:58:15+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "fa58465d-d12f-49d9-8e61-807afd490ed5",
   "type": "CREATE",
   "date_time": "2026-02-02T19:58:15+00:00",
   "state": "SUCCESSFUL"
  }
