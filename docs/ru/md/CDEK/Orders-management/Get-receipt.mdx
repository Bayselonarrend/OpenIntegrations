...
{
 "entity": {
  "uuid": "935cac3e-237b-47c9-8e1c-5ae161d9c800",
  "orders": [
   {
    "order_uuid": "17564154-4d0e-4b4c-97e0-a1bbb7d0446c"
   }
  ],
  "copy_count": 1,
  "type": "tpl_russia",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-01-27T22:57:45+03:00"
   },
   {
    "code": "INVALID",
    "name": "Некорректный запрос",
    "date_time": "2026-01-27T22:57:46+03:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "8958766e-e77c-46f5-bc6d-dc2e85f11020",
   "type": "CREATE",
   "date_time": "2026-01-27T22:57:45+03:00",
   "state": "INVALID",
   "errors": [
   ...
   "warnings": [
    {
     ...
     "message": "Order is invalid 17564154-4d0e-4b4c-97e0-a1bbb7d0446c"
    }
   ]
  }
 ],
