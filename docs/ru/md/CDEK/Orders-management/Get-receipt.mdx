...
{
 "entity": {
  "uuid": "7757c038-976f-4ae0-9ba5-64ac0f32d04f",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/7757c038-976f-4ae0-9ba5-64ac0f32d04f.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2025-10-25T14:29:20+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "c95559ec-90be-4444-a26c-e49b10c2b64b",
   "type": "CREATE",
   "date_time": "2025-10-25T14:29:20+00:00",
   "state": "SUCCESSFUL"
  }
