...
{
 "entity": {
  "uuid": "7a327721-b45d-45fd-9070-5d0255e9f44a",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/7a327721-b45d-45fd-9070-5d0255e9f44a.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2025-09-11T12:52:17+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2025-09-11T12:52:19+00:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "4b31400a-f732-4474-acb4-d10731be0b87",
   "type": "CREATE",
   "date_time": "2025-09-11T12:52:17+00:00",
   "state": "SUCCESSFUL"
  }
