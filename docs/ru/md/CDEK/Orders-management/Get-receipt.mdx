...
{
 "entity": {
  "uuid": "3510f4b5-693e-46f0-9820-fe3cd7410ee0",
  "orders": [
   {
    "order_uuid": "9b63e3b6-22e4-4480-bf8e-64a2c40f64e1"
   }
  ],
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/3510f4b5-693e-46f0-9820-fe3cd7410ee0.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2025-09-08T13:56:34+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2025-09-08T13:56:35+00:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "f88fbdec-8b1d-4293-ae49-90242da240e3",
   "type": "CREATE",
   "date_time": "2025-09-08T13:56:34+00:00",
   "state": "SUCCESSFUL"
  }
