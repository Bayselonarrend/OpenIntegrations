...
{
 "entity": {
  "uuid": "9ec05c15-3cb2-4b2d-8161-c84a3e6de25f",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/9ec05c15-3cb2-4b2d-8161-c84a3e6de25f.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-01-31T18:25:28+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "3ba752a6-cfbc-4c55-988b-52b149d87549",
   "type": "CREATE",
   "date_time": "2026-01-31T18:25:27+03:00",
   "state": "SUCCESSFUL"
  }
 ],
 "related_entities": []
