    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek СформироватьШтрихкод \
              --token *** \
              --uuids "e7b47ed7-a08a-4143-ab45-ea66efad0184" \
              --count 1 \
              --format "A5" \
              --testapi ***
        ```
...
{
 "entity": {
  "uuid": "e56564c0-c546-452c-a1ed-3ba97f4105ce"
 },
 "requests": [
  {
   "request_uuid": "d026f9d0-ad3c-4d16-8d9f-9a4a12b642ba",
   "type": "CREATE",
   "date_time": "2025-09-08T19:45:24+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
