    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek СформироватьШтрихкод \
              --token "***" \
              --uuids "e91e98be-6b1e-48d7-bfe8-b4b007cabeee" \
              --count 1 \
              --format "A5" \
              --testapi "***"
        ```
...
{
 "entity": {
  "uuid": "b8b593b9-9afe-4e0a-b03c-fc36e8704cff"
 },
 "requests": [
  {
   "request_uuid": "8088a154-d855-49b4-aa63-53e2734fb52e",
   "type": "CREATE",
   "date_time": "2025-09-10T13:56:35+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
