    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek СформироватьШтрихкод \
              --token "***" \
              --uuids "\"af71f431-c74b-45e1-9466-a0bf4fabaf0f\"" \
              --count "1" \
              --format "\"A5\"" \
              --testapi "***"
        ```
...
{
 "entity": {
  "uuid": "0cf14599-b4ce-4e86-a7b0-a2135c9a008a"
 },
 "requests": [
  {
   "request_uuid": "b68d2e50-c3e0-4ab8-b605-5288ab98e18a",
   "type": "CREATE",
   "date_time": "2025-09-08T09:40:08+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
