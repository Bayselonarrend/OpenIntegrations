    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek СформироватьШтрихкод \
              --token *** \
              --uuids "abde1de3-7f06-44ba-9427-5cb3f2b441d9" \
              --count 1 \
              --format "A5" \
              --testapi ***
        ```
...
{
 "entity": {
  "uuid": "70950fae-7d6e-4f1d-9fc9-8be05bd34bc1"
 },
 "requests": [
  {
   "request_uuid": "97bfee86-964b-48f7-8e22-5d6f7e9329e7",
   "type": "CREATE",
   "date_time": "2025-09-09T19:02:48+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
