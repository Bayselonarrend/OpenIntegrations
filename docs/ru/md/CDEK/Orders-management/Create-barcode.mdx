    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek СформироватьШтрихкод \
              --token "***" \
              --uuids "aa63630c-1add-434d-8095-6bd3757ab229" \
              --count 1 \
              --format "A5" \
              --testapi "***"
        ```
...
{
 "entity": {
  "uuid": "8955b7d0-87e7-4a3a-b116-3efd6497b362"
 },
 "requests": [
  {
   "request_uuid": "08f8eff3-f9e4-4b10-b33d-ae7ecaabc5fe",
   "type": "CREATE",
   "date_time": "2025-09-10T18:42:17+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
