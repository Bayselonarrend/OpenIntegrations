    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek СформироватьШтрихкод \
              --token *** \
              --uuids "9b63e3b6-22e4-4480-bf8e-64a2c40f64e1" \
              --count 1 \
              --format "A5" \
              --testapi ***
        ```
...
{
 "entity": {
  "uuid": "9e653072-7c91-4686-be7e-e92ddb2aa20b"
 },
 "requests": [
  {
   "request_uuid": "19dfe198-40ac-4a6e-9836-2adce620ae44",
   "type": "CREATE",
   "date_time": "2025-09-08T13:56:37+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
