    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek ПолучитьЗаказ \
              --token *** \
              --uuid "e7b47ed7-a08a-4143-ab45-ea66efad0184" \
              --testapi ***
        ```
    </TabItem>
...
```json title="Результат"
{
 "entity": {
  ...
  "is_return": false,
  "is_reverse": false,
  "cdek_number": "1106603131",
  "number": "35327fdb-d9c1-4572-9175-9b69153b39c3",
  "tariff_code": 139,
  "comment": "Новый заказ",
  ...
  "packages": [
   {
    ...
    "package_id": "c295f73d-489e-4fd6-b1f9-381ee9f75e45"
   }
  ],
  "statuses": [
   {
    "code": "CREATED",
    "name": "Создан",
    "date_time": "2025-09-08T19:44:53+00:00",
    "city": "Офис СДЭК",
    "deleted": false
   },
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2025-09-08T19:44:52+00:00",
    "city": "Офис СДЭК",
    "deleted": false
   }
  ],
