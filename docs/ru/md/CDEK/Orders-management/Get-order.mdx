    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek ПолучитьЗаказ \
              --token *** \
              --uuid "abde1de3-7f06-44ba-9427-5cb3f2b441d9" \
              --testapi ***
        ```
    </TabItem>
...
```json title="Результат"
{
 "entity": {
  ...
  "is_return": false,
  "is_reverse": false,
  "cdek_number": "1106603963",
  "number": "e44f14cf-5f33-481f-b953-2cb9c2447239",
  "tariff_code": 139,
  "comment": "Новый заказ",
  ...
  "packages": [
   {
    ...
    "package_id": "5f682e9c-13c4-4303-9c8b-2fe1b2293d5a"
   }
  ],
  "statuses": [
   {
    "code": "CREATED",
    "name": "Создан",
    "date_time": "2025-09-09T19:02:13+00:00",
    "city": "Офис СДЭК",
    "deleted": false
   },
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2025-09-09T19:02:12+00:00",
    "city": "Офис СДЭК",
    "deleted": false
   }
  ],
