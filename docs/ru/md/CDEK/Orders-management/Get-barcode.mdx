...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    UUID  = "fede046c-5442-4ea1-a553-86f8b359af30";
...
```json title="Результат"
{
 "entity": {
  ...
  "orders": [
   {
    "order_uuid": "07765015-9e55-45e4-a171-aea0be843cc4"
   }
  ],
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/a47f66a3-ee91-4e0c-b00b-b3e2a32abdb6.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2025-09-11T20:57:15+03:00"
   }
  ]
 },
 "requests": [
