...
```json title="Результат"
{
 "entity": {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/0bbf3ae8-d3f3-44c0-b26e-f9a6bc8e053b.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2025-12-02T16:21:55+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2025-12-02T16:21:56+00:00"
   }
  ]
 },
 "requests": [
