...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    UUID  = "e136fdb4-d51a-424e-af38-e6f0c87a933c";
...
```json title="Результат"
{
 "entity": {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/1a5c781c-8c1b-4eaa-8567-fb635171c20c.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2025-10-29T17:51:27+00:00"
   }
  ]
 },
 "requests": [
