...
```json title="Результат"
{
 "entity": {
  ...
  "orders": [
   {
    "order_uuid": "e6f39bcc-a856-4c28-b85d-94138836d7a1"
   }
  ],
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/202d1973-a587-4935-9d11-6c1f4ac62f69.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2025-09-17T16:31:31+03:00"
   }
  ]
 },
 "requests": [
