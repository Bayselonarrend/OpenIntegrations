---
sidebar_position: 11
description:  Получает штрихкод места к заказуСтраницы
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek ПолучитьШтрихкод \
              --token "***" \
              --uuid "72753031-911a-405e-bc38-ec0f3c2cabe8" \
              --getfile true \
              --testapi "***" \
              --out "C:\Users\Administrator\AppData\Local\Temp\iuxrshv1v3s.pdf"
        ```
    </TabItem>
