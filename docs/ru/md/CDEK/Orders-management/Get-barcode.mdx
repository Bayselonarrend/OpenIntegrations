...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    UUID  = "e37eebae-81ca-4c44-9789-7822e0bab8a3";
...
```json title="Результат"
{
 "entity": {
  ...
  "orders": [
   {
    "order_uuid": "da588960-e557-4012-8e6d-30f89f799f2a"
   }
  ],
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/6069bf5f-8b19-44e4-9cae-89e5a62d0172.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2025-10-10T10:24:35+00:00"
   }
  ]
 },
 "requests": [
