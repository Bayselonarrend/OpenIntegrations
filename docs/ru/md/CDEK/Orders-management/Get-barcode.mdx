...
```json title="Результат"
{
 "entity": {
  ...
  "orders": [
   {
    "order_uuid": "e91e98be-6b1e-48d7-bfe8-b4b007cabeee"
   }
  ],
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/b8b593b9-9afe-4e0a-b03c-fc36e8704cff.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2025-09-10T13:56:36+00:00"
   }
  ]
 },
 "requests": [
