...
```json title="Результат"
{
 "entity": {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/8955b7d0-87e7-4a3a-b116-3efd6497b362.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2025-09-10T18:42:21+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2025-09-10T18:42:22+00:00"
   }
  ]
 },
 "requests": [
