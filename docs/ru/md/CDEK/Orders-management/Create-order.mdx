...
```json title="Результат"
{
 ...
 "requests": [
  {
   "request_uuid": "c458e3c2-1343-40ab-a59d-1816e55cc10d",
   "type": "CREATE",
   "date_time": "2025-10-09T17:33:37+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
