    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek СоздатьПреалерт \
              ...
              --date "\"2025-09-09T09:40:08.8186535\"" \
              --point "\"NSK27\"" \
              --testapi "***"
        ```
    </TabItem>
...
{
 "entity": {
  "uuid": "906ed478-1e1d-410c-8393-511d6a4eff59"
 },
 "requests": [
  {
   "request_uuid": "41512275-cfa1-47d2-9701-b98fa7f28da0",
   "type": "CREATE",
   "date_time": "2025-09-08T09:40:10+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
