    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek СоздатьПреалерт \
              ...
              --date "2025-09-10T19:02:48.6347166" \
              --point "NSK27" \
              --testapi ***
        ```
    </TabItem>
...
{
 "entity": {
  "uuid": "b256d33f-845f-4066-b3aa-09c1450e4147"
 },
 "requests": [
  {
   "request_uuid": "b24cbe0b-4987-44c7-a744-ab696e56b2ae",
   "type": "CREATE",
   "date_time": "2025-09-09T19:02:51+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
