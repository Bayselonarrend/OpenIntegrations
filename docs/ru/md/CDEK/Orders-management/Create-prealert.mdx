    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek СоздатьПреалерт \
              ...
              --date "2025-09-11T13:56:36.2538315" \
              --point "NSK27" \
              --testapi "***"
        ```
    </TabItem>
...
{
 "entity": {
  "uuid": "87e69f0e-cb1e-44b1-8d35-8bf584589baf"
 },
 "requests": [
  {
   "request_uuid": "ba872c66-c7bc-43fa-a1dc-d127c802eeec",
   "type": "CREATE",
   "date_time": "2025-09-10T13:56:38+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
