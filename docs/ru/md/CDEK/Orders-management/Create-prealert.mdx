    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek СоздатьПреалерт \
              ...
              --date "2025-09-09T19:45:24.7965135" \
              --point "NSK27" \
              --testapi ***
        ```
    </TabItem>
...
{
 "entity": {
  "uuid": "45fd5304-d179-490e-b73c-0a42110f4d72"
 },
 "requests": [
  {
   "request_uuid": "bb9af195-b377-4f6e-961f-af1f049aa35f",
   "type": "CREATE",
   "date_time": "2025-09-08T19:45:26+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
