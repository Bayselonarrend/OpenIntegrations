    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek СоздатьПреалерт \
              ...
              --date "2025-09-09T13:56:37.7207251" \
              --point "NSK27" \
              --testapi ***
        ```
    </TabItem>
...
{
 "entity": {
  "uuid": "63299214-1d97-4696-a985-37e46b0a21b4"
 },
 "requests": [
  {
   "request_uuid": "9068449c-e737-4f70-902a-43c48c51067b",
   "type": "CREATE",
   "date_time": "2025-09-08T13:56:39+00:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
