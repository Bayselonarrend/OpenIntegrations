---
sidebar_position: 5
description:  Фиксирует оговоренные с клиентом дату, время и адрес доставкиСтраницы
...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    UUIDЗаказа = "fef31e96-2d88-4681-b43a-d79258d288c8";
