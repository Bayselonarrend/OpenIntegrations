    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek ПолучитьДоговоренностьОДоставке \
              --token "***" \
              --uuid "439afc0f-3421-435f-a65b-98900d1033d7" \
              --testapi "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "entity": {
  ...
  "order_uuid": "264039f6-d750-4d92-b74d-ca172ef44023",
  "date": "2026-07-13",
  "time_from": "10:00",
  "time_to": "17:00",
  ...
  "uuid": "914bce6e-feb2-4809-991e-ead090133c5f",
  "statuses": [
   {
    "code": "INVALID",
    "name": "Некорректна",
    "date_time": "2026-06-29T22:51:29+03:00"
   },
   {
    "code": "ACCEPTED",
    "name": "Принята",
    "date_time": "2026-06-29T22:51:28+03:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "31846f1a-fb7e-4283-961d-8ef3eb4ce10a",
   "type": "CREATE",
   "date_time": "2026-06-29T22:51:28+03:00",
   "state": "INVALID",
   "errors": [
