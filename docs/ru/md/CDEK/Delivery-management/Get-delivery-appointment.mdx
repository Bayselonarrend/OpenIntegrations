    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek ПолучитьДоговоренностьОДоставке \
              --token "***" \
              --uuid "fdbe174c-085c-43ec-9c3d-25f901d109b3" \
              --testapi "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "entity": {
  ...
  "order_uuid": "60446a53-7c67-43fc-9de0-3de3aa4fac32",
  "date": "2025-09-24",
  "time_from": "10:00",
  "time_to": "17:00",
  ...
  "statuses": [
   {
    "code": "INVALID",
    "name": "Некорректна",
    "date_time": "2025-09-10T13:58:06+00:00"
   },
   {
    "code": "ACCEPTED",
    "name": "Принята",
    "date_time": "2025-09-10T13:58:05+00:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "7a6ede28-07fa-489b-9be3-046b9e8bc510",
   "type": "CREATE",
   "date_time": "2025-09-10T13:58:05+00:00",
   "state": "INVALID",
   "errors": [
    {
     ...
     "message": "Указанная дата доставки не может быть позднее 2025-09-22"
    }
   ]
  }
 ],
