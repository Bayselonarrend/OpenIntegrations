...
```json title="Результат"
{
 "entity": {
  ...
  "order_uuid": "cb4d7d14-21cf-4a16-bf18-d5b4d45a8084",
  "date": "2026-06-22",
  "time_from": "10:00",
  "time_to": "17:00",
  ...
  "uuid": "01f2c7fa-cc04-4949-8afc-3b157ec7965e",
  "statuses": [
   {
    "code": "INVALID",
    "name": "Некорректна",
    "date_time": "2026-06-08T22:58:01+03:00"
   },
   {
    "code": "ACCEPTED",
    "name": "Принята",
    "date_time": "2026-06-08T22:58:00+03:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "b9c3e0b1-9558-41c8-a429-7f63f56d2d77",
   "type": "CREATE",
   "date_time": "2026-06-08T22:58:00+03:00",
   "state": "INVALID",
   "errors": [
    {
     ...
     "message": "Указанная дата доставки не может быть позднее 2026-06-19"
    }
   ]
  }
 ],
