...
```json title="Результат"
{
 "entity": {
  ...
  "order_uuid": "f30ae27f-6947-47fe-aed5-dcb4a0a43fcc",
  "date": "2026-06-04",
  "time_from": "10:00",
  "time_to": "17:00",
  ...
  "uuid": "56115dca-823c-48bd-b252-721d7588734c",
  "statuses": [
   {
    "code": "INVALID",
    "name": "Некорректна",
    "date_time": "2026-05-21T19:55:52+00:00"
   },
   {
    "code": "ACCEPTED",
    "name": "Принята",
    "date_time": "2026-05-21T19:55:51+00:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "ef167e06-3b27-443b-82c3-f6fcac18bb4c",
   "type": "CREATE",
   "date_time": "2026-05-21T19:55:51+00:00",
   "state": "INVALID",
   "errors": [
    {
     ...
     "message": "Указанная дата доставки не может быть позднее 2026-06-02"
    }
   ]
  }
 ],
