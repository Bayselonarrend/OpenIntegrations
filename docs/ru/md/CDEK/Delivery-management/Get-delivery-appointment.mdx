...
```json title="Результат"
{
 "entity": {
  ...
  "order_uuid": "f70ca56b-5978-4eec-80ec-73efcc5107af",
  "date": "2026-06-08",
  "time_from": "10:00",
  "time_to": "17:00",
  ...
  "uuid": "bea5a452-877f-4280-a65a-2d05ce812c21",
  "statuses": [
   {
    "code": "INVALID",
    "name": "Некорректна",
    "date_time": "2026-05-24T17:07:29+00:00"
   },
   {
    "code": "ACCEPTED",
    "name": "Принята",
    "date_time": "2026-05-24T17:07:28+00:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "e333040f-81b5-462a-9f70-37e9857963fc",
   "type": "CREATE",
   "date_time": "2026-05-24T17:07:28+00:00",
   "state": "INVALID",
   "errors": [
    {
     ...
     "message": "Указанная дата доставки не может быть позднее 2026-06-04"
    }
   ]
  }
 ],
