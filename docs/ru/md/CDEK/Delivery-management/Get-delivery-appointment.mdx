    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek ПолучитьДоговоренностьОДоставке \
              --token "***" \
              --uuid "471ed096-ba18-4d99-b44e-326d8d8becd1" \
              --testapi "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "entity": {
  ...
  "order_uuid": "03f0ea6a-3d1a-47f8-a0e1-798ae08d925b",
  "date": "2026-08-03",
  "time_from": "10:00",
  "time_to": "17:00",
  ...
  "uuid": "c5757991-8ef6-447d-af25-ea1a9605d727",
  "statuses": [
   {
    "code": "INVALID",
    "name": "Некорректна",
    "date_time": "2026-07-18T10:35:18+03:00"
   },
   {
    "code": "ACCEPTED",
    "name": "Принята",
    "date_time": "2026-07-18T10:35:17+03:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "c20553bb-e689-42a7-a2ae-0e622564d5c6",
   "type": "CREATE",
   "date_time": "2026-07-18T10:35:17+03:00",
   "state": "INVALID",
   "errors": [
