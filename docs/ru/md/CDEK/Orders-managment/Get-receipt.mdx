...
:::tip
Квитанция должна быть предварительно создана. См. СформироватьКвитанцию<br/>
Ссылка на файл с квитанцией к заказам доступна в течение 1 часа<br/>
Метод в документации API: [Получение квитанции к заказу](https://api-docs.cdek.ru/36967287.html)<br/>
<br/>
:::
<br/>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint cdek ПолучитьКвитанцию \
              --token "***" \
              --uuid "72753031-9c20-49e0-98ac-341416dcdb42" \
              --testapi "***"
        ```
    </TabItem>
