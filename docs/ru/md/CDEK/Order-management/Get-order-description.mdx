...
`Функция ПолучитьОписаниеЗаказа(Знач Пустая = Ложь, Знач ТолькоОбязательные = Ложь, Знач ИнтернетМагазин = Ложь) Экспорт`
  ...
  | ИнтернетМагазин | --ostore | Булево | &#x2716; | Признак включения в макет полей исключительно для заказов Интернет магазина |
...
:::tip
Обязательность реквизитов может зависеть от типа заказа или вложенности. Обязательно ознакомьтесь с документацией CDEK
