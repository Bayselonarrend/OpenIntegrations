...
```json title="Результат"
{
 ...
 "requests": [
  {
   "request_uuid": "1dc9b713-ff14-4151-b8da-ac721b3efee9",
   "type": "CREATE",
   "date_time": "2026-04-08T09:07:10+03:00",
   "state": "ACCEPTED"
  }
 ],
 "related_entities": []
