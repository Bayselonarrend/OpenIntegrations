...
```json title="Результат"
{
 "entity": {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/1ea7cd7e-ba4d-406a-a168-6a106af3540f.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-04-08T09:04:45+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2026-04-08T09:04:46+03:00"
   }
  ]
 },
 "requests": [
