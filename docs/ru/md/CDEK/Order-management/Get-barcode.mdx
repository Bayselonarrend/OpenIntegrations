...
{
 "entity": {
  "uuid": "34fe5654-06f3-491b-a296-522d9bef6b9d",
  "orders": [
   {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/34fe5654-06f3-491b-a296-522d9bef6b9d.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-02-18T15:29:22+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "e1dee016-bacd-4350-bf3d-957585b48d57",
   "type": "CREATE",
   "date_time": "2026-02-18T15:29:22+00:00",
   "state": "SUCCESSFUL"
  }
