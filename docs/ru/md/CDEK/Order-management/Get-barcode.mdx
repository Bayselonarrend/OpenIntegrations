...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    UUID  = "89797ae1-7cd7-47a5-9e89-fdb877c3749e";
...
{
 "entity": {
  "uuid": "a82ae341-2b9c-4c2e-af48-6a8e059af6cc",
  "orders": [
   {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/a82ae341-2b9c-4c2e-af48-6a8e059af6cc.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-04-23T17:03:32+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "2b1a9ea5-db3e-43d0-a5fd-d77b4557428b",
   "type": "CREATE",
   "date_time": "2026-04-23T17:02:58+03:00",
   "state": "SUCCESSFUL"
  }
 ],
 "related_entities": []
