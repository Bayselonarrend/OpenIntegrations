...
{
 "entity": {
  "uuid": "f5ca2c9a-f951-491c-9aea-f112c522e6bd",
  "orders": [
   {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/f5ca2c9a-f951-491c-9aea-f112c522e6bd.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-04-13T00:30:13+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2026-04-13T00:30:14+03:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "d5b8c019-117b-4279-8a62-1729d221df8d",
   "type": "CREATE",
   "date_time": "2026-04-13T00:30:02+03:00",
   "state": "SUCCESSFUL"
  }
 ],
 "related_entities": []
