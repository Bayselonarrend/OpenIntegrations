...
{
 "entity": {
  "uuid": "e68aa067-11db-4497-af61-df0cd36ef96f",
  "orders": [
   {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/e68aa067-11db-4497-af61-df0cd36ef96f.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-03-05T08:41:09+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "c1876b32-bc34-4c03-a7fc-0cca6fa27aa5",
   "type": "CREATE",
   "date_time": "2026-03-05T08:41:09+00:00",
   "state": "SUCCESSFUL"
  }
