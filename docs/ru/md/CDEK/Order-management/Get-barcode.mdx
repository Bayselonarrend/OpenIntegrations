...
{
 "entity": {
  "uuid": "7e71d0d1-53ed-4a03-8816-dbb0d80ffdf6",
  "orders": [
   {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/7e71d0d1-53ed-4a03-8816-dbb0d80ffdf6.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-06-18T18:18:38+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "af4767b4-39bb-4665-8be9-dc261ea05c9b",
   "type": "CREATE",
   "date_time": "2026-06-18T18:18:38+00:00",
   "state": "SUCCESSFUL"
  }
