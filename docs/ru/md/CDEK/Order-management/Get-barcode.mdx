...
{
 "entity": {
  "uuid": "c5742ea3-09eb-40b7-ae72-db3dcac87361",
  "orders": [
   {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/c5742ea3-09eb-40b7-ae72-db3dcac87361.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-06-06T16:32:41+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "16334919-653b-40b7-abaa-011e9e828421",
   "type": "CREATE",
   "date_time": "2026-06-06T16:32:41+03:00",
   "state": "SUCCESSFUL"
  }
