...
{
 "entity": {
  "uuid": "57b511b5-18f1-4174-94c0-4de170c9f92f",
  "orders": [
   {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/57b511b5-18f1-4174-94c0-4de170c9f92f.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-06-29T22:49:28+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2026-06-29T22:49:29+03:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "2ed606cf-b29c-4341-91e1-aa88327a9fa8",
   "type": "CREATE",
   "date_time": "2026-06-29T22:49:28+03:00",
   "state": "SUCCESSFUL"
  }
