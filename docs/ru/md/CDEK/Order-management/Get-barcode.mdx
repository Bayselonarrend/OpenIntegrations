...
{
 "entity": {
  "uuid": "961127fd-0063-4afc-9233-a142c53647ef",
  "orders": [
   {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/961127fd-0063-4afc-9233-a142c53647ef.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-09-01T20:11:46+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "160b1fe8-e504-40ae-bef9-214951203c5d",
   "type": "CREATE",
   "date_time": "2026-09-01T20:11:46+03:00",
   "state": "SUCCESSFUL"
  }
