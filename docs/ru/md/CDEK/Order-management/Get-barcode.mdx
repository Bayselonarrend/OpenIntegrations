...
{
 "entity": {
  "uuid": "8ae92b2a-2ff9-4e60-8389-850c0633d6fc",
  "orders": [
   {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/8ae92b2a-2ff9-4e60-8389-850c0633d6fc.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-06-15T18:35:46+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "d63bb264-37cb-40a0-be45-97068543c447",
   "type": "CREATE",
   "date_time": "2026-06-15T18:35:45+00:00",
   "state": "SUCCESSFUL"
  }
 ],
 "related_entities": []
