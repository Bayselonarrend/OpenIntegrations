...
{
 "entity": {
  "uuid": "ceefd3a3-4821-45d6-84ab-3444d0a20060",
  "orders": [
   {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/ceefd3a3-4821-45d6-84ab-3444d0a20060.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-06-06T20:36:32+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "d0e3ac78-b206-417e-ad29-10e09d366d56",
   "type": "CREATE",
   "date_time": "2026-06-06T20:36:32+03:00",
   "state": "SUCCESSFUL"
  }
