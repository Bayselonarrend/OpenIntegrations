...
{
 "entity": {
  "uuid": "edac8480-430e-4e20-a446-7cf8a34845e5",
  "orders": [
   {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/edac8480-430e-4e20-a446-7cf8a34845e5.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-04-14T00:13:13+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "8abdd7e6-0f28-4f19-a61d-733d4190d40d",
   "type": "CREATE",
   "date_time": "2026-04-14T00:12:33+03:00",
   "state": "SUCCESSFUL"
  }
 ],
 "related_entities": []
