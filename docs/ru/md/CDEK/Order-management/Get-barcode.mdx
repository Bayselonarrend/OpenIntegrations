...
{
 "entity": {
  "uuid": "26f62c43-9fab-40db-ab1f-2eb0acee143e",
  "orders": [
   {
  ...
  "copy_count": 1,
  "format": "A5",
  "url": "https://api.edu.cdek.ru/v2/print/barcodes/26f62c43-9fab-40db-ab1f-2eb0acee143e.pdf",
  "lang": "RUS",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-06-07T00:32:26+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "82abe473-f44a-4282-85aa-967b8a69603c",
   "type": "CREATE",
   "date_time": "2026-06-07T00:32:26+03:00",
   "state": "SUCCESSFUL"
  }
