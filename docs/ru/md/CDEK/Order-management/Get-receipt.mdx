...
{
 "entity": {
  "uuid": "d620781a-65d6-49be-834d-2294d523481a",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/d620781a-65d6-49be-834d-2294d523481a.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-06-06T16:32:40+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "6d7466bf-6d91-40a7-9d0c-535f4099c1cd",
   "type": "CREATE",
   "date_time": "2026-06-06T16:32:39+03:00",
   "state": "SUCCESSFUL"
  }
 ],
 "related_entities": []
