...
{
 "entity": {
  "uuid": "04dbba98-3207-4a93-81f6-9f2087955921",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/04dbba98-3207-4a93-81f6-9f2087955921.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-04-06T23:33:59+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "dcaa9c65-04ea-45bb-a60d-4f94a813415d",
   "type": "CREATE",
   "date_time": "2026-04-06T23:33:19+03:00",
   "state": "SUCCESSFUL"
  }
 ],
 "related_entities": []
