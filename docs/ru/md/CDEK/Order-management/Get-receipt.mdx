...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    UUID  = "fbecca64-75ed-4e14-b574-e8edc4af43b1";
...
{
 "entity": {
  "uuid": "af654174-a84b-48c8-a259-2add6a034a9d",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/af654174-a84b-48c8-a259-2add6a034a9d.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-04-23T17:03:17+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "b5b9eba3-81fb-415d-b0e0-0aa4748e2c1e",
   "type": "CREATE",
   "date_time": "2026-04-23T17:02:33+03:00",
   "state": "SUCCESSFUL"
  }
 ],
 "related_entities": []
