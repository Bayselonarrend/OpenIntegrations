...
{
 "entity": {
  "uuid": "6c1393a2-9c96-4939-834b-22d2a7ea72ae",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/6c1393a2-9c96-4939-834b-22d2a7ea72ae.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-02-18T15:29:21+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "69be627f-ee08-4a1d-8f24-8d33c286fe56",
   "type": "CREATE",
   "date_time": "2026-02-18T15:29:21+00:00",
   "state": "SUCCESSFUL"
  }
