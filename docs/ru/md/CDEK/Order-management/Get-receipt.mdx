...
{
 "entity": {
  "uuid": "bb09b80e-abd0-4d63-b5a0-52d5e4d0cc50",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/bb09b80e-abd0-4d63-b5a0-52d5e4d0cc50.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-06-07T00:32:25+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "9fe5ece4-e9a8-4eeb-b622-3f5f73521a95",
   "type": "CREATE",
   "date_time": "2026-06-07T00:32:25+03:00",
   "state": "SUCCESSFUL"
  }
