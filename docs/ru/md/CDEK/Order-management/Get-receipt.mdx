...
{
 "entity": {
  "uuid": "4ce4df48-2c33-4111-bfe8-b88db94ab8b7",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/4ce4df48-2c33-4111-bfe8-b88db94ab8b7.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-04-13T00:30:21+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
   ...
   },
   {
    "code": "READY",
    "name": "Сформирован",
    "date_time": "2026-04-13T00:30:22+03:00"
   }
  ]
 },
 "requests": [
  {
   "request_uuid": "7e1de499-1a4f-485f-8ca5-20095d6ddf52",
   "type": "CREATE",
   "date_time": "2026-04-13T00:29:40+03:00",
   "state": "SUCCESSFUL"
  }
 ],
 "related_entities": []
