...
{
 "entity": {
  "uuid": "989156b5-670f-4a38-9d5e-5535a72db88f",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/989156b5-670f-4a38-9d5e-5535a72db88f.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
 ...
 "requests": [
  {
   "request_uuid": "54eafd9a-a87b-4205-abb7-6e570bdeca92",
   "type": "CREATE",
   "date_time": "2026-06-04T21:50:36+03:00",
   "state": "SUCCESSFUL"
  }
 ],
 "related_entities": []
