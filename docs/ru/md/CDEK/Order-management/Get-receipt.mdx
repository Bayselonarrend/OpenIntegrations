...
{
 "entity": {
  "uuid": "d25a4b54-e7e5-44d2-8e50-990f473108cf",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/d25a4b54-e7e5-44d2-8e50-990f473108cf.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-03-05T08:41:07+00:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "ae7e1e7d-6111-4197-ae64-78d6953c01db",
   "type": "CREATE",
   "date_time": "2026-03-05T08:41:07+00:00",
   "state": "SUCCESSFUL"
  }
