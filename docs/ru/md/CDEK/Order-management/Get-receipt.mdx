...
{
 "entity": {
  "uuid": "a0d3e92e-3074-4127-940b-8107572ddbba",
  "orders": [
   {
  ...
  "copy_count": 1,
  "type": "tpl_russia",
  "url": "https://api.edu.cdek.ru/v2/print/orders/a0d3e92e-3074-4127-940b-8107572ddbba.pdf",
  "statuses": [
   {
    "code": "ACCEPTED",
    "name": "Принят",
    "date_time": "2026-06-04T07:14:30+03:00"
   },
   {
    "code": "PROCESSING",
    "name": "Формируется",
 ...
 "requests": [
  {
   "request_uuid": "027b215e-8229-498b-acee-3fbf32279073",
   "type": "CREATE",
   "date_time": "2026-06-04T07:14:30+03:00",
   "state": "SUCCESSFUL"
  }
