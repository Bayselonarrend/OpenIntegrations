...
description: Получить имена классов и другие функции для работы с NativeAPI в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
