...
Для некоторых методов ОПИ доступно использование функции **расширенного вызова** — передачи дополнительных настроек, которые не входят в обычную сигнатуру вызываемой функции. Как правило, это настройки транспорта — прокси, таймаут, формат ответа и т.п.
