...
**oint_x.x.x_all.deb** - это DEB-пакет, предназанченный для установки OInt в Debian/Ubuntu и днругих deb-based дистрибутивых дистрибутивах. Пакет не обладает встроенными зависимостями, следовательно никаких дополнительных подгрузок из интернета для начала работы не требуется

<img style={{paddingRight:'20px',marginTop:'16px'}} src={require('./img/8.png').default} width="86" align="left"/>
**oint-x.x.x-1.el7.x86_64.rpm** - это RPM-пакет, предназанченный для установки OInt в RHEL/Fedora/CentOS и других rpm-based дистрибутивах. При его использовании автоматически предлогается установка libicu - пакета интернализации Unicode (ICU), необходимого для работы движка приложения
