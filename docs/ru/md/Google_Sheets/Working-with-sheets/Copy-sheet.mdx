...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Откуда = "1SDgvwigAytLRE0fDCwfhD8DAZzOpcNvNlOHXrQ-8XiY";
    Куда   = "1N4hERLGwbvv1E3p4MBUzh5zI4Ogumbjp3a3ZAcI-s3g";
    Лист   = "268665747";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint gsheets КопироватьЛист \
              --token "***" \
              --from "1rOyZzZnjj8efoX026N_pwOKUFBUl-j4P54igFGgM8Y8" \
              --to "17amoMNPWcQ1n5Ek6rglhg6cvYCyljC9_X_zxTVmV2ZU" \
              --sheet "596356023"
        ```
    </TabItem>
