...
`Функция СоздатьМодель(Знач URL, Знач Модель, Знач Настройки, Знач ДопЗаголовки = "") Экспорт`
  ...
  | Настройки | --settings | Структура Из КлючИЗначение | &#x2714; | Настройки модели. См. ПолучитьСтруктуруНастроекМодели |
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint ollama СоздатьМодель \
              --url "https://hut.openintegrations.dev/ollama" \
              --model "mario" \
              --settings "/tmp/okm5zfcx.fjo.json" \
              --headers "/tmp/vluzqrgt.aep.json"
        ```
    </TabItem>
