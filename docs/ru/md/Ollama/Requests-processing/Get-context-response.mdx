    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint ollama ПолучитьОтветВКонтексте \
              --url "https://hut.openintegrations.dev/ollama" \
              --model "tinyllama" \
              --msgs "[{'role':'user','content':'What is 1C:Enterprise?'},{'role':'assistant','content':'1C:Enterprise is a proprietary ERP system developed by the Spanish multinational software company, CMS Software. It was originally known as CA Essbase Enterprise and was released in 2003 as part of CA Essbase. The product provides a fully integrated enterprise resource planning (ERP) solution for manufacturers, retailers, and service providers.\n\n1C:Enterprise offers various modules such as supply chain management, finance and accounting, inventory management, sales and marketing, production planning, and quality control. The platform is scalable, flexible, and customizable to meet the needs of different industries and sizes of businesses.'},{'role':'user','content':'When the first version was released?'}]" \
