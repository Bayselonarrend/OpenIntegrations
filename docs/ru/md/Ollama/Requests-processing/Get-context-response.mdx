    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint ollama ПолучитьОтветВКонтексте \
              --url "https://hut.openintegrations.dev/ollama" \
              --model "tinyllama" \
              --msgs "[{'role':'user','content':'What is 1C:Enterprise?'},{'role':'assistant','content':'1C:Enterprise is a comprehensive ERP (enterprise resource planning) solution developed by 1C, an Russian company. The software is designed to help manufacturing, retail, and service organizations streamline their operations and improve decision making. It includes features such as customer relationship management, supply chain management, financial management, inventory management, logistics, and procurement, among others. The platform can be customized based on the organization\u0027s specific needs to enhance efficiency and productivity.'},{'role':'user','content':'When the first version was released?'}]" \
