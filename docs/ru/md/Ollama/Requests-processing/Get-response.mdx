...
{
 "model": "tinyllama",
 "created_at": "2025-12-13T11:01:30.89250206Z",
 "response": "1C:Enterprise is a cloud-based ERP (Enterprise Resource Planning) solution provided by SAP. It offers a suite of business applications for various industries, including manufacturing, wholesale and retail, distribution, service and logistics, and finance and accounting. 1C:Enterprise can be installed on-premise or in the cloud, depending on the needs and preferences of the customer. It is designed to help businesses streamline operations, improve decision-making, and optimize their workforce to provide a better experience for their customers.",
 "done": true,
 "done_reason": "stop",
 "context": [
  "***",
