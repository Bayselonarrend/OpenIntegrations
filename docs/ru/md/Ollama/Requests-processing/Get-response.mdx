...
{
 "model": "tinyllama",
 "created_at": "2026-02-20T12:23:46.096481647Z",
 "response": "1C:Enterprise is a software-as-a-service (SaaS) accounting and business management solution from the Czech company Sage. It offers features such as financial accounting, bookkeeping, invoicing, payroll, expense management, and reporting to help small and medium-sized enterprises (SMEs) manage their finances and operations more efficiently. 1C:Enterprise is available for purchase on a subscription basis, with prices depending on the number of users and services required.",
 "done": true,
 "done_reason": "stop",
 "context": [
  529,
