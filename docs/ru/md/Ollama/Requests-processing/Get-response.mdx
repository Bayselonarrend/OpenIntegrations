...
{
 "model": "tinyllama",
 "created_at": "2026-01-01T16:27:23.906996993Z",
 "response": "1C:Enterprise is a suite of enterprise resource planning (ERP) software that enables businesses to manage their finances, operations, and sales through a single platform. It provides features such as inventory management, order processing, procurement, accounting, payables, receivables, supply chain management, supply chain optimization, customer relationship management (CRM), human resources (HR) management, and more. 1C:Enterprise is an enterprise resource planning software suite developed by Oracle Corporation in partnership with 1C.",
 "done": true,
 "done_reason": "stop",
 "context": [
  null,
