...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Канал              = "C06UFNUTKUL";
    ИдентификаторФайла = "F0B7HVCTZCM";
...
```json title="Результат"
{
 ...
 "file": {
  ...
  "external_id": "22490d46-0145-47be-8901-71096febfef2",
  ...
  "permalink": "https://openintegrationsgroup.slack.com/files/U06UG1CAYH2/F0B9XTYFGH2/novyj_fajl",
  "comments_count": 0,
  "is_starred": false,
  "shares": {
   "public": {
