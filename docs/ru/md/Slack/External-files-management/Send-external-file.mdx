...
```json title="Результат"
{
 ...
 "file": {
  ...
  "username": "",
  "external_id": "3f67f768-fece-42c1-a0db-e08844b51eee",
  ...
  "permalink": "https://openintegrationsgroup.slack.com/files/U06UG1CAYH2/F0AEELHTCET/novyj_fajl",
  "comments_count": 0,
  "is_starred": false,
  "shares": {
   "public": {
