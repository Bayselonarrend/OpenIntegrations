...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Канал              = "C06UFNUTKUL";
    ИдентификаторФайла = "F0ANUGEEFBL";
...
```json title="Результат"
{
 ...
 "file": {
  ...
  "name": "Novyj_fajl",
  "title": "Новый файл",
  "external_id": "a65f362b-b75a-48b8-b5e8-a9cde90b99a2",
  ...
  "permalink": "https://openintegrationsgroup.slack.com/files/U06UG1CAYH2/F0AUSHA854N/novyj_fajl",
  "comments_count": 0,
  "is_starred": false,
  "shares": {
   "public": {
