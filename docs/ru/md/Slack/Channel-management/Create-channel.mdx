    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack СоздатьКанал \
              --token "***" \
              --title "testconv12dd3eb7-d227-425f-a4de-591a38e1e627"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1782581868575,
  "name": "testconv17a1136b-af8c-4f0d-834e-fa02606447c6",
  "name_normalized": "testconv17a1136b-af8c-4f0d-834e-fa02606447c6",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
