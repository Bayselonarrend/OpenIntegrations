    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack СоздатьКанал \
              --token "***" \
              --title "testconvac8c8b54-2d75-4ab7-95de-212924763424"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1781531364315,
  "name": "testconv7013f5c3-0d62-45fc-9ff5-977793fc9b2e",
  "name_normalized": "testconv7013f5c3-0d62-45fc-9ff5-977793fc9b2e",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
