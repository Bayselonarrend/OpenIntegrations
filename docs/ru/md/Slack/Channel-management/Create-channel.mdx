    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack СоздатьКанал \
              --token "***" \
              --title "testconvd740c62f-30e7-40a4-8fad-98be2c8c823c"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1767673097916,
  "name": "testconvbc87ca3c-5a84-4e46-8761-cfc71b435500",
  "name_normalized": "testconvbc87ca3c-5a84-4e46-8761-cfc71b435500",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
