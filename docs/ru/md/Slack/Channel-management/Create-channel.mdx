    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack СоздатьКанал \
              --token "***" \
              --title "testconv1f773f95-c005-446b-a557-59f7c32d1400"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1775627372208,
  "name": "testconv1f773f95-c005-446b-a557-59f7c32d1400",
  "name_normalized": "testconv1f773f95-c005-446b-a557-59f7c32d1400",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
