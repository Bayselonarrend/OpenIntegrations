    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack СоздатьКанал \
              --token "***" \
              --title "testconv974eb205-1305-4c20-bc5b-8b6e13662082"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1774425547848,
  "name": "testconv974eb205-1305-4c20-bc5b-8b6e13662082",
  "name_normalized": "testconv974eb205-1305-4c20-bc5b-8b6e13662082",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
