    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack СоздатьКанал \
              --token "***" \
              --title "testconvc2ec79bc-0727-4745-87cd-f0bb46afd971"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1760030293263,
  "name": "testconv82c3df8c-999a-4f0b-a982-862fa99dba83",
  "name_normalized": "testconv82c3df8c-999a-4f0b-a982-862fa99dba83",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
