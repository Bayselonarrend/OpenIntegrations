    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack СоздатьКанал \
              --token "***" \
              --title "testconvb42613cd-9eac-4905-b7fc-b092641d322f"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1767383512300,
  "name": "testconvb42613cd-9eac-4905-b7fc-b092641d322f",
  "name_normalized": "testconvb42613cd-9eac-4905-b7fc-b092641d322f",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
