    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack СоздатьКанал \
              --token *** \
              --title "testconv5509f1fa-ea4d-40a3-93b0-de38b62e6565"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1757322363887,
  "name": "testconv1299c62a-5f8e-41eb-96c7-d46f2ba79b41",
  "name_normalized": "testconv1299c62a-5f8e-41eb-96c7-d46f2ba79b41",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
