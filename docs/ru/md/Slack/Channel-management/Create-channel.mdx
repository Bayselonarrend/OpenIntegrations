    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack СоздатьКанал \
              --token "***" \
              --title "testconv107be56a-a3ba-4db4-9e81-f0b369c7fa32"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1776028466393,
  "name": "testconv107be56a-a3ba-4db4-9e81-f0b369c7fa32",
  "name_normalized": "testconv107be56a-a3ba-4db4-9e81-f0b369c7fa32",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
