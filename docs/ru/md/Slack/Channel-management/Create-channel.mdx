    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack СоздатьКанал \
              --token *** \
              --title "testconv75876490-97b7-4e9c-986f-eefef7db7d9c"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1757441997197,
  "name": "testconv75876490-97b7-4e9c-986f-eefef7db7d9c",
  "name_normalized": "testconv75876490-97b7-4e9c-986f-eefef7db7d9c",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
