    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack СоздатьКанал \
              --token "***" \
              --title "testconv3a69e474-f5bb-4fab-9d68-1bb8cffd638f"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1772698486547,
  "name": "testconv3a69e474-f5bb-4fab-9d68-1bb8cffd638f",
  "name_normalized": "testconv3a69e474-f5bb-4fab-9d68-1bb8cffd638f",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
