    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack СоздатьКанал \
              --token "***" \
              --title "testconv4878ce9f-14eb-420e-a5f5-8f9154a4307a"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1761905338224,
  "name": "testconvba76ad2a-c236-4b60-b9b5-82b8bb3ecbce",
  "name_normalized": "testconvba76ad2a-c236-4b60-b9b5-82b8bb3ecbce",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
