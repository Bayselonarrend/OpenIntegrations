    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack ПереименоватьКанал \
              --token "***" \
              --channel "C0B6B9YS0HF" \
              --title "testconvd56b3c74-d15e-4c20-a2fa-99156289b628"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1780689527754,
  "name": "testconv12aea6ff-a5f3-4a05-bece-e75661b88e51",
  "name_normalized": "testconv12aea6ff-a5f3-4a05-bece-e75661b88e51",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
  ...
  "previous_names": [
   "testconv99e45e82-fa83-4f57-b1e7-9d05a359e376"
  ]
 }
}
```
