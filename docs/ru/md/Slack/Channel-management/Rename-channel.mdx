    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack ПереименоватьКанал \
              --token "***" \
              --channel "C0B03M77066" \
              --title "testconv5cb4d2cd-4f3c-44f0-8ad6-b106107d2ff5"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1777297955269,
  "name": "testconv5cb4d2cd-4f3c-44f0-8ad6-b106107d2ff5",
  "name_normalized": "testconv5cb4d2cd-4f3c-44f0-8ad6-b106107d2ff5",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
  ...
  "previous_names": [
   "testconva5230f45-8fcc-4f09-857a-074b43a039d6"
  ]
 }
}
```
