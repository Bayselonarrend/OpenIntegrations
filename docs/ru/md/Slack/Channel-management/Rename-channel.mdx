    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack ПереименоватьКанал \
              --token "***" \
              --channel "C0B8NDB13FF" \
              --title "testconv3683d64d-6158-4104-ae5d-4a0372bba626"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1780751929219,
  "name": "testconv3683d64d-6158-4104-ae5d-4a0372bba626",
  "name_normalized": "testconv3683d64d-6158-4104-ae5d-4a0372bba626",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
  ...
  "previous_names": [
   "testconvbb6afed2-4497-48c8-89cd-ece50e0c6fff"
  ]
 }
}
```
