    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack ПереименоватьКанал \
              --token "***" \
              --channel "C0B12PDJ34N" \
              --title "testconv4fb10204-d916-42c2-87a0-c3632482a656"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1777660726891,
  "name": "testconvc7ccf288-03eb-4559-af45-3886cf9a26b8",
  "name_normalized": "testconvc7ccf288-03eb-4559-af45-3886cf9a26b8",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
  ...
  "previous_names": [
   "testconv5fc02434-e54a-48b3-839b-83888aa5505a"
  ]
 }
}
```
