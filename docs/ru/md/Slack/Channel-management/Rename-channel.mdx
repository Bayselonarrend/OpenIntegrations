    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint slack ПереименоватьКанал \
              --token "***" \
              --channel "C0B8SDPBMV0" \
              --title "testconvead85689-f797-465d-a3e7-4d9b87640691"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "channel": {
  ...
  "updated": 1780766545819,
  "name": "testconvead85689-f797-465d-a3e7-4d9b87640691",
  "name_normalized": "testconvead85689-f797-465d-a3e7-4d9b87640691",
  "is_channel": true,
  "is_group": false,
  "is_mpim": false,
  "is_private": false,
  ...
  "previous_names": [
   "testconv969dfd3c-5c9c-4646-a314-817df129f3c9"
  ]
 }
}
```
