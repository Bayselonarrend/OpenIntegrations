    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint sftp УдалитьФайл \
              --conn "{'proxy':{'login':'proxyuser','password':'***','port':'1080','proxy_type':'socks5','server':'127.0.0.1'},'set':{'auth_type':'password','host':'172.33.0.13','key_path':null,'passphrase':null,'password':'***','port':'2222','pub_path':null,'username':'bayselonarrend'}}" \
