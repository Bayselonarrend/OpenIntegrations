    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint sftp СохранитьФайл \
              --conn "{'proxy':{'login':'proxyuser','password':'***','port':'8071','proxy_type':'http','server':'127.0.0.1'},'set':{'auth_type':'private_key','host':'172.33.0.13','key_path':'***','passphrase':null,'password':null,'port':'2222','pub_path':'C:\\Users\\bayse\\AppData\\Local\\Temp\\qex4aoco.lxm.tmp','username':'bayselonarrend'}}" \
              --path "pic_from_disk.png" \
              --file "C:\Users\bayse\AppData\Local\Temp\lyejwc1b.25r.bin"
        ```
    </TabItem>
...
{
 "bytes": 2114023,
 "filepath": "C:\\Users\\bayse\\AppData\\Local\\Temp\\knpk5sd3.dxq.bin",
 "result": true,
 "close_connection": {
  "result": true
 }
