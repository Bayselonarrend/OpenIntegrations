...
description: Сформировать ссылку получения кода и другие функции для работы с GoogleCalendar в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
"https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=345925493105-641q49rl4oflrtr4..."
```
