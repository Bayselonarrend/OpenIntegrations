    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint gcalendar СоздатьСобытие \
              ...
              --props "{'Описание':'Описание тестового события','Заголовок':'Новое событие','МестоПроведения':'В офисе','ДатаНачала':'1/2/2026 10:46:28 PM','ДатаОкончания':'1/2/2026 11:46:28 PM','МассивURLФайловВложений':{'Картинка1':'https://hut.openintegrations.dev/test_data/picture.jpg','Картинка2':'https://hut.openintegrations.dev/test_data/picture2.jpg'},'ОтправлятьУведомления':true}"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "updated": "2026-01-02T19:46:30.296Z",
