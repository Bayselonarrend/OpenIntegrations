    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint gcalendar СоздатьСобытие \
              ...
              --props "{'Описание':'Описание тестового события','Заголовок':'Новое событие','МестоПроведения':'В офисе','ДатаНачала':'4/13/2026 12:11:00 AM','ДатаОкончания':'4/13/2026 1:11:00 AM','МассивURLФайловВложений':{'Картинка1':'https://hut.openintegrations.dev/test_data/picture.jpg','Картинка2':'https://hut.openintegrations.dev/test_data/picture2.jpg'},'ОтправлятьУведомления':true}"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "updated": "2026-04-12T21:10:59.811Z",
