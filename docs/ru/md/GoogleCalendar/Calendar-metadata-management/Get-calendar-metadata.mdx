    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint gcalendar ПолучитьМетаданныеКалендаря \
              --token "***" \
              --calendar "db82177e14cb7969fe0f17dd775218103b86406decca852718b4413f90e14422@group.calendar.google.com"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "etag": "\"6oZdORQ1wYbZjOIxDBTCFDbUq2w\"",
 "id": "10def6fb6c3022cb4e5b198bc18bd91f40ac165a36386e18381a539d97b12cb7@group.calendar.google.com",
