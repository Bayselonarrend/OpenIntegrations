    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint gcalendar ПолучитьМетаданныеКалендаря \
              --token "***" \
              --calendar "01572ff860cce41f0de1dd8b0a4e83c7cec98ce50bf84bb5038a55b045deb94a@group.calendar.google.com"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "etag": "\"AVIRNlKFIVOGPzwAh0Tk_B5s_mA\"",
 "id": "01572ff860cce41f0de1dd8b0a4e83c7cec98ce50bf84bb5038a55b045deb94a@group.calendar.google.com",
