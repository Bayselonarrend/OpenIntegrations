    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint gcalendar ПолучитьМетаданныеКалендаря \
              --token "***" \
              --calendar "c0307bb948a383f66b085dc4ace4b4acb13eba7110f14fbb100121a9a44f9b14@group.calendar.google.com"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "etag": "\"y_Ww6YPcLqLSAWX4_VrsitXD5LE\"",
 "id": "c0307bb948a383f66b085dc4ace4b4acb13eba7110f14fbb100121a9a44f9b14@group.calendar.google.com",
