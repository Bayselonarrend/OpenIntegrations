---
sidebar_position: 7
description: Скоприровать объект и другие функции для работы с GoogleDrive в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint gdrive СкопироватьОбъект \
              --token "***" \
              --object "1eCEMQL6FKBlmoiPhOToSBDLpNHXBVs57" \
...
{
 "kind": "drive#file",
 "id": "1oKcX4A5CWkwTRF9sPClfGHK6VDu8X7Mi",
