...
description: Получить список каталогов и другие функции для работы с GoogleDrive в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
 ...
 "files": [
  {
   ...
   "thumbnailLink": "https://lh3.googleusercontent.com/drive-storage/AJQWtBNF2wKK-rSH09p3rMUK7YFw7KRv07WJAkG0gmJBoGEzDh7PMc7_QQXeZLVbMTuYhRts0AAaFJVbsaNMQvhKXNNwXikr7_AjlYQ61sMKfIPrxVVrmg=s220",
