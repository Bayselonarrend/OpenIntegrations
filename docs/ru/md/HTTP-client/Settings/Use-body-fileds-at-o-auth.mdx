...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "OAuth oauth_consumer_key=\"***\",oauth_token=\"***\",oauth_signature_method=\"HMAC-SHA256\",oauth_timestamp=\"1757997978\",oauth_nonce=\"1757997978\",oauth_version=\"1.0\",oauth_signature=u3nYE%2FtNi0FZwt4lBODWy7BBWDqrwSifcWEM1cGoNC0%3D",
  "Content-Length": "2114378",
  "Content-Type": "multipart/form-data; boundary=a32795ee601a4c02af0a55de9e52f95f",
  "Host": "httpbin.org",
  "User-Agent": "1Script v$2.0.0.0",
  "X-Amzn-Trace-Id": "Root=1-68c8f9aa-5aae28fb2750642342d2905f"
 },
 "json": null,
 "origin": "***",
