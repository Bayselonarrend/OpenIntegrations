...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "OAuth oauth_consumer_key=\"***\",oauth_token=\"***\",oauth_signature_method=\"HMAC-SHA256\",oauth_timestamp=\"1758064661\",oauth_nonce=\"1758064661\",oauth_version=\"1.0\",oauth_signature=%2FZxytT26ox8nSKyb56R6uq2H44zmsOnE3PTsfeNlBTc%3D",
  "Content-Length": "2114378",
  "Content-Type": "multipart/form-data; boundary=52f32fa6a92346f9a88fe47059c6ecc5",
  "Host": "httpbin.org",
  "User-Agent": "1Script v$2.0.0.0",
  "X-Amzn-Trace-Id": "Root=1-68c9d3f5-0e9aec8d2909018959df4bbc"
 },
 "json": null,
 "origin": "***",
