...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "OAuth oauth_consumer_key=\"***\",oauth_token=\"***\",oauth_signature_method=\"HMAC-SHA256\",oauth_timestamp=\"1758584211\",oauth_nonce=\"1758584211\",oauth_version=\"1.0\",oauth_signature=IgLKylsDHxUsJXKbIPDKt3YxRTtWSVvxiY8ufhfrmO4%3D",
  "Content-Length": "2114378",
  "Content-Type": "multipart/form-data; boundary=b87835367cc74d2980c5ee250a91c51e",
  "Host": "httpbin.org",
  "User-Agent": "1Script v$2.0.0.0",
  "X-Amzn-Trace-Id": "Root=1-68d1c173-7b2caf575ede66b71c93f70b"
 },
 "json": null,
 "origin": "***",
