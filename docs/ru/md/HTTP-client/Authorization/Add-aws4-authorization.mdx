...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "AWS4-HMAC-SHA256 Credential=AccessKey/20251211/Region/s3/aws4_request, SignedHeaders=host;x-amz-content-sha256;x-amz-date, Signature=2bf3d86df54287c9f82cc17868796d70f5202b70e5f82e104bde443f31c253e8",
  ...
  "X-Amz-Date": "20251211T083144Z",
  "X-Arr-Log-Id": "089e8174-d9ab-4734-a624-cf3904a1a100",
