    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ИзменитьПоле \
              ...
              --field "fldMMBcKxZxS1oHkY" \
              --title "d6b9f5a5-b3fa-423b-b9ea-cb07de315d7b(изм.)" \
...
```json title="Результат"
{
 ...
 "id": "fldMMBcKxZxS1oHkY",
 "name": "d6b9f5a5-b3fa-423b-b9ea-cb07de315d7b(изм.)",
 "description": "Новое описание"
}
```
