    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ИзменитьПоле \
              ...
              --table "tblKyKgFmOw5XvZW3" \
              --field "fld0Wg3B3C3JIMWki" \
              --title "12de9685-894b-4b32-898d-c60a5905c610(изм.)" \
...
```json title="Результат"
{
 ...
 "id": "fld0Wg3B3C3JIMWki",
 "name": "12de9685-894b-4b32-898d-c60a5905c610(изм.)",
 "description": "Новое описание"
}
```
