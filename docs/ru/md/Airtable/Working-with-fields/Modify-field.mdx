    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ИзменитьПоле \
              ...
              --table "tbl54yTeVkeVelBZu" \
              --field "fldQd3Eqj86o6UwsI" \
              --title "77694c9d-37da-430f-9e0a-6418dc492aa1(изм.)" \
...
```json title="Результат"
{
 ...
 "id": "fldQd3Eqj86o6UwsI",
 "name": "77694c9d-37da-430f-9e0a-6418dc492aa1(изм.)",
 "description": "Новое описание"
}
```
