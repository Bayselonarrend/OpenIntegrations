    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ИзменитьПоле \
              ...
              --field "fldW9MVbxPMFR759K" \
              --title "a5e35fcd-5838-48ec-a647-8a3382abef17(изм.)" \
...
```json title="Результат"
{
 ...
 "id": "fldQyxkjy6hU40DsQ",
 "name": "e4e8a565-3522-4145-94bd-7ee3b7fb7e0b(изм.)",
 "description": "Новое описание"
}
```
