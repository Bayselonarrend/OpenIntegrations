    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ИзменитьПоле \
              ...
              --table "tblXrLoA41EW916FN" \
              --field "fld4xgXTfAlrdx4rK" \
              --title "b70fe584-5e7e-4736-9e49-a09ff394bf11(изм.)" \
...
```json title="Результат"
{
 ...
 "id": "fld4xgXTfAlrdx4rK",
 "name": "b70fe584-5e7e-4736-9e49-a09ff394bf11(изм.)",
 "description": "Новое описание"
}
```
