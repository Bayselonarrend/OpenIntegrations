    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ИзменитьПоле \
              ...
              --field "fldOKHvh9xkvzYIUQ" \
              --title "2e05ffd9-ffa6-4c11-ae66-579666013577(изм.)" \
...
```json title="Результат"
{
 ...
 "id": "fldOgnTMjb1V5Pf74",
 "name": "1e79955a-a5ff-4837-81bb-17e7d74cb262(изм.)",
 "description": "Новое описание"
}
```
