    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ИзменитьПоле \
              ...
              --table "tblnb2nWXvAayDHVi" \
              --field "fldPh4I1VOwAy51Fm" \
              --title "efe1ae02-9a6d-4ec5-8501-dddac9c4de7e(изм.)" \
...
```json title="Результат"
{
 ...
 "id": "fldPh4I1VOwAy51Fm",
 "name": "efe1ae02-9a6d-4ec5-8501-dddac9c4de7e(изм.)",
 "description": "Новое описание"
}
```
