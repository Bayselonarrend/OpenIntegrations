    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ИзменитьПоле \
              ...
              --table "tblP45VrgG3NttsHN" \
              --field "flds8eIgormujNTd0" \
              --title "79ee477a-5b13-49a3-a94a-bf55b7787073(изм.)" \
...
```json title="Результат"
{
 ...
 "id": "flds8eIgormujNTd0",
 "name": "79ee477a-5b13-49a3-a94a-bf55b7787073(изм.)",
 "description": "Новое описание"
}
```
