---
sidebar_position: 2
description:  Изменяет имя и|или описание существующего поля таблицыСтраницы
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ИзменитьПоле \
              ...
              --field "fldtf8L7evTph9yXc" \
              --title "e5ea463d-8f7b-44c4-bf8e-3b4041f65024(изм.)" \
