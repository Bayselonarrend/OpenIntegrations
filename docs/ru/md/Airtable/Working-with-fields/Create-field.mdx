---
sidebar_position: 1
description:  Создет новое поле в таблицеСтраницы
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              ...
              --title "e6c1fb4b-5218-4bab-8442-1a2df6027e90" \
              --fielddata "{'name':'e6c1fb4b-5218-4bab-8442-1a2df6027e90','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
