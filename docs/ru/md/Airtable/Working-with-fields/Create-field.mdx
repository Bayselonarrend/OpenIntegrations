    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appHNem5akN2V7dNA" \
              --table "tblQlkS5oolNUJXEJ" \
              --title "0320812c-d235-4363-a211-359d6c2e21e1" \
              --fielddata "{'name':'0320812c-d235-4363-a211-359d6c2e21e1','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
