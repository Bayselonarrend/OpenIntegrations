    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appNmg0DZknGojmHi" \
              --table "tblngy57MDnB7UcPN" \
              --title "52b933ea-6362-4e8c-aadb-3e6a2e7795f4" \
              --fielddata "{'name':'52b933ea-6362-4e8c-aadb-3e6a2e7795f4','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
