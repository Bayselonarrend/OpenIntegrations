    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appACIexh0TsM7R4c" \
              --table "tblCG1uv3ACUS14NW" \
              --title "f212f922-ec97-4483-aeb5-a25ae90fdbef" \
              --fielddata "{'name':'f212f922-ec97-4483-aeb5-a25ae90fdbef','type':'number','options':{'precision':'0'}}"
        ```
    </TabItem>
