...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    База    = "app6iAjLW6FyzuWRZ";
    Таблица = "tblQLSgX8ksTpqiSA";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              ...
              --table "tblZ4QluCsByp12iO" \
              --title "08d27407-05f2-4b5f-a525-848f85760b6c" \
              --fielddata "{'name':'08d27407-05f2-4b5f-a525-848f85760b6c','type':'number','options':{'precision':'0'}}"
        ```
    </TabItem>
