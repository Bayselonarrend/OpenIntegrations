    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "apphSwVVP5PKW19dH" \
              --table "tblH6L0muW77uRmXv" \
              --title "7703c27e-c22e-4fa3-8175-af3974be8ef4" \
              --fielddata "{'name':'7703c27e-c22e-4fa3-8175-af3974be8ef4','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
