    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appMOEDN9RdYnc4cq" \
              --table "tblywE6wdDoRACHeG" \
              --title "68ac8007-17d9-4808-9de0-e90e365d1b90" \
              --fielddata "{'name':'68ac8007-17d9-4808-9de0-e90e365d1b90','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
