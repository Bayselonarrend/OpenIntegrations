...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    База    = "app6r78jVYU7ND0LI";
    Таблица = "tbl0J6d4dkx6SaA0M";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              ...
              --title "ebdd3fc6-63c7-49fe-acca-ddee6dfdecc0" \
              --fielddata "{'name':'ebdd3fc6-63c7-49fe-acca-ddee6dfdecc0','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
