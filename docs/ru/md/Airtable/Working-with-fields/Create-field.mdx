...
# JSON данные также могут быть переданы как путь к файлу .json
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "apptgSG1ssx8PAZAY" \
              --table "tblaCsHZMaRLqnoor" \
              --title "95538443-7fb4-4c9b-9fab-ba17996c9943" \
              --fielddata "{'name':'95538443-7fb4-4c9b-9fab-ba17996c9943','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
