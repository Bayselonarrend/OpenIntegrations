    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appHJpFYBm4dAiMoQ" \
              --table "tbllJJm1bjZK6C69b" \
              --title "1b1b20c5-7122-4e83-a88b-c3f184e04e0f" \
              --fielddata "{'name':'1b1b20c5-7122-4e83-a88b-c3f184e04e0f','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
