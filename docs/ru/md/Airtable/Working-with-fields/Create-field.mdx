...
# JSON данные также могут быть переданы как путь к файлу .json
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appUmokk26bFEVYX5" \
              --table "tblm98GJV6WBqs6DD" \
              --title "742a3314-b635-448e-8c8c-66f4a485bdbd" \
              --fielddata "{'name':'742a3314-b635-448e-8c8c-66f4a485bdbd','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
