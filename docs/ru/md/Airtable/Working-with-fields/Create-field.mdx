    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token '***' \
              --base 'app7RaxRbN0cAVsr1' \
              --table 'tbltCYdymlGk6tOX2' \
              --title '14104a77-b4ed-4066-bce2-b3546e48228f' \
              --fielddata '{"name":"14104a77-b4ed-4066-bce2-b3546e48228f","type":"number","options":{"precision":0}}'
        ```
    </TabItem>
