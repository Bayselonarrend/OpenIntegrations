    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appVB9zrMEVaL5eaT" \
              --table "tbl1pzIGC7Hq1jCbS" \
              --title "727f449d-eff0-4d9a-b424-ffb9b63cfec9" \
              --fielddata "{'name':'727f449d-eff0-4d9a-b424-ffb9b63cfec9','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
