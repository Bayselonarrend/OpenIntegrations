    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appaA29m32pT8kBF0" \
              --table "tblYuHEAqX1Jmohyt" \
              --title "69c09874-e249-42cb-971f-4f79970b6927" \
              --fielddata "{'name':'69c09874-e249-42cb-971f-4f79970b6927','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
