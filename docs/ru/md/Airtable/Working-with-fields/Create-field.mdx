...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    База    = "appHoWksfa7zimnal";
    Таблица = "tblQJewPd43rzDI9q";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appLbrNEUef2tcg06" \
              --table "tblfMvmNqFWNGohNJ" \
              --title "305f076f-bba1-4969-9701-27e8f621ee2f" \
              --fielddata "{'name':'305f076f-bba1-4969-9701-27e8f621ee2f','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
