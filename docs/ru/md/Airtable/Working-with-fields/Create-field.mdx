...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    База    = "appS0xAXVPSCbldXo";
    Таблица = "tblbQ4RX4OqSmJ70n";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appaEDCZV2voaHkte" \
              --table "tblJLhXAyZXzgzvbv" \
              --title "9f66c8d3-9b8a-4daf-a1d1-9f1479a5b190" \
              --fielddata "{'name':'9f66c8d3-9b8a-4daf-a1d1-9f1479a5b190','type':'number','options':{'precision':'0'}}"
        ```
    </TabItem>
