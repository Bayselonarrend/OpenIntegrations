    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appWna5KCXQtGyN2V" \
              --table "tbluWgoc494VgAAyC" \
              --title "14366bd4-2232-4f99-b368-550176132888" \
              --fielddata "{'name':'14366bd4-2232-4f99-b368-550176132888','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
