    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appOitMmS9nwNCIl3" \
              --table "tbluoviRB9yQ8UIn7" \
              --title "444e6102-02b8-468a-b10e-21697aa7cc2b" \
              --fielddata "C:\Users\Administrator\AppData\Local\Temp\ixzkqgovrhz.tmp"
        ```
    </TabItem>
