    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "apphyCLEV7eiTu21Q" \
              --table "tblwoO575xB70z6YW" \
              --title "b53bf4ec-dee3-4f2f-9cce-4a3f72b9aeac" \
              --fielddata "{'name':'b53bf4ec-dee3-4f2f-9cce-4a3f72b9aeac','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
