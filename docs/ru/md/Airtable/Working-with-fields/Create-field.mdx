    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appHq7X2pVO6QyFgJ" \
              --table "tblFtaGErMranLxfg" \
              --title "54d7237b-b3a8-4901-addf-5a0c9b7fc8b9" \
              --fielddata "{'name':'54d7237b-b3a8-4901-addf-5a0c9b7fc8b9','type':'number','options':{'precision':'0'}}"
        ```
    </TabItem>
