    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appTvHZxlLOmyvUes" \
              --table "tblZJjiHx5vKSWLfe" \
              --title "9203d29b-7839-4d16-9173-c3c8df514cd0" \
              --fielddata "{'name':'9203d29b-7839-4d16-9173-c3c8df514cd0','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
