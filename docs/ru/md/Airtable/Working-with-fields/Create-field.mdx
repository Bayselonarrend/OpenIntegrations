    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "app2eTY7bxliAOhBE" \
              --table "tblKx3qLGRUFBHzAv" \
              --title "e4947b3d-b12a-45a5-9113-6789560c6e42" \
              --fielddata "{'name':'e4947b3d-b12a-45a5-9113-6789560c6e42','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
