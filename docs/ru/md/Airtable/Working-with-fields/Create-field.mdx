    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appLBCrXmrNTZ30yd" \
              --table "tbldUxXUCfgNLf5mo" \
              --title "e3f535a4-0b9f-4881-b05c-ffaeb9f8bf2f" \
              --fielddata "{'name':'e3f535a4-0b9f-4881-b05c-ffaeb9f8bf2f','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
