    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "app0isErAGxfYv3sy" \
              --table "tblNxvy0sESwGeoYB" \
              --title "41dbdd08-ca1b-4421-a025-c98ac1b41130" \
              --fielddata "{'name':'41dbdd08-ca1b-4421-a025-c98ac1b41130','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
