    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appQumYI7bs6puuXB" \
              --table "tblqH4T4i4KwYQ6Ue" \
              --title "5e250386-b1ee-4fd9-907b-9f5d20459e03" \
              --fielddata "{'name':'5e250386-b1ee-4fd9-907b-9f5d20459e03','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
