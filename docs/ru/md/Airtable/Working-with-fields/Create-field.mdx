    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appkO9aNPlE1lelT5" \
              --table "tbl6tRzSLVJFKHLka" \
              --title "1d4bfa2b-53b4-4ef9-b216-4ef88fd4e8f6" \
              --fielddata "{'name':'1d4bfa2b-53b4-4ef9-b216-4ef88fd4e8f6','type':'number','options':{'precision':'0'}}"
        ```
    </TabItem>
