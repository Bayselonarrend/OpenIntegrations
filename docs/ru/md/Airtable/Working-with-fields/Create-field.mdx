    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appwzngt0VXulo8rl" \
              --table "tblqXA4vR3TuTrfeA" \
              --title "33840542-99ba-4779-80e9-119819bec87f" \
              --fielddata "{'name':'33840542-99ba-4779-80e9-119819bec87f','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
