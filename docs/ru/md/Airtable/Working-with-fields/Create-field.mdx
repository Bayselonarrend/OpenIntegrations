    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "applCttR01s4vK97a" \
              --table "tblaTqPVAE19zkmKU" \
              --title "4c6422aa-1b2e-408c-a0f1-61ca11515eb2" \
              --fielddata "{'name':'4c6422aa-1b2e-408c-a0f1-61ca11515eb2','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
