...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    База    = "app0CjRlX0c4N2NME";
    Таблица = "tblKDtiE1I6YBYev5";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              ...
              --title "56063eba-a890-4415-a63e-cb0686d8e391" \
              --fielddata "{'name':'56063eba-a890-4415-a63e-cb0686d8e391','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
