    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appSKzqVMrKzAQTqE" \
              --table "tblD4zx3aZ8YyFVER" \
              --title "01035ccb-3287-4b37-a862-29f5e61d4e3a" \
              --fielddata "{'name':'01035ccb-3287-4b37-a862-29f5e61d4e3a','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
