    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "applr057XKLR923Rh" \
              --table "tblWhzxmIN33eQi06" \
              --title "a661013e-c04c-4e79-8f39-2e7dbfd96120" \
              --fielddata "{'name':'a661013e-c04c-4e79-8f39-2e7dbfd96120','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
