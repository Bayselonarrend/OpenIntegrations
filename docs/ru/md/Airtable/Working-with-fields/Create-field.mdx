    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appwSO09FqrFcD3sF" \
              --table "tblRnrGlksIPEWFqT" \
              --title "a96e1073-47d5-4f5f-8700-f0e14a84fb15" \
              --fielddata "{'name':'a96e1073-47d5-4f5f-8700-f0e14a84fb15','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
