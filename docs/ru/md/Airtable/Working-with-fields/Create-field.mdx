    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "apphYqDpapiqVLNYi" \
              --table "tblw6nQGV7mhRQdaH" \
              --title "e8b75bf6-4854-4940-b59f-157270de9872" \
              --fielddata "{'name':'e8b75bf6-4854-4940-b59f-157270de9872','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
