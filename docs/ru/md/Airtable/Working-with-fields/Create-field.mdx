    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "app3ablPcuemdQRhJ" \
              --table "tblI0Q42reoXYJpxa" \
              --title "68c11786-d25a-4d90-80a5-367154d8ab58" \
              --fielddata "{'name':'68c11786-d25a-4d90-80a5-367154d8ab58','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
