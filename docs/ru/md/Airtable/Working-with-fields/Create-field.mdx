    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appaIY56LZW8RECAw" \
              --table "tblK4H7qVYFk3Ttgp" \
              --title "03c12598-5a29-4f45-b144-eac64fc983d4" \
              --fielddata "{'name':'03c12598-5a29-4f45-b144-eac64fc983d4','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
