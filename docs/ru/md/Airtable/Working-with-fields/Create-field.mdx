    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appm8XIhCpOFMzs7O" \
              --table "tblq0uIP7ndfc8PJb" \
              --title "651aff30-7268-409d-9127-85bf027cbb4c" \
              --fielddata "{'name':'651aff30-7268-409d-9127-85bf027cbb4c','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
