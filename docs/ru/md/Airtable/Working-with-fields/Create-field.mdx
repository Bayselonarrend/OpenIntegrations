...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    База    = "appfVrwbWcoHKh5Rv";
    Таблица = "tblgdVSByIqgajAyf";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appGDs2FHW0plnouv" \
              --table "tblteS81t3qqqxlPx" \
              --title "2dd46b66-9f89-4173-a463-5f5aaa113be9" \
              --fielddata "{'name':'2dd46b66-9f89-4173-a463-5f5aaa113be9','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
