    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appDHoZTzFQPItFeZ" \
              --table "tblESE0mcFOrGMxj1" \
              --title "e439686c-0370-4f34-b40d-bd4e26501d78" \
              --fielddata "{'name':'e439686c-0370-4f34-b40d-bd4e26501d78','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
