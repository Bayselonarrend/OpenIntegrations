    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appljdlpDFRKsrKBx" \
              --table "tbliHTbvRdiIDU0Gv" \
              --title "b04cc040-0a42-4cd7-9d2e-9613b716aab1" \
              --fielddata "{'name':'b04cc040-0a42-4cd7-9d2e-9613b716aab1','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
