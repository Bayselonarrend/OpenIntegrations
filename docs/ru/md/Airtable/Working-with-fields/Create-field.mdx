    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appTf5DUs1vpMFvQO" \
              --table "tbl148giuJIR07cgG" \
              --title "6ebeb83c-4a16-4e84-8c92-dd83369804d3" \
              --fielddata "{'name':'6ebeb83c-4a16-4e84-8c92-dd83369804d3','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
