    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "app7h0TC0LUxFBHh9" \
              --table "tblLVJpque7Ic8kSx" \
              --title "989b2681-ea9b-4d4b-8ce6-b9932be83480" \
              --fielddata "{'name':'989b2681-ea9b-4d4b-8ce6-b9932be83480','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
