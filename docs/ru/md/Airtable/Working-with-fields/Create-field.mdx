    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appI3dsSPZKtPzw5w" \
              --table "tblfwroznmDtDz10R" \
              --title "b1255b8e-11a7-4396-a868-9f67f2652743" \
              --fielddata "{'name':'b1255b8e-11a7-4396-a868-9f67f2652743','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
