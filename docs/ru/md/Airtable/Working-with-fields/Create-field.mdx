    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appG14f6BTzi1jMgY" \
              --table "tblsX0cKoIBrhASHu" \
              --title "7cb3d4b6-7c40-4f78-bc27-5b8b6e91ca6b" \
              --fielddata "{'name':'7cb3d4b6-7c40-4f78-bc27-5b8b6e91ca6b','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
