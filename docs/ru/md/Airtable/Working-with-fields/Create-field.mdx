    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "app93cg9OCQ6Wy2pG" \
              --table "tblRRkMVOaj3o1UwA" \
              --title "6cedad66-ed0c-48b0-8de0-5795118baa5f" \
              --fielddata "{'name':'6cedad66-ed0c-48b0-8de0-5795118baa5f','type':'number','options':{'precision':'0'}}"
        ```
    </TabItem>
