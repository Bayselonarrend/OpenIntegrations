    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appbsbVJoLjaD36Go" \
              --table "tblzVkAUWrJnbxWCd" \
              --title "6e5fcbdd-cc4f-4b47-8d1c-0d83d82c7a47" \
              --fielddata "{'name':'6e5fcbdd-cc4f-4b47-8d1c-0d83d82c7a47','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
