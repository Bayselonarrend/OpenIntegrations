    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "apprsmjpbHpu3Bdg7" \
              --table "tblmoDVuNIgVcSSS5" \
              --title "04c98109-7988-4eec-8787-f99a13b17780" \
              --fielddata "{'name':'04c98109-7988-4eec-8787-f99a13b17780','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
