    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint airtable СоздатьПоле \
              --token "***" \
              --base "appz7OIMiivcLY6Ep" \
              --table "tbl5ca7qjoPaeTs2I" \
              --title "9e1b58b7-ebe3-4e8a-bb1b-480412623f4d" \
              --fielddata "{'name':'9e1b58b7-ebe3-4e8a-bb1b-480412623f4d','type':'number','options':{'precision':0}}"
        ```
    </TabItem>
