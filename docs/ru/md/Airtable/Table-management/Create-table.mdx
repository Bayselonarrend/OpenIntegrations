...
{
 "id": "tblMHDN4VeUY0Az5s",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldeBusToxDf6NOBD",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldeBusToxDf6NOBD",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldJUGtrOdhd3ecSD",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fld9e5hCwdZpYCv8i",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldrCLHsHZPijbvTV",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldNgslnzFKwgqudJ",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fld21itbY1UlN3kkm",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwKifFNVit7iNc9K",
   "name": "Grid view",
   "type": "grid"
  }
 ]
