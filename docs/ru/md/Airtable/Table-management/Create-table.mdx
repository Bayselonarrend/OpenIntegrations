...
{
 "id": "tblQxh0ty0e1wrNuY",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldnHm6RtXBhvolLL",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldnHm6RtXBhvolLL",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldyrU4PhbX20nY0W",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldsGMn8N6Wb75gvU",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldjQljGF5Z8JOgtN",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldWER3yr1HgCJfhu",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldehmyRoCnOhWdsz",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwhjQoWmCbegRa9a",
   "name": "Grid view",
   "type": "grid"
  }
 ]
