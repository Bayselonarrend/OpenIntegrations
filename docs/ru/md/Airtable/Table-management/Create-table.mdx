...
{
 "id": "tblkoQiudLoQP6rSd",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldsb6lZVPUMG77wn",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldsb6lZVPUMG77wn",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fld2ywZFqrmSspHRU",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fld2wOsbstRoLxbBM",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldn4jo8vNyPEEQQJ",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldrUjadF0MookxKc",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fld100OQyNIKt3Zap",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwxBbafKKzaiaVll",
   "name": "Grid view",
   "type": "grid"
  }
 ]
