...
{
 "id": "tblSAjWa16Eim0rPW",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldqWL1qmOvkC61T5",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldqWL1qmOvkC61T5",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldrDREcX9spp1213",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldbCaKbeYZnxESYh",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldrPmC9WqnorpKHo",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldhzokmOQy0uAXj2",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldFaf8pliialbfKu",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viw8D9y1TtXn2PqKn",
   "name": "Grid view",
   "type": "grid"
  }
 ]
