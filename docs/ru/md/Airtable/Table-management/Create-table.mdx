...
{
 "id": "tblkUYffJjs9w6hJR",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fld6iYfhLc68IYMAO",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fld6iYfhLc68IYMAO",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fld4CNNVmruy1P1DS",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldooUHed8LHqvHej",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldB51CBYWNOlLBdN",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldb7aZJvdibOq89j",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "flddeyNugCn740q1m",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwmSh8B67JYcGCsG",
   "name": "Grid view",
   "type": "grid"
  }
 ]
