...
{
 "id": "tblIzkAfwKw7H6HZY",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldU8Rzk1pKyh7jmP",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldU8Rzk1pKyh7jmP",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldgxO24pRi2e2fVw",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fld28hH1FZOKjbQsb",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldzvuvWtb0kBjuIl",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fld6K4W6OvXejWpIa",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldFLc5h4XMUqzKHI",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwr2Ce7rEWgE0RTq",
   "name": "Grid view",
   "type": "grid"
  }
 ]
