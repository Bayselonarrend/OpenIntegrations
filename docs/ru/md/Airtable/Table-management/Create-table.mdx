...
{
 "id": "tblebxjZKOynLwt0P",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "flddcdG54xFjbqmYx",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "flddcdG54xFjbqmYx",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldXUnz8NU1ZpzSKp",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldhNcs7NWmvkN0zQ",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldldouDrkXVv9HTW",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldl2bCVi9RfHerM4",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldjb4SRIFcv0763Q",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwFniE0bUNs9ks98",
   "name": "Grid view",
   "type": "grid"
  }
 ]
