...
{
 "id": "tblM2WApS12IyXUcD",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldPTeyvgaDw4OyFI",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldPTeyvgaDw4OyFI",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldcbCfgDp1SV95Co",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldZIUt4IyvXybX0u",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldCEPyjBTpc28Sst",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldSbzyN7GOW03lf1",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldaiBRgdAkcRMrMb",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viw8FgH4iMRVJfNww",
   "name": "Grid view",
   "type": "grid"
  }
 ]
