...
{
 "id": "tblzWhGPSsqGLxBEK",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldtW4O2o8Pp2GU08",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldtW4O2o8Pp2GU08",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldQbjCGD7iKGPQWJ",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldhmMOZaOaCbHRrL",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldFG4B4ZCSwMR2h5",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fld3icUUnmumN9IIV",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "flduifG7nlo5ZbOlD",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwun6iTDA7fJwMHE",
   "name": "Grid view",
   "type": "grid"
  }
 ]
