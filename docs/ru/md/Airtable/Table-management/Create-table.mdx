...
{
 "id": "tblKyKgFmOw5XvZW3",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldPe5NzMEv4vuiTZ",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldPe5NzMEv4vuiTZ",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldTLv4B8wg0ELVRl",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fld9kCtuavr1s03cP",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldwd7xOnOsioJgm2",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldhcMbYX8X1u4g8J",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldvCg7KgVbosa498",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwZKCASHa7jKeIZM",
   "name": "Grid view",
   "type": "grid"
  }
 ]
