...
{
 "id": "tblnb2nWXvAayDHVi",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldDpPT2FUMaAkHnc",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldDpPT2FUMaAkHnc",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldd4WJEK90yfBcx8",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldA84UacwnifeQM7",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldv3SeAeiIIOkv0j",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldyVNtrFcZRAs6fE",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldByUuVIo1zeCGNI",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwPXRl61W48wYGRf",
   "name": "Grid view",
   "type": "grid"
  }
 ]
