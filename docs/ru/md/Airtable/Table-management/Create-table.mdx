...
{
 "id": "tblsEn5hzIGTaFUI6",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldn2xLZ3bovIZTWh",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldn2xLZ3bovIZTWh",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldJiXnQ6FJFzaMmx",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldsFfck0Mj9satD8",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldMuWU16iTJpSJMA",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldrSseIhVQcDJSuf",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fld2Vp2uj7VxPZEJQ",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwlDboD3rijsTkDt",
   "name": "Grid view",
   "type": "grid"
  }
 ]
