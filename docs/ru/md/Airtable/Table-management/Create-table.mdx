...
{
 "id": "tblGqlOS4iQiML1dB",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldzs3ce8eqInhLGG",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldzs3ce8eqInhLGG",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fld70MPW6uRISbbHI",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldI0UjJLBSpZjfCI",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldMz1h4jt4ShwQay",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldkLCuGywdada543",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldda8xyCKuNtjE4z",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwr6NxxDPxyIGCkS",
   "name": "Grid view",
   "type": "grid"
  }
 ]
