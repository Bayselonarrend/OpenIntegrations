...
{
 "id": "tbl4G6MbcnVilCViD",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldOwVddVEzNhiYmx",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldOwVddVEzNhiYmx",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldoqVjp8yCMkC9OI",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldQBPHRhL4l4ZPbO",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "flds5JxTQ7kxLqizt",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldC4DlD3zPFEaaFm",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldmfct5LDiuTou3F",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viw49sIyWqGC4PGJt",
   "name": "Grid view",
   "type": "grid"
  }
 ]
