...
{
 "id": "tblC27wqsPH6f2koS",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldJOwWwq2XfutciO",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldJOwWwq2XfutciO",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fld3sHGQkI9mP1UOQ",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldMhNNpuP4bcirju",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "flddjYVkdQdbjDW9U",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldGDhdSKg45DDHTj",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fld6uSonEHFS6oaG3",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwAAXT9AEr0z0K97",
   "name": "Grid view",
   "type": "grid"
  }
 ]
