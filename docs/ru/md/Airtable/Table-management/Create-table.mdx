...
{
 "id": "tblUpRjhd8YYUEaTq",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldInaYxIbeBzuIIB",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldInaYxIbeBzuIIB",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldlds6huZqvZuNUX",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fld2T4KsG9y5mtQ91",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldVNYHh35mgq0s9R",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldiOl33Ea8EKOcvF",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldHrBAKWwH1BEXZ1",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwlCcsIbK2q7QmGi",
   "name": "Grid view",
   "type": "grid"
  }
 ]
