...
{
 "id": "tblNksw01RapJJPvY",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldpsIKusateFuDA2",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldpsIKusateFuDA2",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldWqOyoiJqUM8tvq",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldXnCmipm6JfqmvW",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldtAZS1IKn0dCw5n",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldmufUXP4NzrR6XP",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fld6hX4b9voxsFIjp",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwZu4kJycCII5XcG",
   "name": "Grid view",
   "type": "grid"
  }
 ]
