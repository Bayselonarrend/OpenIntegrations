...
{
 "id": "tbl5mFL1tJniYV2Wr",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldlywj894In2X8fv",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldlywj894In2X8fv",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldt2ISzh1NFgQWSw",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fld67DrLcgHTQLnwI",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldQqX7JsBszm2zDM",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldHMqJRAnOZ4Hfnv",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fld9iz80T7geYniZj",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwHkHH7H4VtTHq2U",
   "name": "Grid view",
   "type": "grid"
  }
 ]
