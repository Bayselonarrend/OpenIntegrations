...
{
 "id": "tblX6D1qU74Z5jCuO",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldKzuhmAOpJZCTKb",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldKzuhmAOpJZCTKb",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fld7jCDKuDYldapT9",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldDFgKYgpTC5ccSk",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldT9z9tZ9Vd7gXLc",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldMA7XnydJ3GhMYW",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldSCmvN8RQwuUvnT",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viw3qpij2OVjS15dW",
   "name": "Grid view",
   "type": "grid"
  }
 ]
