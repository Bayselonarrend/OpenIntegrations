...
{
 "id": "tbl1g0WEQFlOfZFKL",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "flddxUTaWyXiVi9M3",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "flddxUTaWyXiVi9M3",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldofP6dYbVtVWY6Z",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldhelb5Jf4uLsReU",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldnHuinJgIfqS1wt",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fld3ZUvPAvXUejG2r",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fld5igA3KbfwUcGut",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwIUKxQ6qg3fKfdb",
   "name": "Grid view",
   "type": "grid"
  }
 ]
