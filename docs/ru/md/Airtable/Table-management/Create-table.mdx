...
{
 "id": "tblg591UGjoEsVVNx",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldynC6tOvVravV3s",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldynC6tOvVravV3s",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldgJLOsKcMramoWg",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldI1KQ7dcAkYy94c",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldjzXdFslHkbvL0V",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldZAs36h4LNuDc9i",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldvbrh0sSjmKNTxX",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viw2fzSrR8CGWWGDq",
   "name": "Grid view",
   "type": "grid"
  }
 ]
