...
{
 "id": "tblsoZRdJOEdtvobP",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldP2rzSqgNcJhcRy",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldP2rzSqgNcJhcRy",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldFo3mKdzY4DFynJ",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldKTSLmu8H1WLl3G",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldRw9SHw8YF8CRVK",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldBfZnC242WgqEpx",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldVpgB1eopiWUw1P",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viw6GbxrbTQR857kY",
   "name": "Grid view",
   "type": "grid"
  }
 ]
