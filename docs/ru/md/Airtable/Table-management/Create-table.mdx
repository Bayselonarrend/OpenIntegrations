...
{
 "id": "tblpc6PnlVntsKRJ2",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldmGOF951ElVTofe",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldmGOF951ElVTofe",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fld3hBS2Al2d7GdY5",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldElcVkPLDUSz42J",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldSXDJwIlb3uKHY8",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldJNS1qte1qn4Pq0",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fld9zcdV7EKQtebk7",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwocYzYnLGsIsECV",
   "name": "Grid view",
   "type": "grid"
  }
 ]
