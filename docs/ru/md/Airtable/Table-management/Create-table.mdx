...
{
 "id": "tbl9SiN0pC2CyNlHH",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldfdODyNTKkw78aR",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldfdODyNTKkw78aR",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fld3BVMuHGpfZlnnL",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldIa34TpjpZKjXD7",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fld3hxpKHECLrCWBg",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldFbkGF0AHBnH7Qo",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldhfWXDWl2KdQOkW",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwpKIP1ENMqftQ5w",
   "name": "Grid view",
   "type": "grid"
  }
 ]
