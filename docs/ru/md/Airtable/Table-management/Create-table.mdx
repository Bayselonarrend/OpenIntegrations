...
{
 "id": "tblZYrt61SwzNZzjd",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fld039Dx70RKsqrUp",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fld039Dx70RKsqrUp",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldw20pES0DpXqXib",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fld4S7N0wuDMRdr4a",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldAymxeqQuUGnbrZ",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldoJkTR9OBtzAAeH",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldX1JcjyrasErl3r",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwbPHGXJJPamXNnF",
   "name": "Grid view",
   "type": "grid"
  }
 ]
