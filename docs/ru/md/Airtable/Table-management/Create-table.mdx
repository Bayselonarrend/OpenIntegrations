...
{
 "id": "tblgMLZeHQHDwiRFx",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldl0Zx8bkKudygy6",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldl0Zx8bkKudygy6",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldsZHvCB20G48pzt",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldsi7owsARjp5sd9",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fld0K8ledtz8rWBcN",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fld97JtiAZ6i532vO",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fld7AWzw69iNur38c",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwiGUpUWYj89y4ek",
   "name": "Grid view",
   "type": "grid"
  }
 ]
