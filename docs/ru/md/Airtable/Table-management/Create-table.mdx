...
{
 "id": "tblJmK6irg88mzzvo",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldkwOzVXY9a0gIYI",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldkwOzVXY9a0gIYI",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldr04ITdruI81vv1",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldBWTUklbb7RU9SU",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fld1UMHcqD7apG7Ay",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldChOaaOQ9LdsNp0",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldk2Dwrnbe7iT39d",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwnIGQquIzfgWMew",
   "name": "Grid view",
   "type": "grid"
  }
 ]
