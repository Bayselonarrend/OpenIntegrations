...
{
 "id": "tblIOMDdAd670RzfB",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fld0A1Mo3BYTs2HUC",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fld0A1Mo3BYTs2HUC",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldUpXnnnRpxOOes3",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldyRbV3FLbauiaIJ",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldZbHML1q8HAQsZZ",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldTZQA92WdIfrTMH",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldPLyl51k2giR9M5",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwZ31nAkHh9PgpKm",
   "name": "Grid view",
   "type": "grid"
  }
 ]
