...
{
 "id": "tbl54yTeVkeVelBZu",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldEJ7RZDNxn61KZQ",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldEJ7RZDNxn61KZQ",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldhkcVV6qjmJO9AO",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldKxQecjdCNTaTzJ",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldkQTKgA5onNqy1l",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldnn7lhpq2bSnj09",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fld4hN5m5L8LyvQC6",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viw6eUKRvc6cKQjih",
   "name": "Grid view",
   "type": "grid"
  }
 ]
