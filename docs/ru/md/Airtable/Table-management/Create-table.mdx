...
{
 "id": "tblSiA6t4AeNBYhpw",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldEp7pdrBAMWJcfm",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldEp7pdrBAMWJcfm",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldEUbxJUvsmK4tSA",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fld48SUk6EesGvDYV",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldYIdM1PJDv4snIg",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fld4AeYnRIab2Ghsd",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldGXnXxTuOkTCu2r",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viw4Z8m3XcQgxeUXS",
   "name": "Grid view",
   "type": "grid"
  }
 ]
