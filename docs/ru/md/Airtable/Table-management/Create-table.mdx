...
{
 "id": "tblEGsVja9AXxM1eA",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldIUHTLWCruwFOMS",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldIUHTLWCruwFOMS",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fld4Az4f91Q9WvXVY",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fld3ifQFbxJg7RZOw",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldW0h8gWv8fDBdGb",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldEljVHv92Kjasuv",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldCr6h7akQ3xP28M",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwcpyd9bBEtsctBs",
   "name": "Grid view",
   "type": "grid"
  }
 ]
