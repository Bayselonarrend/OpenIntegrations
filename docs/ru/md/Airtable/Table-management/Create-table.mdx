...
{
 "id": "tblTl3ueXmVGL5HRJ",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldtEXu0aqnKcqhSn",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldtEXu0aqnKcqhSn",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldP79cweAIWEDXGd",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldqyX9yKKieGQVDH",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldNqM7MiqSAwn4e4",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fld6NkED038QLUquS",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldXcGVTXfcwNMbom",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwCZqL3KV1mUsdyB",
   "name": "Grid view",
   "type": "grid"
  }
 ]
