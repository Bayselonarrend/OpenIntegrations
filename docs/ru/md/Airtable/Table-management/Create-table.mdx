...
{
 "id": "tblbpYnT74ryB7iJw",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldb0fT8iGkUtB8YO",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldb0fT8iGkUtB8YO",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldKCcVC57aryl9pK",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldthXmbuegIK6Wda",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldd5oA64uNTKBNeN",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldBTjxpNFxWZ60lw",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fld0jpLC4NbyfgK5U",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viw59v4TNP2xfrgc3",
   "name": "Grid view",
   "type": "grid"
  }
 ]
