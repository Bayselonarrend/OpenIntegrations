...
{
 "id": "tblh5Gds8wiGrncD9",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldj8GJLCLhUT2hk2",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldj8GJLCLhUT2hk2",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldxmsYGlNsuVFhlA",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldkESZ3ilZdfQBhh",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldWaaij0PuQ2s3qe",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldwBBIBFwUpxzLz1",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldv5q9AkfTLKhEpQ",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwcK2GXj2xBvbAPB",
   "name": "Grid view",
   "type": "grid"
  }
 ]
