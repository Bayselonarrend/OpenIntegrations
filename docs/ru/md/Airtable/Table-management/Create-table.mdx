...
{
 "id": "tbl94rDV3wzmzt4H3",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fld3t8Cpzkp8Ul1Qc",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fld3t8Cpzkp8Ul1Qc",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldTMxXaW9fB7s4En",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldYMuy0nDrBly2UP",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldid9zy2pM94p7Wc",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldIuqPnYhHPXBA1Q",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fld9aSFws9xmPhbMr",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwqj9ET3GkAN8smu",
   "name": "Grid view",
   "type": "grid"
  }
 ]
