...
{
 "id": "tblnBIXfFkHDKxvhy",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fld1ooVpALNOph0PC",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fld1ooVpALNOph0PC",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fld2An1mRhC96oa3t",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "flde8Q9g3drlD8XNP",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldkXoV5bTv6WZp1D",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldW7LVRYcn2rZN7r",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldYZTbgif0GKfR2b",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwbZLxVca0eD7nXl",
   "name": "Grid view",
   "type": "grid"
  }
 ]
