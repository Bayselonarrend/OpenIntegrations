...
{
 "id": "tblsQzdn7PjtHzj0R",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldRkYNdOw9EUBE7A",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldRkYNdOw9EUBE7A",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldcTWXb1AksB5l5y",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldjIOLz8P84OlSHr",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldULytr2xQoT1DQX",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldT5gHOmmZU3MMcu",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldVk6fadg5CaGsIr",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwP5N631VgEfcW8N",
   "name": "Grid view",
   "type": "grid"
  }
 ]
