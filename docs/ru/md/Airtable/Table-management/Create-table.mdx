...
{
 "id": "tblPt6QQ41nLGQv9C",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldelkmkdld82zrZG",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldelkmkdld82zrZG",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldDg6JKitZ6hVhFY",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldVC4cXZ2QoGFXF6",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldBwS1fITQGf1dRk",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldkze5kDnNfTRJ9l",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldzaEeBGoUOdVhM7",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwlriyXaokyDSqjH",
   "name": "Grid view",
   "type": "grid"
  }
 ]
