...
{
 "id": "tblDp3J01kWYSLW0z",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldBuEOzZciiIqdh4",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldBuEOzZciiIqdh4",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fld464ep45lPoyp5E",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldzcOWIzlgnILnKy",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldMtquTzMPgcukLY",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldKxqPkZotZwnIzH",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldNziTYLpjGw0ivJ",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwONoHTN5wtWZ6WV",
   "name": "Grid view",
   "type": "grid"
  }
 ]
