...
{
 "id": "tblKXkCnu4ZrEVp2o",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldZ6g05IJVBceLwZ",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldZ6g05IJVBceLwZ",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldLq3f1Sp2hCIsJ9",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldDtvS81LTmjdQ0X",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "flddUhrLvMVjeRYoW",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fld6leaNSldEdddDZ",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldVutKr8GIcAOBe8",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwvXDcmVGJCH7I7N",
   "name": "Grid view",
   "type": "grid"
  }
 ]
