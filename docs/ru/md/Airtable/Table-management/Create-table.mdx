...
{
 "id": "tblr97PLjfvLTOZsa",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fld92wHR8XS8GjoZN",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fld92wHR8XS8GjoZN",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldLwEk9oDk66mHCR",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldtzSTzN1buApDTX",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldSZBacru7aRm0B0",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldfzrVjr1UVdWvDR",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldMD5cmuhRkh8RJK",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwdTzJx0IQpazfzK",
   "name": "Grid view",
   "type": "grid"
  }
 ]
