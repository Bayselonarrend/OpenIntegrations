...
{
 "id": "tblsY0cU4JBXkL3Ox",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldE9toR2yQUpWK9W",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldE9toR2yQUpWK9W",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fld84h70onF6eamfv",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldiYF1NaCEHwpFaQ",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fld0uxhOAmqa9xUre",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fld2hXHdloxxb5imH",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldgF9xjbRukszBdn",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viw4iFdbNHfOtwiVx",
   "name": "Grid view",
   "type": "grid"
  }
 ]
