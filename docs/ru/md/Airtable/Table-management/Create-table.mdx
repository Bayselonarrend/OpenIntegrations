...
{
 "id": "tblP45VrgG3NttsHN",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldIS6szVGwBheE7W",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldIS6szVGwBheE7W",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fld4jxWYObY7TJy8n",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldVnnuwbTgSx13NH",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldBo9oot1fiY3PA5",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fld5oBi7WuqIlxczR",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldEfoD96fcW3q1iv",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwrF6SDE5HXODS9D",
   "name": "Grid view",
   "type": "grid"
  }
 ]
