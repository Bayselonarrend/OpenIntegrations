...
{
 "id": "tbleSsZMnxLFs8CLy",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldnLVDV9qnM0jWOa",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldnLVDV9qnM0jWOa",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldXnWSKgBjLqHKW4",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldpM6wKDQaBeKhrK",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldseOFohAtcfFX0c",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fld1hDYemEULiHlk9",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldzvBpzZsmQd9Xhp",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwcxhlRJQrtaU7Jy",
   "name": "Grid view",
   "type": "grid"
  }
 ]
