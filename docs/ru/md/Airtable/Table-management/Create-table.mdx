...
{
 "id": "tblP9yDfAp99FH10x",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldeF43x1Yxg9S5hg",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldeF43x1Yxg9S5hg",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldMOkb2IYdDk7lJ6",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldVOgg748YNW81GH",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldvU1QtKVPSWTxfO",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldWsESZI7qT9MU1A",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldGn41aTt3NR9zDH",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwJLP8uQZwi9lG0x",
   "name": "Grid view",
   "type": "grid"
  }
 ]
