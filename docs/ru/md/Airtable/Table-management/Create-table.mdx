...
{
 "id": "tblXrLoA41EW916FN",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldWrGfPjZdBSdqED",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldWrGfPjZdBSdqED",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldw26WBMo0JvOS1Q",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "flddU9vzSOxOk8cZS",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fld0se2oMLIqjmvnj",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldm4D25OZziZaSTt",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fld0nZZb6HkflzSWp",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwV13ZHnIs5z00Bo",
   "name": "Grid view",
   "type": "grid"
  }
 ]
