...
{
 "id": "tblvJk4fmdV1ovDH9",
 "name": "Тестовая таблица 2",
 "description": "Новая таблица",
 "primaryFieldId": "fldmbcTM4hrbl8zz5",
 "fields": [
  {
   "type": "number",
   "options": {
   ...
   "id": "fldmbcTM4hrbl8zz5",
   "name": "Номер"
  },
  {
   "type": "richText",
   "id": "fldc47NyRnhKsFfFC",
   "name": "Строковое"
  },
  {
  ...
  },
  {
   ...
   "id": "fldENZjzt7swbgtiU",
   "name": "Дата"
  },
  {
   "type": "phoneNumber",
   "id": "fldIg0JoCY1q84vPC",
   "name": "Телефон"
  },
  {
   "type": "email",
   "id": "fldhMPceYqpXmaruv",
   "name": "Почта"
  },
  {
   "type": "url",
   "id": "fldy97SfRyAOKp1K0",
   "name": "Ссылка"
  }
 ],
 "views": [
  {
   "id": "viwPzPxbEcTXv9PTc",
   "name": "Grid view",
   "type": "grid"
  }
 ]
