    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ПолучитьКомментарии \
              --token "***" \
              --base "appgEVQCbxLWlJKpU" \
              --table "tbl5mFL1tJniYV2Wr" \
              --record "rec4kCHYhyFKXbX6P"
        ```
    </TabItem>
 ...
 "comments": [
  {
   ...
   "createdTime": "2026-04-27T13:53:31Z",
   "lastUpdatedTime": "2026-04-27T13:53:32Z"
  }
 ],
 "offset": null
}
