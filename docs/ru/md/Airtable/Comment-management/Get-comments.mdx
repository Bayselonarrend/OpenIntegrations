    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ПолучитьКомментарии \
              --token "***" \
              --base "app01DJEj31SXK3dY" \
              --table "tbl50qzGAsM4HMXgH" \
              --record "recpfd0ALVLT5b63t"
        ```
    </TabItem>
 ...
 "comments": [
  {
   ...
   "createdTime": "2026-02-20T11:58:54Z",
   "lastUpdatedTime": "2026-02-20T11:58:55Z"
  }
 ],
 "offset": null
}
