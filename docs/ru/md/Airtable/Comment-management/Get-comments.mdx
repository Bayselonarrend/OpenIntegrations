    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ПолучитьКомментарии \
              --token "***" \
              --base "appfGr7aqJXkeD4lL" \
              --table "tblhahrPnA96rnzTd" \
              --record "recJ70tXnbxXfC7P8"
        ```
    </TabItem>
 ...
 "comments": [
  {
   ...
   "createdTime": "2026-07-19T19:09:57Z",
   "lastUpdatedTime": "2026-07-19T19:09:59Z"
  }
 ],
 "offset": null
}
