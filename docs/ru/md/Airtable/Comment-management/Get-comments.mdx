    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ПолучитьКомментарии \
              --token "***" \
              --base "appkUgQeRG1eZmEiK" \
              --table "tbl5OjCN0PD2ZCJLU" \
              --record "recxJ4L7umLBDEPIf"
        ```
    </TabItem>
 ...
 "comments": [
  {
   ...
   "createdTime": "2026-07-18T07:34:10Z",
   "lastUpdatedTime": "2026-07-18T07:34:11Z"
  }
 ],
 "offset": null
}
