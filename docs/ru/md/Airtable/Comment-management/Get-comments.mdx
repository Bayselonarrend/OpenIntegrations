    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ПолучитьКомментарии \
              --token "***" \
              --base "appfdgTeghDYYUO7b" \
              --table "tblOwjNyAmFbMfIYZ" \
              --record "recCgprR9DIlhu2t6"
        ```
    </TabItem>
 ...
 "comments": [
  {
   ...
   "createdTime": "2026-06-18T18:18:41Z",
   "lastUpdatedTime": "2026-06-18T18:18:43Z"
  }
 ],
 "offset": null
}
