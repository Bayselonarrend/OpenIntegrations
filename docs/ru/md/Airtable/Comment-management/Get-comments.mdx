    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ПолучитьКомментарии \
              --token "***" \
              --base "appAiM312LWvcFanc" \
              --table "tblpl09chI4P9GDy6" \
              --record "reco9Me3yUCcwJAet"
        ```
    </TabItem>
 ...
 "comments": [
  {
   ...
   "createdTime": "2026-06-06T21:19:31Z",
   "lastUpdatedTime": "2026-06-06T21:19:33Z"
  }
 ],
 "offset": null
}
