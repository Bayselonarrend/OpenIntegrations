    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ПолучитьКомментарии \
              --token "***" \
              --base "appbF91qG68ZHmSnb" \
              --table "tblbpYnT74ryB7iJw" \
              --record "rec8o9PMiN7tQ078m"
        ```
    </TabItem>
 ...
 "comments": [
  {
   ...
   "createdTime": "2026-06-06T13:19:49Z",
   "lastUpdatedTime": "2026-06-06T13:19:50Z"
  }
 ],
 "offset": null
}
