    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ПолучитьКомментарии \
              --token "***" \
              --base "appgAYlS6uka08flP" \
              --table "tblqwkSgLaYyaWmAI" \
              --record "recsE4Ggy0lMpqKhZ"
        ```
    </TabItem>
 ...
 "comments": [
  {
   ...
   "createdTime": "2026-06-08T19:47:59Z",
   "lastUpdatedTime": "2026-06-08T19:48:00Z"
  }
 ],
 "offset": null
}
