    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ПолучитьКомментарии \
              --token "***" \
              --base "app2JczSOwS7wzYg2" \
              --table "tbl6xsHqXK7sbqZRy" \
              --record "recMMRDICIXM03qm3"
        ```
    </TabItem>
 ...
 "comments": [
  {
   ...
   "createdTime": "2026-06-15T18:36:16Z",
   "lastUpdatedTime": "2026-06-15T18:36:17Z"
  }
 ],
 "offset": null
}
