    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint airtable ПолучитьКомментарии \
              --token "***" \
              --base "appRxhiMGoKKvX6pG" \
              --table "tblIOsEuVdm5T5g0c" \
              --record "recSiRtu0VyBP2LIC"
        ```
    </TabItem>
 ...
 "comments": [
  {
   ...
   "createdTime": "2026-06-11T07:44:45Z",
   "lastUpdatedTime": "2026-06-11T07:44:46Z"
  }
 ],
 "offset": null
}
