...
description: Создать соединение (SUB) и другие функции для работы с ZeroMQ в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
`Функция СоздатьСоединениеSub(Знач Адрес, Знач Логирование = Неопределено) Экспорт`
  ...
  | Логирование | --log | Структура Из КлючИЗначение | &#x2716; | Настройки логирования. См. [`ПолучитьНастройкиЛогирования`](/docs/ZeroMQ/Common/Get-logging-settings) |
