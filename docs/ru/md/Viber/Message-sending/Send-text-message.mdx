    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint viber ОтправитьТекстовоеСообщение \
              ...
              --ischannel false \
              --keyboard "{'Buttons':[{'ActionType':'reply','ActionBody':'Кнопка 1','Text':'Кнопка 1','BgColor':'#2db9b9','Columns':3},{'ActionType':'reply','ActionBody':'Кнопка 2','Text':'Кнопка 2','BgColor':'#2db9b9','Columns':3},{'ActionType':'reply','ActionBody':'Кнопка 3','Text':'Кнопка 3','BgColor':'#2db9b9','Columns':3}],'Type':'keyboard'}"
        ```
    </TabItem>
