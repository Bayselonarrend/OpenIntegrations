    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint rss РазобратьФидRSS \
              --xml "C:\Users\bayselonarrend\AppData\Local\Temp\vsjimcpk.jnb.xml"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "lastBuildDate": "Sat, 06 Jun 2026 16:53:01 +0000",
 "items": [
  {
   "title": "Первый элемент",
   "description": "Описание первого элемента",
   "link": "https://example.com/item1",
   "pubDate": "Sat, 06 Jun 2026 16:53:00 +0000",
  ...
  },
  {
   ...
   "pubDate": "Sat, 06 Jun 2026 16:53:01 +0000",
   "author": "test@example.com",
   "guid": "item-2"
  }
 ]
