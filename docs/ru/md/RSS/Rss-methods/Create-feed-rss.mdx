    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rss СоздатьФидRSS \
              ...
              --items "[{'title':'Первый элемент','description':'Описание первого элемента','link':'https://example.com/item1','pubDate':'03/25/2026 08:38:47','author':'test@example.com','guid':'item-1'},{'title':'Второй элемент','description':'Описание второго элемента','link':'https://example.com/item2','pubDate':'03/25/2026 08:38:48','author':'test@example.com','guid':'item-2'}]"
        ```
    </TabItem>
