    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rss СоздатьФидRSS \
              ...
              --items "[{'title':'Первый элемент','description':'Описание первого элемента','link':'https://example.com/item1','pubDate':'6/7/2026 12:53:00 AM','author':'test@example.com','guid':'item-1'},{'title':'Второй элемент','description':'Описание второго элемента','link':'https://example.com/item2','pubDate':'6/7/2026 12:53:00 AM','author':'test@example.com','guid':'item-2'}]"
        ```
    </TabItem>
