    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rss СоздатьФидRSS \
              ...
              --items "[{'title':'Первый элемент','description':'Описание первого элемента','link':'https://example.com/item1','pubDate':'7/4/2026 9:29:23 PM','author':'test@example.com','guid':'item-1'},{'title':'Второй элемент','description':'Описание второго элемента','link':'https://example.com/item2','pubDate':'7/4/2026 9:29:25 PM','author':'test@example.com','guid':'item-2'}]"
        ```
    </TabItem>
