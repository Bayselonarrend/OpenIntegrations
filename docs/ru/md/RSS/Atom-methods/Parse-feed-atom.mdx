    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint rss РазобратьФидAtom \
              --xml "C:\Users\bayselonarrend\AppData\Local\Temp\gez1p3g0.10h.xml"
        ```
    </TabItem>
