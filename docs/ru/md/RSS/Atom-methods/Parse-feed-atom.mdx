    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint rss РазобратьФидAtom \
              --xml "C:\Users\bayselonarrend\AppData\Local\Temp\qqp3dvow.nrb.xml"
        ```
    </TabItem>
