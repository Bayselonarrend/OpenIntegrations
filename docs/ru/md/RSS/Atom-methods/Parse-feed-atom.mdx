...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ФидXML = "C:\Users\bayselonarrend\AppData\Local\Temp\v8_1F72_1a.xml";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint rss РазобратьФидAtom \
              --xml "C:\Users\bayselonarrend\AppData\Local\Temp\xj1324ax.yjt.xml"
        ```
    </TabItem>
