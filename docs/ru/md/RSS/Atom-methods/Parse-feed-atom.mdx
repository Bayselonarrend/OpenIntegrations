...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ФидXML = "C:\Users\bayselonarrend\AppData\Local\Temp\v8_4BFA_6e.xml";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint rss РазобратьФидAtom \
              --xml "C:\Users\bayselonarrend\AppData\Local\Temp\vhpjwnou.unc.xml"
        ```
    </TabItem>
