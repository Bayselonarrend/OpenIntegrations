    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rss СоздатьФидAtom \
              ...
              --items "[{'title':'Первая запись','id':'https://example.com/entry1','link':'https://example.com/entry1','updated':'6/9/2026 10:13:34 PM','summary':'Краткое описание первой записи','content':'Полное содержимое первой записи','author':'Автор Первый','published':'6/9/2026 10:13:34 PM'},{'title':'Вторая запись','id':'https://example.com/entry2','link':'https://example.com/entry2','updated':'6/9/2026 10:13:35 PM','summary':'Краткое описание второй записи','content':'Полное содержимое второй записи','author':'Автор Второй','published':'6/9/2026 10:13:35 PM'}]"
        ```
    </TabItem>
