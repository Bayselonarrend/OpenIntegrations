    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rss СоздатьФидAtom \
              ...
              --items "[{'title':'Первая запись','id':'https://example.com/entry1','link':'https://example.com/entry1','updated':'4/14/2026 12:36:00 AM','summary':'Краткое описание первой записи','content':'Полное содержимое первой записи','author':'Автор Первый','published':'4/14/2026 12:36:00 AM'},{'title':'Вторая запись','id':'https://example.com/entry2','link':'https://example.com/entry2','updated':'4/14/2026 12:36:00 AM','summary':'Краткое описание второй записи','content':'Полное содержимое второй записи','author':'Автор Второй','published':'4/14/2026 12:36:00 AM'}]"
        ```
    </TabItem>
