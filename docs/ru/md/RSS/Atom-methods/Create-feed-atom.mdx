    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rss СоздатьФидAtom \
              ...
              --items "[{'title':'Первая запись','id':'https://example.com/entry1','link':'https://example.com/entry1','updated':'06/15/2026 14:07:10','summary':'Краткое описание первой записи','content':'Полное содержимое первой записи','author':'Автор Первый','published':'06/15/2026 14:07:10'},{'title':'Вторая запись','id':'https://example.com/entry2','link':'https://example.com/entry2','updated':'06/15/2026 14:07:11','summary':'Краткое описание второй записи','content':'Полное содержимое второй записи','author':'Автор Второй','published':'06/15/2026 14:07:11'}]"
        ```
    </TabItem>
