  ...
  docs: [

    {
      ...
      items: [{ type: 'autogenerated', dirName: 'Start' }]
        ...
        {
      type: 'category',
      label: 'Мессенджеры и соц. сети',
      className: 'Messenger',
      items: [
        { type: 'category', link: { type: 'doc', id: 'Instructions/GreenAPI' }, label: 'GreenAPI (WhatsApp)', className: 'GreenAPI', items: [{ type: 'autogenerated', dirName: 'GreenAPI' }] },
        { type: 'category', link: { type: 'doc', id: 'Instructions/GreenMax' }, label: 'GreenAPI (Max)', className: 'GreenMax', items: [{ type: 'autogenerated', dirName: 'GreenMax' }] },
        ...
        { type: 'category', link: { type: 'doc', id: 'Instructions/VKTeams' }, label: 'VK Teams', className: 'VKTeams', items: [{ type: 'autogenerated', dirName: 'VKTeams' }] },
           ...
           {
      type: 'category',
      label: 'СУБД и электронные таблицы',
      className: 'Database',
      items: [
        ...
        { type: 'category', link: { type: 'doc', id: 'Instructions/MSSQL' }, label: 'MS SQL', className: 'MSSQL', items: [{ type: 'autogenerated', dirName: 'MSSQL' }] },
      ...
      items: [
        ...
        { type: 'category', link: { type: 'doc', id: 'Instructions/S3' }, label: 'AWS S3', className: 'S3', items: [{ type: 'autogenerated', dirName: 'S3' }] },
      ...
      className: 'Exchange',
      items: [
        { type: 'category', link: { type: 'doc', id: 'Instructions/FTP' }, label: 'FTP(S)', className: 'FTP', items: [{ type: 'autogenerated', dirName: 'FTP' }] },
        { type: 'category', link: { type: 'doc', id: 'Instructions/GRPC' }, label: 'gRPC', className: 'GRPC', items: [{ type: 'autogenerated', dirName: 'GRPC' }] },
        { type: 'category', link: { type: 'doc', id: 'Instructions/HTTP' }, label: 'HTTP', className: 'HTTP', items: [{ type: 'autogenerated', dirName: 'HTTP' }] },
        { type: 'category', link: { type: 'doc', id: 'Instructions/LDAP' }, label: 'LDAP', className: 'LDAP', items: [{ type: 'autogenerated', dirName: 'LDAP' }] },
      ...
      className: 'Formats',
      items: [
        { type: 'category', link: { type: 'doc', id: 'Instructions/7z' }, label: '7z', className: 'a7z', items: [{ type: 'autogenerated', dirName: '7z' }] },
        { type: 'category', link: { type: 'doc', id: 'Instructions/Janx' }, label: 'Janx', className: 'Janx', items: [{ type: 'autogenerated', dirName: 'Janx' }] },
        { type: 'category', link: { type: 'doc', id: 'Instructions/MessagePack' }, label: 'MessagePack', className: 'MessagePack', items: [{ type: 'autogenerated', dirName: 'MessagePack' }] },
        { type: 'category', link: { type: 'doc', id: 'Instructions/RAR' }, label: 'RAR', className: 'RAR', items: [{ type: 'autogenerated', dirName: 'RAR' }] },
        { type: 'category', link: { type: 'doc', id: 'Instructions/RSS' }, label: 'RSS/Atom', className: 'RSS', items: [{ type: 'autogenerated', dirName: 'RSS' }] },
        { type: 'category', link: { type: 'doc', id: 'Instructions/Tar' }, label: 'Tar', className: 'Tar', items: [{ type: 'autogenerated', dirName: 'Tar' }] },
      ],
    },
           {
      type: 'category',
      ...
      className: 'Other',
      items: [
        { type: 'category', link: { type: 'doc', id: 'Instructions/Lua' }, label: 'Lua', className: 'Lua', items: [{ type: 'autogenerated', dirName: 'Lua' }] },
        ...
        { type: 'category', link: { type: 'doc', id: 'Instructions/Ntfy' }, label: 'Ntfy', className: 'Ntfy', items: [{ type: 'autogenerated', dirName: 'Ntfy' }] },
