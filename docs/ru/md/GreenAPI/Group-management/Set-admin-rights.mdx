...
description: Назначить права администратора и другие функции для работы с GreenAPI в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
:::tip
Метод в документации API: [SetGroupAdmin](https://green-api.com/docs/api/groups/SetGroupAdmin/)
:::
<br/>
 ...
 <Tabs>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint greenapi НазначитьПраваАдминистратора \
