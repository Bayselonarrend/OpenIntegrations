...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    IDСообщения = "3EB00CE2030AC5285D9B18";
...
{
 "type": "outgoing",
 "idMessage": "3EB0FAB8A32B9AC25571C3",
 "timestamp": 1767674312,
 ...
 "statusMessage": "sent",
 "sendByApi": "***",
 "deletedMessageId": "3EB0CE4B5E6229B508D52D",
 "editedMessageId": "",
 "isEdited": false,
 "isDeleted": true
}
