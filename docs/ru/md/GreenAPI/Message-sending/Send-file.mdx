...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Файл     = "https://releases.openintegrations.dev/test_data/picture.jpg"; // URL, Путь или Двоичные данные
    ИмяФайла = "photo.jpg";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint greenapi ОтправитьФайл \
              ...
              --chat "***" \
              --file "https://releases.openintegrations.dev/test_data/video.mp4" \
              --filename "vid.mp4" \
              --caption "Описание файла" \
              --quoted "3EB0FAEB4F0A854ACA8E80"
        ```
    </TabItem>
...
{
 "idMessage": "3EB09E3CD2B469CD24544E",
 "urlFile": "https://do-mediaout-7105.fra1.digitaloceanspaces.com/7105187566/1781f547-704c-4738-a69e-cb4cf353011d.jpg"
}
```
