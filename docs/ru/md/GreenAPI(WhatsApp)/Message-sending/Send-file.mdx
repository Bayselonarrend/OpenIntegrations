---
sidebar_position: 2
description: Отправить файл и другие функции для работы с GreenAPI (WhatsApp) в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
{
 "idMessage": "BAE522EC9A5CB15D",
 "urlFile": "https://do-mediaout-7105.fra1.digitaloceanspaces.com/7105187566/9c262676-2b35-42a7-96e4-9a94debbacf0.jpg"
}
```
