    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint tar РазархивироватьКаталог \
              --src "C:\Users\bayselonarrend\AppData\Local\Temp\\opi_tar_modify_63918786804018/archive.tar" \
              --dest "C:\Users\bayselonarrend\AppData\Local\Temp\\opi_tar_modify_63918786804018/out"
        ```
    </TabItem>
