    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint tar РазархивироватьКаталог \
              --src "C:\Users\bayselonarrend\AppData\Local\Temp\\opi_tar_modify_63918770373943/archive.tar" \
              --dest "C:\Users\bayselonarrend\AppData\Local\Temp\\opi_tar_modify_63918770373943/out"
        ```
    </TabItem>
