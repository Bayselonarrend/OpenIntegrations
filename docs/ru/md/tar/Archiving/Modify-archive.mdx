    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint tar ИзменитьАрхив \
              --src "C:\Users\bayselonarrend\AppData\Local\Temp\kgokkczx.oxn" \
              --additions "{'extra/info.txt':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\\\opi_tar_modify_63918743127558/extra_info.txt','readme.txt':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\rd3ecoja.pot'}" \
