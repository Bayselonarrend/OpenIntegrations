    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint tar ИзменитьАрхив \
              --src "C:\Users\bayselonarrend\AppData\Local\Temp\aasbjoe3.hq2" \
              --additions "{'extra/info.txt':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\\\opi_tar_modify_63918825412342/extra_info.txt','readme.txt':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\qurgoq3r.nlz'}" \
