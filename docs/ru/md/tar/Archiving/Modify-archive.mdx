    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint tar ИзменитьАрхив \
              ...
              --additions "{'extra/info.txt':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\\\opi_tar_modify_63918850434483/extra_info.txt','readme.txt':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\1dbq4ldk.xzb'}" \
