    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint tar ИзменитьАрхив \
              --src "C:\Users\bayselonarrend\AppData\Local\Temp\jph5fdfn.1xz" \
              --additions "{'extra/info.txt':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\\\opi_tar_modify_63918786804018/extra_info.txt','readme.txt':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\3rwmg35w.4sp'}" \
