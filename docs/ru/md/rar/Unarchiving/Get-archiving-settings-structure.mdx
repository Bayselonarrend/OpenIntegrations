...
description: Получить структуру настроек архивации и другие функции для работы с rar в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
