    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint clickhouse ВыполнитьЗапрос \
              ...
              --req "{'query':'CREATE TABLE IF NOT EXISTS events_grpc (\n    id UInt64,\n    timestamp DateTime,\n    user_id UInt32,\n    event_type String,\n    payload String\n) ENGINE    = MergeTree()\nORDER BY (timestamp, id)','format':'JSON'}"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "headers": {
  "Date": "Fri, 06 Feb 2026 16:04:20 GMT",
  "Connection": "Keep-Alive",
  "X-ClickHouse-Server-Display-Name": "clickhouse",
  "Transfer-Encoding": "chunked",
  "X-ClickHouse-Query-Id": "b2a1cd43-e0da-4d4a-86ce-3cde990c6702",
