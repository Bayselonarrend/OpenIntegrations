    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint clickhouse ВыполнитьЗапрос \
              --conn "{'auth_type':'basic','address':'http://127.0.0.1:9101','password':'***','transport':'grpc','user':'bayselonarrend'}" \
...
```json title="Результат"
{
 ...
 "headers": {
  "Date": "Sat, 02 May 2026 10:02:34 GMT",
  "Connection": "Keep-Alive",
  "X-ClickHouse-Server-Display-Name": "clickhouse",
  "Transfer-Encoding": "chunked",
  "X-ClickHouse-Query-Id": "9c4dad85-d4a5-4eac-bb70-9b1246b95d24",
