    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint clickhouse ВыполнитьЗапрос \
              --conn "{'password':'***','user':'bayselonarrend','transport':'grpc','auth_type':'basic','address':'http://127.0.0.1:9101'}" \
...
```json title="Результат"
{
 ...
 "headers": {
  "Date": "Wed, 08 Apr 2026 06:28:04 GMT",
  "Connection": "Keep-Alive",
  "X-ClickHouse-Server-Display-Name": "clickhouse",
  "Transfer-Encoding": "chunked",
  "X-ClickHouse-Query-Id": "38ab365f-49fe-4d18-a95e-512402bc98a6",
