    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint clickhouse ВыполнитьЗапрос \
              --conn "{'address':'http://127.0.0.1:9101','password':'***','transport':'grpc','auth_type':'basic','user':'bayselonarrend'}" \
...
```json title="Результат"
{
 ...
 "headers": {
  "Date": "Sat, 25 Apr 2026 12:50:03 GMT",
  "Connection": "Keep-Alive",
  "X-ClickHouse-Server-Display-Name": "clickhouse",
  "Transfer-Encoding": "chunked",
  "X-ClickHouse-Query-Id": "135afc65-3517-4640-bfcc-2bfda99f1e75",
