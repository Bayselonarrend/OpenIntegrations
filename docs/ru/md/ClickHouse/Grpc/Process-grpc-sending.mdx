    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint clickhouse ОбработатьОтправкуGRPC \
              --conn "{'address':'http://127.0.0.1:9101','auth_type':'basic','password':'***','transport':'grpc','user':'bayselonarrend'}" \
...
```json title="Результат"
{
 ...
 "received_message": {
  "message": {
   ...
   "extremes": "<Двоичные данные>",
   "logs": [],
   "output": "<Двоичные данные>",
   "output_columns": [],
   "output_format": "",
   "progress": {
    "read_bytes": 0,
   ...
   "query_id": "860c1020-fc1f-426f-ac53-f79be5ce98bf",
   "stats": {
    "allocated_bytes": 0,
