    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint sqlite ДобавитьЗаписи \
              --table "test" \
              --rows "[{'name':'Vitaly','age':25,'salary':1000.12,'is_active':true,'created_at':'2025-03-18T09:05:42.7520092Z','data':{'blob':'C:\\Users\\Administrator\\AppData\\Local\\Temp\\2qggpasqy41.png'}},{'name':'Lesha','age':20,'salary':200.20,'is_active':false,'created_at':'2025-03-18T09:05:42.7534969Z','data':{'blob':'C:\\Users\\Administrator\\AppData\\Local\\Temp\\2qggpasqy41.png'}}]" \
