    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint sqlite ВыполнитьЗапросSQL \
              ...
              --params "['Vitaly',25,1000.12,true,'2025-01-05T20:31:04.8792581Z',{'blob':'C:\\Users\\Administrator\\AppData\\Local\\Temp\\a3gcttci1kv.png'}]" \
              --db "C:\Users\Administrator\AppData\Local\Temp\e4caqcgjjp3.sqlite"
        ```
    </TabItem>
