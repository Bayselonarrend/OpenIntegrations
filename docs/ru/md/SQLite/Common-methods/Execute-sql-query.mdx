    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint sqlite ВыполнитьЗапросSQL \
              ...
              --params "['Vitaly',25,1000.12,true,'2025-01-10T16:20:27.7277164Z',{'blob':'C:\\Users\\Administrator\\AppData\\Local\\Temp\\2lqf23wuwtz.png'}]" \
              --db "C:\Users\Administrator\AppData\Local\Temp\hhbzsqzvtsy.sqlite"
        ```
    </TabItem>
