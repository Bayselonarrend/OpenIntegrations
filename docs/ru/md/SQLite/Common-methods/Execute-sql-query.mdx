    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint sqlite ВыполнитьЗапросSQL \
              ...
              --params "['Vitaly',25,1000.12,true,'2025-01-07T20:11:36.6018524Z',{'blob':'C:\\Users\\Administrator\\AppData\\Local\\Temp\\mbie5yvv3ml.png'}]" \
              --db "C:\Users\Administrator\AppData\Local\Temp\2ezhoiu3wyw.sqlite"
        ```
    </TabItem>
