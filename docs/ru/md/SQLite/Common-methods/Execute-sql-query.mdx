...
:::tip
Доступные типы параметров: Строка, Число, Дата, Булево, ДвоичныеДанные. Двоичные данные могут также быть переданы как структура `{'blob':Путь к файлу}`. Возвращаются значения двоичных данных (BLOB) в виде `{'blob':Base64 строка}`
...
```json title="Результат"
{
 "data": [
  {
   "age": 25,
   "created_at": "2026-05-02T09:24:57Z",
   "data": {
    "blob": "Base64"
   },
   "id": 1,
