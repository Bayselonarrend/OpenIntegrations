...
`Функция ОткрытьСоединение(Знач База = "", Знач Логирование = Неопределено) Экспорт`

  | Параметр | CLI опция | Тип | Обяз. | Назначение |
  |-|-|-|-|-|
  | База | - | Строка | &#x2716; | Путь к базе. In memory, если не заполнено |
  | Логирование | - | Структура Из КлючИЗначение | &#x2716; | Настройки логирования. См. [`ПолучитьНастройкиЛогирования`](/docs/SQLite/Common-methods/Get-logging-settings) |
