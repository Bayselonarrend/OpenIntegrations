...
{
 "logs": [
  "[2026-06-15 14:00:31.042] Connecting to SQLite (in_memory=false)",
  "[2026-06-15 14:00:31.044] Connected to SQLite",
  "[2026-06-15 14:00:31.045] Execute query (params=0, force_result=false): SELECT 1 AS n",
  "[2026-06-15 14:00:31.046] Query returned 1 row(s)"
 ],
 "result": true,
 "returned": 4,
 "total": 4
