...
{
 "logs": [
  "[2026-06-11 10:36:22.492] Connecting to SQLite (in_memory=false)",
  "[2026-06-11 10:36:22.493] Connected to SQLite",
  "[2026-06-11 10:36:22.494] Execute query (params=0, force_result=false): SELECT 1 AS n",
  "[2026-06-11 10:36:22.494] Query returned 1 row(s)"
 ],
 "result": true,
 "returned": 4,
 "total": 4
