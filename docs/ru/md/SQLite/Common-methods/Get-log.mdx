...
{
 "logs": [
  "[2026-07-14 06:11:15.858] Connecting to SQLite (in_memory=false)",
  "[2026-07-14 06:11:15.859] Connected to SQLite",
  "[2026-07-14 06:11:15.861] Execute query (params=0, force_result=false): SELECT 1 AS n",
  "[2026-07-14 06:11:15.861] Query returned 1 row(s)"
 ],
 "result": true,
 "returned": 4,
 "total": 4
