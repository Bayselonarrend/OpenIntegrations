...
{
 "logs": [
  "[2026-05-25 03:55:59.874] Connecting to SQLite (in_memory=false)",
  "[2026-05-25 03:55:59.874] Connected to SQLite",
  "[2026-05-25 03:55:59.876] Execute query (params=0, force_result=false): SELECT 1 AS n",
  "[2026-05-25 03:55:59.876] Query returned 1 row(s)"
 ],
 "result": true,
 "returned": 4,
 "total": 4
