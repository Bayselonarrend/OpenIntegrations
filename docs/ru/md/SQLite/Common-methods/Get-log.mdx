...
{
 "logs": [
  "[2026-06-15 11:56:12.682] Connecting to SQLite (in_memory=false)",
  "[2026-06-15 11:56:12.686] Connected to SQLite",
  "[2026-06-15 11:56:12.688] Execute query (params=0, force_result=false): SELECT 1 AS n",
  "[2026-06-15 11:56:12.688] Query returned 1 row(s)"
 ],
 "result": true,
 "returned": 4,
 "total": 4
