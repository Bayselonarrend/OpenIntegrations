...
{
 "logs": [
  "[2026-07-15 05:39:08.165] Connecting to SQLite (in_memory=false)",
  "[2026-07-15 05:39:08.165] Connected to SQLite",
  "[2026-07-15 05:39:08.168] Execute query (params=0, force_result=false): SELECT 1 AS n",
  "[2026-07-15 05:39:08.168] Query returned 1 row(s)"
 ],
 "result": true,
 "returned": 4,
 "total": 4
