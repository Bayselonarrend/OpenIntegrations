...
{
 "logs": [
  "[2026-06-08 22:39:23.716] Connecting to SQLite (in_memory=false)",
  "[2026-06-08 22:39:23.720] Connected to SQLite",
  "[2026-06-08 22:39:23.722] Execute query (params=0, force_result=false): SELECT 1 AS n",
  "[2026-06-08 22:39:23.722] Query returned 1 row(s)"
 ],
 "result": true,
 "returned": 4,
 "total": 4
