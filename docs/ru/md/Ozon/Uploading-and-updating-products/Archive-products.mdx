...
:::tip
Вы можете передать до 100 идентификаторов за раз<br/>
Метод в документации API: [post /v1/product/archive](https://docs.ozon.ru/api/seller/#operation/ProductAPI_ProductArchive)<br/>
<br/>
:::
<br/>
