    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьНовость \
              ...
              --files "{'1.png':'https://releases.openintegrations.dev/test_data/picture.jpg'}" \
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1784488285,
  "finish": 1784488285.58612,
  "duration": 0.586123943328857,
  "processing": 0,
  "date_start": "2026-07-19T22:11:25+03:00",
  "date_finish": "2026-07-19T22:11:25+03:00",
  "operating_reset_at": 1784488885,
  "operating": 0.442688941955566
 }
}
```
