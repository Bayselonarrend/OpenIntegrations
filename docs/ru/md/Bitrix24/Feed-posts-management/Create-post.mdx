...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Картинка1 = "https://releases.openintegrations.dev/test_data/picture.jpg";  // URL, Путь или Двоичные данные
    Картинка2 = "https://releases.openintegrations.dev/test_data/picture2.jpg"; // URL, Путь или Двоичные данные
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьНовость \
              --url "b24-ar17wx.bitrix24.by" \
              --text "Текст новости" \
              --files "{'1.png':'https://releases.openintegrations.dev/test_data/picture.jpg','2.png':'https://releases.openintegrations.dev/test_data/picture2.jpg'}" \
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1784488213,
  "finish": 1784488214.35362,
  "duration": 1.35362195968628,
  "processing": 1,
  "date_start": "2026-07-19T22:10:13+03:00",
  "date_finish": "2026-07-19T22:10:14+03:00",
  "operating_reset_at": 1784488813,
  "operating": 1.05125617980957
 }
}
```
