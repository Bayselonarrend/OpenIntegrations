    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьСобытияКалендарей \
              ...
              --owner "1" \
              --type ""user"" \
              --filter ""C:\Users\bayse\AppData\Local\Temp\way530ji.jms.json"" \
              --token "***"
        ```
    </TabItem>
 ...
 "result": [
  {
   ...
   "EVENT_TYPE": null,
   "CREATED_BY": "1",
   "DATE_CREATE": "16.09.2025 23:38:25",
   "TIMESTAMP_X": "16.09.2025 23:38:25",
   ...
   "EXDATE": "",
   "DAV_XML_ID": "20250917T203800Z-38b99c97f5ca1a2b30070bf63707f241@b24-ar17wx.bitrix24.by",
   "G_EVENT_ID": "",
   "DAV_EXCH_LABEL": "",
   "CAL_DAV_LABEL": "",
   "VERSION": "1",
