    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ПолучитьСобытияКалендарей \
              ...
              --owner 1 \
              --type "user" \
              --filter "{'from':'6/7/2026 4:29:12 PM','to':'6/8/2026 4:29:12 PM','section':['2546','2548']}" \
              --token "***"
        ```
    </TabItem>
 ...
 "result": [
  {
   ...
   "OWNER_ID": "1",
   "NAME": "Новое событие",
   "DATE_FROM": "07.06.2026 16:29:00",
   "DATE_TO": "07.06.2026 17:29:00",
   "ORIGINAL_DATE_FROM": "***",
   "TZ_FROM": "Europe/Minsk",
   "TZ_TO": "Europe/Minsk",
   "TZ_OFFSET_FROM": "10800",
   "TZ_OFFSET_TO": "10800",
   "DATE_FROM_TS_UTC": "1780828143",
   "DATE_TO_TS_UTC": "1783434540",
   "DT_SKIP_TIME": "N",
   "DT_LENGTH": 3600,
   "EVENT_TYPE": null,
   "CREATED_BY": "1",
   "DATE_CREATE": "06.06.2026 16:29:03",
   "TIMESTAMP_X": "06.06.2026 16:29:03",
   ...
   "EXDATE": "",
   "DAV_XML_ID": "20260607T132900Z-4ad0ccae476463f9000c01ff76a82db3@b24-ar17wx.bitrix24.by",
   "G_EVENT_ID": "",
   "DAV_EXCH_LABEL": "",
   "CAL_DAV_LABEL": "",
   "VERSION": "1",
   ...
   "DATE_FROM_FORMATTED": "Sun Jun 07 2026 16:29:00",
   "DATE_TO_FORMATTED": "Sun Jun 07 2026 17:29:00",
  ...
  },
  {
   ...
   "EVENT_TYPE": null,
   "CREATED_BY": "1",
   "DATE_CREATE": "06.06.2026 16:29:04",
   "TIMESTAMP_X": "06.06.2026 16:29:04",
   "DESCRIPTION": "Описание события",
   "DT_FROM": null,
   "DT_TO": null,
   "PRIVATE_EVENT": "1",
