---
sidebar_position: 4
description:  Получает события календарей с фильтрами или безСтраницы
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ПолучитьСобытияКалендарей \
              ...
              --owner 1 \
              --type "user" \
              --filter "{'from':'2025-05-06T00:41:21.7785713Z','to':'2025-05-07T00:41:21.7785713Z','section':[668,670]}" \
              --token "***"
        ```
    </TabItem>
