    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьСобытиеКалендаря \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'type':'user','ownerId':'1','from':'05/02/2026 15:36:37','to':'05/02/2026 16:36:37','section':'2316','name':'Новое событие','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Описание события','color':'%23000000>','text_color':'%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'05/12/2026 15:36:37'},'is_meeting':'Y','location':'Офис','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'***','allow_invite':'***','hide_guests':'N'}}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1777661137,
  "finish": 1777661137.26411,
  "duration": 0.264111995697022,
  "processing": 0,
  "date_start": "2026-05-01T21:45:37+03:00",
  "date_finish": "2026-05-01T21:45:37+03:00",
  "operating_reset_at": 1777661737,
  "operating": 0.167165040969849
 }
}
```
