    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьСобытиеКалендаря \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'type':'user','ownerId':'1','from':'04/16/2026 05:12:00','to':'04/16/2026 06:12:00','section':'2272','name':'Новое событие','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Описание события','color':'%23000000>','text_color':'%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'04/26/2026 05:12:00'},'is_meeting':'Y','location':'Офис','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'***','allow_invite':'***','hide_guests':'N'}}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1776952803,
  "finish": 1776952804.28198,
  "duration": 1.28198003768921,
  "processing": 0,
  "date_start": "2026-04-23T17:00:03+03:00",
  "date_finish": "2026-04-23T17:00:04+03:00",
  "operating_reset_at": 1776953404,
  "operating": 0.264986991882324
 }
}
```
