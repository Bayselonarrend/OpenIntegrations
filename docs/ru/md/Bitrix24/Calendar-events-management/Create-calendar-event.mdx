    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьСобытиеКалендаря \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'type':'user','ownerId':'1','from':'4/15/2026 12:09:46 AM','to':'4/15/2026 1:09:46 AM','section':'2264','name':'Новое событие','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Описание события','color':'%%23000000>','text_color':'%%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'4/25/2026 12:09:46 AM'},'is_meeting':'Y','location':'Офис','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'***','allow_invite':'***','hide_guests':'N'}}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1776114586,
  "finish": 1776114587.15775,
  "duration": 1.15775299072266,
  "processing": 0,
  "date_start": "2026-04-14T00:09:46+03:00",
  "date_finish": "2026-04-14T00:09:47+03:00",
  "operating_reset_at": 1776115187,
  "operating": 0.154132127761841
 }
}
```
