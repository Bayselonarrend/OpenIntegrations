    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьСобытиеКалендаря \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'type':'user','ownerId':'1','from':'03/26/2026 08:11:55','to':'03/26/2026 09:11:55','section':'2192','name':'Новое событие','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Описание события','color':'%23000000>','text_color':'%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'04/05/2026 08:11:55'},'is_meeting':'Y','location':'Офис','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'***','allow_invite':'***','hide_guests':'N'}}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1775244316,
  "finish": 1775244316.9493,
  "duration": 0.949301958084106,
  "processing": 0,
  "date_start": "2026-04-03T22:25:16+03:00",
  "date_finish": "2026-04-03T22:25:16+03:00",
  "operating_reset_at": 1775244916,
  "operating": 0.138810873031616
 }
}
```
