    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьСобытиеКалендаря \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'type':'user','ownerId':'1','from':'6/12/2026 4:17:18 PM','to':'6/12/2026 5:17:18 PM','section':'2592','name':'Новое событие','skip_time':'N','timezone_from':'Europe/Minsk','timezone_to':'Europe/Minsk','description':'Описание события','color':'%%23000000>','text_color':'%%23FFFFFF','accessibility':'quest','importance':'normal','private_event':'Y','rrule':{'FREQ':'DAILY','COUNT':'3','INTERVAL':'10','BYDAY':['SA','MO'],'UNTIL':'6/22/2026 4:17:18 PM'},'is_meeting':'Y','location':'Офис','remind':[{'type':'day','count':'1'}],'attendees':['1','10'],'host':'1','meeting':{'notify':'Y','reinvite':'***','allow_invite':'***','hide_guests':'N'}}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1781164264,
  "finish": 1781164264.43767,
  "duration": 0.437673091888428,
  "processing": 0,
  "date_start": "2026-06-11T10:51:04+03:00",
  "date_finish": "2026-06-11T10:51:04+03:00",
  "operating_reset_at": 1781164864,
  "operating": 0.168329954147339
 }
}
```
