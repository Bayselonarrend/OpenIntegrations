...
:::tip
Метод в документации API: [tasks.task.add](https://dev.1c-bitrix.ru/rest_help/tasks/task/tasks/tasks_task_add.php)<br/>
<br/>
:::
<br/>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьЗадачу \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'TITLE':'Новая задача','DESCRIPTION':'Новое описание задачи','PRIORITY':'2','DEADLINE':'2024-11-20T20:11:04.9036305Z','RESPONSIBLE_ID':1}" \
              --token "***"
        ```
    </TabItem>
