...
```json title="Результат"
{
 "result": {
  "FILES": {
   "upload43118": {
    ...
    "viewerAttrs": {
     ...
     "actions": "[{\"type\":\"download\"},{\"type\":\"copyToMe\",\"text\":\"Сохранить на Диск\",\"action\":\"BXIM.disk.saveToDiskAction\",\"params\":{\"fileId\":\"43118\"},\"extension\":\"disk.viewer.actions\",\"buttonIconClass\":\"ui-btn-icon-cloud\"}]"
    },
    "mediaUrl": {
     "preview": {
      "250": ""
  ...
  "FILE_MODELS": {
   "upload43118": {
    ...
    "fileId": 28976,
    "size": 24071,
    "etag": "393f78c8fd0548ef862075b6594fb67e",
    "links": {
     "download": "/bitrix/services/main/ajax.php?action=disk.file.download&SITE_ID=s1&fileId=43118",
     "showInGrid": "/bitrix/tools/disk/focus.php?objectId=43118&action=showObjectInGrid&ncc=1"
    }
   }
  },
  "MESSAGE_ID": 61758
 ...
 "time": {
  "start": 1758575739.67241,
  "finish": 1758575739.88931,
  "duration": 0.216897964477539,
  "processing": 0.189741134643555,
  "date_start": "2025-09-23T00:15:39+03:00",
  "date_finish": "2025-09-23T00:15:39+03:00",
  "operating_reset_at": 1758576339,
  "operating": 0.189725875854492
 }
}
```
