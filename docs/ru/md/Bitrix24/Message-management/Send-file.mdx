...
```json title="Результат"
{
 "result": {
  "FILES": {
   "upload43064": {
    ...
    "viewerAttrs": {
     ...
     "actions": "[{\"type\":\"download\"},{\"type\":\"copyToMe\",\"text\":\"Сохранить на Диск\",\"action\":\"BXIM.disk.saveToDiskAction\",\"params\":{\"fileId\":\"43064\"},\"extension\":\"disk.viewer.actions\",\"buttonIconClass\":\"ui-btn-icon-cloud\"}]"
    },
    "mediaUrl": {
     "preview": {
      "250": ""
  ...
  "FILE_MODELS": {
   "upload43064": {
    ...
    "fileId": 28922,
    "size": 24071,
    "etag": "a099d15a2339d9e6fb2039163d08c866",
    "links": {
     "download": "/bitrix/services/main/ajax.php?action=disk.file.download&SITE_ID=s1&fileId=43064",
     "showInGrid": "/bitrix/tools/disk/focus.php?objectId=43064&action=showObjectInGrid&ncc=1"
    }
   }
  },
  "MESSAGE_ID": 61662
 ...
 "time": {
  "start": 1758186836.6476,
  "finish": 1758186836.7128,
  "duration": 0.0651979446411133,
  "processing": 0.039578914642334,
  "date_start": "2025-09-18T12:13:56+03:00",
  "date_finish": "2025-09-18T12:13:56+03:00",
  "operating_reset_at": 1758187436,
  "operating": 0
 }
}
```
