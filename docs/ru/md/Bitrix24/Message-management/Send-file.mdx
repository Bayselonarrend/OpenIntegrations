...
```json title="Результат"
{
 "result": {
  "FILES": {
   "upload46650": {
    ...
    "viewerAttrs": {
     ...
     "actions": "[{\"type\":\"download\"},{\"type\":\"copyToMe\",\"text\":\"Сохранить на Диск\",\"action\":\"BXIM.disk.saveToDiskAction\",\"params\":{\"fileId\":\"46650\"},\"extension\":\"disk.viewer.actions\",\"buttonIconClass\":\"ui-btn-icon-cloud\"}]"
    },
    "mediaUrl": {
     "preview": {
      "250": ""
  ...
  "FILE_MODELS": {
   "upload46650": {
    ...
    "updatedBy": "1",
    "deletedBy": "0",
    "uniqueCode": "jGeIlkfIq1OSSqJyVipe",
    "typeFile": 4,
    "globalContentVersion": 2,
    "fileId": 31498,
    "size": 24071,
    "etag": "240a2d73595a63e1ed4e4333c52b7131",
    "links": {
     "download": "/bitrix/services/main/ajax.php?action=disk.file.download&SITE_ID=s1&fileId=46650",
     "showInGrid": "/bitrix/tools/disk/focus.php?objectId=46650&action=showObjectInGrid&ncc=1"
    }
   }
  },
  "MESSAGE_ID": 67452
 ...
 "time": {
  "start": 1761905790,
  "finish": 1761905790.57207,
  "duration": 0.572067022323608,
  "processing": 0,
  "date_start": "2025-10-31T13:16:30+03:00",
  "date_finish": "2025-10-31T13:16:30+03:00",
  "operating_reset_at": 1761906390,
  "operating": 0
 }
}
```
