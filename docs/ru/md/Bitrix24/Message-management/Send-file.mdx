...
```json title="Результат"
{
 "result": {
  "FILES": {
   "upload41688": {
    ...
    "viewerAttrs": {
     ...
     "actions": "[{\"type\":\"download\"},{\"type\":\"copyToMe\",\"text\":\"Сохранить на Диск\",\"action\":\"BXIM.disk.saveToDiskAction\",\"params\":{\"fileId\":\"41688\"},\"extension\":\"disk.viewer.actions\",\"buttonIconClass\":\"ui-btn-icon-cloud\"}]"
    },
    "mediaUrl": {
     "preview": {
      "250": ""
  ...
  "FILE_MODELS": {
   "upload41688": {
    ...
    "fileId": 27944,
    "size": 24071,
    "etag": "9fa7d50ca09381015211552ccb07fb1c",
    "links": {
     "download": "/bitrix/services/main/ajax.php?action=disk.file.download&SITE_ID=s1&fileId=41688",
     "showInGrid": "/bitrix/tools/disk/focus.php?objectId=41688&action=showObjectInGrid&ncc=1"
    }
   }
  },
  "MESSAGE_ID": 59362
 ...
 "time": {
  "start": 1757443408.68862,
  "finish": 1757443408.74174,
  "duration": 0.0531270503997803,
  "processing": 0.030940055847168,
  "date_start": "2025-09-09T18:43:28+00:00",
  "date_finish": "2025-09-09T18:43:28+00:00",
  "operating_reset_at": 1757444008,
  "operating": 0
 }
}
```
