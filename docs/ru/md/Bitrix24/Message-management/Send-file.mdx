...
```json title="Результат"
{
 "result": {
  "FILES": {
   "upload41904": {
    ...
    "viewerAttrs": {
     ...
     "actions": "[{\"type\":\"download\"},{\"type\":\"copyToMe\",\"text\":\"Сохранить на Диск\",\"action\":\"BXIM.disk.saveToDiskAction\",\"params\":{\"fileId\":\"41904\"},\"extension\":\"disk.viewer.actions\",\"buttonIconClass\":\"ui-btn-icon-cloud\"}]"
    },
    "mediaUrl": {
     "preview": {
      "250": ""
  ...
  "FILE_MODELS": {
   "upload41904": {
    ...
    "fileId": 28096,
    "size": 24071,
    "etag": "23f5650065f370e2eefd959633120d0c",
    "links": {
     "download": "/bitrix/services/main/ajax.php?action=disk.file.download&SITE_ID=s1&fileId=41904",
     "showInGrid": "/bitrix/tools/disk/focus.php?objectId=41904&action=showObjectInGrid&ncc=1"
    }
   }
  },
  "MESSAGE_ID": 59694
 ...
 "time": {
  "start": 1757613120.89615,
  "finish": 1757613120.95034,
  "duration": 0.054192066192627,
  "processing": 0.026472806930542,
  "date_start": "2025-09-11T20:52:00+03:00",
  "date_finish": "2025-09-11T20:52:00+03:00",
  "operating_reset_at": 1757613720,
  "operating": 0
 }
}
```
