    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ДобавитьКомментарийЗадачи \
              ...
              --task "7758" \
              --text "Задача невыполнима, расходимся"
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": 18084,
 "time": {
  "start": 1757323078.45449,
  "finish": 1757323078.68987,
  "duration": 0.235379934310913,
  "processing": 0.205768823623657,
  "date_start": "2025-09-08T09:17:58+00:00",
  "date_finish": "2025-09-08T09:17:58+00:00",
  "operating_reset_at": 1757323678,
  "operating": 0.205746173858643
 }
}
```
