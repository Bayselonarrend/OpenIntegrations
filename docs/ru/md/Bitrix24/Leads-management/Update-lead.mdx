    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ИзменитьЛид \
              --url ""b24-ar17wx.bitrix24.by"" \
              --lead "2474" \
              --fields ""C:\Users\bayse\AppData\Local\Temp\so0aim32.2ed.json"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": true,
 "time": {
  "start": 1758055055.52662,
  "finish": 1758055055.67281,
  "duration": 0.14618706703186,
  "processing": 0.122556924819946,
  "date_start": "2025-09-16T23:37:35+03:00",
  "date_finish": "2025-09-16T23:37:35+03:00",
  "operating_reset_at": 1758055655,
  "operating": 0.122541189193726
 }
}
```
