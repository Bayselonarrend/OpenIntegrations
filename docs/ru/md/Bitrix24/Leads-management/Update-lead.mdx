    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ИзменитьЛид \
              --url ""b24-ar17wx.bitrix24.by"" \
              --lead "2478" \
              --fields ""C:\Users\bayse\AppData\Local\Temp\5r1gqag0.uoz.json"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": true,
 "time": {
  "start": 1758115269.53556,
  "finish": 1758115269.752,
  "duration": 0.216448068618774,
  "processing": 0.191328048706055,
  "date_start": "2025-09-17T16:21:09+03:00",
  "date_finish": "2025-09-17T16:21:09+03:00",
  "operating_reset_at": 1758115869,
  "operating": 0.191301107406616
 }
}
```
