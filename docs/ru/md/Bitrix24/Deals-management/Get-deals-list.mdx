    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьСписокСделок \
              --url ""b24-ar17wx.bitrix24.by"" \
              --filter ""C:\Users\bayse\AppData\Local\Temp\yfsuxobw.wri.json"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "total": 1,
 "time": {
  "start": 1758055088.72677,
  "finish": 1758055088.76984,
  "duration": 0.0430738925933838,
  "processing": 0.0193841457366943,
  "date_start": "2025-09-16T23:38:08+03:00",
  "date_finish": "2025-09-16T23:38:08+03:00",
  "operating_reset_at": 1758055688,
  "operating": 0
 }
}
```
