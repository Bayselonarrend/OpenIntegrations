    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьСписокСделок \
              --url ""b24-ar17wx.bitrix24.by"" \
              --filter ""C:\Users\bayse\AppData\Local\Temp\zwvcc4nq.l15.json"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "total": 1,
 "time": {
  "start": 1758115305.90043,
  "finish": 1758115305.97446,
  "duration": 0.0740242004394531,
  "processing": 0.0442540645599365,
  "date_start": "2025-09-17T16:21:45+03:00",
  "date_finish": "2025-09-17T16:21:45+03:00",
  "operating_reset_at": 1758115905,
  "operating": 0
 }
}
```
