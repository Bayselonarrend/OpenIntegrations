    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ИзменитьСделку \
              --url ""b24-ar17wx.bitrix24.by"" \
              --deal "4934" \
              --fields ""C:\Users\bayse\AppData\Local\Temp\zoq20kjx.nrf.json"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": true,
 "time": {
  "start": 1758055080.37855,
  "finish": 1758055080.65185,
  "duration": 0.27330207824707,
  "processing": 0.245045185089111,
  "date_start": "2025-09-16T23:38:00+03:00",
  "date_finish": "2025-09-16T23:38:00+03:00",
  "operating_reset_at": 1758055680,
  "operating": 0.245022058486938
 }
}
```
