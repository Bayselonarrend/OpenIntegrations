    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'3f661af2-737e-4f7d-921d-cdb7fdd15916@mail.org','NAME':'Виталий','LAST_NAME':'Альпака','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1780752495,
  "finish": 1780752497.1532,
  "duration": 2.1531970500946,
  "processing": 2,
  "date_start": "2026-06-06T16:28:15+03:00",
  "date_finish": "2026-06-06T16:28:17+03:00",
  "operating_reset_at": 1780753095,
  "operating": 1.2032151222229
 }
}
```
