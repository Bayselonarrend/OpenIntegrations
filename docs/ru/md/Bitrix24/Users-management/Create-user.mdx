    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'2f0850ba-55c7-49f5-bdbf-80f6b7f0cbb6@mail.org','NAME':'Виталий','LAST_NAME':'Альпака','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1780781278,
  "finish": 1780781279.45582,
  "duration": 1.45582008361816,
  "processing": 1,
  "date_start": "2026-06-07T00:27:58+03:00",
  "date_finish": "2026-06-07T00:27:59+03:00",
  "operating_reset_at": 1780781878,
  "operating": 1.23874306678772
 }
}
```
