    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'582b9913-ee06-41c6-a75e-0aaae4eebaa7@mail.org','NAME':'Виталий','LAST_NAME':'Альпака','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1784488624,
  "finish": 1784488626.17046,
  "duration": 2.17045593261719,
  "processing": 2,
  "date_start": "2026-07-19T22:17:04+03:00",
  "date_finish": "2026-07-19T22:17:06+03:00",
  "operating_reset_at": 1784489224,
  "operating": 1.36016201972961
 }
}
```
