    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'26157bc4-874e-4f4b-a843-611e92ffa38f@example.org','NAME':'Виталий','LAST_NAME':'Альпака','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1776952777,
  "finish": 1776952780.28645,
  "duration": 3.28645205497742,
  "processing": 3,
  "date_start": "2026-04-23T16:59:37+03:00",
  "date_finish": "2026-04-23T16:59:40+03:00",
  "operating_reset_at": 1776953377,
  "operating": 2.29530000686646
 }
}
```
