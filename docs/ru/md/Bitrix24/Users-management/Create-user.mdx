    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'8998b228-6ef8-4260-aae7-5e88eae7c10a@mail.org','NAME':'Виталий','LAST_NAME':'Альпака','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1780767122,
  "finish": 1780767123.70788,
  "duration": 1.70787811279297,
  "processing": 1,
  "date_start": "2026-06-06T20:32:02+03:00",
  "date_finish": "2026-06-06T20:32:03+03:00",
  "operating_reset_at": 1780767722,
  "operating": 1.2147970199585
 }
}
```
