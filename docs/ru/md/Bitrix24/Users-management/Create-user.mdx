    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'71e1c1c5-e431-49de-8d6f-14b812f0bdbb@example.org','NAME':'Виталий','LAST_NAME':'Альпака','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1776114537,
  "finish": 1776114539.53107,
  "duration": 2.53106689453125,
  "processing": 2,
  "date_start": "2026-04-14T00:08:57+03:00",
  "date_finish": "2026-04-14T00:08:59+03:00",
  "operating_reset_at": 1776115137,
  "operating": 2.16240692138672
 }
}
```
