    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'c146479b-cdb4-4575-8add-d1563f9e48d3@mail.org','NAME':'Виталий','LAST_NAME':'Альпака','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1781531716,
  "finish": 1781531717.68746,
  "duration": 1.68746209144592,
  "processing": 1,
  "date_start": "2026-06-15T16:55:16+03:00",
  "date_finish": "2026-06-15T16:55:17+03:00",
  "operating_reset_at": 1781532316,
  "operating": 1.31582021713257
 }
}
```
