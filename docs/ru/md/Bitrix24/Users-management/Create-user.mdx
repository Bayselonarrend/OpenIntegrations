    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'a542a84e-1829-428b-86d4-62a2705b5317@example.org','NAME':'Виталий','LAST_NAME':'Альпака','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1777661111,
  "finish": 1777661114.00662,
  "duration": 3.0066180229187,
  "processing": 3,
  "date_start": "2026-05-01T21:45:11+03:00",
  "date_finish": "2026-05-01T21:45:14+03:00",
  "operating_reset_at": 1777661711,
  "operating": 2.18684196472168
 }
}
```
