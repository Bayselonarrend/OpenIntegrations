    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'364ab7b4-4fb4-43e3-aade-9b7a49a140c8@example.org','NAME':'Виталий','LAST_NAME':'Альпака','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1777714692,
  "finish": 1777714694.27551,
  "duration": 2.27551007270813,
  "processing": 2,
  "date_start": "2026-05-02T09:38:12+00:00",
  "date_finish": "2026-05-02T09:38:14+00:00",
  "operating_reset_at": 1777715292,
  "operating": 4.30967879295349
 }
}
```
