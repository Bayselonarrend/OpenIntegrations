    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'69a8e428-17f7-4d7a-a3c4-d5fa062dfc82@mail.org','NAME':'Виталий','LAST_NAME':'Альпака','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1784138116,
  "finish": 1784138118.17176,
  "duration": 2.17176508903503,
  "processing": 2,
  "date_start": "2026-07-15T17:55:16+00:00",
  "date_finish": "2026-07-15T17:55:18+00:00",
  "operating_reset_at": 1784138716,
  "operating": 1.28353714942932
 }
}
```
