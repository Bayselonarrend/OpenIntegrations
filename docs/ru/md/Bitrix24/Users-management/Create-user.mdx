    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'056b5b3f-77a8-4057-a69a-67e7f58f8f5a@mail.org','NAME':'Виталий','LAST_NAME':'Альпака','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1782762964,
  "finish": 1782762966.23153,
  "duration": 2.23153305053711,
  "processing": 2,
  "date_start": "2026-06-29T22:56:04+03:00",
  "date_finish": "2026-06-29T22:56:06+03:00",
  "operating_reset_at": 1782763564,
  "operating": 1.41544103622437
 }
}
```
