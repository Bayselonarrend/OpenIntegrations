    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'3222a6ac-1820-4603-ad3f-00a937cabe2a@example.org','NAME':'Виталий','LAST_NAME':'Альпака','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1777298515,
  "finish": 1777298517.41049,
  "duration": 2.41049194335938,
  "processing": 2,
  "date_start": "2026-04-27T14:01:55+00:00",
  "date_finish": "2026-04-27T14:01:57+00:00",
  "operating_reset_at": 1777299115,
  "operating": 2.34217715263367
 }
}
```
