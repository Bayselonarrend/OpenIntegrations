    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'5b306911-cb46-4889-94e4-617220d7e33b@mail.org','NAME':'Виталий','LAST_NAME':'Альпака','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1781164238,
  "finish": 1781164240.36762,
  "duration": 2.36762309074402,
  "processing": 1,
  "date_start": "2026-06-11T10:50:38+03:00",
  "date_finish": "2026-06-11T10:50:40+03:00",
  "operating_reset_at": 1781164839,
  "operating": 1.36495113372803
 }
}
```
