    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'bf5d8f41-6b31-40f7-9ae2-d6ba025b9e42@mail.org','NAME':'Виталий','LAST_NAME':'Альпака','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1784360411,
  "finish": 1784360412.3808,
  "duration": 1.38080191612244,
  "processing": 1,
  "date_start": "2026-07-18T10:40:11+03:00",
  "date_finish": "2026-07-18T10:40:12+03:00",
  "operating_reset_at": 1784361011,
  "operating": 1.35726881027222
 }
}
```
