    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'EMAIL':'9b049b41-a659-46ce-9688-773ef2efdf35@example.org','NAME':'Виталий','LAST_NAME':'Альпака','PERSONAL_MOBILE':'88003553535','UF_DEPARTMENT':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1775627987,
  "finish": 1775627990.3122,
  "duration": 3.31219696998596,
  "processing": 3,
  "date_start": "2026-04-08T08:59:47+03:00",
  "date_finish": "2026-04-08T08:59:50+03:00",
  "operating_reset_at": 1775628587,
  "operating": 2.34248995780945
 }
}
```
