    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3842 \
              --fields "{'EMAIL':'6613e20d-1c27-4adb-93c4-38bde3716cd3@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1780767127,
  "finish": 1780767128.27179,
  "duration": 1.27179193496704,
  "processing": 1,
  "date_start": "2026-06-06T20:32:07+03:00",
  "date_finish": "2026-06-06T20:32:08+03:00",
  "operating_reset_at": 1780767727,
  "operating": 0.381788015365601
 }
}
```
