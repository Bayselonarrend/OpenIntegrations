    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3572 \
              --fields "{'EMAIL':'882badf9-8c93-4ca5-833f-22c92de4362c@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1776114543,
  "finish": 1776114543.7132,
  "duration": 0.713200092315674,
  "processing": 0,
  "date_start": "2026-04-14T00:09:03+03:00",
  "date_finish": "2026-04-14T00:09:03+03:00",
  "operating_reset_at": 1776115143,
  "operating": 0.197157144546509
 }
}
```
