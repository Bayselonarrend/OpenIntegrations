    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3790 \
              --fields "{'EMAIL':'0b4a4736-78a3-42e5-8305-84c7e2768870@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1780546290,
  "finish": 1780546290.55654,
  "duration": 0.556535005569458,
  "processing": 0,
  "date_start": "2026-06-04T07:11:30+03:00",
  "date_finish": "2026-06-04T07:11:30+03:00",
  "operating_reset_at": 1780546890,
  "operating": 0.360451936721802
 }
}
```
