    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 4218 \
              --fields "{'EMAIL':'a4f3589f-791a-4b38-9cf9-57f0b9350b15@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1784360415,
  "finish": 1784360415.8347,
  "duration": 0.834697961807251,
  "processing": 0,
  "date_start": "2026-07-18T10:40:15+03:00",
  "date_finish": "2026-07-18T10:40:15+03:00",
  "operating_reset_at": 1784361015,
  "operating": 0.345548152923584
 }
}
```
