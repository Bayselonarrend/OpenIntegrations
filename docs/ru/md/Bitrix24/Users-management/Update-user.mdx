    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3850 \
              --fields "{'EMAIL':'f31f707b-665f-4401-9dfe-eda3a3a47d58@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1780781283,
  "finish": 1780781283.79617,
  "duration": 0.796174049377441,
  "processing": 0,
  "date_start": "2026-06-07T00:28:03+03:00",
  "date_finish": "2026-06-07T00:28:03+03:00",
  "operating_reset_at": 1780781883,
  "operating": 0.353085994720459
 }
}
```
