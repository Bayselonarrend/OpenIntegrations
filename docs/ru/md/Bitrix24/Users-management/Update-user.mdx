    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 4338 \
              --fields "{'EMAIL':'93513b0f-d5b6-4978-8ddd-a303387093ae@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1784488629,
  "finish": 1784488629.63388,
  "duration": 0.633877038955688,
  "processing": 0,
  "date_start": "2026-07-19T22:17:09+03:00",
  "date_finish": "2026-07-19T22:17:09+03:00",
  "operating_reset_at": 1784489229,
  "operating": 0.368582963943481
 }
}
```
