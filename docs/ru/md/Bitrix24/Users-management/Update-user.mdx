    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3564 \
              --fields "{'EMAIL':'9c943ece-0675-459b-80c3-e723df455389@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1775627994,
  "finish": 1775627994.85623,
  "duration": 0.856226921081543,
  "processing": 0,
  "date_start": "2026-04-08T08:59:54+03:00",
  "date_finish": "2026-04-08T08:59:54+03:00",
  "operating_reset_at": 1775628594,
  "operating": 0.20464015007019
 }
}
```
