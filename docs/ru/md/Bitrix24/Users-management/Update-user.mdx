    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3894 \
              --fields "{'EMAIL':'277d4fbb-6443-4674-a279-16f6fd1d46a8@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1781521612,
  "finish": 1781521612.65002,
  "duration": 0.650021076202393,
  "processing": 0,
  "date_start": "2026-06-15T14:06:52+03:00",
  "date_finish": "2026-06-15T14:06:52+03:00",
  "operating_reset_at": 1781522212,
  "operating": 0.383018970489502
 }
}
```
