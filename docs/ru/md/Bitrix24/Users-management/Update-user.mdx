    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 4166 \
              --fields "{'EMAIL':'87096f96-a604-46b1-9e3e-a925e5f2d23b@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1784138121,
  "finish": 1784138121.68613,
  "duration": 0.686132907867432,
  "processing": 0,
  "date_start": "2026-07-15T17:55:21+00:00",
  "date_finish": "2026-07-15T17:55:21+00:00",
  "operating_reset_at": 1784138721,
  "operating": 0.371847152709961
 }
}
```
