    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3636 \
              --fields "{'EMAIL':'f2a86ff2-b845-43b9-bcc0-da04582a0204@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1777714695,
  "finish": 1777714695.90714,
  "duration": 0.907135009765625,
  "processing": 0,
  "date_start": "2026-05-02T09:38:15+00:00",
  "date_finish": "2026-05-02T09:38:15+00:00",
  "operating_reset_at": 1777715295,
  "operating": 0.518186807632446
 }
}
```
