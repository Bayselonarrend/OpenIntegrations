    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3874 \
              --fields "{'EMAIL':'ca5e3a3f-327c-4c3f-91b0-9848cc21c0b5@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1780948439,
  "finish": 1780948440.09666,
  "duration": 1.09666204452515,
  "processing": 1,
  "date_start": "2026-06-08T22:53:59+03:00",
  "date_finish": "2026-06-08T22:54:00+03:00",
  "operating_reset_at": 1780949039,
  "operating": 0.315467834472656
 }
}
```
