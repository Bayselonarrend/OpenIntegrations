    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 4126 \
              --fields "{'EMAIL':'dd12ea3f-6194-488e-9829-d22f8c8809b5@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1781807059,
  "finish": 1781807059.47219,
  "duration": 0.472186088562012,
  "processing": 0,
  "date_start": "2026-06-18T18:24:19+00:00",
  "date_finish": "2026-06-18T18:24:19+00:00",
  "operating_reset_at": 1781807659,
  "operating": 0.359271049499512
 }
}
```
