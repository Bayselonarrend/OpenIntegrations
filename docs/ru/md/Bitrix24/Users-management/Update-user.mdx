    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3918 \
              --fields "{'EMAIL':'4a90faa9-0619-4347-9ff7-1405cf7c860b@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1781548897,
  "finish": 1781548897.51828,
  "duration": 0.518280029296875,
  "processing": 0,
  "date_start": "2026-06-15T18:41:37+00:00",
  "date_finish": "2026-06-15T18:41:37+00:00",
  "operating_reset_at": 1781549497,
  "operating": 0.344451904296875
 }
}
```
