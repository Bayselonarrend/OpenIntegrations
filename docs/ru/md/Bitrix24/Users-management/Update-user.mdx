    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3890 \
              --fields "{'EMAIL':'30494011-62c1-453a-95d3-333f1599d53a@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1781164242,
  "finish": 1781164242.58874,
  "duration": 0.5887451171875,
  "processing": 0,
  "date_start": "2026-06-11T10:50:42+03:00",
  "date_finish": "2026-06-11T10:50:42+03:00",
  "operating_reset_at": 1781164842,
  "operating": 0.424057006835938
 }
}
```
