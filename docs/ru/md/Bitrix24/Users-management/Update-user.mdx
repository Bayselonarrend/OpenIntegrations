    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3838 \
              --fields "{'EMAIL':'ea18078e-890a-4171-8626-8cd78a5c88ad@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1780752501,
  "finish": 1780752501.567,
  "duration": 0.567002058029175,
  "processing": 0,
  "date_start": "2026-06-06T16:28:21+03:00",
  "date_finish": "2026-06-06T16:28:21+03:00",
  "operating_reset_at": 1780753101,
  "operating": 0.365640878677368
 }
}
```
