    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3858 \
              --fields "{'EMAIL':'2336c26f-e166-438d-9abe-63de8140726b@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1780930668,
  "finish": 1780930668.53458,
  "duration": 0.534584999084473,
  "processing": 0,
  "date_start": "2026-06-08T17:57:48+03:00",
  "date_finish": "2026-06-08T17:57:48+03:00",
  "operating_reset_at": 1780931268,
  "operating": 0.332774877548218
 }
}
```
