    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3608 \
              --fields "{'EMAIL':'cecb8e91-cb4c-41bb-b62f-52cc74d9a6b6@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1777298521,
  "finish": 1777298521.37033,
  "duration": 0.370328903198242,
  "processing": 0,
  "date_start": "2026-04-27T14:02:01+00:00",
  "date_finish": "2026-04-27T14:02:01+00:00",
  "operating_reset_at": 1777299121,
  "operating": 0.237758874893188
 }
}
```
