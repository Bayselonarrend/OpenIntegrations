    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3568 \
              --fields "{'EMAIL':'0caa5b45-c622-4f5b-a15a-ce43c29e7113@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1776029077,
  "finish": 1776029077.77349,
  "duration": 0.773489952087402,
  "processing": 0,
  "date_start": "2026-04-13T00:24:37+03:00",
  "date_finish": "2026-04-13T00:24:37+03:00",
  "operating_reset_at": 1776029677,
  "operating": 0.197827100753784
 }
}
```
