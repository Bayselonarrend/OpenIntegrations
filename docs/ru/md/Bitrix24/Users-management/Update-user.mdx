    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 ИзменитьПользователя \
              --url "b24-ar17wx.bitrix24.by" \
              --userid 3624 \
              --fields "{'EMAIL':'ebcd2285-48bb-4a93-8be4-8ff525d95585@example.org','NAME':'Олег','LAST_NAME':'Лама','UF_DEPARTMENT':'7'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1777661115,
  "finish": 1777661115.77994,
  "duration": 0.779936075210571,
  "processing": 0,
  "date_start": "2026-05-01T21:45:15+03:00",
  "date_finish": "2026-05-01T21:45:15+03:00",
  "operating_reset_at": 1777661715,
  "operating": 0.213196992874146
 }
}
```
