    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьЗадачу \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'TITLE':'Новая задача','DESCRIPTION':'Новое описание задачи','PRIORITY':'2','DEADLINE':'12/7/2025 8:24:41 PM','RESPONSIBLE_ID':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": {
  "task": {
   ...
   "responsibleId": "1",
   "changedBy": "1",
   "changedDate": "2025-12-06T20:24:46+03:00",
   ...
   "status": "2",
   "statusChangedDate": "2025-12-06T20:24:46+03:00",
   "durationPlan": null,
   "durationType": "days",
   "favorite": "N",
   "groupId": "0",
 ...
 "time": {
  "start": 1765041886,
  "finish": 1765041886.29419,
  "duration": 0.29419207572937,
  "processing": 0,
  "date_start": "2025-12-06T20:24:46+03:00",
  "date_finish": "2025-12-06T20:24:46+03:00",
  "operating_reset_at": 1765042486,
  "operating": 0.120076894760132
 }
}
```
