    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьЗадачу \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'TITLE':'Новая задача','DESCRIPTION':'Новое описание задачи','PRIORITY':'2','DEADLINE':'10/30/2025 17:31:56','RESPONSIBLE_ID':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": {
  "task": {
   ...
   "responsibleId": "1",
   "changedBy": "1",
   "changedDate": "2025-10-29T17:32:01+00:00",
   ...
   "status": "2",
   "statusChangedDate": "2025-10-29T17:32:01+00:00",
   "durationPlan": null,
   "durationType": "days",
   "favorite": "N",
   "groupId": "0",
 ...
 "time": {
  "start": 1761759121,
  "finish": 1761759121.411,
  "duration": 0.410995960235596,
  "processing": 0,
  "date_start": "2025-10-29T17:32:01+00:00",
  "date_finish": "2025-10-29T17:32:01+00:00",
  "operating_reset_at": 1761759721,
  "operating": 0.139169216156006
 }
}
```
