    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 СоздатьЗадачу \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'TITLE':'Новая задача','DESCRIPTION':'Новое описание задачи','PRIORITY':'2','DEADLINE':'09/10/2025 18:30:11','RESPONSIBLE_ID':'1'}" \
              --token ***
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": {
  "task": {
   ...
   "responsibleId": "1",
   "changedBy": "1",
   "changedDate": "2025-09-09T18:30:16+00:00",
   ...
   "status": "2",
   "statusChangedDate": "2025-09-09T18:30:16+00:00",
   "durationPlan": null,
   "durationType": "days",
   "favorite": "N",
   "groupId": "0",
 ...
 "time": {
  "start": 1757442616.48558,
  "finish": 1757442616.68942,
  "duration": 0.203836917877197,
  "processing": 0.181195974349976,
  "date_start": "2025-09-09T18:30:16+00:00",
  "date_finish": "2025-09-09T18:30:16+00:00",
  "operating_reset_at": 1757443216,
  "operating": 0.18116283416748
 }
}
```
