    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьЗадачу \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'TITLE':'Новая задача','DESCRIPTION':'Новое описание задачи','PRIORITY':'2','DEADLINE':'10/08/2025 19:02:40','RESPONSIBLE_ID':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": {
  "task": {
   ...
   "responsibleId": "1",
   "changedBy": "1",
   "changedDate": "2025-10-07T23:57:00+03:00",
   ...
   "status": "2",
   "statusChangedDate": "2025-10-07T23:57:00+03:00",
   "durationPlan": null,
   "durationType": "days",
   "favorite": "N",
   "groupId": "0",
 ...
 "time": {
  "start": 1759870620,
  "finish": 1759870620.72278,
  "duration": 0.722784042358398,
  "processing": 0,
  "date_start": "2025-10-07T23:57:00+03:00",
  "date_finish": "2025-10-07T23:57:00+03:00",
  "operating_reset_at": 1759871220,
  "operating": 0.120179891586304
 }
}
```
