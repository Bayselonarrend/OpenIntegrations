    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьЗадачу \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'TITLE':'Новая задача','DESCRIPTION':'Новое описание задачи','PRIORITY':'2','DEADLINE':'12/8/2025 10:42:28 PM','RESPONSIBLE_ID':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": {
  "task": {
   ...
   "responsibleId": "1",
   "changedBy": "1",
   "changedDate": "2025-12-07T22:42:32+03:00",
   ...
   "status": "2",
   "statusChangedDate": "2025-12-07T22:42:32+03:00",
   "durationPlan": null,
   "durationType": "days",
   "favorite": "N",
   "groupId": "0",
 ...
 "time": {
  "start": 1765136552,
  "finish": 1765136552.95026,
  "duration": 0.950254917144775,
  "processing": 0,
  "date_start": "2025-12-07T22:42:32+03:00",
  "date_finish": "2025-12-07T22:42:32+03:00",
  "operating_reset_at": 1765137152,
  "operating": 0.147408008575439
 }
}
```
