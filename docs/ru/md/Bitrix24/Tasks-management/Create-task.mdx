    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьЗадачу \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'TITLE':'Новая задача','DESCRIPTION':'Новое описание задачи','PRIORITY':'2','DEADLINE':'10/11/2025 09:59:46','RESPONSIBLE_ID':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": {
  "task": {
   ...
   "responsibleId": "1",
   "changedBy": "1",
   "changedDate": "2025-10-10T09:59:52+00:00",
   ...
   "status": "2",
   "statusChangedDate": "2025-10-10T09:59:52+00:00",
   "durationPlan": null,
   "durationType": "days",
   "favorite": "N",
   "groupId": "0",
 ...
 "time": {
  "start": 1760090392,
  "finish": 1760090393.04297,
  "duration": 1.04297304153442,
  "processing": 1,
  "date_start": "2025-10-10T09:59:52+00:00",
  "date_finish": "2025-10-10T09:59:53+00:00",
  "operating_reset_at": 1760090992,
  "operating": 0.133959054946899
 }
}
```
