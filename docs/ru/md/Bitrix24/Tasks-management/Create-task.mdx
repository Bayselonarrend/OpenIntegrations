    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьЗадачу \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'TITLE':'Новая задача','DESCRIPTION':'Новое описание задачи','PRIORITY':'2','DEADLINE':'10/9/2025 1:52:32 PM','RESPONSIBLE_ID':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": {
  "task": {
   ...
   "responsibleId": "1",
   "changedBy": "1",
   "changedDate": "2025-10-09T17:22:37+00:00",
   ...
   "status": "2",
   "statusChangedDate": "2025-10-09T17:22:37+00:00",
   "durationPlan": null,
   "durationType": "days",
   "favorite": "N",
   "groupId": "0",
 ...
 "time": {
  "start": 1760030557,
  "finish": 1760030557.76067,
  "duration": 0.760668039321899,
  "processing": 0,
  "date_start": "2025-10-09T17:22:37+00:00",
  "date_finish": "2025-10-09T17:22:37+00:00",
  "operating_reset_at": 1760031157,
  "operating": 0.115469932556152
 }
}
```
