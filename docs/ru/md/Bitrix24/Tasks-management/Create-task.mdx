    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint bitrix24 СоздатьЗадачу \
              --url "b24-ar17wx.bitrix24.by" \
              --fields "{'TITLE':'Новая задача','DESCRIPTION':'Новое описание задачи','PRIORITY':'2','DEADLINE':'10/15/2025 14:29:24','RESPONSIBLE_ID':'1'}" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": {
  "task": {
   ...
   "responsibleId": "1",
   "changedBy": "1",
   "changedDate": "2025-10-25T14:21:18+00:00",
   ...
   "status": "2",
   "statusChangedDate": "2025-10-25T14:21:18+00:00",
   "durationPlan": null,
   "durationType": "days",
   "favorite": "N",
   "groupId": "0",
 ...
 "time": {
  "start": 1761402078,
  "finish": 1761402078.76766,
  "duration": 0.767656087875366,
  "processing": 0,
  "date_start": "2025-10-25T14:21:18+00:00",
  "date_finish": "2025-10-25T14:21:18+00:00",
  "operating_reset_at": 1761402678,
  "operating": 0.111692190170288
 }
}
```
