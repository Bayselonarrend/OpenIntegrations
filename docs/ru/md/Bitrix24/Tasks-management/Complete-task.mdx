...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Токен    = "2b185168006e9f06006b12e400000001000...";
    IDЗадачи = "6342";
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1728409725.56009,
  "finish": 1728409725.94625,
  "duration": 0.386157989501953,
  "processing": 0.35835599899292,
  "date_start": "2024-10-08T20:48:45+03:00",
  "date_finish": "2024-10-08T20:48:45+03:00",
  "operating_reset_at": 1728410325,
  "operating": 0.358325958251953
 }
}
```
