...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Картинка = "https://releases.openintegrations.dev/test_data/picture2.jpg";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ИзменитьКартинкуЧата \
              --url "b24-ar17wx.bitrix24.by" \
              --chat "***" \
              --picture "https://releases.openintegrations.dev/test_data/picture2.jpg" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1784488552,
  "finish": 1784488553.12742,
  "duration": 1.12742209434509,
  "processing": 1,
  "date_start": "2026-07-19T22:15:52+03:00",
  "date_finish": "2026-07-19T22:15:53+03:00",
  "operating_reset_at": 1784489152,
  "operating": 0.813817977905274
 }
}
```
