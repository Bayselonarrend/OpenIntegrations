    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-05-02T08:18:20" \
              --to "2026-05-09T08:18:20" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1777714720,
  "finish": 1777714720.29217,
  "duration": 0.292167901992798,
  "processing": 0,
  "date_start": "2026-05-02T09:38:40+00:00",
  "date_finish": "2026-05-02T09:38:40+00:00",
  "operating_reset_at": 1777715320,
  "operating": 0
 }
}
```
