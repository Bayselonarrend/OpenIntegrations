    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-06-08T16:20:45" \
              --to "2026-06-15T16:20:45" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1780930695,
  "finish": 1780930695.27197,
  "duration": 0.271972894668579,
  "processing": 0,
  "date_start": "2026-06-08T17:58:15+03:00",
  "date_finish": "2026-06-08T17:58:15+03:00",
  "operating_reset_at": 1780931295,
  "operating": 0
 }
}
```
