    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-02-03T12:55:27" \
              --to "2026-02-10T12:55:27" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1770112531,
  "finish": 1770112531.19192,
  "duration": 0.191920042037964,
  "processing": 0,
  "date_start": "2026-02-03T12:55:31+03:00",
  "date_finish": "2026-02-03T12:55:31+03:00",
  "operating_reset_at": 1770113131,
  "operating": 0
 }
}
```
