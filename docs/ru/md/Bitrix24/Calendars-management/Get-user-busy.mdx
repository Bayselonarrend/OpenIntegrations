    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-02-15T20:56:22" \
              --to "2026-02-22T20:56:22" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1771428357,
  "finish": 1771428357.7276,
  "duration": 0.727596998214722,
  "processing": 0,
  "date_start": "2026-02-18T15:25:57+00:00",
  "date_finish": "2026-02-18T15:25:57+00:00",
  "operating_reset_at": 1771428957,
  "operating": 0
 }
}
```
