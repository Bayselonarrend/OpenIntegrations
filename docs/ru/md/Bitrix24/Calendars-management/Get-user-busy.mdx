    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-01-03T19:56:05.6450421" \
              --to "2026-01-10T19:56:05.6450421" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1767470171,
  "finish": 1767470171.57122,
  "duration": 0.571223974227905,
  "processing": 0,
  "date_start": "2026-01-03T19:56:11+00:00",
  "date_finish": "2026-01-03T19:56:11+00:00",
  "operating_reset_at": 1767470771,
  "operating": 0
 }
}
```
