    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url ""b24-ar17wx.bitrix24.by"" \
              --users "1" \
              --from ""2025-09-16T05:09:09.1941618"" \
              --to ""2025-09-23T05:09:09.1941618"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1757999353.54202,
  "finish": 1757999353.58492,
  "duration": 0.0428988933563232,
  "processing": 0.0175669193267822,
  "date_start": "2025-09-16T05:09:13+00:00",
  "date_finish": "2025-09-16T05:09:13+00:00",
  "operating_reset_at": 1757999953,
  "operating": 0
 }
}
```
