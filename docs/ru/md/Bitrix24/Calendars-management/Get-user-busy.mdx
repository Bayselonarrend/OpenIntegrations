    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url ""b24-ar17wx.bitrix24.by"" \
              --users "1" \
              --from ""2025-09-17T16:22:27.3435311"" \
              --to ""2025-09-24T16:22:27.3435311"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1758115350.55178,
  "finish": 1758115350.59941,
  "duration": 0.0476288795471191,
  "processing": 0.0148959159851074,
  "date_start": "2025-09-17T16:22:30+03:00",
  "date_finish": "2025-09-17T16:22:30+03:00",
  "operating_reset_at": 1758115950,
  "operating": 0
 }
}
```
