    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2025-09-08T13:47:22.8194731" \
              --to "2025-09-15T13:47:22.8194731" \
              --token ***
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1757339247.17447,
  "finish": 1757339247.22563,
  "duration": 0.0511589050292969,
  "processing": 0.0144619941711426,
  "date_start": "2025-09-08T13:47:27+00:00",
  "date_finish": "2025-09-08T13:47:27+00:00",
  "operating_reset_at": 1757339847,
  "operating": 0
 }
}
```
