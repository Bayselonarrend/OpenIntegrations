    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-02-03T23:22:42" \
              --to "2026-02-10T23:22:42" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1770150165,
  "finish": 1770150165.62118,
  "duration": 0.621182918548584,
  "processing": 0,
  "date_start": "2026-02-03T23:22:45+03:00",
  "date_finish": "2026-02-03T23:22:45+03:00",
  "operating_reset_at": 1770150765,
  "operating": 0
 }
}
```
