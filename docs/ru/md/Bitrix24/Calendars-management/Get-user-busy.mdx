    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2025-09-09T18:51:16.6549889" \
              --to "2025-09-16T18:51:16.6549889" \
              --token ***
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1757443882.93448,
  "finish": 1757443882.97074,
  "duration": 0.0362610816955566,
  "processing": 0.0118119716644287,
  "date_start": "2025-09-09T18:51:22+00:00",
  "date_finish": "2025-09-09T18:51:22+00:00",
  "operating_reset_at": 1757444482,
  "operating": 0
 }
}
```
