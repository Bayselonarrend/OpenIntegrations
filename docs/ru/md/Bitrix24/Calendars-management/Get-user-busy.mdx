    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-06-07T15:57:26" \
              --to "2026-06-14T15:57:26" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1780781340,
  "finish": 1780781340.43956,
  "duration": 0.439559936523438,
  "processing": 0,
  "date_start": "2026-06-07T00:29:00+03:00",
  "date_finish": "2026-06-07T00:29:00+03:00",
  "operating_reset_at": 1780781940,
  "operating": 0
 }
}
```
