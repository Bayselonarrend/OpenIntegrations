    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-01-31T18:20:28.5887014" \
              --to "2026-02-07T18:20:28.5887014" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1769872832,
  "finish": 1769872832.22369,
  "duration": 0.22368597984314,
  "processing": 0,
  "date_start": "2026-01-31T18:20:32+03:00",
  "date_finish": "2026-01-31T18:20:32+03:00",
  "operating_reset_at": 1769873432,
  "operating": 0
 }
}
```
