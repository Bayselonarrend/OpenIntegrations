    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2025-12-06T20:38:29.687418" \
              --to "2025-12-13T20:38:29.687418" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1765042713,
  "finish": 1765042713.65262,
  "duration": 0.652620077133179,
  "processing": 0,
  "date_start": "2025-12-06T20:38:33+03:00",
  "date_finish": "2025-12-06T20:38:33+03:00",
  "operating_reset_at": 1765043313,
  "operating": 0
 }
}
```
