    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-04-27T14:02:56" \
              --to "2026-05-04T14:02:56" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1777298577,
  "finish": 1777298577.5585,
  "duration": 0.558502912521362,
  "processing": 0,
  "date_start": "2026-04-27T14:02:57+00:00",
  "date_finish": "2026-04-27T14:02:57+00:00",
  "operating_reset_at": 1777299177,
  "operating": 0
 }
}
```
