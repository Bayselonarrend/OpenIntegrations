    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-05-26T17:58:09" \
              --to "2026-06-02T17:58:09" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1780546316,
  "finish": 1780546316.29355,
  "duration": 0.293545961380005,
  "processing": 0,
  "date_start": "2026-06-04T07:11:56+03:00",
  "date_finish": "2026-06-04T07:11:56+03:00",
  "operating_reset_at": 1780546916,
  "operating": 0
 }
}
```
