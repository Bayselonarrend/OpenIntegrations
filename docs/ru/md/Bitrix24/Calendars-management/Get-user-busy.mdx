    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2025-09-18T12:17:42.4734195" \
              --to "2025-09-25T12:17:42.4734195" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1758187066.71797,
  "finish": 1758187066.76147,
  "duration": 0.0434970855712891,
  "processing": 0.0176980495452881,
  "date_start": "2025-09-18T12:17:46+03:00",
  "date_finish": "2025-09-18T12:17:46+03:00",
  "operating_reset_at": 1758187666,
  "operating": 0
 }
}
```
