    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2025-10-10T10:16:40.4039199" \
              --to "2025-10-17T10:16:40.4039199" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1760091404,
  "finish": 1760091404.68815,
  "duration": 0.688148975372314,
  "processing": 0,
  "date_start": "2025-10-10T10:16:44+00:00",
  "date_finish": "2025-10-10T10:16:44+00:00",
  "operating_reset_at": 1760092004,
  "operating": 0
 }
}
```
