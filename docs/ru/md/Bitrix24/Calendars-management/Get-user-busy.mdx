    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-04-06T22:03:51" \
              --to "2026-04-13T22:03:51" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1775507477,
  "finish": 1775507477.65604,
  "duration": 0.656035900115967,
  "processing": 0,
  "date_start": "2026-04-06T23:31:17+03:00",
  "date_finish": "2026-04-06T23:31:17+03:00",
  "operating_reset_at": 1775508077,
  "operating": 0
 }
}
```
