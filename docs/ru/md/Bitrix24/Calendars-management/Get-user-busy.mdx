    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-06-18T19:16:13" \
              --to "2026-06-25T19:16:13" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1782582220,
  "finish": 1782582220.31299,
  "duration": 0.312987089157104,
  "processing": 0,
  "date_start": "2026-06-27T20:43:40+03:00",
  "date_finish": "2026-06-27T20:43:40+03:00",
  "operating_reset_at": 1782582820,
  "operating": 0
 }
}
```
