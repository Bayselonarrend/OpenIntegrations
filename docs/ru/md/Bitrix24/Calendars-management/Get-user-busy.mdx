    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url ""b24-ar17wx.bitrix24.by"" \
              --users "1" \
              --from ""2025-09-11T12:42:07.4408503"" \
              --to ""2025-09-18T12:42:07.4408503"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1757613187.48792,
  "finish": 1757613187.51997,
  "duration": 0.0320489406585693,
  "processing": 0.00978302955627441,
  "date_start": "2025-09-11T20:53:07+03:00",
  "date_finish": "2025-09-11T20:53:07+03:00",
  "operating_reset_at": 1757613787,
  "operating": 0
 }
}
```
