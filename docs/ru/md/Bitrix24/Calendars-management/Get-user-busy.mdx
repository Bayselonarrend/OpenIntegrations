    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-07-05T16:25:12" \
              --to "2026-07-12T16:25:12" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1784094603,
  "finish": 1784094603.12691,
  "duration": 0.126910924911499,
  "processing": 0,
  "date_start": "2026-07-15T05:50:03+00:00",
  "date_finish": "2026-07-15T05:50:03+00:00",
  "operating_reset_at": 1784095203,
  "operating": 0
 }
}
```
