    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-01-19T22:25:00.6417421" \
              --to "2026-01-26T22:25:00.6417421" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1768850703,
  "finish": 1768850704.00425,
  "duration": 1.00425291061401,
  "processing": 1,
  "date_start": "2026-01-19T22:25:03+03:00",
  "date_finish": "2026-01-19T22:25:04+03:00",
  "operating_reset_at": 1768851303,
  "operating": 0
 }
}
```
