    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-02-20T01:42:14" \
              --to "2026-02-27T01:42:14" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1771589262,
  "finish": 1771589262.56273,
  "duration": 0.562728881835938,
  "processing": 0,
  "date_start": "2026-02-20T12:07:42+00:00",
  "date_finish": "2026-02-20T12:07:42+00:00",
  "operating_reset_at": 1771589862,
  "operating": 0
 }
}
```
