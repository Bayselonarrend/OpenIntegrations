    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-02-13T23:02:58" \
              --to "2026-02-20T23:02:58" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1771023782,
  "finish": 1771023782.14937,
  "duration": 0.149374008178711,
  "processing": 0,
  "date_start": "2026-02-13T23:03:02+00:00",
  "date_finish": "2026-02-13T23:03:02+00:00",
  "operating_reset_at": 1771024382,
  "operating": 0
 }
}
```
