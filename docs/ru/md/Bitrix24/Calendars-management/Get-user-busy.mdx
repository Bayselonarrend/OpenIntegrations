    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2025-10-08T14:05:44.4746639" \
              --to "2025-10-15T14:05:44.4746639" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1760030858,
  "finish": 1760030858.50878,
  "duration": 0.508785009384155,
  "processing": 0,
  "date_start": "2025-10-09T17:27:38+00:00",
  "date_finish": "2025-10-09T17:27:38+00:00",
  "operating_reset_at": 1760031458,
  "operating": 0
 }
}
```
