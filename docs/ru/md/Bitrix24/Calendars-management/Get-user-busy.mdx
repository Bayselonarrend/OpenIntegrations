    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2025-12-11T10:27:10.1064312" \
              --to "2025-12-18T10:27:10.1064312" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1767082026,
  "finish": 1767082026.67068,
  "duration": 0.670680046081543,
  "processing": 0,
  "date_start": "2025-12-30T11:07:06+03:00",
  "date_finish": "2025-12-30T11:07:06+03:00",
  "operating_reset_at": 1767082626,
  "operating": 0
 }
}
```
