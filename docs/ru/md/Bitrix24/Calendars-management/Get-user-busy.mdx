    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-06-11T16:17:30" \
              --to "2026-06-18T16:17:30" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1781164269,
  "finish": 1781164269.09011,
  "duration": 0.0901069641113281,
  "processing": 0,
  "date_start": "2026-06-11T10:51:09+03:00",
  "date_finish": "2026-06-11T10:51:09+03:00",
  "operating_reset_at": 1781164869,
  "operating": 0
 }
}
```
