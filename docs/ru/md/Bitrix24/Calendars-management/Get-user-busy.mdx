    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "\"b24-ar17wx.bitrix24.by\"" \
              --users "1" \
              --from "\"2025-09-08T09:30:39.5493885\"" \
              --to "\"2025-09-15T09:30:39.5493885\"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1757323844.22347,
  "finish": 1757323844.27257,
  "duration": 0.0491020679473877,
  "processing": 0.0155000686645508,
  "date_start": "2025-09-08T09:30:44+00:00",
  "date_finish": "2025-09-08T09:30:44+00:00",
  "operating_reset_at": 1757324444,
  "operating": 0
 }
}
```
