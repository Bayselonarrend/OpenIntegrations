    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-02-05T20:02:24" \
              --to "2026-02-12T20:02:24" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1770310948,
  "finish": 1770310948.25678,
  "duration": 0.256778001785278,
  "processing": 0,
  "date_start": "2026-02-05T20:02:28+03:00",
  "date_finish": "2026-02-05T20:02:28+03:00",
  "operating_reset_at": 1770311548,
  "operating": 0
 }
}
```
