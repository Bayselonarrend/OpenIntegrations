    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2025-12-02T16:14:38.2134753" \
              --to "2025-12-09T16:14:38.2134753" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1764692084,
  "finish": 1764692084.57643,
  "duration": 0.576431035995484,
  "processing": 0,
  "date_start": "2025-12-02T16:14:44+00:00",
  "date_finish": "2025-12-02T16:14:44+00:00",
  "operating_reset_at": 1764692684,
  "operating": 0
 }
}
```
