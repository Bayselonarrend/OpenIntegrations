    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2025-12-07T16:31:12.65741" \
              --to "2025-12-14T16:31:12.65741" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1765114276,
  "finish": 1765114276.1935,
  "duration": 0.193499088287354,
  "processing": 0,
  "date_start": "2025-12-07T16:31:16+03:00",
  "date_finish": "2025-12-07T16:31:16+03:00",
  "operating_reset_at": 1765114876,
  "operating": 0
 }
}
```
