    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-04-14T00:09:58" \
              --to "2026-04-21T00:09:58" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1776114598,
  "finish": 1776114598.20646,
  "duration": 0.206459999084473,
  "processing": 0,
  "date_start": "2026-04-14T00:09:58+03:00",
  "date_finish": "2026-04-14T00:09:58+03:00",
  "operating_reset_at": 1776115198,
  "operating": 0
 }
}
```
