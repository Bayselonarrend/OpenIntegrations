    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-07-16T09:55:40" \
              --to "2026-07-23T09:55:40" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1784360461,
  "finish": 1784360462.02573,
  "duration": 1.02572798728943,
  "processing": 0,
  "date_start": "2026-07-18T10:41:01+03:00",
  "date_finish": "2026-07-18T10:41:02+03:00",
  "operating_reset_at": 1784361062,
  "operating": 0
 }
}
```
