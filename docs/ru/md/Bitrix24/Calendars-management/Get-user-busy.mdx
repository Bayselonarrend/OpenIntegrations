    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-07-20T08:56:17" \
              --to "2026-07-27T08:56:17" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1784488674,
  "finish": 1784488674.17281,
  "duration": 0.172810077667236,
  "processing": 0,
  "date_start": "2026-07-19T22:17:54+03:00",
  "date_finish": "2026-07-19T22:17:54+03:00",
  "operating_reset_at": 1784489274,
  "operating": 0
 }
}
```
