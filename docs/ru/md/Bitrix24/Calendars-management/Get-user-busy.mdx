    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-04-15T05:12:11" \
              --to "2026-04-22T05:12:11" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1776952809,
  "finish": 1776952809.54801,
  "duration": 0.548007011413574,
  "processing": 0,
  "date_start": "2026-04-23T17:00:09+03:00",
  "date_finish": "2026-04-23T17:00:09+03:00",
  "operating_reset_at": 1776953409,
  "operating": 0
 }
}
```
