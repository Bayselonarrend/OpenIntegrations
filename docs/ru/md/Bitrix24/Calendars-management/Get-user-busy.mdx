    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-02-13T14:20:20" \
              --to "2026-02-20T14:20:20" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1770992423,
  "finish": 1770992423.88355,
  "duration": 0.883548021316528,
  "processing": 0,
  "date_start": "2026-02-13T14:20:23+00:00",
  "date_finish": "2026-02-13T14:20:23+00:00",
  "operating_reset_at": 1770993023,
  "operating": 0
 }
}
```
