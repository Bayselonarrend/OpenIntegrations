    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url ""b24-ar17wx.bitrix24.by"" \
              --users "1" \
              --from ""2025-09-14T19:18:13.9273071"" \
              --to ""2025-09-21T19:18:13.9273071"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1757925535.63629,
  "finish": 1757925535.6702,
  "duration": 0.0339100360870361,
  "processing": 0.0117170810699463,
  "date_start": "2025-09-15T11:38:55+03:00",
  "date_finish": "2025-09-15T11:38:55+03:00",
  "operating_reset_at": 1757926135,
  "operating": 0
 }
}
```
