    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-02-02T21:07:32" \
              --to "2026-02-09T21:07:32" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1770062098,
  "finish": 1770062098.28616,
  "duration": 0.286164045333862,
  "processing": 0,
  "date_start": "2026-02-02T19:54:58+00:00",
  "date_finish": "2026-02-02T19:54:58+00:00",
  "operating_reset_at": 1770062698,
  "operating": 0
 }
}
```
