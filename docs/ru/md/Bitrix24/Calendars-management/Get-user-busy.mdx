    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-06-06T16:29:15" \
              --to "2026-06-13T16:29:15" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1780752556,
  "finish": 1780752556.12617,
  "duration": 0.12617301940918,
  "processing": 0,
  "date_start": "2026-06-06T16:29:16+03:00",
  "date_finish": "2026-06-06T16:29:16+03:00",
  "operating_reset_at": 1780753156,
  "operating": 0
 }
}
```
