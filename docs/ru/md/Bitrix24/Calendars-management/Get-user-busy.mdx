    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2025-10-29T17:46:01.3806208" \
              --to "2025-11-05T17:46:01.3806208" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1761759965,
  "finish": 1761759965.38606,
  "duration": 0.386061906814575,
  "processing": 0,
  "date_start": "2025-10-29T17:46:05+00:00",
  "date_finish": "2025-10-29T17:46:05+00:00",
  "operating_reset_at": 1761760565,
  "operating": 0
 }
}
```
