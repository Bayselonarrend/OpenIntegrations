    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-03-06T20:13:21" \
              --to "2026-03-13T20:13:21" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1772817204,
  "finish": 1772817204.36377,
  "duration": 0.363771915435791,
  "processing": 0,
  "date_start": "2026-03-06T20:13:24+03:00",
  "date_finish": "2026-03-06T20:13:24+03:00",
  "operating_reset_at": 1772817804,
  "operating": 0
 }
}
```
