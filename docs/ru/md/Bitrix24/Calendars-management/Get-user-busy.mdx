    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-03-05T08:35:41" \
              --to "2026-03-12T08:35:41" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1772699745,
  "finish": 1772699745.82855,
  "duration": 0.828548908233642,
  "processing": 0,
  "date_start": "2026-03-05T08:35:45+00:00",
  "date_finish": "2026-03-05T08:35:45+00:00",
  "operating_reset_at": 1772700345,
  "operating": 0
 }
}
```
