    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url ""b24-ar17wx.bitrix24.by"" \
              --users "1" \
              --from ""2025-09-10T18:33:57.885176"" \
              --to ""2025-09-17T18:33:57.885176"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1757529241.34588,
  "finish": 1757529241.37819,
  "duration": 0.032310962677002,
  "processing": 0.00729203224182129,
  "date_start": "2025-09-10T18:34:01+00:00",
  "date_finish": "2025-09-10T18:34:01+00:00",
  "operating_reset_at": 1757529841,
  "operating": 0
 }
}
```
