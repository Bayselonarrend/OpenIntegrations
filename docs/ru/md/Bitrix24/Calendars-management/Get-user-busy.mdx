    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-06-15T14:21:12" \
              --to "2026-06-22T14:21:12" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1781531758,
  "finish": 1781531758.38549,
  "duration": 0.385487079620361,
  "processing": 0,
  "date_start": "2026-06-15T16:55:58+03:00",
  "date_finish": "2026-06-15T16:55:58+03:00",
  "operating_reset_at": 1781532358,
  "operating": 0.135739088058472
 }
}
```
