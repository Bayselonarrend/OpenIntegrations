    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2025-10-26T18:20:46.0823927" \
              --to "2025-11-02T18:20:46.0823927" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1761502850,
  "finish": 1761502850.1934,
  "duration": 0.193397045135498,
  "processing": 0,
  "date_start": "2025-10-26T18:20:50+00:00",
  "date_finish": "2025-10-26T18:20:50+00:00",
  "operating_reset_at": 1761503450,
  "operating": 0
 }
}
```
