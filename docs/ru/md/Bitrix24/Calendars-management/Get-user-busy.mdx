    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-01-02T18:14:58.4883805" \
              --to "2026-01-09T18:14:58.4883805" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1767366902,
  "finish": 1767366902.31211,
  "duration": 0.312113046646118,
  "processing": 0,
  "date_start": "2026-01-02T18:15:02+03:00",
  "date_finish": "2026-01-02T18:15:02+03:00",
  "operating_reset_at": 1767367502,
  "operating": 0
 }
}
```
