    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-01-02T23:09:29.8025886" \
              --to "2026-01-09T23:09:29.8025886" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1767384573,
  "finish": 1767384573.78079,
  "duration": 0.780786037445068,
  "processing": 0,
  "date_start": "2026-01-02T23:09:33+03:00",
  "date_finish": "2026-01-02T23:09:33+03:00",
  "operating_reset_at": 1767385173,
  "operating": 0
 }
}
```
