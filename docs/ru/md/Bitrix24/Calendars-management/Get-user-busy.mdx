    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url ""b24-ar17wx.bitrix24.by"" \
              --users "1" \
              --from ""2025-09-16T23:38:47.7157981"" \
              --to ""2025-09-23T23:38:47.7157981"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1758055130.87104,
  "finish": 1758055130.89978,
  "duration": 0.0287327766418457,
  "processing": 0.00784015655517578,
  "date_start": "2025-09-16T23:38:50+03:00",
  "date_finish": "2025-09-16T23:38:50+03:00",
  "operating_reset_at": 1758055730,
  "operating": 0
 }
}
```
