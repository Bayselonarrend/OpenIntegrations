    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2025-09-08T19:35:36.1598858" \
              --to "2025-09-15T19:35:36.1598858" \
              --token ***
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1757360140.69329,
  "finish": 1757360140.72091,
  "duration": 0.0276210308074951,
  "processing": 0.00694417953491211,
  "date_start": "2025-09-08T19:35:40+00:00",
  "date_finish": "2025-09-08T19:35:40+00:00",
  "operating_reset_at": 1757360740,
  "operating": 0
 }
}
```
