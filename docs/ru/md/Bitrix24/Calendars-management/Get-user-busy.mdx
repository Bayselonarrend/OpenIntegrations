    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-02-06T23:44:35" \
              --to "2026-02-13T23:44:35" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1770446976,
  "finish": 1770446976.49567,
  "duration": 0.495671033859253,
  "processing": 0,
  "date_start": "2026-02-07T06:49:36+00:00",
  "date_finish": "2026-02-07T06:49:36+00:00",
  "operating_reset_at": 1770447576,
  "operating": 0
 }
}
```
