    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-06-06T20:33:04" \
              --to "2026-06-13T20:33:04" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1780767184,
  "finish": 1780767184.68448,
  "duration": 0.684478998184204,
  "processing": 0,
  "date_start": "2026-06-06T20:33:04+03:00",
  "date_finish": "2026-06-06T20:33:04+03:00",
  "operating_reset_at": 1780767784,
  "operating": 0
 }
}
```
