    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-02-01T22:40:53" \
              --to "2026-02-08T22:40:53" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1769974856,
  "finish": 1769974856.94406,
  "duration": 0.94406008720398,
  "processing": 0,
  "date_start": "2026-02-01T22:40:56+03:00",
  "date_finish": "2026-02-01T22:40:56+03:00",
  "operating_reset_at": 1769975456,
  "operating": 0
 }
}
```
