    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ПолучитьЗанятостьПользователей \
              --url "b24-ar17wx.bitrix24.by" \
              --users 1 \
              --from "2026-07-05T08:28:48" \
              --to "2026-07-12T08:28:48" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1782763016,
  "finish": 1782763016.9662,
  "duration": 0.96619701385498,
  "processing": 0,
  "date_start": "2026-06-29T22:56:56+03:00",
  "date_finish": "2026-06-29T22:56:56+03:00",
  "operating_reset_at": 1782763616,
  "operating": 0
 }
}
```
