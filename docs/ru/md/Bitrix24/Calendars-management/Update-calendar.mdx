    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ИзменитьКалендарь \
              --url ""b24-ar17wx.bitrix24.by"" \
              --calendar "1380" \
              --fields ""C:\Users\bayse\AppData\Local\Temp\voacjpvc.rjo.json"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": 1380,
 "time": {
  "start": 1758055099.21559,
  "finish": 1758055099.25514,
  "duration": 0.0395472049713135,
  "processing": 0.0157389640808105,
  "date_start": "2025-09-16T23:38:19+03:00",
  "date_finish": "2025-09-16T23:38:19+03:00",
  "operating_reset_at": 1758055699,
  "operating": 0
 }
}
```
