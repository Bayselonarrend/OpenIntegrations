    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 ИзменитьКалендарь \
              --url ""b24-ar17wx.bitrix24.by"" \
              --calendar "1384" \
              --fields ""C:\Users\bayse\AppData\Local\Temp\qxr0sydt.vs3.json"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": 1384,
 "time": {
  "start": 1758115316.99521,
  "finish": 1758115317.05305,
  "duration": 0.0578389167785644,
  "processing": 0.0191648006439209,
  "date_start": "2025-09-17T16:21:56+03:00",
  "date_finish": "2025-09-17T16:21:57+03:00",
  "operating_reset_at": 1758115917,
  "operating": 0
 }
}
```
