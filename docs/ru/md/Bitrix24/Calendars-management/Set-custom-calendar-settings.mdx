    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 УстановитьПользовательскиеНастройкиКалендаря \
              --url ""b24-ar17wx.bitrix24.by"" \
              --settings ""C:\Users\bayse\AppData\Local\Temp\ci5zsitg.cc5.json"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": true,
 "time": {
  "start": 1758055146.44879,
  "finish": 1758055146.48114,
  "duration": 0.032351016998291,
  "processing": 0.0039820671081543,
  "date_start": "2025-09-16T23:39:06+03:00",
  "date_finish": "2025-09-16T23:39:06+03:00",
  "operating_reset_at": 1758055746,
  "operating": 0
 }
}
```
