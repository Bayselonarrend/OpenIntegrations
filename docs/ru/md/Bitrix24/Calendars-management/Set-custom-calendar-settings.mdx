    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint bitrix24 УстановитьПользовательскиеНастройкиКалендаря \
              --url ""b24-ar17wx.bitrix24.by"" \
              --settings ""C:\Users\bayse\AppData\Local\Temp\u1z2g15j.e0i.json"" \
              --token "***"
        ```
    </TabItem>
...
```json title="Результат"
{
 "result": true,
 "time": {
  "start": 1758115368.57914,
  "finish": 1758115368.61451,
  "duration": 0.0353691577911377,
  "processing": 0.0116119384765625,
  "date_start": "2025-09-17T16:22:48+03:00",
  "date_finish": "2025-09-17T16:22:48+03:00",
  "operating_reset_at": 1758115968,
  "operating": 0
 }
}
```
