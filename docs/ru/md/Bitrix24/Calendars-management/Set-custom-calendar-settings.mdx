...
`Функция УстановитьПользовательскиеНастройкиКалендаря(Знач URL, Знач СтруктураНастроек, Знач Токен = "") Экспорт`
  ...
  | СтруктураНастроек | --settings | Структура Из КлючИЗначение | &#x2714; | Структура настроек. См. [`ПолучитьСтруктуруПользовательскихНастроекКалендаря`](/docs/Bitrix24/Calendars-management/Get-calednar-custom-settings-structure) |
...
```json title="Результат"
{
 ...
 "time": {
  "start": 1777714722,
  "finish": 1777714722.9706,
  "duration": 0.97060489654541,
  "processing": 0,
