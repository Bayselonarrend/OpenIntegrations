    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':5},'smallint_field':{'SMALLINT':2000},'int_field':{'INT':200000},'bigint_field':{'BIGINT':20000000000},'float24_field':{'FLOAT24':10.1234567},'float53_field':{'FLOAT53':10.123456789123456},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/zn2qwe3d.qj2'},'uid_field':{'UUID':'5dbeef6d-3f98-46ea-8aaa-388768720db6'},'numeric_field':{'NUMERIC':5.333},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?><root>\n    <element>\n        <name>Пример</name>\n        <value>123</value>\n    </element>\n    <element>\n        <name>Тест</name>\n        <value>456</value>\n    </element>\n</root>'},'date_field':{'DATE':'2026-06-14T12:06:41+00:00'},'time_field':{'TIME':'2026-06-14T12:06:41+00:00'},'dto_field':{'DATETIMEOFFSET':'2026-06-14T12:06:41+05:00'},'datetime_field':{'DATETIME':'2026-06-14T12:06:41+00:00'}}]" \
              --trn true \
