    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':5},'smallint_field':{'SMALLINT':2000},'int_field':{'INT':200000},'bigint_field':{'BIGINT':20000000000},'float24_field':{'FLOAT24':10.1234567},'float53_field':{'FLOAT53':10.123456789123456},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/34td00zt.ndw'},'uid_field':{'UUID':'276e3fed-f88b-4e2b-be7c-ad91d1ad2ded'},'numeric_field':{'NUMERIC':5.333},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?><root>\n    <element>\n        <name>Пример</name>\n        <value>123</value>\n    </element>\n    <element>\n        <name>Тест</name>\n        <value>456</value>\n    </element>\n</root>'},'date_field':{'DATE':'2026-05-01T15:16:02+00:00'},'time_field':{'TIME':'2026-05-01T15:16:02+00:00'},'dto_field':{'DATETIMEOFFSET':'2026-05-01T15:16:02+05:00'},'datetime_field':{'DATETIME':'2026-05-01T15:16:02+00:00'}}]" \
              --trn true \
