    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':'5'},'smallint_field':{'SMALLINT':'2000'},'int_field':{'INT':'200000'},'bigint_field':{'BIGINT':'20000000000'},'float24_field':{'FLOAT24':'10.1234567'},'float53_field':{'FLOAT53':'10.1234567891235'},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\b01dqird.rof'},'uid_field':{'UUID':'91ceb7ec-d17c-4da6-9d73-3ea46391c8e8'},'numeric_field':{'NUMERIC':'5.333'},'xml_field':{'XML':'<?xml version=\"1.0\"?><root>\n    <element>\n        <name>Пример</name>\n        <value>123</value>\n    </element>\n    <element>\n        <name>Тест</name>\n        <value>456</value>\n    </element>\n</root>'},'date_field':{'DATE':'4/6/2026 9:40:55 PM'},'time_field':{'TIME':'4/6/2026 9:40:55 PM'},'dto_field':{'DATETIMEOFFSET':'4/6/2026 7:40:55 PM'},'datetime_field':{'DATETIME':'4/6/2026 9:40:55 PM'}}]" \
              --trn true \
