    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint mssql ДобавитьЗаписи \
              --table ""testtable"" \
              --rows ""[{'tinyint_field':{'TINYINT':5},'smallint_field':{'SMALLINT':2000},'int_field':{'INT':200000},'bigint_field':{'BIGINT':20000000000},'float24_field':{'FLOAT24':10.1234567},'float53_field':{'FLOAT53':10.123456789123456},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/jf32lqcv.sfs'},'uid_field':{'UUID':'7a85cf0f-9568-48d6-b079-afd822e54cf9'},'numeric_field':{'NUMERIC':5.333},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?> <root>     <element>         <name>Пример</name>         <value>123</value>     </element>     <element>         <name>Тест</name>         <value>456</value>     </element> </root>'},'date_field':{'DATE':'2025-09-11T12:00:14.5765592Z'},'time_field':{'TIME':'2025-09-11T12:00:14.5765592Z'},'dto_field':{'DATETIMEOFFSET':'2025-09-11T12:00:14.5765592+05:00'},'datetime_field':{'DATETIME':'2025-09-11T12:00:14.5765592Z'}}]"" \
              --trn "true" \
              --dbc "Server=127.0.0.1;Database=***;User Id=SA;Password=***;" \
              --tls ""/tmp/4nyy5plo.qfx.json""
        ```
    </TabItem>
