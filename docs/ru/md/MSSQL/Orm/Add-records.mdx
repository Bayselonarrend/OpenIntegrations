    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':5},'smallint_field':{'SMALLINT':2000},'int_field':{'INT':200000},'bigint_field':{'BIGINT':20000000000},'float24_field':{'FLOAT24':10.1234567},'float53_field':{'FLOAT53':10.123456789123456},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/jzanvlak.o42'},'uid_field':{'UUID':'1d7150be-d0f0-4e41-a03f-e8ea64f2a81b'},'numeric_field':{'NUMERIC':5.333},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?><root>     <element>         <name>Пример</name>         <value>123</value>     </element>     <element>         <name>Тест</name>         <value>456</value>     </element> </root>'},'date_field':{'DATE':'2026-01-05T23:47:47.4784652Z'},'time_field':{'TIME':'2026-01-05T23:47:47.4784652Z'},'dto_field':{'DATETIMEOFFSET':'2026-01-05T23:47:47.4784652+05:00'},'datetime_field':{'DATETIME':'2026-01-05T23:47:47.4784652Z'}}]" \
              --trn true \
