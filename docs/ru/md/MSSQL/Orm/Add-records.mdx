    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':'5'},'smallint_field':{'SMALLINT':'2000'},'int_field':{'INT':'200000'},'bigint_field':{'BIGINT':'20000000000'},'float24_field':{'FLOAT24':'10.1234567'},'float53_field':{'FLOAT53':'10.1234567891235'},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'C:\\Users\\bayse\\AppData\\Local\\Temp\\xre4vd5o.va0'},'uid_field':{'UUID':'8c38c087-efd2-419e-9798-52d2088a2bb7'},'numeric_field':{'NUMERIC':'5.333'},'xml_field':{'XML':'<?xml version=\"1.0\"?><root>     <element>         <name>Пример</name>         <value>123</value>     </element>     <element>         <name>Тест</name>         <value>456</value>     </element> </root>'},'date_field':{'DATE':'12/6/2025 7:59:35 PM'},'time_field':{'TIME':'12/6/2025 7:59:35 PM'},'dto_field':{'DATETIMEOFFSET':'12/6/2025 5:59:35 PM'},'datetime_field':{'DATETIME':'12/6/2025 7:59:35 PM'}}]" \
              --trn true \
