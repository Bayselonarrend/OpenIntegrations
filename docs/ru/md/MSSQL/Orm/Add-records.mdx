    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':5},'smallint_field':{'SMALLINT':2000},'int_field':{'INT':200000},'bigint_field':{'BIGINT':20000000000},'float24_field':{'FLOAT24':10.1234567},'float53_field':{'FLOAT53':10.123456789123456},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/j12i01zf.k4q'},'uid_field':{'UUID':'385274eb-2ae5-4cfd-8088-725251f3d9fe'},'numeric_field':{'NUMERIC':5.333},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?><root>\n    <element>\n        <name>Пример</name>\n        <value>123</value>\n    </element>\n    <element>\n        <name>Тест</name>\n        <value>456</value>\n    </element>\n</root>'},'date_field':{'DATE':'2026-02-06T05:33:44+00:00'},'time_field':{'TIME':'2026-02-06T05:33:44+00:00'},'dto_field':{'DATETIMEOFFSET':'2026-02-06T05:33:44+05:00'},'datetime_field':{'DATETIME':'2026-02-06T05:33:44+00:00'}}]" \
              --trn true \
