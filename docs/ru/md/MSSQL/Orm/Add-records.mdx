    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':5},'smallint_field':{'SMALLINT':2000},'int_field':{'INT':200000},'bigint_field':{'BIGINT':20000000000},'float24_field':{'FLOAT24':10.1234567},'float53_field':{'FLOAT53':10.123456789123456},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/5u5lkp2b.ceq'},'uid_field':{'UUID':'e2e078a5-5b63-46a9-be09-78d7b5a3a34e'},'numeric_field':{'NUMERIC':5.333},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?><root>     <element>         <name>Пример</name>         <value>123</value>     </element>     <element>         <name>Тест</name>         <value>456</value>     </element> </root>'},'date_field':{'DATE':'2025-10-07T18:36:40.1651783Z'},'time_field':{'TIME':'2025-10-07T18:36:40.1651783Z'},'dto_field':{'DATETIMEOFFSET':'2025-10-07T18:36:40.1651783+05:00'},'datetime_field':{'DATETIME':'2025-10-07T18:36:40.1651783Z'}}]" \
              --trn true \
