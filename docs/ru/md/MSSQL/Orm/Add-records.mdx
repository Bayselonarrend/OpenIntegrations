    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':'5'},'smallint_field':{'SMALLINT':'2000'},'int_field':{'INT':'200000'},'bigint_field':{'BIGINT':'20000000000'},'float24_field':{'FLOAT24':'10.1234567'},'float53_field':{'FLOAT53':'10.123456789123456'},'bit_field':{'BIT':'True'},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/3cvpwftj.dbg'},'uid_field':{'UUID':'41640091-56d3-4f68-99ec-71f9106c4ab8'},'numeric_field':{'NUMERIC':'5.333'},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?>\\n<root>\\n    <element>\\n        <name>Пример</name>\\n        <value>123</value>\\n    </element>\\n    <element>\\n        <name>Тест</name>\\n        <value>456</value>\\n    </element>\\n</root>'},'date_field':{'DATE':'07/29/2025 07:20:10'},'time_field':{'TIME':'07/29/2025 07:20:10'},'dto_field':{'DATETIMEOFFSET':'2025-07-29T07:20:10.829068+05:00'},'datetime_field':{'DATETIME':'07/29/2025 07:20:10'}}]" \
