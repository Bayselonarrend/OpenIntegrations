    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':'5'},'smallint_field':{'SMALLINT':'2000'},'int_field':{'INT':'200000'},'bigint_field':{'BIGINT':'20000000000'},'float24_field':{'FLOAT24':'10.1234567'},'float53_field':{'FLOAT53':'10.1234567891235'},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'C:\\Users\\bayse\\AppData\\Local\\Temp\\nsg5t00l.lj4'},'uid_field':{'UUID':'82bc2d3b-b5c3-4f57-8605-77995f679b58'},'numeric_field':{'NUMERIC':'5.333'},'xml_field':{'XML':'<?xml version=\"1.0\"?><root>\\n    <element>\\n        <name>Пример</name>\\n        <value>123</value>\\n    </element>\\n    <element>\\n        <name>Тест</name>\\n        <value>456</value>\\n    </element>\\n</root>'},'date_field':{'DATE':'2/5/2026 7:20:42 PM'},'time_field':{'TIME':'2/5/2026 7:20:42 PM'},'dto_field':{'DATETIMEOFFSET':'2/5/2026 5:20:42 PM'},'datetime_field':{'DATETIME':'2/5/2026 7:20:42 PM'}}]" \
              --trn true \
