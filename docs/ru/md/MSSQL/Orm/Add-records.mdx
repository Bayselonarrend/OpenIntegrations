    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':'5'},'smallint_field':{'SMALLINT':'2000'},'int_field':{'INT':'200000'},'bigint_field':{'BIGINT':'20000000000'},'float24_field':{'FLOAT24':'10.1234567'},'float53_field':{'FLOAT53':'10.1234567891235'},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'C:\\Users\\bayse\\AppData\\Local\\Temp\\4d2ipnif.jp5'},'uid_field':{'UUID':'b6617687-ff63-4f38-93d2-d8535813da37'},'numeric_field':{'NUMERIC':'5.333'},'xml_field':{'XML':'<?xml version=\"1.0\"?><root>     <element>         <name>Пример</name>         <value>123</value>     </element>     <element>         <name>Тест</name>         <value>456</value>     </element> </root>'},'date_field':{'DATE':'1/31/2026 5:43:12 PM'},'time_field':{'TIME':'1/31/2026 5:43:12 PM'},'dto_field':{'DATETIMEOFFSET':'1/31/2026 3:43:12 PM'},'datetime_field':{'DATETIME':'1/31/2026 5:43:12 PM'}}]" \
              --trn true \
