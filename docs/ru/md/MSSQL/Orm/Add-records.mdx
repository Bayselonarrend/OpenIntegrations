    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':'5'},'smallint_field':{'SMALLINT':'2000'},'int_field':{'INT':'200000'},'bigint_field':{'BIGINT':'20000000000'},'float24_field':{'FLOAT24':'10.1234567'},'float53_field':{'FLOAT53':'10.123456789123456'},'bit_field':{'BIT':'True'},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/nwayhuyj.jm5'},'uid_field':{'UUID':'17378373-90a4-475e-afc4-eca367c2b5b2'},'numeric_field':{'NUMERIC':'5.333'},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?>\\n<root>\\n    <element>\\n        <name>Пример</name>\\n        <value>123</value>\\n    </element>\\n    <element>\\n        <name>Тест</name>\\n        <value>456</value>\\n    </element>\\n</root>'},'date_field':{'DATE':'07/21/2025 20:11:55'},'time_field':{'TIME':'07/21/2025 20:11:55'},'dto_field':{'DATETIMEOFFSET':'2025-07-21T20:11:55.6867534+05:00'},'datetime_field':{'DATETIME':'07/21/2025 20:11:55'}}]" \
