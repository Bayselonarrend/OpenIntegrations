    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':5},'smallint_field':{'SMALLINT':2000},'int_field':{'INT':200000},'bigint_field':{'BIGINT':20000000000},'float24_field':{'FLOAT24':10.1234567},'float53_field':{'FLOAT53':10.123456789123456},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/z3dt0lzt.la5'},'uid_field':{'UUID':'2cdb2495-aee5-422f-9cbe-d328bb7dc6d7'},'numeric_field':{'NUMERIC':5.333},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?><root>     <element>         <name>Пример</name>         <value>123</value>     </element>     <element>         <name>Тест</name>         <value>456</value>     </element> </root>'},'date_field':{'DATE':'2025-12-02T15:27:00.4003324Z'},'time_field':{'TIME':'2025-12-02T15:27:00.4003324Z'},'dto_field':{'DATETIMEOFFSET':'2025-12-02T15:27:00.4003324+05:00'},'datetime_field':{'DATETIME':'2025-12-02T15:27:00.4003324Z'}}]" \
              --trn true \
