    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':'5'},'smallint_field':{'SMALLINT':'2000'},'int_field':{'INT':'200000'},'bigint_field':{'BIGINT':'20000000000'},'float24_field':{'FLOAT24':'10.1234567'},'float53_field':{'FLOAT53':'10.123456789123456'},'bit_field':{'BIT':'True'},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/jjiobqup.l33'},'uid_field':{'UUID':'81d003ad-fb76-42e8-b4cb-eadf391fbe60'},'numeric_field':{'NUMERIC':'5.333'},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?>\\n<root>\\n    <element>\\n        <name>Пример</name>\\n        <value>123</value>\\n    </element>\\n    <element>\\n        <name>Тест</name>\\n        <value>456</value>\\n    </element>\\n</root>'},'date_field':{'DATE':'07/22/2025 12:01:35'},'time_field':{'TIME':'07/22/2025 12:01:35'},'dto_field':{'DATETIMEOFFSET':'2025-07-22T12:01:35.4231642+05:00'},'datetime_field':{'DATETIME':'07/22/2025 12:01:35'}}]" \
