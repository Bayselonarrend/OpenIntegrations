    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':5},'smallint_field':{'SMALLINT':2000},'int_field':{'INT':200000},'bigint_field':{'BIGINT':20000000000},'float24_field':{'FLOAT24':10.1234567},'float53_field':{'FLOAT53':10.123456789123456},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/qwdzayta.ozd'},'uid_field':{'UUID':'bed5b080-0210-4e37-be57-968bb5f81c0b'},'numeric_field':{'NUMERIC':5.333},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?>\\n<root>\\n    <element>\\n        <name>Пример</name>\\n        <value>123</value>\\n    </element>\\n    <element>\\n        <name>Тест</name>\\n        <value>456</value>\\n    </element>\\n</root>'},'date_field':{'DATE':'2025-07-20T21:04:35.1487252Z'},'time_field':{'TIME':'2025-07-20T21:04:35.1487252Z'},'dto_field':{'DATETIMEOFFSET':'2025-07-20T21:04:35.1487252+05:00'},'datetime_field':{'DATETIME':'2025-07-20T21:04:35.1487252Z'}}]" \
