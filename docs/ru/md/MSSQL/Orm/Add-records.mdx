    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':5},'smallint_field':{'SMALLINT':2000},'int_field':{'INT':200000},'bigint_field':{'BIGINT':20000000000},'float24_field':{'FLOAT24':10.1234567},'float53_field':{'FLOAT53':10.123456789123456},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/idfoznh3.k4i'},'uid_field':{'UUID':'65c6f83b-dec6-4bf2-9938-eddbf4f813db'},'numeric_field':{'NUMERIC':5.333},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?> <root>     <element>         <name>Пример</name>         <value>123</value>     </element>     <element>         <name>Тест</name>         <value>456</value>     </element> </root>'},'date_field':{'DATE':'2025-09-08T18:56:09.7691268Z'},'time_field':{'TIME':'2025-09-08T18:56:09.7691268Z'},'dto_field':{'DATETIMEOFFSET':'2025-09-08T18:56:09.7691268+05:00'},'datetime_field':{'DATETIME':'2025-09-08T18:56:09.7691268Z'}}]" \
              --trn true \
