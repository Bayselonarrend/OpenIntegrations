    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':5},'smallint_field':{'SMALLINT':2000},'int_field':{'INT':200000},'bigint_field':{'BIGINT':20000000000},'float24_field':{'FLOAT24':10.1234567},'float53_field':{'FLOAT53':10.123456789123456},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/eqbfj2tw.sbt'},'uid_field':{'UUID':'179ea260-6816-4521-ba90-2da95634f9c9'},'numeric_field':{'NUMERIC':5.333},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?><root>     <element>         <name>Пример</name>         <value>123</value>     </element>     <element>         <name>Тест</name>         <value>456</value>     </element> </root>'},'date_field':{'DATE':'2026-01-03T19:09:27.9712644Z'},'time_field':{'TIME':'2026-01-03T19:09:27.9712644Z'},'dto_field':{'DATETIMEOFFSET':'2026-01-03T19:09:27.9712644+05:00'},'datetime_field':{'DATETIME':'2026-01-03T19:09:27.9712644Z'}}]" \
              --trn true \
