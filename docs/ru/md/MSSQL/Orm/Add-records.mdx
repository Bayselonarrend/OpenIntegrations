    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mssql ДобавитьЗаписи \
              --table "testtable" \
              --rows "[{'tinyint_field':{'TINYINT':5},'smallint_field':{'SMALLINT':2000},'int_field':{'INT':200000},'bigint_field':{'BIGINT':20000000000},'float24_field':{'FLOAT24':10.1234567},'float53_field':{'FLOAT53':10.123456789123456},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/jib3sekz.x3b'},'uid_field':{'UUID':'cf791708-3723-451d-b412-b105434d3bd0'},'numeric_field':{'NUMERIC':5.333},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?><root>     <element>         <name>Пример</name>         <value>123</value>     </element>     <element>         <name>Тест</name>         <value>456</value>     </element> </root>'},'date_field':{'DATE':'2025-10-29T17:09:05.2589272Z'},'time_field':{'TIME':'2025-10-29T17:09:05.2589272Z'},'dto_field':{'DATETIMEOFFSET':'2025-10-29T17:09:05.2589272+05:00'},'datetime_field':{'DATETIME':'2025-10-29T17:09:05.2589272Z'}}]" \
              --trn true \
