    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint mssql ДобавитьЗаписи \
              --table ""testtable"" \
              --rows ""[{'tinyint_field':{'TINYINT':5},'smallint_field':{'SMALLINT':2000},'int_field':{'INT':200000},'bigint_field':{'BIGINT':20000000000},'float24_field':{'FLOAT24':10.1234567},'float53_field':{'FLOAT53':10.123456789123456},'bit_field':{'BIT':true},'nvarchar_field':{'NVARCHAR':'Some text'},'varbinary_field':{'BYTES':'/tmp/ir4xbpcu.xzb'},'uid_field':{'UUID':'c92530e3-8a48-4fd6-b8c8-a69587055df7'},'numeric_field':{'NUMERIC':5.333},'xml_field':{'XML':'<?xml version=\"'"1.0\"'"?> <root>     <element>         <name>Пример</name>         <value>123</value>     </element>     <element>         <name>Тест</name>         <value>456</value>     </element> </root>'},'date_field':{'DATE':'2025-09-14T18:37:59.5595566Z'},'time_field':{'TIME':'2025-09-14T18:37:59.5595566Z'},'dto_field':{'DATETIMEOFFSET':'2025-09-14T18:37:59.5595566+05:00'},'datetime_field':{'DATETIME':'2025-09-14T18:37:59.5595566Z'}}]"" \
              --trn "true" \
              --dbc "Server=127.0.0.1;Database=***;User Id=SA;Password=***;" \
              --tls ""/tmp/kr4ezbk0.ai2.json""
        ```
    </TabItem>
