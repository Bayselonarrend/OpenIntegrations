...
description: Вернуть ответ как JSON коллекцию  и другие функции для работы с HTTP в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "X-Arr-Log-Id": "c6b5ba32-a99b-4f80-beaf-b4092ae26832",
