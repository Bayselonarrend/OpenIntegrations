...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "AWS4-HMAC-SHA256 Credential=AccessKey/20260604/Region/s3/aws4_request, SignedHeaders=host;x-amz-cont...",
  ...
  "X-Amz-Date": "20260604T043005Z",
  "X-Arr-Log-Id": "1707d64c-88df-4caf-b532-a9674cf728ea",
