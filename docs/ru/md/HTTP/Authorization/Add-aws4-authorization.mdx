...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "AWS4-HMAC-SHA256 Credential=AccessKey/20260524/Region/s3/aws4_request, SignedHeaders=host;x-amz-cont...",
  ...
  "X-Amz-Date": "20260524T172535Z",
  "X-Arr-Log-Id": "efc9b33d-fbcb-42c2-966b-1ac56f4ab870",
