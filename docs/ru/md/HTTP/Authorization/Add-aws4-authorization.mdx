...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "AWS4-HMAC-SHA256 Credential=AccessKey/20260719/Region/s3/aws4_request, SignedHeaders=host;x-amz-content-sha256;x-amz-date, Signature=32b1a3ed73b7db05000f548cd36988898af779dadd4e0148633ff794ad8da480",
  ...
  "X-Amz-Date": "20260719T191208Z",
  "X-Arr-Log-Id": "8109ed99-2ffb-4419-a2b0-1bbe77e178be",
