...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "AWS4-HMAC-SHA256 Credential=AccessKey/20260425/Region/s3/aws4_request, SignedHeaders=host;x-amz-cont...",
  ...
  "X-Amz-Date": "20260425T124851Z",
  "X-Arr-Log-Id": "d9a17ce1-915a-4ca7-8e9b-1ed99809c27c",
