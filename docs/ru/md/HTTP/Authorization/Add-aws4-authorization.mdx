...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "AWS4-HMAC-SHA256 Credential=AccessKey/20260526/Region/s3/aws4_request, SignedHeaders=host;x-amz-cont...",
  ...
  "X-Amz-Date": "20260526T165750Z",
  "X-Arr-Log-Id": "18aa2c62-778b-4148-9b67-76d61d6a9b4b",
