...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "AWS4-HMAC-SHA256 Credential=AccessKey/20260516/Region/s3/aws4_request, SignedHeaders=host;x-amz-cont...",
  ...
  "X-Amz-Date": "20260516T134444Z",
  "X-Arr-Log-Id": "55b9a033-b92e-4bfe-ab58-530bb194170f",
