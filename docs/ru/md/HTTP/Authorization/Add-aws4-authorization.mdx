...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "AWS4-HMAC-SHA256 Credential=AccessKey/20260322/Region/s3/aws4_request, SignedHeaders=host;x-amz-cont...",
  ...
  "X-Amz-Date": "20260322T132520Z",
  "X-Arr-Log-Id": "2ed04b16-530d-4079-9da3-63324c4a2550",
