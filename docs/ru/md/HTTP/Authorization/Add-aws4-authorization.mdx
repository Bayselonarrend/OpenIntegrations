...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "AWS4-HMAC-SHA256 Credential=AccessKey/20260427/Region/s3/aws4_request, SignedHeaders=host;x-amz-cont...",
  ...
  "X-Amz-Date": "20260427T122547Z",
  "X-Arr-Log-Id": "cee33f82-bd28-4c0a-b6dd-c67d753f0fce",
