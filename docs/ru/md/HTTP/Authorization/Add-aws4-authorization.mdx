...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "AWS4-HMAC-SHA256 Credential=AccessKey/20260423/Region/s3/aws4_request, SignedHeaders=host;x-amz-cont...",
  ...
  "X-Amz-Date": "20260423T142116Z",
  "X-Arr-Log-Id": "092e3655-3400-4768-8830-d58c43c5213f",
