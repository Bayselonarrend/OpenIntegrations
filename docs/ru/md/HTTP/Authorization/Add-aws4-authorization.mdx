...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "AWS4-HMAC-SHA256 Credential=AccessKey/20260525/Region/s3/aws4_request, SignedHeaders=host;x-amz-cont...",
  ...
  "X-Amz-Date": "20260525T043031Z",
  "X-Arr-Log-Id": "e0930a7f-efae-4307-9d18-37a88119e9f2",
