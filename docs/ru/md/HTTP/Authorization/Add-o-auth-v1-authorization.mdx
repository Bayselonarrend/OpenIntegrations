...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "OAuth oauth_consumer_key=\"***\",oauth_token=\"***\",oauth_signature_method=\"HMAC-SHA256\",oauth_timestamp=\"1782589160\",oauth_nonce=\"1782589160\",oauth_version=\"1.0\",oauth_signature=EisZq8wftZO5vGry9%2FSdOqhnyShdRdPz9oVLRrLlkL8%3D",
  "Connection": "Keep-Alive",
  "Content-Length": "0",
  "Host": "bin.openintegrations.dev",
  "Max-Forwards": "10",
  "User-Agent": "1Script v$2.0.1.0",
  "X-Arr-Log-Id": "fb51d0be-e0a2-4c2f-aa54-de23595a8f91",
