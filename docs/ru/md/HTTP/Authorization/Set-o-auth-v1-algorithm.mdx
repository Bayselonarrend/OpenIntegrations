---
sidebar_position: 5
description: Установить алгоритм OAuth V1  и другие функции для работы с HTTP в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "OAuth oauth_consumer_key=\"***\",oauth_token=\"***\",oauth_signature_method=\"HMAC-SHA1\",oauth_timestamp=\"1770444973\",oauth_nonce=\"1770444973\",oauth_version=\"1.0\",oauth_signature=1Q3%2FS3WNuG%2B1fupvIH4ql%2Fy4kR0%3D",
  "Connection": "Keep-Alive",
  "Content-Length": "0",
  "Host": "bin.openintegrations.dev",
  "Max-Forwards": "10",
  "User-Agent": "1Script v$2.0.0.0",
  "X-Arr-Log-Id": "30227ca1-312c-4be2-bef2-b3d708564a05",
