---
sidebar_position: 2
description: Добавить Bearer авторизацию  и другие функции для работы с HTTP в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "X-Arr-Log-Id": "cfa20cfc-895f-4eeb-80a2-24dd7bcfaca1",
