...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Картинка = "https://releases.openintegrations.dev/test_data/picture.jpg"; // URL, Путь или Двоичные данные
...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "Authorization": "OAuth oauth_consumer_key=\"***\",oauth_token=\"***\",oauth_signature_method=\"HMAC-SHA256\",oauth_timestamp=\"1784367265\",oauth_nonce=\"1784367265\",oauth_version=\"1.0\",oauth_signature=RkCc9vqbn5kRiKbM%2B21UgY90Vaizs7j%2FcgUG9a%2FefPs%3D",
  "Connection": "Keep-Alive",
  "Content-Length": "2114378",
  "Content-Type": "multipart/form-data; boundary=dccb68685c954b59a24b7c50a81e59ba",
  "Host": "bin.openintegrations.dev",
  "Max-Forwards": "10",
  "User-Agent": "1Script v$2.0.1.0",
  "X-Arr-Log-Id": "128daa3f-e4f3-4769-8645-1163bb7c5f25",
