---
sidebar_position: 1
description: Получить количество сообщений к отправке и другие функции для работы с GreenAPI (Max) в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
:::tip
Метод в документации API: [GetMessagesCount](https://green-api.com/v3/docs/api/queues/GetMessagesCount/)
:::
<br/>
