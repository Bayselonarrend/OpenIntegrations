---
sidebar_position: 10
description: Перезапустить инстанс и другие функции для работы с GreenAPI (Max) в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
