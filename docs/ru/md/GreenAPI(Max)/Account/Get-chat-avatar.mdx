---
sidebar_position: 15
description: Получить аватар чата и другие функции для работы с GreenAPI (Max) в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
