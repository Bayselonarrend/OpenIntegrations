    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint vk ДобавитьТовар \
              --product "{'Имя':'Тестовый товар (со свойством)','Описание':'Описание товара','Категория':'20173','Цена':'1','СтараяЦена':'15','ОсновноеФото':'https://releases.openintegrations.dev/test_data/picture.jpg','URL':'https://github.com/Bayselonarrend/OpenIntegrations','ДополнительныеФото':['https://releases.openintegrations.dev/test_data/picture.jpg','https://releases.openintegrations.dev/test_data/picture2.jpg'],'ГлавныйВГруппе':true,'Ширина':'20','Высота':'30','Глубина':'40','Вес':'100','SKU':'12345','ДоступныйОстаток':'10','ЗначенияСвойств':'11403'}" \
