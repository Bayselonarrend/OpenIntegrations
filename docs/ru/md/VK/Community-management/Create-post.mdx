    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint vk СоздатьПост \
              ...
              --pictures "['https://github.com/Bayselonarrend/OpenIntegrations/raw/main/service/test_data/picture.jpg','C:\\Users\\Administrator\\AppData\\Local\\Temp\\jbrowji0us1.png']" \
              --ad true \
              --url "https://github.com/Bayselonarrend/OpenIntegrations" \
