    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint vk СоздатьИсторию \
              --picture ""C:\Users\bayse\AppData\Local\Temp\1avtsmbx.kol.png"" \
              --auth ""C:\Users\bayse\AppData\Local\Temp\bjp2rld4.aan.json""
        ```
    </TabItem>
  ...
  "items": [
   {
    ...
    "photo": {
     ...
     "text": "",
     "user_id": 100,
     "web_view_token": "f6540a96d0f404024d",
     "has_tags": false
    },
    "replies": {
     "count": 0,
    ...
    "track_code": "story_json/eyJvd25lcl9pZCI6LTIxODg2MTc1Niwic3RvcnlfaWQiOjQ1NjI0MTA4OCwidmlld2VyX2lkIjo2NTc4NDY3NTZ9",
    "type": "photo",
    "views": 0,
    "likes_count": 0,
