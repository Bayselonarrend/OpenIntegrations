    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint vk СоздатьИсторию \
              --picture "C:\Users\bayselonarrend\AppData\Local\Temp\3gx0a4st.ucr.png" \
  ...
  "items": [
   {
    ...
    "track_code": "story_json/eyJvd25lcl9pZCI6LTIxODg2MTc1Niwic3RvcnlfaWQiOjQ1NjI0MTY2MSwidmlld2VyX2lkIjo2NTc4NDY3NTZ9",
    "type": "photo",
    "views": 0,
    "likes_count": 0,
