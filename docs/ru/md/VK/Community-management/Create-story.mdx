    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint vk СоздатьИсторию \
              --picture ""/tmp/qd5cjlyj.psp.png"" \
              --auth ""/tmp/fdqlahmz.dxj.json""
        ```
    </TabItem>
  ...
  "items": [
   {
    ...
    "photo": {
     ...
     "text": "",
     "user_id": 100,
     "web_view_token": "8a7d79d4a351d8a7b9",
     "has_tags": false
    },
    "replies": {
     "count": 0,
    ...
    "track_code": "story_json/eyJvd25lcl9pZCI6LTIxODg2MTc1Niwic3RvcnlfaWQiOjQ1NjI0MTA0Miwidmlld2VyX2lkIjo2NTc4NDY3NTZ9",
    "type": "photo",
    "views": 0,
    "likes_count": 0,
