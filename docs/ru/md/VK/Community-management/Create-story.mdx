    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint vk СоздатьИсторию \
              --picture "C:\Users\bayselonarrend\AppData\Local\Temp\smlodahx.fml.png" \
  ...
  "items": [
   {
    ...
    "track_code": "story_json/eyJvd25lcl9pZCI6LTIxODg2MTc1Niwic3RvcnlfaWQiOjQ1NjI0MTUzOSwidmlld2VyX2lkIjo2NTc4NDY3NTZ9",
    "type": "photo",
    "views": 0,
    "likes_count": 0,
