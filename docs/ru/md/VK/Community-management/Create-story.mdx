    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint vk СоздатьИсторию \
              --picture ""/tmp/uqcze0hk.bcg.png"" \
              --auth ""/tmp/tdwx0r4w.yqx.json""
        ```
    </TabItem>
  ...
  "items": [
   {
    ...
    "photo": {
     ...
     "text": "",
     "user_id": 100,
     "web_view_token": "10d0112d1f3ab95da4",
     "has_tags": false
    },
    "replies": {
     "count": 0,
    ...
    "track_code": "story_json/eyJvd25lcl9pZCI6LTIxODg2MTc1Niwic3RvcnlfaWQiOjQ1NjI0MTA2OCwidmlld2VyX2lkIjo2NTc4NDY3NTZ9",
    "type": "photo",
    "views": 0,
    "likes_count": 0,
