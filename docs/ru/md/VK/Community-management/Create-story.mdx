    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint vk СоздатьИсторию \
              --picture "C:\Users\bayse\AppData\Local\Temp\ys2mjbzf.0i4.png" \
  ...
  "items": [
   {
    ...
    "photo": {
     ...
     "text": "",
     "user_id": 100,
     "web_view_token": "832daca8c5c507226b",
     "has_tags": false
    },
    "replies": {
     "count": 0,
    ...
    "track_code": "story_json/eyJvd25lcl9pZCI6LTIxODg2MTc1Niwic3RvcnlfaWQiOjQ1NjI0MTEyNCwidmlld2VyX2lkIjo2NTc4NDY3NTZ9",
    "type": "photo",
    "views": 0,
    "likes_count": 0,
