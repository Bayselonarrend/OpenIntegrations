    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint vk СоздатьИсторию \
              --picture ""/tmp/ymc3bf30.ehy.png"" \
              --auth ""/tmp/isbjlxjo.q3q.json""
        ```
    </TabItem>
  ...
  "items": [
   {
    ...
    "photo": {
     ...
     "text": "",
     "user_id": 100,
     "web_view_token": "62c6293d5fed242a7c",
     "has_tags": false
    },
    "replies": {
     "count": 0,
    ...
    "track_code": "story_json/eyJvd25lcl9pZCI6LTIxODg2MTc1Niwic3RvcnlfaWQiOjQ1NjI0MTA0MCwidmlld2VyX2lkIjo2NTc4NDY3NTZ9",
    "type": "photo",
    "views": 0,
    "likes_count": 0,
