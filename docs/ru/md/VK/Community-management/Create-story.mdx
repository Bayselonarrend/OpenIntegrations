    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint vk СоздатьИсторию \
              --picture "\"/tmp/2gbxaxsp.tsk.png\"" \
              --auth "\"/tmp/icsjuit4.w0r.json\""
        ```
    </TabItem>
  ...
  "items": [
   {
    ...
    "photo": {
     ...
     "text": "",
     "user_id": 100,
     "web_view_token": "98261c9f436d514a79",
     "has_tags": false
    },
    "replies": {
     "count": 0,
    ...
    "track_code": "story_json/eyJvd25lcl9pZCI6LTIxODg2MTc1Niwic3RvcnlfaWQiOjQ1NjI0MTAzMSwidmlld2VyX2lkIjo2NTc4NDY3NTZ9",
    "type": "photo",
    "views": 0,
    "likes_count": 0,
