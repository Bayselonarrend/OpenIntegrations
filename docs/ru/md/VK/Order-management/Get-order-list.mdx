  ...
  "preview_order_items": [
   {
    ...
    "item": {
     ...
     "is_owner": true,
     "is_adult": false,
     "thumb_photo": "https://sun1-84.userapi.com/impg/XRrzu8dbsPmwF35EnWBibiQ-Sgo7O5rgWY4fUg/wosvBQJa9bQ.jpg?size=0x400&q...",
     "cart_quantity": 0,
     "sku": "12 345",
     "reject_info": {
     ...
     "sizes": [
      {
       ...
       "type": "s",
       "width": "***",
       "url": "https://sun1-84.userapi.com/s/v1/ig2/31vvuOgBYo0XLpwmR4BsP1ilGbMDyMakBQIYLHejeBhcKeBHxTjKG25nKWgMCYP..."
      },
      {
       "height": 160,
       "type": "m",
