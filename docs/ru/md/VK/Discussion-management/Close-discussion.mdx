---
sidebar_position: 2
description: Закрыть обсуждение и другие функции для работы с VK в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint vk ЗакрытьОбсуждение \
              --topic "54112370" \
              --remove "false" \
              --auth ""C:\Users\bayse\AppData\Local\Temp\m3yvd1d4.azz.json""
        ```
    </TabItem>
