    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint vk ПолучитьСтатистику \
              --datefrom "\"2025-09-08T00:00:00\"" \
              --dateto "\"2025-09-08T23:59:59\"" \
              --auth "\"/tmp/x4y054s1.nyx.json\""
        ```
    </TabItem>
 ...
 "response": [
  {
   ...
   "period_from": 1757289600,
   "period_to": 1757375999,
   "reach": {
    "age": [
     {
      "value": "12-18",
  ...
  },
  {
   ...
   "period_from": 1757203200,
   "period_to": 1757289599,
   "reach": {
    "age": [
...
```
