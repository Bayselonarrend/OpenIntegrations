    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint vk ПолучитьСтатистику \
              --datefrom ""2025-09-17T00:00:00"" \
              --dateto ""2025-09-17T23:59:59"" \
              --auth ""C:\Users\bayse\AppData\Local\Temp\yfsvddx0.ug0.json""
        ```
    </TabItem>
 ...
 "response": [
  {
   ...
   "period_from": 1758067200,
   "period_to": 1758153599,
   "reach": {
    "age": [
     {
      "value": "12-18",
  ...
  },
  {
   ...
   "period_from": 1757980800,
   "period_to": 1758067199,
   "reach": {
    "age": [
...
```
