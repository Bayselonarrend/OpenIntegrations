    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint vk ПолучитьСтатистику \
              --datefrom ""2025-09-11T00:00:00"" \
              --dateto ""2025-09-11T23:59:59"" \
              --auth ""/tmp/jie4hssl.fqa.json""
        ```
    </TabItem>
 ...
 "response": [
  {
   ...
   "period_from": 1757548800,
   "period_to": 1757635199,
   "reach": {
    "age": [
     {
      "value": "12-18",
  ...
  },
  {
   ...
   "period_from": 1757462400,
   "period_to": 1757548799,
   "reach": {
    "age": [
...
```
