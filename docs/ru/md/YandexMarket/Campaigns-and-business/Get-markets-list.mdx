---
sidebar_position: 1
description: Получить список магазинов и другие функции для работы с YandexMarket в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
