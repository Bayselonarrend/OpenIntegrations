---
sidebar_position: 2
description: Получить магазин и другие функции для работы с Yandex Market в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
