---
sidebar_position: 4
description: Получить структуру товара и другие функции для работы с YandexMarket в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
