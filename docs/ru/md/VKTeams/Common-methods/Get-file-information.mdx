...
:::tip
Метод в документации API: [GET /files/getInfo](https://teams.vk.com/botapi/#/files/get_files_getInfo)<br/>
<br/>
:::
<br/>
...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    IDФайла  = "WDVpjxoc3tbwO9jVmsytwq673248631bd";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint vkteams ПолучитьИнформациюОФайле \
              --token "***" \
              --fileid "dYIQCZAacUoGnQ4sU6025C673cc91d1bd"
        ```
    </TabItem>
