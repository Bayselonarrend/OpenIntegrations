...
:::tip
Метод в документации API: [GET /messages/sendVoice](https://teams.vk.com/botapi/#/messages/get_messages_sendVoice)<br/>
<br/>
:::
<br/>
...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    IDФайла  = "I000bUV8sweEAf2AhDjFjo673248761bd";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint vkteams ПереслатьГолосовоеСообщение \
              ...
              --fileid "I000bEA6Vd6KBLkCJpmzNk673cc93b1bd"
        ```
    </TabItem>
