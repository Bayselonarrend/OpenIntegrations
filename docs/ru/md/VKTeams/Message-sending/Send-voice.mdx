...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Файл     = "https://releases.openintegrations.dev/test_data/song.m4a";        // URL
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint vkteams ОтправитьГолосовоеСообщение \
              --token "***" \
              --chatid "***" \
              --file "C:\Users\bayselonarrend\AppData\Local\Temp\cko5yqbc.uve"
        ```
    </TabItem>
...
{
 "fileId": "I000bcC81ptHpI5te4hS1T6a5d21181bd",
 "msgId": "7664318527817412581",
 "ok": true
}
```
