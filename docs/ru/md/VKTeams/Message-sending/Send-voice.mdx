...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    IDЦитируемого = "7646661947328322340";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint vkteams ОтправитьГолосовоеСообщение \
              --token "***" \
              --chatid "***" \
              --file "C:\Users\bayselonarrend\AppData\Local\Temp\2numxiy0.luf"
        ```
    </TabItem>
...
{
 "fileId": "I000bvUATZNx0Ivs2Fxqtt6a2a69261bd",
 "msgId": "7650042528971906346",
 "ok": true
}
```
