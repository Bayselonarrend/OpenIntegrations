...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Файл     = "https://releases.openintegrations.dev/test_data/document.docx";        // URL
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint vkteams ОтправитьФайл \
              --token "***" \
              --chatid "***" \
              --file "C:\Users\bayselonarrend\AppData\Local\Temp\1oteltee.ki3" \
...
{
 "fileId": "aAoxSvB5VPAlkHY4J8fK746a5d21051bd",
 "msgId": "7664318446213026899",
 "ok": true
}
```
