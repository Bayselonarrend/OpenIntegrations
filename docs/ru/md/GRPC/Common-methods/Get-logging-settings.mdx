...
description: Получить настройки логирования и другие функции для работы с GRPC в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    Результат = OPI_GRPC.ПолучитьНастройкиЛогирования(Истина, 100, ПолучитьИмяВременногоФайла());
```
...
```json title="Результат"
{
 "mode": "both",
 "max_entries": 100,
 "file_path": "C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\3uh3jmuo.3do"
}
```
