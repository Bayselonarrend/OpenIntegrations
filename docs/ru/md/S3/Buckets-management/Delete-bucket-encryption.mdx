...
description: Удалить шифрование бакета и другие функции для работы с S3 в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18ABB65A1121F713",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "6420",
  "X-Ratelimit-Remaining": "6420",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Sat, 02 May 2026 09:42:55 GMT"
 }
}
```
