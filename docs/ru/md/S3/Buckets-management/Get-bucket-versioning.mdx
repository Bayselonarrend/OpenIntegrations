...
`Функция ПолучитьНастройкиВерсионированияБакета(Знач Наименование, Знач ОсновныеДанные, Знач Каталог = Ложь, Знач Заголовки = Неопределено) Экспорт`
 ...
 <Tabs>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ПолучитьНастройкиВерсионированияБакета \
              --name "ff2e1e24" \
...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18ABB65A40EF38E8",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "6420",
  "X-Ratelimit-Remaining": "6420",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Sat, 02 May 2026 09:42:56 GMT",
