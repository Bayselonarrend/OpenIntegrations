    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ЗавершитьЗагрузкуЧастями \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLjRhZjFlZjdjLTdmZDItNDA5OC1iZDY4LTc3OTVkMTY0MDk3MA" \
...
```json title="Результат"
{
 ...
 "response": {
  "CompleteMultipartUploadResult": {
   "Location": "https://opi-gpbucket6.storage-155.s3hoster.by/fileChunked.mp3",
   "Bucket": "opi-gpbucket6",
   "Key": "***",
