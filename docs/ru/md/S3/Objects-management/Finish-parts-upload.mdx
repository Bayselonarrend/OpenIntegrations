    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ЗавершитьЗагрузкуЧастями \
              ...
              --upload "NGU4YWU5ZGItY2JiMC00Y2U4LThjM2QtY2QyODU2N2VkODVmLjdjNDAwYWFiLTRmNWYtNDE2ZS1iODQxLWJhMzBiODljNmM4N3gxNzcxMDI0NTQzMDgxMjAzNTA1" \
...
```json title="Результат"
{
 ...
 "response": {
  "CompleteMultipartUploadResult": {
   "Location": "http://s3.openintegrations.dev/7a9af49f/fileChunked.mp3",
   "Bucket": "7a9af49f",
   "Key": "***",
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "1893F1714953F488",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "3038",
  "X-Ratelimit-Remaining": "3038",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Fri, 13 Feb 2026 23:15:47 GMT",
