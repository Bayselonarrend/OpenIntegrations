    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ЗагрузитьОбъект \
              ...
              --basic "{'URL':'storage-564.s3hoster.by','AccessKey':'***','SecretKey':'***','Region':'BTC','Service':'s3','ChunkSize':'5242880'}" \
              --dir true
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "headers": {
  "Accept-Ranges": "bytes",
  "Date": "Sun, 14 Dec 2025 18:10:12 GMT",
  ...
  "X-Amz-Request-Id": "18812757DD774696",
