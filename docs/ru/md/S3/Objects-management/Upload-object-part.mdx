    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ЗагрузитьЧастьОбъекта \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLmU5NWM2NTQxLWRiZWUtNDMyOS1hNzRlLTZkZWI0ZGVhYTAxOQ" \
              --part 2 \
              --content "C:\Users\Administrator\AppData\Local\Temp\0mwpx5r35wb.tmp"
        ```
    </TabItem>
