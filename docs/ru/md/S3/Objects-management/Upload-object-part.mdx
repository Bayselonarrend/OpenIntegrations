---
sidebar_position: 4
description:  Загружает часть объекта при загрузке по частямСтраницы
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ЗагрузитьЧастьОбъекта \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLjk2ZWU2ZDliLWVjZmItNDY5Ny05YmQ4LWU0Zjg2NTcwZDUzZA" \
              --part 2 \
              --content "C:\Users\Administrator\AppData\Local\Temp\2uzv0n0tvgr.tmp"
        ```
    </TabItem>
