    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ЗагрузитьЧастьОбъекта \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLjBjYWYwNTZiLTMxZmYtNDQ4Mi1hMWI1LTExOWVmNGI5OWQ3MQ" \
              --part 2 \
              --content "C:\Users\Administrator\AppData\Local\Temp\kdfuqznudau.tmp"
        ```
    </TabItem>
