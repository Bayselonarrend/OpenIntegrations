    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ЗагрузитьЧастьОбъекта \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLjZmYzhlZWEzLTJkNmYtNDBkZi04NjhkLTM1M2U5ZDAwNWZhMg" \
              --part 2 \
              --content "C:\Users\bayse\AppData\Local\Temp\1evz0tegmfo.tmp"
        ```
    </TabItem>
