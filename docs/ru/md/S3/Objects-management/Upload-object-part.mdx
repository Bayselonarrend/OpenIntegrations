    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ЗагрузитьЧастьОбъекта \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLmE4MGU5YzBiLTc3NGUtNDZlMi04Mzk2LTE5OGY3NWNmYzZmNw" \
              --part 2 \
              --content "C:\Users\Administrator\AppData\Local\Temp\2jgfcputkil.tmp"
        ```
    </TabItem>
