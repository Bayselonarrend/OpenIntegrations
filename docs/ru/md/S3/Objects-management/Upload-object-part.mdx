    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ЗагрузитьЧастьОбъекта \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLmY2MmM5YWE4LWQ4YTktNDg4ZC05MzJhLWEyNjlkODhkMjBkMg" \
              --part 2 \
              --content "C:\Users\bayse\AppData\Local\Temp\kyxuchhyd0t.tmp"
        ```
    </TabItem>
