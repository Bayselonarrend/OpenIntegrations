    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ЗагрузитьЧастьОбъекта \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLmVmM2I3YTFjLWI4ZWUtNDBiZC1hN2JkLThiZjhhZTU1OWMzNA" \
              --part 2 \
              --content "C:\Users\Administrator\AppData\Local\Temp\bypryd3ujeg.tmp"
        ```
    </TabItem>
