    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ЗагрузитьЧастьОбъекта \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLmI0NGQxNzZlLTYwZWItNDM5OC1iMGVkLWVkZmQ0NzJkMmY5MQ" \
              --part 2 \
              --content "C:\Users\Administrator\AppData\Local\Temp\akxp1jfjfon.tmp"
        ```
    </TabItem>
