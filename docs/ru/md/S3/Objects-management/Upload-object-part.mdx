    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ЗагрузитьЧастьОбъекта \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLmQ1ZDFmMTczLTkzMjYtNDBiYi1hNjRmLTQ1ZGQ0ZWI3YTc5MQ" \
              --part 2 \
              --content "C:\Users\bayse\AppData\Local\Temp\b5dlrkuu1xv.tmp"
        ```
    </TabItem>
