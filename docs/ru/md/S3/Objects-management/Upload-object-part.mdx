    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ЗагрузитьЧастьОбъекта \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLmU5YjNlNzhhLWFkNGUtNDdjNy1hOGQwLTQxNjVhODY2NDEwMA" \
              --part 2 \
              --content "C:\Users\Administrator\AppData\Local\Temp\cmulolbmvgz.tmp"
        ```
    </TabItem>
