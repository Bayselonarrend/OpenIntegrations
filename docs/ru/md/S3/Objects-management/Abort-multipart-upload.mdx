    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ОтменитьЗагрузкуЧастями \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLjZkODcxYWY0LTk2YjEtNGZhOS1hMGJjLTYzMDM5ZDc2NWMyOQ" \
              --dir true
        ```
    </TabItem>
