    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ОтменитьЗагрузкуЧастями \
              ...
              --upload "NGU4YWU5ZGItY2JiMC00Y2U4LThjM2QtY2QyODU2N2VkODVmLmVhYmZiOWUyLWE5MGMtNDYzZC05NTI5LTNmYmNhMjJhM2Y3YXgxNzcyODE3OTIwMzk3MzQxNjI1" \
              --dir true
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "189A5081C4375DFA",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "3088",
  "X-Ratelimit-Remaining": "3088",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Fri, 06 Mar 2026 17:25:21 GMT"
 }
}
```
