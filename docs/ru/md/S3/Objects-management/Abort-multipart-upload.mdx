    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ОтменитьЗагрузкуЧастями \
              ...
              --upload "MGI2Y2U2YTAtMDYxZC00NzkwLTk3YmEtOTM0NDY2MWFjZGYwLjM4OTAyMDlkLTE4OWItNDcxNS1hN2Y1LTdlZDk1NDVkMDY1ZngxNzc3Mjk5NTY3MDY2NTcwMjA2" \
              --dir true
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "18AA3C8A4F145693",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "6525",
  "X-Ratelimit-Remaining": "6525",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Mon, 27 Apr 2026 14:19:26 GMT"
 }
}
```
