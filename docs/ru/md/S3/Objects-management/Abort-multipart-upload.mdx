    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint s3 ОтменитьЗагрузкуЧастями \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLjc1ZTMwOWI5LTU0NzgtNDRlMy05ZmUyLWY3NzliMjU2YTQ4Zg" \
              --dir true
        ```
    </TabItem>
