    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ОтменитьЗагрузкуЧастями \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLjJlYjUyYzBkLTk3MWYtNDdjNC05ZmZlLTg0MDEyYTQzNzM3Ng" \
              --dir false
        ```
    </TabItem>
