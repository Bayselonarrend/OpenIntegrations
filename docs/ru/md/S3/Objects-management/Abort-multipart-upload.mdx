    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ОтменитьЗагрузкуЧастями \
              ...
              --upload "NGU4YWU5ZGItY2JiMC00Y2U4LThjM2QtY2QyODU2N2VkODVmLjFkMDA3ODdkLTQ5YjEtNGFhNS05NTcyLTJiZjc5NjRmNDM1N3gxNzcwMzU5ODc2NTU5MzMxNDky" \
              --dir true
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "189194EE3AC96276",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "3006",
  "X-Ratelimit-Remaining": "3006",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Fri, 06 Feb 2026 06:37:59 GMT"
 }
}
```
