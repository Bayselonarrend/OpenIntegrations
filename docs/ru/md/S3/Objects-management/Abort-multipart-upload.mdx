    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint s3 ОтменитьЗагрузкуЧастями \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLjVhMmMwYTA3LTNjNzAtNDE5OS1hZGZjLTlkNzMzNWI5MzMyMA" \
              --dir true
        ```
    </TabItem>
