    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint s3 ОтменитьЗагрузкуЧастями \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLmFjNjBkNzZlLTFjM2ItNDQ5ZS05MmIzLTE4NmEwYjM2NDMzYQ" \
              --dir true
        ```
    </TabItem>
