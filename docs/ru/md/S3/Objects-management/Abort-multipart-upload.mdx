    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint s3 ОтменитьЗагрузкуЧастями \
              ...
              --basic "\"/tmp/uxjqdsku.zaz.json\"" \
              --upload "\"MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLmI5Y2QxMzg4LTE1YTYtNDY1MS04NDk1LTg5MTg1MWUzMmNiOQ\"" \
              --dir "true"
        ```
    </TabItem>
