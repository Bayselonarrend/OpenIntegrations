---
sidebar_position: 6
description:  Отменяет загрузку объекта по частямСтраницы
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ОтменитьЗагрузкуЧастями \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLmI0YmRlMTY3LWRhOGQtNDExYi1iZmI0LWE0Mzg1Y2VkODI4YQ"
        ```
    </TabItem>
