    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ОтменитьЗагрузкуЧастями \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLmRmNTZkYTViLTQ4MjItNDc1Ny05NmUyLTAyOTIwMjBhYWY4MA" \
              --dir true
        ```
    </TabItem>
