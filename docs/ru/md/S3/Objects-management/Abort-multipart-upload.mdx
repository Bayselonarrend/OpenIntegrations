    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ОтменитьЗагрузкуЧастями \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLmZhYzg2MmE0LTZhMGQtNDM5NS05ZTdmLTE0YTg3YTA0N2VlZQ" \
              --dir true
        ```
    </TabItem>
