    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 ОтменитьЗагрузкуЧастями \
              ...
              --upload "NGU4YWU5ZGItY2JiMC00Y2U4LThjM2QtY2QyODU2N2VkODVmLjNkMWNjYzZlLTMwOGMtNGRjYS04OTQyLTZhZWQ2MjQwMjM4MHgxNzY5NTQ0MjQ0MjUwNzEyMTg4" \
              --dir true
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "188EAF1DBCC1DF5C",
  "X-Content-Type-Options": "nosniff",
  "X-Ratelimit-Limit": "3016",
  "X-Ratelimit-Remaining": "3016",
  "X-XSS-Protection": "1; mode=block",
  "X-Powered-By": "ARR/3.0",
  "Date": "Tue, 27 Jan 2026 20:04:05 GMT"
 }
}
```
