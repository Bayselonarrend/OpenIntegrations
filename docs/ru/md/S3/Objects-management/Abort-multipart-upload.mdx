    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint s3 ОтменитьЗагрузкуЧастями \
              ...
              --upload "MDk2NGE5MDUtNDcxZS00ZDljLTkzYjMtODM5ZDM4NGMyMWVhLjNmZTgyMzk2LWY0NGYtNDM4My04NThiLTlkMjM0YWYyMWQ2Yw" \
              --dir true
        ```
    </TabItem>
