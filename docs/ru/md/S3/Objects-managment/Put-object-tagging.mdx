...
:::tip
Установка нового набора удаляет все существующие теги объекта<br/>
Метод в документации AWS: [PutObjectTagging](https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutObjectTagging.html)<br/>
<br/>
:::
<br/>
