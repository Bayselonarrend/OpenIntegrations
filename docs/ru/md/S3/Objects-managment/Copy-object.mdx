...
:::tip
Метод в документации AWS: [CopyObject](https://docs.aws.amazon.com/AmazonS3/latest/API/API_CopyObject.html)<br/>
<br/>
:::
<br/>
...
```json title="Результат"
{
 ...
 "response": {
  "CopyObjectResult": {
   "LastModified": "2024-11-20T17:13:08.193Z",
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "1809BC7FA0572BE5",
