...
:::tip
Метод в документации AWS: [PutBucketEncryption](https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutBucketEncryption.html)<br/>
<br/>
:::
<br/>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint s3 УстановитьШифрованиеБакета \
              ...
              --conf "C:\Users\Administrator\AppData\Local\Temp\cdwfd1r4z1z.xml" \
              --dir false
        ```
    </TabItem>
