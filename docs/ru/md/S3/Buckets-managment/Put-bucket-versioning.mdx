...
:::tip
Метод в документации AWS: [PutBucketVersioning](https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutBucketVersioning.html)<br/>
<br/>
:::
<br/>
...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "1809AD12F4CF55BC",
