...
:::tip
Метод в документации AWS: [DeleteBucketEncryption](https://docs.aws.amazon.com/AmazonS3/latest/API/API_DeleteBucketEncryption.html)<br/>
<br/>
:::
<br/>
...
```json title="Результат"
{
 ...
 "headers": {
  ...
  "X-Amz-Request-Id": "1809AD12EB8C78EC",
