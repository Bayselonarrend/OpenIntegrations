    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint 7z ПолучитьМетаданные \
              --src "C:\Users\bayselonarrend\AppData\Local\Temp\\opi_sevenz_meta_63920123002563/archive_lzma.7z"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "entries": [
  {
   "access_time": 1784488173,
   "compressed_size": 15,
   "crc": 531809357,
   "creation_time": 1784488173,
   "directory": false,
   "has_stream": true,
   "modified_time": 1784488173,
   "name": "docs/note.txt",
   "size": 11
  },
  {
