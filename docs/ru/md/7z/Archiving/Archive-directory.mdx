...
`Функция АрхивироватьКаталог(Знач Каталог, Знач ПутьАрхива = "", Знач Настройки = Неопределено) Экспорт`
  ...
  |-|-|-|-|-|
  | Каталог | --src | Строка, Соответствие Из КлючИЗначение | &#x2714; | Путь к каталогу или описание. См. [`ПолучитьСтруктуруОписанияАрхива`](/docs/7z/Archiving/Get-archive-description-structure) |
