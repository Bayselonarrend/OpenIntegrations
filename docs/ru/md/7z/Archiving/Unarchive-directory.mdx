    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint 7z РазархивироватьКаталог \
              --src "C:\Users\bayselonarrend\AppData\Local\Temp\\opi_sevenz_63920122775899/archive.7z" \
              --dest "C:\Users\bayselonarrend\AppData\Local\Temp\\opi_sevenz_63920122775899/out"
        ```
    </TabItem>
