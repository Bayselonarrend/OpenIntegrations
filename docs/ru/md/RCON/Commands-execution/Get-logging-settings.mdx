...
description: Получить настройки логирования  и другие функции для работы с RCON в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
```json title="Результат"
{
 "mode": "both",
 "max_entries": 100,
 "file_path": "C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\g0st43nt.ire"
}
```
