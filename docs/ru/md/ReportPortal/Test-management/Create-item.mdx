    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal СоздатьЭлемент \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'name':'Test','startTime':'1/1/2026 10:00:00 AM','type':'test','description':'Test launch','launchUuid':'d6d68b53-ee01-495c-8d10-62302cd46436'}"
        ```
    </TabItem>
...
{
 "id": "37e4792b-fcc9-4ff5-a1e5-b1afff76c3d6",
