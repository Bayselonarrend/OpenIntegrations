    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal СоздатьЭлемент \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'name':'Test','startTime':'01/01/2026 10:00:00','type':'test','description':'Test launch','launchUuid':'fbfa6599-7fc7-4d0c-a752-590d2ed5b166'}"
        ```
    </TabItem>
...
{
 "id": "434bd8d7-3efb-4c0e-93cf-1f61a0d76a5d",
