    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal СоздатьЭлемент \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'name':'Test','startTime':'01/01/2026 10:00:00','type':'test','description':'Test launch','launchUuid':'a2343777-36ee-426e-9255-0832da1a10ec'}"
        ```
    </TabItem>
...
{
 "id": "0648de90-9236-43e0-8283-07f2891c694d",
