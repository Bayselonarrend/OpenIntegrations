    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal СоздатьЭлемент \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'name':'Test','startTime':'01/01/2026 10:00:00','type':'test','description':'Test launch','launchUuid':'a2dcd42e-73d2-454a-9575-e76a5f35666a'}"
        ```
    </TabItem>
...
{
 "id": "02c52a60-0405-4e0c-a628-597476f6b5e3",
