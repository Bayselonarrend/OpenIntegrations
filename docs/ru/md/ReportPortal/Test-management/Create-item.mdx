    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal СоздатьЭлемент \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'name':'Test','startTime':'1/1/2026 10:00:00 AM','type':'test','description':'Test launch','launchUuid':'2f273790-da97-4c97-b81f-97766a023dd6'}"
        ```
    </TabItem>
...
{
 "id": "59d5d8bd-5ee9-4be6-b550-b8bb80e973a2",
