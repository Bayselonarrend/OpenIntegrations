    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal СоздатьЭлемент \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'name':'Test','startTime':'01/01/2026 10:00:00','type':'test','description':'Test launch','launchUuid':'4f6e020d-cbb6-4fbd-b414-cdc5a2c127fe'}"
        ```
    </TabItem>
...
{
 "id": "aa6ade5d-1387-4f4f-a0a4-e697363c7c35",
