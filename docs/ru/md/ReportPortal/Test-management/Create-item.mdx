    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal СоздатьЭлемент \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'name':'Test','startTime':'1/1/2026 10:00:00 AM','type':'test','description':'Test launch','launchUuid':'bd1295dd-d8ca-4ed4-86df-bb600ca83583'}"
        ```
    </TabItem>
...
{
 "id": "b79f4816-9ae0-454e-afc6-02a10c7d3cec",
