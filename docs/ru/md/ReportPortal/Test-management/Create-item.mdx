    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal СоздатьЭлемент \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'name':'Test','startTime':'01/01/2026 10:00:00','type':'test','description':'Test launch','launchUuid':'a66b7511-996f-4895-9e1a-c3028f1d50f6'}"
        ```
    </TabItem>
...
{
 "id": "e067838a-c814-4a81-931d-d83ece4cd0f2",
