    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal СоздатьЭлемент \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'name':'Test','startTime':'01/01/2026 10:00:00','type':'test','description':'Test launch','launchUuid':'0fe1fd93-2dec-40b6-a5ff-05aadc475c60'}"
        ```
    </TabItem>
...
{
 "id": "b635be0f-8cc1-46a1-af38-1defec2ca769",
