    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint rportal СоздатьЭлемент \
              ...
              --token "***" \
              --proj "Test" \
              --params "{'name':'Test','startTime':'01/01/2026 10:00:00','type':'test','description':'Test launch','launchUuid':'2091abc6-198a-48a5-94ec-81385ac1e441'}"
        ```
    </TabItem>
...
{
 "id": "219eb935-fa73-4175-af3b-897d822a2249",
