...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    UUIDЗапуска = "cb951f92-5e40-481c-93b2-c55cea50a183";
    Проект      = "Test";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint rportal ПолучитьЗапуск \
              ...
              --token "***" \
              --proj "Test" \
              --uuid "5c5935a5-8270-42f8-a990-a422a5ee2ef6"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "locked": false,
 "id": 677,
 "uuid": "12dd323a-690b-46b7-8856-74a74295edf4",
 "name": "Test",
 "number": 439,
 "startTime": "2026-01-01T10:00:00Z",
 "lastModified": "2026-07-19T19:08:44.889272Z",
 "status": "IN_PROGRESS",
 "statistics": {
  "executions": {},
  "defects": {}
