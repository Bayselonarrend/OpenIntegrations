...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    UUIDЗапуска = "af98edb4-9615-4ded-b542-e3f106fabd9c";
    Проект      = "Test";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint rportal ПолучитьЗапуск \
              ...
              --token "***" \
              --proj "Test" \
              --uuid "972ae899-22ff-422e-a49a-30f0bbb54824"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "locked": false,
 "id": 93,
 "uuid": "20093584-0ed5-4daf-81a8-60c9cf5e5cb5",
 "name": "Test",
 "number": 61,
 "startTime": "2026-01-01T10:00:00Z",
 "lastModified": "2026-04-23T14:21:36.061411Z",
 "status": "IN_PROGRESS",
 "statistics": {
  "executions": {},
  "defects": {}
