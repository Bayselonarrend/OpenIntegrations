    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint rportal ПолучитьСтруктуруЛога \
              --launch "c0cc3abb-e745-455f-bd82-ecf0e299cf22" \
              --id "e0c92bd1-1e4d-4686-b15f-910ac1bbd2b6" \
...
{
 "launchUuid": "823e242a-a6ec-4db9-8347-f94446d22de6",
 "itemUuid": "0bdacd56-9738-418b-afe2-e2dfa890b881",
 "time": "1767258010",
 "message": "Some log",
 "level": "info"
}
