    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint janx ДесериализоватьДанные \
              --data "\nНепредвиденная ошибка!: {Модуль {C:\Program Files (x86)\OInt\share\oint\lib\oint-cli\core\Classes\internal\Modules\Executor.os}:13:<exec> / Error in line: 3 / Property 'OPI_Janx' is not writable}\nOPI_Janx = ЗагрузитьСценарий("C:/Program Files (x86)/OInt/share/oint/lib/oint/formats/janx/Modules/OPI_Janx.os", Контекст);\n\n"
        ```
    </TabItem>
