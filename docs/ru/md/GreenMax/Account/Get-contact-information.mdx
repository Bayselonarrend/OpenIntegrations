...
description: Получить информацию о контакте и другие функции для работы с GreenMax в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
:::tip
Метод в документации API: [GetContactInfo](https://green-api.com/v3/docs/api/service/GetContactInfo/)
:::
<br/>
 ...
 <Tabs>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint greenmax ПолучитьИнформациюОКонтакте \
