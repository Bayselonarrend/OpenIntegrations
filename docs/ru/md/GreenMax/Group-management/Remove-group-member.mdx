...
description: Удалить участника группы и другие функции для работы с GreenMax в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
`Функция УдалитьУчастникаГруппы(Знач ПараметрыДоступа, Знач IDЧата, Знач IDУчастника) Экспорт`
  ...
  | IDУчастника | --member | Строка | &#x2714; | ID участника для удаления |
...
:::tip
Метод в документации API: [RemoveGroupParticipant](https://green-api.com/v3/docs/api/groups/RemoveGroupParticipant/)
:::
<br/>
 ...
 <Tabs>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint greenmax УдалитьУчастникаГруппы \
