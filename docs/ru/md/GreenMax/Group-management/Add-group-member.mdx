...
description: Добавить участника группы и другие функции для работы с GreenMax в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
`Функция ДобавитьУчастникаГруппы(Знач ПараметрыДоступа, Знач IDЧата, Знач IDУчастника) Экспорт`
  ...
  | IDУчастника | --member | Строка | &#x2714; | ID участника для добавления |
...
:::tip
Метод в документации API: [AddGroupParticipant](https://green-api.com/v3/docs/api/groups/AddGroupParticipant/)
:::
<br/>
 ...
 <Tabs>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint greenmax ДобавитьУчастникаГруппы \
