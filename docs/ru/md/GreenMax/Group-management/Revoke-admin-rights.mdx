...
description: Отозвать права администратора и другие функции для работы с GreenMax в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
:::tip
Метод в документации API: [RemoveAdmin](https://green-api.com/v3/docs/api/groups/RemoveAdmin/)
:::
<br/>
 ...
 <Tabs>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint greenmax ОтозватьПраваАдминистратора \
