    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "2fb82aa7-fc4e-8165-bd42-dfcbbed755cf" \
...
{
 "object": "page",
 "id": "2fb82aa7-fc4e-817d-8daf-c857d51d0ba1",
 "created_time": "2026-02-02T19:43:00Z",
 "last_edited_time": "2026-02-02T19:43:00Z",
 "created_by": {
  "object": "user",
 ...
 "url": "https://www.notion.so/2fb82aa7fc4e817d8dafc857d51d0ba1",
 "public_url": null,
 "request_id": "9f2c112d-ede9-4f55-bcc5-69f25685a89c"
}
```
