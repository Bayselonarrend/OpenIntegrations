    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint notion ИзменитьСвойстваСтраницы \
              --token *** \
              --page "26882aa7-fc4e-817a-ab1c-e75138344523" \
...
{
 "object": "page",
 "id": "26882aa7-fc4e-817a-ab1c-e75138344523",
 ...
 "url": "https://www.notion.so/26882aa7fc4e817aab1ce75138344523",
 "public_url": null,
 "request_id": "5afddd8e-cd52-4372-9c7e-3220bfaebb84"
}
```
