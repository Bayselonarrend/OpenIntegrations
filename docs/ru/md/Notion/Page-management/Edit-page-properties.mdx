    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "2c682aa7-fc4e-8156-a242-dc6c8190909a" \
...
{
 "object": "page",
 "id": "2db82aa7-fc4e-8162-9d87-eb4edae38c9e",
 ...
 "url": "https://www.notion.so/2db82aa7fc4e81629d87eb4edae38c9e",
 "public_url": null,
 "request_id": "c2595698-4fa6-4cea-a844-66b90b90cf67"
}
```
