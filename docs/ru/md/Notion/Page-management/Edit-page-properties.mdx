    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "31b82aa7-fc4e-8162-965e-e1a2ae1f04ff" \
...
{
 "object": "page",
 "id": "31b82aa7-fc4e-8162-965e-e1a2ae1f04ff",
 ...
 "url": "https://www.notion.so/31b82aa7fc4e8162965ee1a2ae1f04ff",
 "public_url": null,
 "request_id": "11f031d1-5028-4bd0-98b1-d64ba64ecc5c"
}
```
