    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "2c282aa7-fc4e-818c-91af-c71d816d62db" \
...
{
 "object": "page",
 "id": "2c282aa7-fc4e-818c-91af-c71d816d62db",
 ...
 "url": "https://www.notion.so/2c282aa7fc4e818c91afc71d816d62db",
 "public_url": null,
 "request_id": "5f2a5e4e-748d-4612-ad30-467d1de63f58"
}
```
