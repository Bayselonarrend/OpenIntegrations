    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "37982aa7-fc4e-8102-abe7-f64ec71f324d" \
...
{
 "object": "page",
 "id": "37982aa7-fc4e-8189-bd21-ff991ac664da",
 ...
 "url": "https://app.notion.com/p/37982aa7fc4e8189bd21ff991ac664da",
 "public_url": null,
 "archived": false,
 "request_id": "cbd4f85f-594b-4c20-adbd-b0226c71c3bb"
}
```
