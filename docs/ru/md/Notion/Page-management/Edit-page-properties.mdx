    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "31a82aa7-fc4e-8131-b7bc-c774264a110c" \
...
{
 "object": "page",
 "id": "31a82aa7-fc4e-8131-b7bc-c774264a110c",
 "created_time": "2026-03-05T08:12:00Z",
 ...
 "url": "https://www.notion.so/31a82aa7fc4e8131b7bcc774264a110c",
 "public_url": null,
 "request_id": "7cff8b04-fffa-4d69-a225-8d92e331e339"
}
```
