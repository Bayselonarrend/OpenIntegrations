    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "27082aa7-fc4e-8105-b25e-de296a2e0c85" \
...
{
 "object": "page",
 "id": "27082aa7-fc4e-8105-b25e-de296a2e0c85",
 ...
 "url": "https://www.notion.so/27082aa7fc4e8105b25ede296a2e0c85",
 "public_url": null,
 "request_id": "e069e752-e269-46fd-bf34-216c0112d4de"
}
```
