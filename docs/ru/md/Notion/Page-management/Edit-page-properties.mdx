    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "33c82aa7-fc4e-81eb-b378-d73142e9fcf3" \
...
{
 "object": "page",
 "id": "33c82aa7-fc4e-81eb-b378-d73142e9fcf3",
 ...
 "url": "https://www.notion.so/33c82aa7fc4e81ebb378d73142e9fcf3",
 "public_url": null,
 "archived": false,
 "request_id": "6dc85217-bd72-485b-99d1-378c5924f7b1"
}
```
