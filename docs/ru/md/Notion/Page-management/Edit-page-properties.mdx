...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Страница     = "2df82aa7-fc4e-817f-94d7-dd5ae2ac1b09";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "2e082aa7-fc4e-81f7-af35-d6dfc143a390" \
...
{
 "object": "page",
 "id": "2e082aa7-fc4e-810f-a5d7-fdef5654a379",
 "created_time": "2026-01-06T04:16:00Z",
 "last_edited_time": "2026-01-06T04:16:00Z",
 "created_by": {
  "object": "user",
 ...
 "url": "https://www.notion.so/2e082aa7fc4e810fa5d7fdef5654a379",
 "public_url": null,
 "request_id": "fb0cb167-ca8b-4116-bb2e-a27f7d02fd09"
}
```
