...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Иконка       = "https://releases.openintegrations.dev/test_data/picture.jpg";
    Обложка      = "https://releases.openintegrations.dev/test_data/picture2.jpg";
    Архивировать = Ложь;
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "39482aa7-fc4e-8149-b0b1-def405dd1956" \
...
{
 "object": "page",
 "id": "39e82aa7-fc4e-8101-950a-cd84ffbbbd38",
 ...
 "url": "https://app.notion.com/p/39e82aa7fc4e8101950acd84ffbbbd38",
 "public_url": null,
 "archived": false,
 "request_id": "246a9d04-6dfd-4b56-bd1f-ad297366b54a"
}
```
