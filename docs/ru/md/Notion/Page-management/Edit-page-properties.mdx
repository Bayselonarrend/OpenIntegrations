...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Страница     = "29a82aa7-fc4e-816f-a287-e8f5ece475c4";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "29b82aa7-fc4e-817d-9725-de893b788d7f" \
...
{
 "object": "page",
 "id": "29b82aa7-fc4e-817d-9725-de893b788d7f",
 ...
 "url": "https://www.notion.so/29b82aa7fc4e817d9725de893b788d7f",
 "public_url": null,
 "request_id": "66ed16a5-9d18-484f-9ca5-3d538bf6b3f7"
}
```
