    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "\"26882aa7-fc4e-8176-9537-f4263f14b8fb\"" \
              --data "\"/tmp/kcnwcl2o.4qd.json\"" \
...
{
 "object": "page",
 "id": "26882aa7-fc4e-8176-9537-f4263f14b8fb",
 ...
 "url": "https://www.notion.so/26882aa7fc4e81769537f4263f14b8fb",
 "public_url": null,
 "request_id": "fac198f3-f9fd-4d68-9c40-00e68368524d"
}
```
