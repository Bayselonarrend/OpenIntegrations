    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "30682aa7-fc4e-8186-a35c-e717bb3a17d3" \
...
{
 "object": "page",
 "id": "30682aa7-fc4e-8186-a35c-e717bb3a17d3",
 ...
 "url": "https://www.notion.so/30682aa7fc4e8186a35ce717bb3a17d3",
 "public_url": null,
 "request_id": "5a5f43da-a7ed-4b14-8491-c438695755f2"
}
```
