    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint notion ИзменитьСвойстваСтраницы \
              --token *** \
              --page "26882aa7-fc4e-8114-b56f-f53b9e0053a5" \
...
{
 "object": "page",
 "id": "26882aa7-fc4e-8114-b56f-f53b9e0053a5",
 ...
 "url": "https://www.notion.so/26882aa7fc4e8114b56ff53b9e0053a5",
 "public_url": null,
 "request_id": "fa139397-0f09-4357-b93d-ce7fc78c8ad7"
}
```
