    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "2fc82aa7-fc4e-81ee-93bc-fc559432e703" \
...
{
 "object": "page",
 "id": "2fc82aa7-fc4e-81ee-93bc-fc559432e703",
 ...
 "url": "https://www.notion.so/2fc82aa7fc4e81ee93bcfc559432e703",
 "public_url": null,
 "request_id": "09378fd1-86d3-4190-ab60-e0114ab9737c"
}
```
