    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "30682aa7-fc4e-814c-9a71-f71d772f0729" \
...
{
 "object": "page",
 "id": "30682aa7-fc4e-814c-9a71-f71d772f0729",
 ...
 "url": "https://www.notion.so/30682aa7fc4e814c9a71f71d772f0729",
 "public_url": null,
 "request_id": "227bce60-22c1-4dc4-b0bd-f4fba0254a8b"
}
```
