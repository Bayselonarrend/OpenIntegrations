    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint notion ИзменитьСвойстваСтраницы \
              --token *** \
              --page "26982aa7-fc4e-819e-bcf6-f66d7da88304" \
...
{
 "object": "page",
 "id": "26982aa7-fc4e-819e-bcf6-f66d7da88304",
 ...
 "url": "https://www.notion.so/26982aa7fc4e819ebcf6f66d7da88304",
 "public_url": null,
 "request_id": "7cf1330c-b4fa-4ba3-b09e-51c92d9c77a0"
}
```
