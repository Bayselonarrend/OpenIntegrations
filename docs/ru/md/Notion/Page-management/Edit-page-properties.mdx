    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "37882aa7-fc4e-8173-a485-cba65713346a" \
...
{
 "object": "page",
 "id": "37782aa7-fc4e-81b4-a3dc-dd79e28ecf12",
 ...
 "url": "https://app.notion.com/p/37782aa7fc4e81b4a3dcdd79e28ecf12",
 "public_url": null,
 "archived": false,
 "request_id": "22de2813-fdd6-47bf-b1c8-cec81dc93fc9"
}
```
