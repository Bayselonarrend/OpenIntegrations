    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "27182aa7-fc4e-81f1-b37f-f03732fe7e8a" \
...
{
 "object": "page",
 "id": "27182aa7-fc4e-81f1-b37f-f03732fe7e8a",
 ...
 "url": "https://www.notion.so/27182aa7fc4e81f1b37ff03732fe7e8a",
 "public_url": null,
 "request_id": "d43fb2be-f81f-4e2b-9a73-2bbc495a198f"
}
```
