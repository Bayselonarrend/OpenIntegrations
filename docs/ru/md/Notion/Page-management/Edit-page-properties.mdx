    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "2f582aa7-fc4e-814a-90e8-d720ea545575" \
...
{
 "object": "page",
 "id": "2f582aa7-fc4e-814a-90e8-d720ea545575",
 ...
 "url": "https://www.notion.so/2f582aa7fc4e814a90e8d720ea545575",
 "public_url": null,
 "request_id": "d5152fb1-c9b8-43bc-b72f-07f2cc3cab2b"
}
```
