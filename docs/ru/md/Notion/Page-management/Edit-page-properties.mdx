    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "2fe82aa7-fc4e-8144-8d2d-f9509cd3e81f" \
...
{
 "object": "page",
 "id": "2fe82aa7-fc4e-8144-8d2d-f9509cd3e81f",
 ...
 "url": "https://www.notion.so/2fe82aa7fc4e81448d2df9509cd3e81f",
 "public_url": null,
 "request_id": "900652db-3917-4090-8723-9028d740255c"
}
```
