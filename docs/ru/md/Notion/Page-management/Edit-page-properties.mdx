    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "34082aa7-fc4e-81ae-b36e-d90e7a212d70" \
...
{
 "object": "page",
 "id": "34082aa7-fc4e-81ae-b36e-d90e7a212d70",
 ...
 "url": "https://www.notion.so/34082aa7fc4e81aeb36ed90e7a212d70",
 "public_url": null,
 "archived": false,
 "request_id": "f560e759-0276-4d29-b09f-710809443201"
}
```
