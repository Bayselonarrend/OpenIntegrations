...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Страница     = "2c282aa7-fc4e-8163-9f10-d0ece6955133";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "2c282aa7-fc4e-81f7-961f-e8f36ca321c0" \
...
{
 "object": "page",
 "id": "2c282aa7-fc4e-81f7-961f-e8f36ca321c0",
 ...
 "url": "https://www.notion.so/2c282aa7fc4e81f7961fe8f36ca321c0",
 "public_url": null,
 "request_id": "ad63092b-47a9-40af-8458-26f172a6d27a"
}
```
