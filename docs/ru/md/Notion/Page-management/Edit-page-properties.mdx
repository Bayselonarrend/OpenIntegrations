    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "32e82aa7-fc4e-81aa-855e-e86695504a77" \
...
{
 "object": "page",
 "id": "33782aa7-fc4e-8153-bbd6-f37d9e111625",
 ...
 "url": "https://www.notion.so/33782aa7fc4e8153bbd6f37d9e111625",
 "public_url": null,
 "archived": false,
 "request_id": "185f0ac9-cf31-4c6e-911c-c6e46bb1b6b1"
}
```
