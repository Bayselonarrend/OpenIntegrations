    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "33a82aa7-fc4e-8164-8611-e8a02c9f2df6" \
...
{
 "object": "page",
 "id": "33a82aa7-fc4e-81c2-9ea1-eb1d51058d30",
 ...
 "url": "https://www.notion.so/33a82aa7fc4e81c29ea1eb1d51058d30",
 "public_url": null,
 "archived": false,
 "request_id": "2723c27e-72bc-4810-94af-f8a0c66592f3"
}
```
