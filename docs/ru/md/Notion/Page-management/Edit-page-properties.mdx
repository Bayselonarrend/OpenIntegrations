    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "2ff82aa7-fc4e-81c8-baf9-dc2106967296" \
...
{
 "object": "page",
 "id": "2ff82aa7-fc4e-81c8-baf9-dc2106967296",
 ...
 "url": "https://www.notion.so/2ff82aa7fc4e81c8baf9dc2106967296",
 "public_url": null,
 "request_id": "4b1df1d2-933b-41dd-83c2-a83cb488f640"
}
```
