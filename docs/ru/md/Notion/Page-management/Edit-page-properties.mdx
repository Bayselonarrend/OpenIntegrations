    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "28582aa7-fc4e-8113-8c62-ebe326ae60b0" \
...
{
 "object": "page",
 "id": "28582aa7-fc4e-810a-9a32-f2e9ee89903d",
 ...
 "url": "https://www.notion.so/28582aa7fc4e810a9a32f2e9ee89903d",
 "public_url": null,
 "request_id": "f27b0b7f-22a9-49d9-8660-f4ebdc4e48bd"
}
```
