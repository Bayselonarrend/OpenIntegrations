    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "27082aa7-fc4e-81c5-8fd4-ea7ed835a902" \
...
{
 "object": "page",
 "id": "27082aa7-fc4e-81c5-8fd4-ea7ed835a902",
 ...
 "url": "https://www.notion.so/27082aa7fc4e81c58fd4ea7ed835a902",
 "public_url": null,
 "request_id": "bcc1522c-6958-4598-b572-c0f9a12b2c5d"
}
```
