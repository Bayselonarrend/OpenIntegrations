    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "2fa82aa7-fc4e-8130-a91a-d85a1cbf6221" \
...
{
 "object": "page",
 "id": "2fa82aa7-fc4e-8130-a91a-d85a1cbf6221",
 ...
 "url": "https://www.notion.so/2fa82aa7fc4e8130a91ad85a1cbf6221",
 "public_url": null,
 "request_id": "4b79e460-70b7-496f-9de4-a8bd54ae9cd8"
}
```
