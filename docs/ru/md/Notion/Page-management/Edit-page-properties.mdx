    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "2c182aa7-fc4e-813f-a4d8-e7abd2c9653b" \
...
{
 "object": "page",
 "id": "2c182aa7-fc4e-813f-a4d8-e7abd2c9653b",
 ...
 "url": "https://www.notion.so/2c182aa7fc4e813fa4d8e7abd2c9653b",
 "public_url": null,
 "request_id": "3a5553cc-49f3-4692-b7bd-5cb0925f44e7"
}
```
