    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "39f82aa7-fc4e-815e-9b42-c72242770a1a" \
...
{
 "object": "page",
 "id": "3a182aa7-fc4e-8182-bc5c-e6f737453c89",
 "created_time": "2026-07-18T07:31:00Z",
 ...
 "url": "https://app.notion.com/p/3a182aa7fc4e8182bc5ce6f737453c89",
 "public_url": null,
 "archived": false,
 "request_id": "afe22d3d-bad0-416e-bbde-f2476ee42ca1"
}
```
