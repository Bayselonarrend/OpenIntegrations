    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "34f82aa7-fc4e-81cc-b1c1-c34ea2cc3acc" \
...
{
 "object": "page",
 "id": "34f82aa7-fc4e-81cc-b1c1-c34ea2cc3acc",
 ...
 "url": "https://www.notion.so/34f82aa7fc4e81ccb1c1c34ea2cc3acc",
 "public_url": null,
 "archived": false,
 "request_id": "93f17de0-e0d1-4656-ad37-5959b470bc09"
}
```
