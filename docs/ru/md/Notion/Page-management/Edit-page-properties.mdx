    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "35382aa7-fc4e-8135-950a-dc27218500dc" \
...
{
 "object": "page",
 "id": "35382aa7-fc4e-81b0-8461-dd7a89f7d017",
 "created_time": "2026-05-01T18:37:00Z",
 ...
 "url": "https://app.notion.com/p/35382aa7fc4e81b08461dd7a89f7d017",
 "public_url": null,
 "archived": false,
 "request_id": "7887c6b6-c046-4eba-a8e7-2a939f43f2b3"
}
```
