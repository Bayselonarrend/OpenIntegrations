    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "2dc82aa7-fc4e-815a-856f-f4ea20b11f7f" \
...
{
 "object": "page",
 "id": "2dc82aa7-fc4e-815a-856f-f4ea20b11f7f",
 "created_time": "2026-01-02T14:53:00Z",
 ...
 "url": "https://www.notion.so/2dc82aa7fc4e815a856ff4ea20b11f7f",
 "public_url": null,
 "request_id": "62ef7fbb-888b-406a-a0fb-dd109f17b5a5"
}
```
