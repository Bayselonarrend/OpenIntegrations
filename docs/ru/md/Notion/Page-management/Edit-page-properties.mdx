    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "3a382aa7-fc4e-81d2-8cd3-c2635c8406ce" \
...
{
 "object": "page",
 "id": "3a282aa7-fc4e-81a6-8b0b-c2e55d3995b3",
 ...
 "url": "https://app.notion.com/p/3a282aa7fc4e81a68b0bc2e55d3995b3",
 "public_url": null,
 "archived": false,
 "request_id": "9577351a-24e8-4f48-9bde-b339509bf12e"
}
```
