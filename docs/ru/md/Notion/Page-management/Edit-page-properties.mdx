    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "30882aa7-fc4e-81ea-a56b-c8a20ec96c53" \
...
{
 "object": "page",
 "id": "30b82aa7-fc4e-8142-9052-d83137bcaf60",
 ...
 "url": "https://www.notion.so/30b82aa7fc4e81429052d83137bcaf60",
 "public_url": null,
 "request_id": "cdd9f850-5bf6-4d54-90c0-beb9d7b02789"
}
```
