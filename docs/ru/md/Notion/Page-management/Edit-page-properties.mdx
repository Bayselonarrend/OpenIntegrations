    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion ИзменитьСвойстваСтраницы \
              --token "***" \
              --page "37782aa7-fc4e-81a4-bd30-dfe20598715d" \
...
{
 "object": "page",
 "id": "37782aa7-fc4e-81a4-bd30-dfe20598715d",
 ...
 "url": "https://app.notion.com/p/37782aa7fc4e81a4bd30dfe20598715d",
 "public_url": null,
 "archived": false,
 "request_id": "46c9ed1b-645c-4124-bb6f-acb61761a4b1"
}
```
