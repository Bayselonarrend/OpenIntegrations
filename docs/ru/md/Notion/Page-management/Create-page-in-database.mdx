    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion СоздатьСтраницуВБазу \
              ...
              --data "{'Имя':'ООО Вектор','Описание':'Наш первый клиент','Номер':'1','Дата создания':'1/27/2026 10:32:41 PM','Картинка':{'Лого':'https://hut.openintegrations.dev/test_data/picture.jpg'},'Активен':true,'Сайт':'https://vector.ru','Почта':'mail@vector.ru','Телефон':'88005553535','Статус':'Новый'}"
        ```
    </TabItem>
...
{
 "object": "page",
 "id": "2f582aa7-fc4e-81a3-8bd4-fe05192e1b0c",
 ...
 "parent": {
  "type": "database_id",
  "database_id": "2f582aa7-fc4e-81ea-8981-e8858e2c055b"
 },
 "archived": false,
 "in_trash": false,
 "is_locked": false,
 "properties": {
  "Дата создания": {
   ...
   "type": "date",
   "date": {
    "start": "2026-01-27T13:32:00+03:00",
    "end": null,
    "time_zone": null
   }
  },
 ...
 "url": "https://www.notion.so/2f582aa7fc4e81a38bd4fe05192e1b0c",
 "public_url": null,
 "request_id": "28053e7e-0665-4245-9237-f324a74e5a0a"
}
```
