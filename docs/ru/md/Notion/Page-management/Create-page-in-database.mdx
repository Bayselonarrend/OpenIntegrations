    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion СоздатьСтраницуВБазу \
              --token '***' \
              --base '22982aa7-fc4e-8190-9f4d-d85229279879' \
              --data '{\"Имя\":\"ООО Вектор\",\"Описание\":\"Наш первый клиент\",\"Номер\":1,\"Статус\":\"Новый\",\"Дата создания\":\"2025-07-07T11:21:57.979736Z\",\"Картинка\":{\"Лого\":\"https://hut.openintegrations.dev/test_data/picture.jpg\"},\"Активен\":true,\"Сайт\":\"https://vector.ru\",\"Почта\":\"mail@vector.ru\",\"Телефон\":\"88005553535\"}'
        ```
    </TabItem>
