    ...
    <TabItem value="bash" label="Bash" default>
        ...
        # JSON данные также могут быть переданны как путь к файлу .json
            ...
            oint notion СоздатьСтраницуВБазу \
              --token "***" \
              --base "12082aa7-fc4e-81f9-88d1-d22baa9612e5" \
              --data "{'Имя':'ООО Вектор','Описание':'Наш первый клиент','Номер':1,'Статус':'Новый','Дата создания':'2024-10-15T12:39:44.5637652Z','Картинка':{'Лого':'https://github.com/Bayselonarrend/OpenIntegrations/raw/main/service/test_data/picture.jpg'},'Активен':true,'Сайт':'https://vector.ru','Почта':'mail@vector.ru','Телефон':'88005553535'}"
        ```
    </TabItem>
