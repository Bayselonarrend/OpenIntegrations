    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion СоздатьСтраницуВБазу \
              --token "***" \
              --base "14082aa7-fc4e-81ab-8893-c7d031865a22" \
              --data "{'Имя':'ООО Вектор','Описание':'Наш первый клиент','Номер':1,'Статус':'Новый','Дата создания':'2024-11-16T11:21:08.7236575Z','Картинка':{'Лого':'https://github.com/Bayselonarrend/OpenIntegrations/raw/main/service/test_data/picture.jpg'},'Активен':true,'Сайт':'https://vector.ru','Почта':'mail@vector.ru','Телефон':'88005553535'}"
        ```
    </TabItem>
