    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion СоздатьСтраницуВБазу \
              ...
              --data "{'Имя':'ООО Вектор','Описание':'Наш первый клиент','Номер':'1','Дата создания':'2/6/2026 11:21:08 PM','Картинка':{'Лого':'https://hut.openintegrations.dev/test_data/picture.jpg'},'Активен':true,'Сайт':'https://vector.ru','Почта':'mail@vector.ru','Телефон':'88005553535','Статус':'Новый'}"
        ```
    </TabItem>
...
{
 "object": "page",
 "id": "30082aa7-fc4e-8169-9cce-ef330ff13e14",
 ...
 "parent": {
  "type": "database_id",
  "database_id": "30082aa7-fc4e-8111-af67-f6a500d8dc29"
 },
 "archived": false,
 "in_trash": false,
 "is_locked": false,
 "properties": {
  ...
  "Дата создания": {
   ...
   "type": "date",
   "date": {
    "start": "2026-02-07T06:36:00+00:00",
    "end": null,
    "time_zone": null
   }
  },
 ...
 "url": "https://www.notion.so/30082aa7fc4e81699cceef330ff13e14",
 "public_url": null,
 "request_id": "cd56b3d5-7664-4dd2-be80-cc336f812ddd"
}
```
