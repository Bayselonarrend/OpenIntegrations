    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion СоздатьСтраницуВБазу \
              --token "***" \
              --base "37e82aa7-fc4e-8198-a1c7-fdec61664c8a" \
              --data "{'Имя':'ООО Вектор','Описание':'Наш первый клиент','Номер':'1','Дата создания':'6/14/2026 12:03:08 AM','Картинка':{'Лого':'https://hut.openintegrations.dev/test_data/picture.jpg'},'Активен':true,'Сайт':'https://vector.ru','Почта':'mail@vector.ru','Телефон':'88005553535','Статус':'Новый'}"
        ```
    </TabItem>
...
{
 "object": "page",
 "id": "37c82aa7-fc4e-818e-abec-ebbb9428b22b",
 ...
 "parent": {
  "type": "database_id",
  "database_id": "37c82aa7-fc4e-813a-a5dd-e54497650ff4"
 },
 "in_trash": false,
 "is_archived": false,
 "is_locked": false,
 "properties": {
  ...
  "Дата создания": {
   ...
   "type": "date",
   "date": {
    "start": "2026-06-11T13:43:00+03:00",
    "end": null,
    "time_zone": null
   }
  },
 ...
 "url": "https://app.notion.com/p/37c82aa7fc4e818eabecebbb9428b22b",
 "public_url": null,
 "archived": false,
 "request_id": "0cce4342-2977-4f31-98e2-61eda0e91991"
}
```
