...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    База      = "1cd82aa7-fc4e-8189-aad3-f4ec3b03cad3";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion СоздатьСтраницуВБазу \
              --token "***" \
              --base "1cd82aa7-fc4e-81ce-9c7a-e6594769a59c" \
              --data "{'Имя':'ООО Вектор','Описание':'Наш первый клиент','Номер':1,'Статус':'Новый','Дата создания':'2025-04-06T14:54:48.4162319Z','Картинка':{'Лого':'https://github.com/Bayselonarrend/OpenIntegrations/raw/main/service/test_data/picture.jpg'},'Активен':true,'Сайт':'https://vector.ru','Почта':'mail@vector.ru','Телефон':'88005553535'}"
        ```
    </TabItem>
