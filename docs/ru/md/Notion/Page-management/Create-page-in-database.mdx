    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion СоздатьСтраницуВБазу \
              ...
              --data "{'Имя':'ООО Вектор','Описание':'Наш первый клиент','Номер':'1','Дата создания':'10/10/2025 09:50:04','Картинка':{'Лого':'https://hut.openintegrations.dev/test_data/picture.jpg'},'Активен':true,'Сайт':'https://vector.ru','Почта':'mail@vector.ru','Телефон':'88005553535','Статус':'Новый'}"
        ```
    </TabItem>
...
{
 "object": "page",
 "id": "28882aa7-fc4e-8145-ac50-c7d33c009a1f",
 ...
 "parent": {
  "type": "database_id",
  "database_id": "28882aa7-fc4e-81a6-996b-e95e2d72be00"
 },
 "archived": false,
 "in_trash": false,
 "is_locked": false,
 "properties": {
  ...
  "Дата создания": {
   ...
   "type": "date",
   "date": {
    "start": "2025-10-10T09:50:00+00:00",
    "end": null,
    "time_zone": null
   }
  },
 ...
 "url": "https://www.notion.so/28882aa7fc4e8145ac50c7d33c009a1f",
 "public_url": null,
 "request_id": "f33bdbad-4832-4a4f-bdfa-761d40fe71ab"
}
```
