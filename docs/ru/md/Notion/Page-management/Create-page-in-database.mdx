    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion СоздатьСтраницуВБазу \
              ...
              --data "{'Имя':'ООО Вектор','Описание':'Наш первый клиент','Номер':'1','Дата создания':'2/3/2026 12:34:03 PM','Картинка':{'Лого':'https://hut.openintegrations.dev/test_data/picture.jpg'},'Активен':true,'Сайт':'https://vector.ru','Почта':'mail@vector.ru','Телефон':'88005553535','Статус':'Новый'}"
        ```
    </TabItem>
...
{
 "object": "page",
 "id": "2fc82aa7-fc4e-818b-b285-e817396652c7",
 "created_time": "2026-02-03T09:34:00Z",
 ...
 "parent": {
  "type": "database_id",
  "database_id": "2fc82aa7-fc4e-816b-b1e3-d40bf6707778"
 },
 "archived": false,
 "in_trash": false,
 "is_locked": false,
 "properties": {
  "Дата создания": {
   ...
   "type": "date",
   "date": {
    "start": "2026-02-03T15:34:00+03:00",
    "end": null,
    "time_zone": null
   }
  },
 ...
 "url": "https://www.notion.so/2fc82aa7fc4e818bb285e817396652c7",
 "public_url": null,
 "request_id": "81a781ec-9da9-4499-8fad-cb83164d62ab"
}
```
