...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    База      = "16682aa7-fc4e-8180-89b8-fae5177a406e";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion СоздатьСтраницуВБазу \
              --token "***" \
              --base "17282aa7-fc4e-81ed-8531-f856722d97f6" \
              --data "{'Имя':'ООО Вектор','Описание':'Наш первый клиент','Номер':1,'Статус':'Новый','Дата создания':'2025-01-05T20:41:10.1803069Z','Картинка':{'Лого':'https://github.com/Bayselonarrend/OpenIntegrations/raw/main/service/test_data/picture.jpg'},'Активен':true,'Сайт':'https://vector.ru','Почта':'mail@vector.ru','Телефон':'88005553535'}"
        ```
    </TabItem>
