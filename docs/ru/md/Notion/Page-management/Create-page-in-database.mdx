    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion СоздатьСтраницуВБазу \
              ...
              --data "{'Имя':'ООО Вектор','Описание':'Наш первый клиент','Номер':'1','Дата создания':'01/06/2026 00:07:43','Картинка':{'Лого':'https://hut.openintegrations.dev/test_data/picture.jpg'},'Активен':true,'Сайт':'https://vector.ru','Почта':'mail@vector.ru','Телефон':'88005553535','Статус':'Новый'}"
        ```
    </TabItem>
...
{
 "object": "page",
 "id": "2e082aa7-fc4e-8116-b3db-c4da79566a01",
 ...
 "parent": {
  "type": "database_id",
  "database_id": "2e082aa7-fc4e-8146-8f49-e90759e229fe"
 },
 "archived": false,
 "in_trash": false,
 "is_locked": false,
 "properties": {
  ...
  "Дата создания": {
   ...
   "type": "date",
   "date": {
    "start": "2026-01-06T04:17:00+00:00",
    "end": null,
    "time_zone": null
   }
  },
 ...
 "url": "https://www.notion.so/2e082aa7fc4e8116b3dbc4da79566a01",
 "public_url": null,
 "request_id": "be04fdf8-c6d8-4767-83f9-cb4084b3cabe"
}
```
