    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion СоздатьСтраницуВБазу \
              ...
              --data "{'Имя':'ООО Вектор','Описание':'Наш первый клиент','Номер':'1','Дата создания':'6/8/2026 4:08:39 PM','Картинка':{'Лого':'https://hut.openintegrations.dev/test_data/picture.jpg'},'Активен':true,'Сайт':'https://vector.ru','Почта':'mail@vector.ru','Телефон':'88005553535','Статус':'Новый'}"
        ```
    </TabItem>
...
{
 "object": "page",
 "id": "37982aa7-fc4e-8152-9b80-d7772cdd9b58",
 ...
 "parent": {
  "type": "database_id",
  "database_id": "37982aa7-fc4e-81a3-adf4-da5b71d31a89"
 },
 "in_trash": false,
 "is_archived": false,
 "is_locked": false,
 "properties": {
  ...
  "Дата создания": {
   ...
   "type": "date",
   "date": {
    "start": "2026-06-08T08:50:00+03:00",
    "end": null,
    "time_zone": null
   }
  },
 ...
 "url": "https://app.notion.com/p/37982aa7fc4e81529b80d7772cdd9b58",
 "public_url": null,
 "archived": false,
 "request_id": "80df91bd-f86b-40da-88b6-808e7de45dee"
}
```
