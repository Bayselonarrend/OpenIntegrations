    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint notion СоздатьБлок \
              ...
              --block "{'object':'block','parent':{'type':'page_id','page_id':'5dd94c34-fab0-4bff-986b-7511c0779f77'},'in_trash':'True','type':'to_do','to_do':{'rich_text':[{'type':'text','text':{'content':'YoYO','link':''},'annotations':{'bold':'False','italic':'False','strikethrough':'False','underline':'False','code':'False','color':'default'},'plain_text':'YoYO','href':''}],'checked':'False','color':'default'}}"
        ```
    </TabItem>
