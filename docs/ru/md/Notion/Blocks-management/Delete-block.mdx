    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint notion УдалитьБлок \
              --token "***" \
              --block "39f82aa7-fc4e-814b-82c1-e2282dbeb565"
        ```
    </TabItem>
...
{
 "object": "block",
 "id": "3a182aa7-fc4e-812a-8b80-c0c54b2e3f82",
 "parent": {
  "type": "page_id",
  "page_id": "5dd94c34-fab0-4bff-986b-7511c0779f77"
 },
 "created_time": "2026-07-18T07:33:00Z",
 "last_edited_time": "2026-07-18T07:33:00Z",
 "created_by": {
  "object": "user",
 ...
 "archived": true,
 "request_id": "7077a623-6a30-4052-bb78-f81136357aaf"
}
```
