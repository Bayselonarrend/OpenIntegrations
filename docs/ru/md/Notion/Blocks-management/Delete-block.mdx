    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint notion УдалитьБлок \
              --token "***" \
              --block "38082aa7-fc4e-8108-be16-d356b561df00"
        ```
    </TabItem>
...
{
 "object": "block",
 "id": "38082aa7-fc4e-81a5-823e-c4b0afe384c6",
 "parent": {
  "type": "page_id",
  "page_id": "5dd94c34-fab0-4bff-986b-7511c0779f77"
 },
 "created_time": "2026-06-15T18:35:00Z",
 "last_edited_time": "2026-06-15T18:35:00Z",
 "created_by": {
  "object": "user",
 ...
 "archived": true,
 "request_id": "2411ae8a-1ef7-4017-bcd7-6154e2a002bf"
}
```
