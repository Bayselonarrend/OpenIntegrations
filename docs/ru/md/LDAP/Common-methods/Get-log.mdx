...
description: Получить лог  и другие функции для работы с LDAP в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Результат = OPI_LDAP.ВыполнитьПоиск(Соединение, База);
