...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    КалендарьИсточник = "b4cd7b78fa45f2448bc045fe33639a9322a4851ff48d6eaa6dfbc2f95a6410d5@group.calendar.google.com";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint gcalendar ПереместитьСобытие \
              --token "***" \
              --from "5086efb3ade0d580a6576820ba83a67e96ad5bca6488ed12a2aa97ac207f4b2b@group.calendar.google.com" \
