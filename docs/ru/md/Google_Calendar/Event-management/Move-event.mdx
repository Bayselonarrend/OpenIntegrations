...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    КалендарьИсточник = "928137ad4c58ead6e2346466c3a2d25e5c71f116b9a800930bc63587c2602fc6@group.calendar.google.com";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint gcalendar ПереместитьСобытие \
              --token "***" \
              --from "1bed44c1e29681df971b3fbf71052273e90a031b0c287dc4fb00bb5687568d23@group.calendar.google.com" \
