...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    КалендарьИсточник = "dab5d3445c73b7ed25725760d7f531a74a1be2c11a708994fa3546b6606dffdf@group.calendar.google.com";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint gcalendar ПереместитьСобытие \
              --token "***" \
              --from "de252ebd9ca060a07edc27adc7c3fcc74e61b7f24b8b9ad9f6ad9a0b71b256ec@group.calendar.google.com" \
