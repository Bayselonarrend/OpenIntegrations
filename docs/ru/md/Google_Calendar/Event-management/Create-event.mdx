    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint gcalendar СоздатьСобытие \
              ...
              --props "{'Описание':'Описание тестового события','Заголовок':'Новое событие','МестоПроведения':'В офисе','ДатаНачала':'2025-07-20T11:06:43.1907533Z','ДатаОкончания':'2025-07-20T12:06:43.1907533Z','МассивURLФайловВложений':{'Картинка1':'https://hut.openintegrations.dev/test_data/picture.jpg','Картинка2':'https://hut.openintegrations.dev/test_data/picture2.jpg'},'ОтправлятьУведомления':true}"
        ```
    </TabItem>
