    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint gcalendar СоздатьСобытие \
              --token "***" \
              --calendar "0ed09b8eda312fd101b65e1dbb7e3a9178a578b13cc50c94dd05c0fdc705434f@group.calendar.google.com" \
              --props "{'Описание':'Описание тестового события','Заголовок':'Новое событие','МестоПроведения':'В офисе','ДатаНачала':'2025-07-09T06:10:21.5451644Z','ДатаОкончания':'2025-07-09T07:10:21.5451644Z','МассивURLФайловВложений':{'Картинка1':'https://hut.openintegrations.dev/test_data/picture.jpg','Картинка2':'https://hut.openintegrations.dev/test_data/picture2.jpg'},'ОтправлятьУведомления':true}"
        ```
    </TabItem>
