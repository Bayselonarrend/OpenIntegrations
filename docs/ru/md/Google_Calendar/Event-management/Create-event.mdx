    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint gcalendar СоздатьСобытие \
              --token "***" \
              --calendar "0eac8b6523cb2b06aae50d8be7fccc46dff04c76be7387547ea7a2133425fd75@group.calendar.google.com" \
              --props "{'Описание':'Описание тестового события','Заголовок':'Новое событие','МестоПроведения':'В офисе','ДатаНачала':'2025-07-02T22:03:13.3279945Z','ДатаОкончания':'2025-07-02T23:03:13.3279945Z','МассивURLФайловВложений':{'Картинка1':'https://hut.openintegrations.dev/test_data/picture.jpg','Картинка2':'https://hut.openintegrations.dev/test_data/picture2.jpg'},'ОтправлятьУведомления':true}"
        ```
    </TabItem>
