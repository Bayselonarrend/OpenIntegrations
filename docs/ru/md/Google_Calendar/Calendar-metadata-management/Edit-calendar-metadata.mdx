    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint gcalendar ИзменитьМетаданныеКалендаря \
              --token "***" \
              --calendar "fda4ba719c3d3f06082ae2d458b809317ea8f8cce33561c3ee6d9160c4f1211d@group.calendar.google.com" \
...
```json title="Результат"
{
 ...
 "etag": "\"AnTeUZ9IdcR8rkJPJ5nhQhb_yo8\"",
 "id": "fda4ba719c3d3f06082ae2d458b809317ea8f8cce33561c3ee6d9160c4f1211d@group.calendar.google.com",
