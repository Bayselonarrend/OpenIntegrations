...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    IDРаботы = "dbjid:AADy4LhqUVmBuj1z4wEB-vs2QZvVyKgKGEco4p-LYaCcXP_8YnS5p-dOaj9UnQabdhF3yHAmAd1SbhE4VggFg7Ox";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint dropbox ПолучитьСтатусАсинхронногоИзменения \
              --token "***" \
              --job "dbjid:AACcpLpmqXr0ZjZsKdoYLdADtiZx10YiLk9Uf15u675_D2X9E7reeDTYXTLelPdOumXMGEINqxRrgEtZMIxBSTT3"
        ```
    </TabItem>
