...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    IDРаботы = "dbjid:AAAt9cshbTi8yLwTYbNk0moecki3sobufBkjs0MubjYKGoaaORJneR7TlBfng9iipUZ3pW5ulrZNMfhB68TFnvYz";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint dropbox ПолучитьСтатусАсинхронногоИзменения \
              --token "***" \
              --job "dbjid:AABFuCkLg9PiOjPcnlVE71VZoA3sbBJNt9AhfS1xlN3sgarKiyhHx2LODt9QZDlnihcFMGn4gjyXyBBSmsiyIg_q"
        ```
    </TabItem>
