...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    IDРаботы = "dbjid:AACbUJOe7Bq8k_fjiAXtBr7ENOXVmvF5Z3qfq_YJ7db53_9KhvjOZGQhHYIbIUx8q2EckBX-2BKbPba2pxzHZr9B";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint dropbox ПолучитьСтатусАсинхронногоИзменения \
              --token "***" \
              --job "dbjid:AADxA04tzpaJowiLHBXZzBkGdAj41fYatwFXXaJmiWPbiYuyTeWPDX9aywy0GtiFGleBoBVaMDU-Fg_QAIt3d2Ae"
        ```
    </TabItem>
