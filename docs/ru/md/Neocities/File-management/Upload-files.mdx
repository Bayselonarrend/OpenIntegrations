...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Гифка     = "https://releases.openintegrations.dev/test_data/animation.gif";      // URL, Путь или Двоичные данные
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint neocities ЗагрузитьФайлы \
              --token "***" \
              --files "{'test/pic1.png':'https://releases.openintegrations.dev/test_data/picture.jpg','test/gif.gif':'https://releases.openintegrations.dev/test_data/picture2.jpg','pic2.png':'https://releases.openintegrations.dev/test_data/animation.gif'}"
        ```
    </TabItem>
