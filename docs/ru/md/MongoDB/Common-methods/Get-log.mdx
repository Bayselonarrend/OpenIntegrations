...
description: Получить лог  и другие функции для работы с MongoDB в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Результат = OPI_MongoDB.ВыполнитьКоманду(Соединение, "listDatabases", , , Новый Структура("nameOnly", Истина));
...
{
 "logs": [
  "[2026-07-18 10:32:20.887] Connecting to MongoDB...",
  "[2026-07-18 10:32:20.900] Connected to MongoDB",
  "[2026-07-18 10:32:20.905] Execute operation: listDatabases"
 ],
 "result": true,
 "returned": 3,
 "total": 3
