...
`Функция ОткрытьСоединение(Знач СтрокаПодключения, Знач Логирование = Неопределено) Экспорт`

  | Параметр | CLI опция | Тип | Обяз. | Назначение |
  |-|-|-|-|-|
  | СтрокаПодключения | - | Строка | &#x2714; | Строка подключения. См. [`СформироватьСтрокуПодключения`](/docs/MongoDB/Common-methods/Generate-connection-string) |
  | Логирование | - | Структура Из КлючИЗначение | &#x2716; | Настройки логирования. См. [`ПолучитьНастройкиЛогирования`](/docs/MongoDB/Common-methods/Get-logging-settings) |
