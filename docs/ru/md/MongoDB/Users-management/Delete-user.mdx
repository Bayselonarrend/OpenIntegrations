...
description: Удалить пользователя и другие функции для работы с MongoDB в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
```
 ...
 <Tabs>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint mongodb УдалитьПользователя \
