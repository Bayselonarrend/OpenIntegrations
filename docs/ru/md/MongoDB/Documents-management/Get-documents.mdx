...
```json title="Результат"
{
 ...
 "data": [
  {
   "_id": "6a241c0da363fd76dac57b1a",
   "arrayField": [
    "A",
    "<<MinKey>>"
   ],
   "binaryField": "C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\bied0fk3.34u",
   "boolField": true,
   ...
   "stringField": "Текст",
   "symbolField": "Y",
   "tsField": "Timestamp(1780762172, 0)"
  },
  {
   "_id": "6a241c0da363fd76dac57b19",
   "arrayField": [
    "Значение1",
    "Значение2"
   ],
   "boolField": true,
   "dateField": "2026-06-06T16:09:32Z",
   "docField": {
    "number": 10,
    "text": "Текст"
   },
