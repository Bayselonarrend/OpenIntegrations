    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint mongodb ПолучитьДокументы \
              ...
              --coll "new_collection" \
              --db "main" \
              --query "{'category':'книги'}" \
              --sort "{'price':'-1'}" \
              --params "{'projection':{'productName':'1','price':'1','rating':'1'}}"
        ```
    </TabItem>
 ...
 "data": [
  {
   ...
   "tsField": "Timestamp(1765122849, 0)",
  ...
  },
  {
   ...
   "dateField": "2025-12-07T15:54:09.104Z",
   "nullField": null
  }
 ]
}
