...
`Функция ИзменитьРоль(Знач Соединение, Знач Имя, Знач База = Неопределено, Знач МассивПривилегий = Неопределено, Знач МассивРолей = Неопределено, Знач Параметры = Неопределено) Экспорт`
