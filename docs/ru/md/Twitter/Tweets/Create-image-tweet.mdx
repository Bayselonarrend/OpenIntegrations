    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитКартинки \
              --text "Тестовый твитт533bcc5d-f8d7-4d4b-a856-32bd20ffc916" \
              --pictures "C:\Users\bayse\AppData\Local\Temp\nmq3otmg.tty" \
...
{
 "data": {
  "id": "2006751628603404343",
  "text": "Тестовый твитт1bb01867-48a9-4f18-9743-0da0e9e65866 https://t.co/BfuyNqUQP7",
