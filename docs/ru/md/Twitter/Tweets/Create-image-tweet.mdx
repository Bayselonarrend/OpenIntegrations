    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитКартинки \
              --text "Тестовый твиттeeeae8d0-dabc-43c1-8d8b-176093055d56" \
              --pictures "/tmp/opcxpgts.ee0" \
...
```json title="Результат"
{
 "data": {
  ...
  "id": "1982492423432409235",
  "text": "Тестовый твитт55757892-570b-4983-bbd8-0af9307c2be5 https://t.co/KmmgA1Jdn8"
 }
}
```
