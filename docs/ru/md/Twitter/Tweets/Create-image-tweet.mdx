    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитКартинки \
              --text "Тестовый твитт2db861ea-c0ee-4dfd-b468-df2d08916bae" \
              --pictures "C:\Users\bayse\AppData\Local\Temp\kn4jnfma.kqx" \
...
{
 "data": {
  "text": "Тестовый твитт7a30284f-63c9-4bfe-8244-37fdbe6a0a2b https://t.co/FoP72xs4uu",
  "edit_history_tweet_ids": [
   "2018026979082076383"
  ],
  "id": "2018026979082076383"
 }
}
```
