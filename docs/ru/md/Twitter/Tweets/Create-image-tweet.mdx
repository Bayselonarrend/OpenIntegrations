    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитКартинки \
              --text "Тестовый твит75a91045-3809-45ec-9dbc-a46f49da2bdd" \
              --pictures "/tmp/jd4zalu3.cdv" \
...
```json title="Результат"
{
 "data": {
  ...
  "id": "2022293807656513606",
  "text": "Тестовый твит6c62f507-6485-46a9-b1a5-01bc52f59271 https://t.co/jOkfoAfUHm"
 }
}
```
