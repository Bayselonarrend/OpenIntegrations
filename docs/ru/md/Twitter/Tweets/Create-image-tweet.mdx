    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint twitter СоздатьТвитКартинки \
              --text "Тестовый твитт146b8f5b-f7be-4fb4-912d-01cadc08dd02" \
              --pictures "/tmp/jgzxmcfb.3en" \
...
{
 "data": {
  "id": "1965467441196151241",
  "edit_history_tweet_ids": [
   "1965467441196151241"
  ],
  "text": "Тестовый твитт479b5d86-da82-4d42-b403-5d501e8b9546 https://t.co/ykGYxdR2Cz"
 }
}
```
