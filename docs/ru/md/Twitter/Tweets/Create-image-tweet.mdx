    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитКартинки \
              --text "Тестовый твитт6248b2da-9021-472a-97bb-abd5dc0fbc9d" \
              --pictures "/tmp/2xmxblnd.5mn" \
...
```json title="Результат"
{
 "data": {
  ...
  "id": "1982082507576062191",
  "text": "Тестовый твитт35b31579-4d67-4289-8eec-f80ced580a43 https://t.co/n5pEA0NWuY"
 }
}
```
