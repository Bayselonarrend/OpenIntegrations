    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитКартинки \
              --text "Тестовый твитee7be0bb-4c3b-485a-b3ea-8fd03c12edf2" \
              --pictures "C:\Users\bayse\AppData\Local\Temp\vw5mdmak.4tv" \
...
```json title="Результат"
{
 "data": {
  ...
  "id": "2019434432629813743",
  "text": "Тестовый твитaa1bdc39-2b27-4877-a5bb-fbd6169191e0 https://t.co/lID0AvxyxV"
 }
}
```
