    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитКартинки \
              --text "Тестовый твиттd72938ea-40ca-4d1f-98f9-e246192a67c9" \
              --pictures "C:\Users\bayse\AppData\Local\Temp\t5aawk4m.gzh" \
...
{
 "data": {
  "text": "Тестовый твиттa5b4caa3-fb7f-4942-a621-00aca4e910c6 https://t.co/kmkRLqyjiP",
  "edit_history_tweet_ids": [
   "2018402796219850891"
  ],
  "id": "2018402796219850891"
 }
}
```
