    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитКартинки \
              --text "Тестовый твиттfeb8a537-b86b-4327-8d0d-3ccb4cf75595" \
              --pictures "/tmp/yj12ias4.dm4" \
...
{
 "data": {
  "id": "1975657999361351843",
  "edit_history_tweet_ids": [
   "1975657999361351843"
  ],
  "text": "Тестовый твиттccda686c-85f4-43eb-bfb2-0425730324ae https://t.co/XpdO5AQQF2"
 }
}
```
