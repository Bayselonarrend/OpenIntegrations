    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитКартинки \
              --text "Тестовый твитт15e8a4af-c56e-4f37-84a8-c7ebf823ce34" \
              --pictures "/tmp/byt5w3fd.bw1" \
...
{
 "data": {
  "id": "1983797494740865056",
  "edit_history_tweet_ids": [
   "1983797494740865056"
  ],
  "text": "Тестовый твитт38c1e6b3-52f4-4a2b-bb81-b243a0bebf88 https://t.co/66D9sVq7sO"
 }
}
```
