---
sidebar_position: 3
description:  Создает твит с картинкой вложениемСтраницы
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитКартинки \
              --text "Тестовый твитт281899af-a010-4afa-9cf4-ed46faadc3d1" \
              --pictures "C:\Users\Administrator\AppData\Local\Temp\mxzko5ulutx.tmp" \
