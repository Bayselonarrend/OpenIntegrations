    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитКартинки \
              --text "Тестовый твитт802c9c62-88fd-4d2d-aecf-fcb7af6122e9" \
              --pictures "C:\Users\bayse\AppData\Local\Temp\x1x4edqk.iud" \
...
```json title="Результат"
{
 "data": {
  ...
  "id": "1997736547223834997",
  "text": "Тестовый твиттd274bea9-050a-4c49-8caa-682ff622cb14 https://t.co/4ghxvysEwe"
 }
}
```
