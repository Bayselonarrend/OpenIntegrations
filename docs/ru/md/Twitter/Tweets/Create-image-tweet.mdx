    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитКартинки \
              --text "Тестовый твитт395633fd-a774-47ee-8933-92114b98900b" \
              --pictures "C:\Users\bayse\AppData\Local\Temp\z2de3mrf.432" \
...
{
 "data": {
  "id": "2007162892638990397",
  "text": "Тестовый твитт85e68ab5-26d2-438e-89dc-5f8f8172dd81 https://t.co/nIpS2UJ4al",
