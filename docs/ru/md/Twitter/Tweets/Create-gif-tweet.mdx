    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитГифки \
              --text "Тестовый твит838bb356-a17b-47d8-a5fd-c2f7111ed45b" \
              --gifs "/tmp/vp5g2n3a.qow" \
...
{
 "data": {
  "id": "2036705447726432686",
  "edit_history_tweet_ids": [
   "2036705447726432686"
  ],
  "text": "Тестовый твитf5771227-7cd5-4b84-a13f-e3a593f6f820 https://t.co/l3pZVSBJxa"
 }
}
```
