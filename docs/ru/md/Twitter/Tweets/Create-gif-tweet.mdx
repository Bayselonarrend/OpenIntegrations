    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитГифки \
              --text "Тестовый твитb44ad732-ba4c-49ac-a4a9-99273d450363" \
              --gifs "/tmp/1jqtngqv.pf0" \
...
```json title="Результат"
{
 "data": {
  ...
  "text": "Тестовый твит855c1226-a354-4fe1-9560-88cedb7523bc https://t.co/xxcudUDkWU",
  "id": "2022294027186381055"
 }
}
```
