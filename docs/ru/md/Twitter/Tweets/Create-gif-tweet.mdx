    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint twitter СоздатьТвитГифки \
              --text "Тестовый твиттef915e91-1307-4d09-afcc-5b1c44287df3" \
              --gifs "/tmp/e4nd0fft.gqr" \
...
{
 "data": {
  "text": "Тестовый твитт1db73757-c1f9-4311-b4f8-2c324253abc2 https://t.co/4NwHNexF50",
  "edit_history_tweet_ids": [
   "1966101146168160477"
  ],
  "id": "1966101146168160477"
 }
}
```
