    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитГифки \
              --text "Тестовый твитec50f3bc-6b75-46dd-ae76-77aaabf700ef" \
              --gifs "C:\Users\bayse\AppData\Local\Temp\4w5arkpg.oco" \
...
{
 "data": {
  "id": "2019434675291189261",
  "edit_history_tweet_ids": [
   "2019434675291189261"
  ],
  "text": "Тестовый твит59befcb0-97bb-4dc5-9b80-32a94b79dbdc https://t.co/HDPonrbeeJ"
 }
}
```
