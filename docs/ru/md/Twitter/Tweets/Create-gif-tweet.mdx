    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитГифки \
              --text "Тестовый твит917243a2-108d-4e02-ab4d-2a968b68fd9e" \
              --gifs "/tmp/dqniavcd.1ka" \
...
```json title="Результат"
{
 "data": {
  ...
  "id": "2029456025359675776",
  "text": "Тестовый твит24a11fdc-5d6b-4ac4-939c-15559dd8f636 https://t.co/aBvs3NuJfc"
 }
}
```
