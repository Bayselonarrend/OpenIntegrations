    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint twitter СоздатьТвитГифки \
              --text "Тестовый твитт13029e85-39be-44f5-a7a5-2e3ac8c9d8d2" \
              --gifs "/tmp/p1dh3wh2.cc1" \
...
```json title="Результат"
{
 "data": {
  ...
  "text": "Тестовый твитт6984192d-b3a0-465d-842c-63c28402cae1 https://t.co/oMF1uXAAc9",
  "id": "1965467655730552836"
 }
}
```
