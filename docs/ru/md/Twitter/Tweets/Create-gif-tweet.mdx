    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитГифки \
              --text "Тестовый твиттa3cce0e0-e043-4341-ab9c-94bd65a2a24b" \
              --gifs "C:\Users\bayse\AppData\Local\Temp\reb0qrpo.rzt" \
...
{
 "data": {
  "id": "1997736746352550005",
  "edit_history_tweet_ids": [
   "***"
  ],
  "text": "Тестовый твиттfb54fc59-fa75-46ab-9098-e05b976f7a32 https://t.co/Dihp6aLNCN"
 }
}
```
