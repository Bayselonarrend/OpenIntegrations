    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитГифки \
              --text "Тестовый твитт62ec898d-a991-465e-82a7-8b9ccd390e95" \
              --gifs "C:\Users\bayse\AppData\Local\Temp\j1rt13g1.c5a" \
...
```json title="Результат"
{
 "data": {
  ...
  "text": "Тестовый твитт353b7d77-80da-4a31-b273-0ccf9b09ea7c https://t.co/BUu9JXt56X",
  "id": "2013313741887041699"
 }
}
```
