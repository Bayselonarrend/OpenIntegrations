    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитГифки \
              --text "Тестовый твиттd0054fa5-9782-408c-9247-325c91aa561a" \
              --gifs "C:\Users\bayse\AppData\Local\Temp\0bbtunse.00z" \
...
```json title="Результат"
{
 "data": {
  ...
  "id": "1997339289537880224",
  "text": "Тестовый твиттabe1e05f-e733-40b5-879c-7f3c08a0ef84 https://t.co/DODzrOiXvl"
 }
}
```
