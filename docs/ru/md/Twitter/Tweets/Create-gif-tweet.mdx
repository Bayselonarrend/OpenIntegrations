    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитГифки \
              --text "Тестовый твиттc0fc59bc-47d5-4ed6-9ada-5d00e0326520" \
              --gifs "C:\Users\bayse\AppData\Local\Temp\cisj5bno.qai" \
...
{
 "data": {
  "text": "Тестовый твитт459f8bdb-97bf-4cca-8219-4fe22e6c8424 https://t.co/Hv24RP8VPj",
  "edit_history_tweet_ids": [
   null
  ],
  "id": "2000252106419085335"
 }
}
```
