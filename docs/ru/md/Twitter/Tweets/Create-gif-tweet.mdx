    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитГифки \
              --text "Тестовый твит48ca926b-346b-49be-8b88-505717fe16d5" \
              --gifs "C:\Users\bayse\AppData\Local\Temp\vuxxen35.2zb" \
...
```json title="Результат"
{
 "data": {
  ...
  "text": "Тестовый твит19a9ca86-f8d1-4368-9f36-2f2e42da7f97 https://t.co/pCoUPfgbPv",
  "id": "2029951119112167679"
 }
}
```
