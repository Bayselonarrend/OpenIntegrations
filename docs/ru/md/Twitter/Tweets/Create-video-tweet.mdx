    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитВидео \
              --text "Тестовый твитт5a3c36b0-f460-46f7-8a6f-3c948075cba0" \
              --videos "/tmp/5503td3o.kym" \
...
{
 "data": {
  "text": "Тестовый твиттd72d22cd-1fa9-46f4-9296-03aa66a88a27 https://t.co/Q30vIurCeC",
  "edit_history_tweet_ids": [
   "1983797282928500779"
  ],
  "id": "1983797282928500779"
 }
}
```
