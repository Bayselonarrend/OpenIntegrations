    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитВидео \
              --text "Тестовый твит3ac3418c-1b58-46fe-9a7c-aa3e234bed2c" \
              --videos "C:\Users\bayse\AppData\Local\Temp\zpulo3jl.zim" \
...
```json title="Результат"
{
 "data": {
  ...
  "id": "2019434191235027237",
  "text": "Тестовый твит49cf81e4-77c5-4e1e-af6d-76ea07aa855f https://t.co/NFRKeoDg86"
 }
}
```
