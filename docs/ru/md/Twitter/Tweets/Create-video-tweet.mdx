    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитВидео \
              --text "Тестовый твитт4b7fa8a4-cf52-4fc6-87e3-f30500a35ae7" \
              --videos "C:\Users\bayse\AppData\Local\Temp\tyig2mpo.e44" \
...
```json title="Результат"
{
 "data": {
  ...
  "text": "Тестовый твитт0fcdda6d-4e07-45ed-a9d7-8bdaf3df9e2e https://t.co/jHF9oytEYk",
  "id": "2018026745018884229"
 }
}
```
