---
sidebar_position: 5
description:  Создает твит с видеовложениемСтраницы
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитВидео \
              --text "Тестовый твиттbbe0f2b9-338e-4bf6-a20b-d20106e6f5fc" \
              --videos "C:\Users\Administrator\AppData\Local\Temp\x2tt23gnjql.tmp" \
