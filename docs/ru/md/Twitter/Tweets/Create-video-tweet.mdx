    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитВидео \
              --text "Тестовый твитd9e5c2b9-1830-496d-b39b-bc4f701edae6" \
              --videos "/tmp/mjtalyac.mn5" \
...
```json title="Результат"
{
 "data": {
  ...
  "text": "Тестовый твит331be7d9-cd8b-4e19-b5a4-5046e8c3d32f https://t.co/KoPdxUH5B1",
  "id": "2036705061670191550"
 }
}
```
