    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитВидео \
              --text "Тестовый твитт56f77169-d4e9-4fbb-a92f-dda463d45900" \
              --videos "C:\Users\bayse\AppData\Local\Temp\arpwmzuz.fsm" \
...
{
 "data": {
  "id": "1997736350557053063",
  "text": "Тестовый твитт28a34791-dfa2-4097-aacb-6a4de3f112f0 https://t.co/5PEsRwmota",
