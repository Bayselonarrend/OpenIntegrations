    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитВидео \
              --text "Тестовый твит257045f8-7ebc-45f0-9998-4aeed8e34c01" \
              --videos "/tmp/ep1n5oxy.jig" \
...
```json title="Результат"
{
 "data": {
  ...
  "text": "Тестовый твит5c46dcc2-bdbf-4ed2-8769-1f2c216ab90a https://t.co/8WUjgzeSYC",
  "id": "2029455595644793067"
 }
}
```
