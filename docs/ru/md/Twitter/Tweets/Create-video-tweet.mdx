    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint twitter СоздатьТвитВидео \
              --text "Тестовый твиттbd48c5e1-e51f-41f2-9568-f28c170399b4" \
              --videos "/tmp/k0ahjscq.aym" \
...
{
 "data": {
  "id": "1965756808502333508",
  "edit_history_tweet_ids": [
   "1965756808502333508"
  ],
  "text": "Тестовый твиттcc778cea-fce5-4441-9285-e65141b0ddc4 https://t.co/rSQh7flUZn"
 }
}
```
