    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитВидео \
              --text "Тестовый твитc80f75ff-83b4-4813-b293-675452913431" \
              --videos "C:\Users\bayse\AppData\Local\Temp\xm0jo5qv.lvo" \
...
```json title="Результат"
{
 "data": {
  ...
  "id": "2029950699350409412",
  "text": "Тестовый твит7b4762f9-8f7c-484f-bce9-e8f30283acac https://t.co/dCIJVS4sLO"
 }
}
```
