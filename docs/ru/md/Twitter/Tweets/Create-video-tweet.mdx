    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint twitter СоздатьТвитВидео \
              --text "Тестовый твиттa15af63b-0226-405c-8e4b-38ae6c4d2e51" \
              --videos "/tmp/i2udmtq0.q2j" \
...
```json title="Результат"
{
 "data": {
  ...
  "text": "Тестовый твитт013e5ea3-0e7c-4995-b334-6a3ac5f5522a https://t.co/1EW44TOI31",
  "id": "1965467231480943008"
 }
}
```
