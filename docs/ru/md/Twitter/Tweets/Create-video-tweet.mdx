    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter СоздатьТвитВидео \
              --text "Тестовый твитт911e5831-c335-4351-a415-85d11a927eb1" \
              --videos "C:\Users\bayse\AppData\Local\Temp\mdjt3xuf.1tr" \
...
{
 "data": {
  "text": "Тестовый твитт58994fca-a942-4bcf-bad7-ea48b190ef70 https://t.co/V5MSyGYc1o",
  "edit_history_tweet_ids": [
   null
  ],
  "id": "2007162668558295444"
 }
}
```
