    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint twitter ПолучитьСсылкуАвторизации \
              --auth "{'redirect_uri':'https://hut.openintegrations.dev/melezh/6ad91cc8b','client_id':'***','client_secret':'***','access_token':null,'refresh_token':'***','oauth_token':'***','oauth_token_secret':'***','oauth_consumer_key':'***','oauth_consumer_secret':'***'}"
        ```
    </TabItem>
