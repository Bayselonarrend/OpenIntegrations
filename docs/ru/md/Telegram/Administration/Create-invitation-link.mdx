    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram СоздатьСсылкуПриглашение \
              --token *** \
              --chat "@testsichee" \
              --title "Ссылка 09/08/2025 11:36:51" \
              --expire "2025-09-09T11:36:51.8010101" \
              --limit 200
        ```
    </TabItem>
...
```json title="Результат"
{
 "ok": true,
 "result": {
  "invite_link": "https://t.me/+ecUZm3cOg6YwZmEy",
  "name": "Ссылка 09/08/2025 08:11:10",
  "creator": {
   "id": 6129457865,
   "is_bot": true,
