    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram СоздатьСсылкуПриглашение \
              --token "***" \
              --chat "@testsichee" \
              --title "Ссылка 10/29/2025 16:16:40" \
              --expire "2025-10-30T16:16:40.9156641" \
              --limit 200
        ```
    </TabItem>
...
```json title="Результат"
{
 "ok": true,
 "result": {
  "invite_link": "https://t.me/+b6zCcgaXT51iNGVi",
  "name": "Ссылка 10/29/2025 16:16:40",
  "creator": {
   "id": 6129457865,
   "is_bot": true,
