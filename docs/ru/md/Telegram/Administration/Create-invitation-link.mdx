...
:::tip
Метод в документации API: [createChatInviteLink](https://core.telegram.org/bots/api#createchatinvitelink)<br/>
<br/>
:::
<br/>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram СоздатьСсылкуПриглашение \
              --token "***" \
              --chat "@testsichee" \
              --expire "2024-11-20T19:40:18.3793245" \
              --title "Ссылка 19.11.2024 19:40:18" \
              --limit 200
        ```
    </TabItem>
