    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram СоздатьСсылкуПриглашение \
              --token *** \
              --chat "@testsichee" \
              --title "Ссылка 09/08/2025 12:15:45" \
              --expire "2025-09-09T12:15:45.6788309" \
              --limit 200
        ```
    </TabItem>
...
```json title="Результат"
{
 "ok": true,
 "result": {
  "invite_link": "https://t.me/+SoTxrwIWbS45MWFi",
  "name": "Ссылка 09/08/2025 12:15:45",
  "creator": {
   "id": 6129457865,
   "is_bot": true,
