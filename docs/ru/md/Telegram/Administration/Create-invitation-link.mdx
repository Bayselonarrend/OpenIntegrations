    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram СоздатьСсылкуПриглашение \
              --token *** \
              --chat "@testsichee" \
              --title "Ссылка 09/08/2025 18:19:11" \
              --expire "2025-09-09T18:19:11.0007689" \
              --limit 200
        ```
    </TabItem>
...
```json title="Результат"
{
 "ok": true,
 "result": {
  "invite_link": "https://t.me/+56VMTwr1kzo3ZWNi",
  "name": "Ссылка 09/08/2025 18:19:11",
  "creator": {
   "id": 6129457865,
   "is_bot": true,
