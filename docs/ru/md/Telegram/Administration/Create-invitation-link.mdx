    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram СоздатьСсылкуПриглашение \
              --token *** \
              --chat "@testsichee" \
              --title "Ссылка 09/09/2025 17:15:29" \
              --expire "2025-09-10T17:15:29.6238617" \
              --limit 200
        ```
    </TabItem>
...
```json title="Результат"
{
 "ok": true,
 "result": {
  "invite_link": "https://t.me/+ek6ff1q_nSQ1NzY6",
  "name": "Ссылка 09/09/2025 17:15:29",
  "creator": {
   "id": 6129457865,
   "is_bot": true,
