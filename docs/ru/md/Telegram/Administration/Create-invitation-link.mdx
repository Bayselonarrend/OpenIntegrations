    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram СоздатьСсылкуПриглашение \
              --token "***" \
              --chat "@testsichee" \
              --title "Ссылка 9/16/2025 10:24:02 PM" \
              --expire "2025-09-17T22:24:02.925234" \
              --limit 200
        ```
    </TabItem>
...
```json title="Результат"
{
 "ok": true,
 "result": {
  "invite_link": "https://t.me/+77z8Of2BFrxiYzRi",
  "name": "Ссылка 9/16/2025 10:24:02 PM",
  "creator": {
   "id": 6129457865,
   "is_bot": true,
