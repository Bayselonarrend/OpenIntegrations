...
:::tip
Метод в документации API: [editGeneralForumTopic](https://core.telegram.org/bots/api#editgeneralforumtopic)<br/>
<br/>
:::
<br/>
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram ИзменитьИмяГлавнойТемыФорума \
              --token "***" \
              --forum "-1001971186208" \
              --title "Новое имя главной темы 4d072981-b1bd-4882-832e-c597fad294b3"
        ```
    </TabItem>
