    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint telegram ОтправитьМедиагруппу \
              ...
              --media "{'https://hut.openintegrations.dev/test_data/document.docx':'document','/tmp/re1hr5vw.rbx.docx':'document'}"
        ```
    </TabItem>
 ...
 "result": [
  {
   ...
   "date": 1759867953,
   "media_group_id": "14078943630115106",
   "photo": [
    {
  ...
  },
  {
   ...
   "video": {
    ...
    "mime_type": "video/mp4",
    "thumbnail": {
     "file_id": "AAMCAgADFQdo5XQxE2_MZ55X2qFLcSTlweRPAgACgIUAAr90KEuwM-Tq18oy3QEAB20AAzYE",
     "file_unique_id": "AQADgIUAAr90KEty",
     "file_size": 19828,
     "width": 320,
     "height": 240
    },
    ...
    "file_id": "BAACAgIAAxUHaOV0MRNvzGeeV9qhS3Ek5cHkTwIAAoCFAAK_dChLsDPk6tfKMt02BA",
    "file_unique_id": "AgADgIUAAr90KEs",
    "file_size": 1137878
   }
  }
 ]
