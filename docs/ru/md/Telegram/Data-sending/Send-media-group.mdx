    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram ОтправитьМедиагруппу \
              ...
              --media "{"https://hut.openintegrations.dev/test_data/document.docx":"document","/tmp/eyeuxedb.ase.docx":"document"}"
        ```
    </TabItem>
 ...
 "result": [
  {
   ...
   "date": 1757333651,
   "media_group_id": "14058669211493626",
   "photo": [
    {
  ...
  },
  {
   ...
   "video": {
    ...
    "mime_type": "video/mp4",
    "thumbnail": {
     "file_id": "AAMCAgADFQdovsiTVQrvmrvfmctqSRaPVKWD0QAC-34AAkvv-EnLDiTn_OBtwQEAB20AAzYE",
     "file_unique_id": "AQAD-34AAkvv-Ely",
     "file_size": 20106,
     "width": 320,
     "height": 240
    },
    ...
    "file_id": "BAACAgIAAxUHaL7Ik1UK75q735nLakkWj1Slg9EAAvt-AAJL7_hJyw4k5_zgbcE2BA",
    "file_unique_id": "AgAD-34AAkvv-Ek",
    "file_size": 1137878
   }
  }
 ]
