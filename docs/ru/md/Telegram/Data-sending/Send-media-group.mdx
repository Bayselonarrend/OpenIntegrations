    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint telegram ОтправитьМедиагруппу \
              ...
              --media "{'C:\\Users\\Administrator\\AppData\\Local\\Temp\\arfst10bklu.png':'photo','https://github.com/Bayselonarrend/OpenIntegrations/raw/main/service/test_data/video.mp4':'video'}"
        ```
    </TabItem>
