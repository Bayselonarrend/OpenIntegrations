    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram ОтправитьМедиагруппу \
              ...
              --media "{"https://hut.openintegrations.dev/test_data/document.docx":"document","/tmp/xhmooaty.ecu.docx":"document"}"
        ```
    </TabItem>
 ...
 "result": [
  {
   ...
   "date": 1757355455,
   "media_group_id": "14058843645836026",
   "photo": [
    {
  ...
  },
  {
   ...
   "video": {
    ...
    "mime_type": "video/mp4",
    "thumbnail": {
     "file_id": "AAMCAgADFQdovx2_u52A7qa8FwIvUW9tnRd8DAAC_oUAAkvv-Emb7EcSBGlQmAEAB20AAzYE",
     "file_unique_id": "AQAD_oUAAkvv-Ely",
     "file_size": 20106,
     "width": 320,
     "height": 240
    },
    ...
    "file_id": "BAACAgIAAxUHaL8dv7udgO6mvBcCL1FvbZ0XfAwAAv6FAAJL7_hJm-xHEgRpUJg2BA",
    "file_unique_id": "AgAD_oUAAkvv-Ek",
    "file_size": 1137878
   }
  }
 ]
