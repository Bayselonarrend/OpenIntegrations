    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint telegram ОтправитьМедиагруппу \
              ...
              --media "{'C:\\Users\\Administrator\\AppData\\Local\\Temp\\gmuvzxyoxdm.png':'photo','https://github.com/Bayselonarrend/OpenIntegrations/raw/main/service/test_data/video.mp4':'video'}"
        ```
    </TabItem>
