...
```json title="Результат"
{
 ...
 "result": {
  ...
  "animation": {
   ...
   "height": 220,
   "thumbnail": {
    "file_id": "AAMCAgADGQMAAiA9ZwQnDcimOGf8002klmvainUs_McAAtZhAAIDZSFISl166s97jUYBAAdtAAM2BA",
    "file_unique_id": "AQAD1mEAAgNlIUhy",
    "file_size": 11352,
    "width": 220,
    "height": 220
   },
   ...
   "file_id": "CgACAgIAAxkDAAIgPWcEJw3Ipjhn_NNNpJZr2op1LPzHAALWYQACA2UhSEpdeurPe41GNgQ",
   "file_unique_id": "AgAD1mEAAgNlIUg",
   "file_size": 84941
  },
  "document": {
   "file_name": "animation.gif.mp4",
