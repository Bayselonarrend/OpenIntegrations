    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram ОтправитьДокумент \
              ...
              --doc "C:\Users\bayse\AppData\Local\Temp\enmw2uoa.z0v" \
...
```json title="Результат"
{
 ...
 "result": {
  ...
  "document": {
   ...
   "file_id": "BQACAgIAAxkDAAJK22l5BCfYb74ESBy1-LPoDE9GLs_pAAI5mAACrJHJS9yUyD0n0W_iOAQ",
   "file_unique_id": "AgADOZgAAqyRyUs",
   "file_size": 24069
  },
