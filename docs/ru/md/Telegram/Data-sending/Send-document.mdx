    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram ОтправитьДокумент \
              ...
              --doc "C:\Users\bayse\AppData\Local\Temp\j3z3uj2k.d2n" \
...
```json title="Результат"
{
 ...
 "result": {
  ...
  "document": {
   ...
   "file_id": "BQACAgIAAxkDAAJI9mlXy_fBtait6ARb149-mA-h33jjAAIShgACPG3AStOmQ2FgrWFrOAQ",
   "file_unique_id": "AgADEoYAAjxtwEo",
   "file_size": 24069
  },
