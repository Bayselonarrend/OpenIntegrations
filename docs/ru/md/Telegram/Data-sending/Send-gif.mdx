...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Гифка    = "https://releases.openintegrations.dev/test_data/animation.gif";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram ОтправитьГифку \
              ...
              --gif "C:\Users\bayselonarrend\AppData\Local\Temp\rg1wqpum.ymh"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "result": {
  ...
  "animation": {
   ...
   "height": 220,
   "thumbnail": {
    "file_id": "AAMCAgADGQMAAl2NalfIoJ3Rm-sFPklI_L3nm08EjyEAAkydAAKb08BK69TdAAFAs7qpAQAHbQADPQQ",
    "file_unique_id": "AQADTJ0AApvTwEpy",
    "file_size": 11342,
    "width": "***",
    "height": 220
   },
   ...
   "file_id": "CgACAgIAAxkDAAJdjWpXyKCd0ZvrBT5JSPy955tPBI8hAAJMnQACm9PASuvU3QABQLO6qT0E",
   "file_unique_id": "AgADTJ0AApvTwEo",
   "file_size": 84979
  },
  "document": {
   "file_name": "animation.gif.mp4",
