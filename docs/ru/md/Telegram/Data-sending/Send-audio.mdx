    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram ОтправитьАудио \
              ...
              --audio "C:\Users\bayselonarrend\AppData\Local\Temp\lzkx3upz.iqi"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "result": {
  ...
  "audio": {
   ...
   "title": "Dogs",
   "performer": "Motorhead",
   "file_id": "CQACAgIAAxkDAAJQz2ndTwX_xzvYZOrKRQ6s-wWWeZQoAAI_nwACwXnpSu9THXD3fu6LOwQ",
   "file_unique_id": "AgADP58AAsF56Uo",
   "file_size": 9229352
  },
