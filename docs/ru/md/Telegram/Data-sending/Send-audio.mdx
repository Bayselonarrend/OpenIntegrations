    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram ОтправитьАудио \
              ...
              --audio "C:\Users\bayselonarrend\AppData\Local\Temp\zkhj2jor.vvh"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "result": {
  ...
  "audio": {
   ...
   "title": "Dogs",
   "performer": "Motorhead",
   "file_id": "CQACAgIAAxkDAAJWzGoqYRD6IfGTDKqAkw1JYXZ3dlIHAAIsowACNVJQSQxgcm2kQrSgOwQ",
   "file_unique_id": "AgADLKMAAjVSUEk",
   "file_size": 9229352
  },
