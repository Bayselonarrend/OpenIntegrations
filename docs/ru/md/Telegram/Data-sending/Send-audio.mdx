    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram ОтправитьАудио \
              ...
              --audio "C:\Users\bayse\AppData\Local\Temp\x1cpjkey.szr"
        ```
    </TabItem>
...
```json title="Результат"
{
 ...
 "result": {
  ...
  "audio": {
   ...
   "title": "Dogs",
   "performer": "Motorhead",
   "file_id": "CQACAgIAAxkDAAJLsmmG0xIDAtDJLNYD-HrwrFsaCmq6AAIHnAACpVsxSLY4j93uOnzXOgQ",
   "file_unique_id": "AgADB5wAAqVbMUg",
   "file_size": 9229352
  },
