...
:::tip
Метод в документации API: [getFile](https://core.telegram.org/bots/api#getfile)<br/>
<br/>
:::
<br/>
...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    IDФайла = "CQACAgIAAx0EcNsaZQACLaFnPujpQB1KQ5QoSGCtkhnUzX1Q2QACi1cAAktD-UklsOLt7kYekzYE";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram СкачатьФайл \
              --token "***" \
              --fileid "CQACAgIAAx0EcNsaZQACLUNnPL72XSxUpuAv0NsPuOFeYLoRcQACaWcAAgqX6UlH-h7y0NC_KjYE"
        ```
    </TabItem>
