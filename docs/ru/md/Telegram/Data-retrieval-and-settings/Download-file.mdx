...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    IDФайла = "CQACAgIAAx0EcNsaZQACUvJo5XAcXZofyuLkaWQchvsH-XYV1wACnYkAAihAMEsjczWoS8ZqGzYE";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint telegram СкачатьФайл \
              --token "***" \
              --fileid "CQACAgIAAx0EcNsaZQACU8Ro6MJMkr8lG-9TufAFOdtEzduphwACS3wAAshfSEv1JixJZgW63zYE"
        ```
    </TabItem>
