    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint msgpack СериализоватьДанные \
              --value "{'title':'Пример','count':'42','active':true,'payload':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\oetlptyl.fuf','nested':{'label':'nested','inner':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\3xgjpzxv.5tx'},'items':['tag','1',false,'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\r5o4nqji.og4']}"
        ```
    </TabItem>
