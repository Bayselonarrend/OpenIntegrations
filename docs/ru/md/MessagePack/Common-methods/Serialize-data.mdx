    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint msgpack СериализоватьДанные \
              --value "{'title':'Пример','count':'42','active':true,'payload':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\mzlqiaiz.y1c','nested':{'label':'nested','inner':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\2jgasuhl.jyv'},'items':['tag','1',false,'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\wchwiqsn.mb0']}"
        ```
    </TabItem>
