    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint msgpack СериализоватьДанные \
              --value "{'title':'Пример','count':'42','active':true,'payload':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\mmua1qtq.ogn','nested':{'label':'nested','inner':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\w0rxzf2d.hh4'},'items':['tag','1',false,'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\2kg1geaa.s2b']}"
        ```
    </TabItem>
