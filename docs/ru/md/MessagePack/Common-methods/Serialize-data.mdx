    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint msgpack СериализоватьДанные \
              --value "{'title':'Пример','count':'42','active':true,'payload':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\o53qppxt.0jj','nested':{'label':'nested','inner':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\skc1fugb.jyz'},'items':['tag','1',false,'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\p0c4jvsa.tpg']}"
        ```
    </TabItem>
