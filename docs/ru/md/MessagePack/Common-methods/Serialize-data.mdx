    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint msgpack СериализоватьДанные \
              --value "{'title':'Пример','count':'42','active':true,'payload':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\u0zz2q02.g4j','nested':{'label':'nested','inner':'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\exdibsvx.bcg'},'items':['tag','1',false,'C:\\Users\\bayselonarrend\\AppData\\Local\\Temp\\40js5omq.jki']}"
        ```
    </TabItem>
