    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint msgpack ДесериализоватьДанные \
              --data "\nНепредвиденная ошибка!: {Модуль {C:\Program Files (x86)\OInt\share\oint\lib\oint-cli\core\Classes\internal\Modules\Executor.os}:13:<exec> / Error in line: 3 / Внешнее исключение (System.IO.DirectoryNotFoundException): Could not find a part of the path 'C:\Program Files (x86)\OInt\share\oint\lib\oint\api\msgpack\Modules\OPI_MessagePack.os'.}\nOPI_MessagePack = ЗагрузитьСценарий("C:/Program Files (x86)/OInt/share/oint/lib/oint/api/msgpack/Modules/OPI_MessagePack.os", Контекст);\n\ncaused by:\nCould not find a part of the path 'C:\Program Files (x86)\OInt\share\oint\lib\oint\api\msgpack\Modules\OPI_MessagePack.os'.\n\n"
        ```
    </TabItem>
