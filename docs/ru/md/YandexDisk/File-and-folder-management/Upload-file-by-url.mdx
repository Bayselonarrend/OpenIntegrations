...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Адрес = "https://releases.openintegrations.dev/test_data/picture.jpg";
...
{
 "method": "GET",
 "href": "https://cloud-api.yandex.net/v1/disk/operations/96f0c772d29d15ccc3dc7e90f40b2643363e9bd5ef9d6864be83fc552b4a096e",
 "templated": false
}
```
