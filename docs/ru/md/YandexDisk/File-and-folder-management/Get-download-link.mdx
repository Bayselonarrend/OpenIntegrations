    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint yadisk ПолучитьСсылкуДляСкачивания \
              --token "***" \
              --path "/cd1fe306-bd58-4f43-9129-8051c1540139.png"
        ```
    </TabItem>
...
{
 "method": "GET",
 "href": "https://downloader.disk.yandex.ru/disk/0ac5affc3864707f39a83db22de60ce21a7be6436a9d6a95db6714b3e90b1ee3/6a5d59f5/Kdpe3dFisZLPovVA4r-aBmpkby3AOQiLsayEHYapOMw2ylFGSbZZrsWtGPTvHxG_-QDrqSGFBOOsS3b3gKT1zA%3D%3D?uid=1573541518&filename=c38c54db-05ed-4bce-ada3-687408965f78.png&disposition=attachment&hash=&limit=0&content_type=multipart&owner_uid=1573541518&fsize=2114023&hid=03d7263840468e281bd0b238a26e7d0d&media_type=image&tknv=v3&is_direct_zip_experiment=1&etag=9e0176f87f6565a22f78e0f9b39a4d78",
 "templated": false
}
```
