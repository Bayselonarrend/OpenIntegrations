...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    Картинка = "https://releases.openintegrations.dev/test_data/picture.jpg"; // URL
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint yadisk ЗагрузитьФайл \
              --token "***" \
              --path "/6a3473e9-f3e7-4b18-b550-6b7cb16bb122.png" \
              --file "C:\Users\bayselonarrend\AppData\Local\Temp\gfshmprv.2qh.png" \
              --rewrite true
        ```
    </TabItem>
