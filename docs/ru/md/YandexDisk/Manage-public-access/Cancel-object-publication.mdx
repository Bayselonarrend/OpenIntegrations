    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint yadisk ОтменитьПубликациюОбъекта \
              --token "***" \
              --path "/b8781dd4-cb8b-489d-8778-ac9540018ce4.png"
        ```
    </TabItem>
...
{
 "path": "disk:/b8781dd4-cb8b-489d-8778-ac9540018ce4.png",
 "type": "file",
 ...
 "file": "https://downloader.disk.yandex.ru/disk/b22cdaa76610fb24b76975152bd5cee7c9a2bf09b2165e1292892c2c858ef..."
}
```
