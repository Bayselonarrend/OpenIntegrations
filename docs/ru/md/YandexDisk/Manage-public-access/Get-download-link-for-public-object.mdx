...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    ...
    URL   = "https://yadi.sk/d/2JYnD6Hj64hsHg";
    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint yadisk ПолучитьСсылкуСкачиванияПубличногоОбъекта \
              --token "***" \
              --url "https://yadi.sk/d/PBD_6l9vvK6_vw"
        ```
    </TabItem>
...
{
 "method": "GET",
 "href": "https://downloader.disk.yandex.ru/disk/5c6fc04883fc8747daa7d3a2d2f02f961524b7a384755c4b106296c94f515...",
 "templated": false
}
```
