...
description: Получить структуру описания архива и другие функции для работы с Tar в Открытом пакете интеграций - бесплатной open-source библиотеке интеграций для 1С:Предприятие 8, OneScript и CLI
...
# Получить структуру описания архива
 Получает структуру описания данных для запаковки без каталога на диске
...
```bsl title="Пример использования для 1С:Предприятие/OneScript"
    Результат = OPI_Tar.ПолучитьСтруктуруОписанияАрхива();
```
