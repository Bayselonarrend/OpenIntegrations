    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            oint tar РазархивироватьКаталог \
              --src "C:\Users\bayselonarrend\AppData\Local\Temp\\opi_tar_modify_63918854116310/archive.tar" \
              --dest "C:\Users\bayselonarrend\AppData\Local\Temp\\opi_tar_modify_63918854116310/out"
        ```
    </TabItem>
