    ...
    <TabItem value="bash" label="Bash" default>
        ```bash
            ...
            oint ssh ВыполнитьКоманду \
              --conn "{'set':{'auth_type':'password','host':'172.33.0.13','port':'2222','username':'bayselonarrend','password':'***'},'proxy':{'server':'127.0.0.1','port':'1080','proxy_type':'socks5','login':'proxyuser','password':'***'}}" \
              --comm "whoami"
        ```
    </TabItem>
