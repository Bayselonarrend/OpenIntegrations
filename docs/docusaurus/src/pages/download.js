...
const cliInstallByOs = [
  {
    os: 'Debian / Ubuntu',
    commands: {
      ru: `wget https://github.com/Bayselonarrend/OpenIntegrations/releases/download/2.2.0/oint_2.2.0_all_ru.deb
sudo apt install -y ./oint_2.2.0_all_ru.deb`,
      en: `wget https://github.com/Bayselonarrend/OpenIntegrations/releases/download/2.2.0/oint_2.2.0_all_en.deb
sudo apt install -y ./oint_2.2.0_all_en.deb`,
    },
  },
  {
    os: 'Fedora / RHEL',
    commands: {
      ru: `wget https://github.com/Bayselonarrend/OpenIntegrations/releases/download/2.2.0/oint-2.2.0-1.noarch_ru.rpm
sudo rpm -i oint-2.2.0-1.noarch_ru.rpm`,
      en: `wget https://github.com/Bayselonarrend/OpenIntegrations/releases/download/2.2.0/oint-2.2.0-1.noarch_en.rpm
sudo rpm -i oint-2.2.0-1.noarch_en.rpm`,
    },
  },
  {
    os: 'Linux (AppImage)',
    commands: {
      ru: `wget https://github.com/Bayselonarrend/OpenIntegrations/releases/download/2.2.0/oint-2.2.0_ru-x86_64.AppImage
chmod +x ./oint-2.2.0_ru-x86_64.AppImage
./oint-2.2.0_ru-x86_64.AppImage`,
      en: `wget https://github.com/Bayselonarrend/OpenIntegrations/releases/download/2.2.0/oint-2.2.0_en-x86_64.AppImage
chmod +x ./oint-2.2.0_en-x86_64.AppImage
./oint-2.2.0_en-x86_64.AppImage`,
    },
  },
];
      ...
      items: [
        {
          name: 'CFE (расширение)',
          files: {
            ru: 'OpenIntegrations_2.2.0_ru.cfe',
            en: 'OpenIntegrations_2.2.0_en.cfe',
          },
        ...
        },
        {
          ...
          files: {
            ru: 'OpenIntegrations_2.2.0_ru.cf',
            en: 'OpenIntegrations_2.2.0_en.cf',
          },
      ...
      items: [
        {
          ...
          files: {
            ru: 'oint-2.2.0_ru.ospx',
            en: 'oint-2.2.0_en.ospx',
          },
        ...
        },
        {
          ...
          files: {
            ru: 'oint-cli-2.2.0_ru.ospx',
            en: 'oint-cli-2.2.0_en.ospx',
          },
      ...
      items: [
        {
          ...
          files: {
            ru: 'oint_2.2.0_installer_ru.exe',
            en: 'oint_2.2.0_installer_en.exe',
          },
        ...
        },
        {
          ...
          files: {
            ru: 'oint_2.2.0_all_ru.deb',
            en: 'oint_2.2.0_all_en.deb',
          },
        ...
        },
        {
          ...
          files: {
            ru: 'oint-2.2.0-1.noarch_ru.rpm',
            en: 'oint-2.2.0-1.noarch_en.rpm',
          },
        ...
        },
        {
          name: 'Linux (.AppImage)',
          files: {
            ru: 'oint-2.2.0_ru-x86_64.AppImage',
            en: 'oint-2.2.0_en-x86_64.AppImage',
          },
        ...
        <div className={styles.downloadHeaderWrapper}>
          ...
          <div>
            ...
            <p className={styles.downloadSubtitle}>
              Текущая версия: 2.2.0 | Выберите подходящий язык и вариант поставки
            </p>
          </div>
        </div>
