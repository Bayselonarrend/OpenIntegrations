      ...
      items: [
        {
          name: 'CFE (расширение)',
          files: {
            ru: 'OpenIntegrations_1.33.0_ru.cfe',
            en: 'OpenIntegrations_1.33.0_en.cfe',
          },
      ...
      items: [
        {
          ...
          files: {
            ru: 'oint_1.33.0_installer_ru.exe',
            en: 'oint_1.33.0_installer_en.exe',
          },
        ...
        },
        {
          ...
          files: {
            ru: 'oint_1.33.0_all_ru.deb',
            en: 'oint_1.33.0_all_en.deb',
          },
        ...
        },
        {
          ...
          files: {
            ru: 'oint-1.33.0-1.noarch_ru.rpm',
            en: 'oint-1.33.0-1.noarch_en.rpm',
          },
      ...
      items: [
        {
          ...
          files: {
            ru: 'oint-1.33.0_ru.ospx',
            en: 'oint-1.33.0_en.ospx',
          },
        ...
        },
        {
          ...
          files: {
            ru: 'oint-cli-1.33.0_ru.ospx',
            en: 'oint-cli-1.33.0_en.ospx',
          },
        ...
        <div className={styles.downloadHeaderWrapper}>
          ...
          <div>
            ...
            <p className={styles.downloadSubtitle}>
              Текущая версия: 1.33.0 | Выберите подходящий язык и вариант поставки
            </p>
          </div>
        </div>
