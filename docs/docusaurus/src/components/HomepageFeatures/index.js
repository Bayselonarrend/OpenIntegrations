...
const FeatureList = [
  {
    ...
    description: (
      <>
		Пакет содержит множество методов для работы с различными API. Эти методы не требуют глубокого погружения в тонкости работы, но и не ограничивают вас в возможности их модификации
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ОПИ легко интегрировать в любой проект: в виде проекта EDT, 1C-расширения или пакета OneScript. Для интеграции, независимой от конкретных технологий, есть CLI версия под Windows и Linux
      </>
    ),
  },
  {
