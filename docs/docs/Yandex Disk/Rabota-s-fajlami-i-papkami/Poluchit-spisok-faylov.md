...
*Функция ПолучитьСписокФайлов(Знач Токен, Знач Количество = 0, Знач СмещениеОтНачала = 0, Знач ОтборПоТипу = "", Знач СортироватьПоДате = Ложь) Экспорт*
  ...
  | Количество | Число | Количество файлов в возвращаемом списке |
  | СмещениеОтНачала | Число | Число пропускаемых файлов с начала списка |
  | ОтборПоТипу | Строка | Отбор по типу файлов |
  | СортироватьПоДате | Булево | Истина - по дате, Ложь - по имени |
