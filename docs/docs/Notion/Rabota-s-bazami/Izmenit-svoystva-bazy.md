...
*Функция ИзменитьСвойстваБазы(Знач Токен, Знач База, Знач Свойства = "", Знач Заголовок = "", Знач Описание = "") Экспорт*
  ...
  | Свойства | --props | Соответствие | Ключ - Имя изменяемого свойства, Значение - Тип или неопределено. Если неопределено - свойство удаляется  |
  | Заголовок | --title | Строка | Заголовок базы |
  | Описание | --description | Строка | Описание базы |
