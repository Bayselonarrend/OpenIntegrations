...
Процедура СоздатьПакеты(Данные)
	...
	СоответствиеДополнений.Вставить("deb", "--depends libssl3 --depends 'openssl >= 1.1.1' ");
	СоответствиеДополнений.Вставить("rpm", " --rpm-os linux --depends libicu --depends 'openssl >= 1.1.1' ");
