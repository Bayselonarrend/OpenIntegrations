...
Процедура СоздатьПакеты(Данные)
	...
	СоответствиеДополнений.Вставить("deb", "--depends 'libssl3' ");
	СоответствиеДополнений.Вставить("rpm", " --rpm-os linux --depends libicu --depends 'openssl-libs >= 3.0.0, openssl-libs < 4.0.0' ");
