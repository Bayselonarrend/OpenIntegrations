...
Процедура СоздатьПакеты(Данные)
	...
	СоответствиеДополнений.Вставить("deb", "--depends libssl3 --depends 'openssl = 1.0.0' ");
	СоответствиеДополнений.Вставить("rpm", " --rpm-os linux --depends libicu --depends 'openssl = 1.0.0' ");
