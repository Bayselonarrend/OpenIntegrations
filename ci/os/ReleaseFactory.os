...
Процедура ПриСозданииОбъекта(Знач ДанныеПроекта_ = Неопределено)
	...
	НеобходимоеЧислоАртефактов = Артефакты.ОжидаемоеКоличество(Версия);
