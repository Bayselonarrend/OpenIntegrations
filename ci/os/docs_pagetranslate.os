...
Для Каждого Файл Из МассивФайлов Цикл
	...
	ТекущийТекст = СтрЗаменить(ТекущийТекст, "Наши спонсоры", "Our Sponsors");
	ТекущийТекст = СтрЗаменить(ТекущийТекст, "Благодарим наших спонсоров за поддержку проекта", "We thank our sponsors for supporting the project");
	ТекущийТекст = СтрЗаменить(ТекущийТекст, "Стабильный шлюз WhatsApp API", "Stable WhatsApp API Gateway");
