...
Процедура ОбработатьНесовпаденияOneScript(ТекстМодуля, ПутьКМодулю)
	...
	СоответствиеОшибок.Вставить("ConcatBinaryData"                 , "СоединитьДвоичныеДанные");
	...
	СоответствиеОшибок.Вставить("GetStringFromBinaryData"          , "ПолучитьСтрокуИзДвоичныхДанных");
	СоответствиеОшибок.Вставить("GetBinaryDataBufferFromString"    , "ПолучитьБуферДвоичныхДанныхИзСтроки");
	СоответствиеОшибок.Вставить("GetBinaryDataFromHexString"       , "ПолучитьДвоичныеДанныеИзHexСтроки");
	СоответствиеОшибок.Вставить("GetBinaryDataBufferFromBinaryData", "ПолучитьБуферДвоичныхДанныхИзДвоичныхДанных");
