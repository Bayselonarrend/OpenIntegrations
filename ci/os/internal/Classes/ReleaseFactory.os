...
Процедура СоздатьOSPX(Данные)
	...
	МассивОписанийOSPX = Новый Массив;
	МассивОписанийOSPX.Добавить("oint");
	МассивОписанийOSPX.Добавить("oint-cli");
	
	Для Каждого ИдентификаторOSPX Из МассивОписанийOSPX Цикл
...
Процедура СоздатьПакеты(Данные)
	...
	Для Каждого Пакет Из ВидыПакетов Цикл
		...
		ПутьШаблонаСкрипта = Пакет["value"]["buildScript"]["value"];
		Дистрибутив        = Пакет["value"]["wslDistro"]["value"];
