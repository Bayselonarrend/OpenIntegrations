...
Процедура ПриСозданииОбъекта(КлючРасшифровки_ = Неопределено)
	...
	ДанныеКонфигурации       = Новый Массив;
	...
	Для Каждого ПутьКонфигурации Из МассивФайловКонфигурации Цикл
		...
		ДанныеКонфигурации.Добавить(ПрочитатьJSON(ЧтениеJSON, Истина));
		ЧтениеJSON.Закрыть();
	КонецЦикла;
...
Функция ПолучитьЗначениеНастройки(Знач Имя) Экспорт
	...
	Для Н = 0 По ДанныеКонфигурации.ВГраница() Цикл

		ТекущиеДанные = ДанныеКонфигурации[Н];
		...
		Для Каждого Часть Из ЧастиИмени Цикл
			...
			Исключение
				...
				Если Н = ДанныеКонфигурации.ВГраница() Тогда
