...
Функция ПолучитьЗначениеНастройкиЛокализации(Знач Имя, Зная Язык) Экспорт
...
Функция ПолучитьСопоставлениеФайлов() Экспорт
	...
	Если СопоставлениеФайлов = Неопределено Тогда
		...
		ОсновнойПутьИсходников = ПолучитьЗначениеНастройки("paths.configurationSrc");
		ОсновнойЯзык           = ПолучитьЗначениеНастройки("localization.mainLang");
		ОсновнойПутьИсходников = ОсновнойПутьИсходников + ОсновнойЯзык;
