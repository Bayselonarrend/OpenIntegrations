...
Процедура ПриСозданииОбъекта(Знач ДанныеПроекта = Неопределено) Экспорт
	...
	Tools.СообщитьПроцесс("Формирование jenkinsfile тестирования");
	...
	ХостJenkins = ДанныеПроекта.ПолучитьЗначениеНастройки("local.jenkinsSrc");
	...
	Для Каждого Язык Из Языки Цикл
		...
		ЛокальныеПараметры = ДанныеПроекта.ПолучитьЗначениеНастройки("localization.langsVars." + Язык);;
