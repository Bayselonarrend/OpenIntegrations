...
Процедура СоздатьДублеры(ФайлыДублеров)
	...
	Для Каждого Оригиналы Из СоответствиеМетодовОригиналов Цикл
		...
		ТекстОригинала = Новый ДвоичныеДанные(ТекущийМодуль);
		...
		CommonTools.ЗаписатьТекст(ТекстОригинала, ТекущийМодуль);
