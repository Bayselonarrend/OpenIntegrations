...
Процедура ПриСозданииОбъекта(Знач ДанныеПроекта = Неопределено)
    ...
    Языки             = ДанныеПроекта.ПолучитьЗначениеНастройки("localization.languages");
    КаталогДополнений = ДанныеПроекта.ПолучитьЗначениеНастройки("paths.paramsExamplesSrc");

    CommonTools.СообщитьПроцесс("Формирование CLI версии");
