...
Процедура ПриСозданииОбъекта(Знач ДанныеПроекта_ = Неопределено)
    ...
    Для Каждого Язык Из Языки Цикл
        ...
        ЗаполнитьТаблицыСостава(Язык, КаталогИндекса);
        ЗаписатьИнструментыMCP(КаталогИндекса);
...
Процедура ЗаполнитьТаблицыСостава(Язык, КаталогИндекса)
...
Функция ПолучитьИмяИнструмента(Библиотека, Значение, Язык)
    ...
    ПереведенноеИмя = Синонимайзер(Значение);
...
Процедура ДополнитьМассивИнструментов(МассивМетодов, ТекущаяБиблиотека, Язык)
    ...
    Для Каждого Метод Из МассивМетодов Цикл
        ...
        Для Каждого Параметр Из Метод["params"] Цикл
            ...
            СтруктураПараметра.Вставить("description", "string");
...
Процедура ЗаписатьИнструментыMCP(КаталогИндекса)

    Путь = ОбъединитьПути(КаталогИндекса, "mcp.json");
