Функция ПолучитьСостав() Экспорт
    ...
    НоваяСтрока.Библиотека  = "dropbox";
    НоваяСтрока.Модуль      = "OPI_Dropbox";
    НоваяСтрока.Метод       = "ВостановитьОбъектКВерсии";
    НоваяСтрока.МетодПоиска = "ВОСТАНОВИТЬОБЪЕКТКВЕРСИИ";
    НоваяСтрока.Параметр    = "--token";
    НоваяСтрока.Описание    = "Токен";
    НоваяСтрока.Область     = "Работа с файлами и каталогами";
    НоваяСтрока.ОписаниеМетода   = "Востанавливает состояние объекта к необходимой версии (ревизии)";
