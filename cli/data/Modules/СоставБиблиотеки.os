Функция ПолучитьСостав() Экспорт
...

 {
    ...
    НоваяСтрока.Обработка   = "Строка";
    НоваяСтрока.ОписаниеМетода   = "Выполняет запрос 
getMe, возвращающий базовую информацию о боте: имя, id, возможность добавлять бота в группы и т.д.";
    ...
    НоваяСтрока.Обработка   = "Строка";
    НоваяСтрока.ОписаниеМетода   = "Выполняет запрос 
getUpdates, возвращающий информацию о событиях бота. Используется при работе в polling режиме";
