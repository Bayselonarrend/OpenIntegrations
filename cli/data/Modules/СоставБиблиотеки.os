...
Функция ПолучитьСостав() Экспорт
    ...
    НоваяСтрока.Описание    = "Признак ""Это реклама"" (Ложь по ум.) (необяз. по ум. - False)";
    ...
    НоваяСтрока.МетодПоиска = "СОЗДАТЬПОСТ";
    НоваяСтрока.Параметр    = "--url";
    НоваяСтрока.Описание    = "Ссылка (URL) под записью (необяз.) (необяз. по ум. - Пустое значение)";
    ...
    НоваяСтрока.МетодПоиска = "СОЗДАТЬИСТОРИЮ";
    НоваяСтрока.Параметр    = "--url";
    НоваяСтрока.Описание    = "URL для кнопки под историей (необяз.) (необяз. по ум. - Пустое значение)";
    ...
    НоваяСтрока.Описание    = "Удалить полностью (Истина) или закрыть (Ложь, по ум.) (необяз. по ум. - False)";
