...
Функция ПолучитьСостав() Экспорт
    ...
    НоваяСтрока.Описание    = "Признак ""Это реклама"" (Ложь по ум.) (необяз. по ум. - Нет)";
    ...
    НоваяСтрока.Описание    = "Удалить полностью (Истина) или закрыть (Ложь, по ум.) (необяз. по ум. - Нет)";
