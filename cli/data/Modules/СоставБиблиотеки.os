Функция ПолучитьСостав() Экспорт
    ...
    НоваяСтрока.Описание    = "разрешение на методы Calendar";
    ...
    НоваяСтрока.Описание    = "разрешение на методы Drive";
    ...
    НоваяСтрока.Описание    = "Отбор по имени";
    ...
    НоваяСтрока.Описание    = "Добавляет список файлов к полям каталога";
    ...
    НоваяСтрока.Описание    = "Отбор по ID каталога родителя";
    ...
    НоваяСтрока.МетодПоиска = "СКОПИРОВАТЬОБЪЕКТ";
    НоваяСтрока.Параметр    = "--title";
    НоваяСтрока.Описание    = "Новое имя объекта";
    ...
    НоваяСтрока.МетодПоиска = "СКОПИРОВАТЬОБЪЕКТ";
    НоваяСтрока.Параметр    = "--catalog";
    НоваяСтрока.Описание    = "Новый каталог размещения";
    ...
    НоваяСтрока.МетодПоиска = "ОБНОВИТЬФАЙЛ";
    НоваяСтрока.Параметр    = "--title";
    НоваяСтрока.Описание    = "Новое имя файла (если необходимо)";
    ...
    НоваяСтрока.Описание    = "Новое описание календаря";
    ...
    НоваяСтрока.Описание    = "Скрытый календарь";
    ...
    НоваяСтрока.МетодПоиска = "ИЗМЕНИТЬСВОЙСТВАСТРАНИЦЫ";
    НоваяСтрока.Параметр    = "--data";
    НоваяСтрока.Описание    = "Соответствие изменяемых параметров";
    ...
    НоваяСтрока.Метод       = "ИзменитьСвойстваСтраницы";
    НоваяСтрока.МетодПоиска = "ИЗМЕНИТЬСВОЙСТВАСТРАНИЦЫ";
    НоваяСтрока.Параметр    = "--иконки страницы";
    НоваяСтрока.Описание    = "icon";
    ...
    НоваяСтрока.Метод       = "ИзменитьСвойстваСтраницы";
    НоваяСтрока.МетодПоиска = "ИЗМЕНИТЬСВОЙСТВАСТРАНИЦЫ";
    НоваяСтрока.Параметр    = "--обложки страницы";
    НоваяСтрока.Описание    = "cover";
    ...
    НоваяСтрока.Описание    = "Архивировать страницу или нет (булево)";
    ...
    НоваяСтрока.МетодПоиска = "СОЗДАТЬБАЗУДАННЫХ";
    НоваяСтрока.Параметр    = "--props";
    НоваяСтрока.Описание    = "Свойства базы данных";
    ...
    НоваяСтрока.МетодПоиска = "ИЗМЕНИТЬСВОЙСТВАБАЗЫ";
    НоваяСтрока.Параметр    = "--title";
    НоваяСтрока.Описание    = "Новый заголовок базы";
    ...
    НоваяСтрока.МетодПоиска = "ИЗМЕНИТЬСВОЙСТВАБАЗЫ";
    НоваяСтрока.Параметр    = "--description";
    НоваяСтрока.Описание    = "Новое описание базы";
    ...
    НоваяСтрока.Описание    = "ID блока, после которого необходимо встаивть новый";
    ...
    НоваяСтрока.Описание    = "Истина > служебные поля удаляются, остается только сам блок";
 ...
 |    для дальнейших действий";
    ...
    НоваяСтрока.Описание    = "В корзину";
    ...
    НоваяСтрока.Описание    = "Перезаписывать если файл с таким именем уже существует";
 ...
 |                            mage, settings, spreadsheet, text, unknown, video, web";
    ...
    НоваяСтрока.Описание    = "Количество возвращаемых объектов";
    ...
    НоваяСтрока.Описание    = "Смещение для получение объектов не из начала списка";
    ...
    НоваяСтрока.Описание    = "Отбор по типу файла";
    ...
    НоваяСтрока.Описание    = "Истина > сортировать по дате, Ложь > по алфавиту";
    ...
    НоваяСтрока.Метод       = "ПереместитьОбъект";
    НоваяСтрока.МетодПоиска = "ПЕРЕМЕСТИТЬОБЪЕКТ";
    НоваяСтрока.Параметр    = "--назначение для перемещения";
    НоваяСтрока.Описание    = "to";
    ...
    НоваяСтрока.МетодПоиска = "ПОЛУЧИТЬПУБЛИЧНЫЙОБЪЕКТ";
    НоваяСтрока.Параметр    = "--amount";
    НоваяСтрока.Описание    = "Количество возвращаемых вложенных объектов (для каталога)";
    ...
    НоваяСтрока.МетодПоиска = "ПОЛУЧИТЬПУБЛИЧНЫЙОБЪЕКТ";
    НоваяСтрока.Параметр    = "--offset";
    НоваяСтрока.Описание    = "Смещение для получение вложенных объектов не из начала списка";
    ...
    НоваяСтрока.МетодПоиска = "ПОЛУЧИТЬССЫЛКУСКАЧИВАНИЯПУБЛИЧНОГООБЪЕКТА";
    НоваяСтрока.Параметр    = "--path";
    НоваяСтрока.Описание    = "Путь внутри объекта";
    ...
    НоваяСтрока.МетодПоиска = "СОХРАНИТЬПУБЛИЧНЫЙОБЪЕКТНАДИСК";
    НоваяСтрока.Параметр    = "--from";
    НоваяСтрока.Описание    = "Путь внутри публичного каталога (только для папок)";
    ...
    НоваяСтрока.МетодПоиска = "СОХРАНИТЬПУБЛИЧНЫЙОБЪЕКТНАДИСК";
    НоваяСтрока.Параметр    = "--to";
    НоваяСтрока.Описание    = "Путь сохранения файла";
 ...
 |    ID пользователя из информации о канале не подойдет для отправки сообщений через бота - они разные";
    ...
    НоваяСтрока.Описание    = "Размер файла. Если не заполнен > определяется автоматически скачиванием файла";
