...
СоответствиеКомандМодулей.Вставить("jenva", "Дженва");
...
Функция ПолучитьСостав() Экспорт
    ...
    НоваяСтрока.Библиотека  = "jenva";
    НоваяСтрока.Модуль      = "Дженва";
    НоваяСтрока.Метод       = "РазложитьJSONНаПараметры";
    НоваяСтрока.МетодПоиска = "РАЗЛОЖИТЬJSONНАПАРАМЕТРЫ";
    ...
    НоваяСтрока.Описание    = "Ограничение на уровень вложенности поля. Разбирает на всю глубину по умолчанию (необяз. по ум. - Пустое значение)";
    ...
    НоваяСтрока.Описание    = "Имя поля, значение которого необходимо получить. Выводит весь список доступных, если не указано (необяз. по ум. - Пустое значение)";
