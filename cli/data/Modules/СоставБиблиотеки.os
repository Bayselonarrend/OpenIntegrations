Функция ПолучитьСостав() Экспорт
    ...
    НоваяСтрока.ОписаниеМетода   = "Получение ссылки для интерактивного получения токена (access_token), который необходим для дальнейших действий";
    ...
    НоваяСтрока.Обработка   = "Строка";
    НоваяСтрока.ОписаниеМетода   = "Создает пост с картинками Структура данных авторизации: { ""access_token"": """", ""from_group""  : ""1"", ""owner_id""    : """", ""v""           : ""5.131"", ""app_id""      : """", ""group_id""    : """" }";
    ...
    НоваяСтрока.Обработка   = "Строка";
    НоваяСтрока.ОписаниеМетода   = "Удаляет пост по id Структура данных авторизации: { ""access_token"": """", ""from_group""  : ""1"", ""owner_id""    : """", ""v""           : ""5.131"", ""app_id""      : """", ""group_id""    : """" } Пример строки массива картинок: --options ""['Вариант1', 'Вариант2']""";
    ...
    НоваяСтрока.Обработка   = "Строка";
    НоваяСтрока.ОписаниеМетода   = "Создает опрос с вариантами ответа Структура данных авторизации: { ""access_token"": """", ""from_group""  : ""1"", ""owner_id""    : """", ""v""           : ""5.131"", ""app_id""      : """", ""group_id""    : """" }";
    ...
    НоваяСтрока.Описание    = "Токен бота";
    НоваяСтрока.Обработка   = "Строка";
    НоваяСтрока.ОписаниеМетода   = "Отправляет набор файлов в чат или канал. Варианты типов медиа: audio, document, photo, video Структура данных медиагруппы { ""ПутьКФайлу"": ""ТипМедиа"", ""ПутьКФайлу"": ""ТипМедиа"", ... }";
    ...
    НоваяСтрока.Описание    = "Токен бота";
    НоваяСтрока.Обработка   = "Строка";
    НоваяСтрока.ОписаниеМетода   = "Отправляет опрос с вариантами ответа Пример строки массива вариантов ответа --options ""['Вар1','Вар2']""";
    ...
    НоваяСтрока.Обработка   = "Массив";
    НоваяСтрока.ОписаниеМетода   = "Формирует простую JSON клавиатуру из массив кнопок для сообщения или нижней панели Пример строки массива кнопок: --buttons ""['Кнопка1','Кнопка2']""";
